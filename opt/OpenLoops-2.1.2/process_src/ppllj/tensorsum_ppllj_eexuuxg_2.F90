...
! **********************************************************************
module ol_tables_storage_ppllj_eexuuxg_2_/**/REALKIND
! **********************************************************************
...
end module ol_tables_storage_ppllj_eexuuxg_2_/**/REALKIND

! **********************************************************************
module ol_tensor_sum_storage_ppllj_eexuuxg_2_/**/REALKIND
! **********************************************************************
  use KIND_TYPES, only: REALKIND, QREALKIND, intkind2
  ...
  type(hcl), save, dimension(51) :: G0tensor
...
integer, save :: mass4set(0:3,1)
  ...
  type(hcl), save, dimension(34) :: T0sum
...
!**********************************************************************
  ...
  use ol_loop_storage_ppllj_eexuuxg_2_/**/DREALKIND, only: nhel
  use ol_data_types_/**/REALKIND, only: hol
...
!**********************************************************************
  ...
  call hcl_allocation(1,G0tensor, 51)
...
!**********************************************************************
  ...
  implicit none
    ...
    call hcl_allocation(1,T0sum,34)
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_ppllj_eexuuxg_2")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_ppllj_eexuuxg_2")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 0
...
! **********************************************************************
  ...
  masses2_7 = [ nMT, nMT ]
  masses2_8 = [ 0, 0, 0 ]
  masses2_9 = [ nMB, nMB, nMB ]
  masses2_10 = [ nMC, nMC, nMC ]
  masses2_11 = [ nMT, nMT, nMT ]
  masses2_12 = [ 0, 0, 0, 0 ]
...
! **********************************************************************
...
#endif
  call TI_call_OL(0,0, momenta_20, masses2_12, T0sum(1), M2)
  call TI_call_OL(0,0, momenta_19, masses2_12, T0sum(2), M2)
  call TI_call_OL(0,0, momenta_18, masses2_12, T0sum(3), M2)
  call TI_call_OL(0,0, momenta_10, masses2_8, T0sum(4), M2)
  call TI_call_OL(0,0, momenta_15, masses2_8, T0sum(5), M2)
  call TI_call_OL(0,0, momenta_9, masses2_8, T0sum(6), M2)
  call TI_call_OL(0,0, momenta_16, masses2_8, T0sum(7), M2)
  call TI_call_OL(0,0, momenta_17, masses2_8, T0sum(8), M2)
  call TI_call_OL(0,0, momenta_11, masses2_8, T0sum(9), M2)
  call TI_call_OL(0,0, momenta_14, masses2_8, T0sum(10), M2)
  call TI_call_OL(0,0, momenta_12, masses2_8, T0sum(11), M2)
  call TI_call_OL(0,0, momenta_13, masses2_8, T0sum(12), M2)
  call TI_call_OL(0,0, momenta_9, masses2_10, T0sum(13), M2)
  call TI_call_OL(0,0, momenta_9, masses2_11, T0sum(14), M2)
  call TI_call_OL(0,0, momenta_9, masses2_9, T0sum(15), M2)
  ...
  call TI_call_OL(0,0, momenta_8, masses2_1, T0sum(19), M2)
  call TI_call_OL(0,0, momenta_5, masses2_1, T0sum(20), M2)
  call TI_call_OL(0,0, momenta_3, masses2_1, T0sum(21), M2)
  call TI_call_OL(0,0, momenta_6, masses2_1, T0sum(22), M2)
  call TI_call_OL(0,0, momenta_8, masses2_6, T0sum(23), M2)
  call TI_call_OL(0,0, momenta_3, masses2_6, T0sum(24), M2)
  call TI_call_OL(0,0, momenta_2, masses2_6, T0sum(25), M2)
  call TI_call_OL(0,0, momenta_1, masses2_3, T0sum(26), M2)
  call TI_call_OL(0,0, momenta_8, masses2_7, T0sum(27), M2)
  call TI_call_OL(0,0, momenta_3, masses2_7, T0sum(28), M2)
  call TI_call_OL(0,0, momenta_2, masses2_7, T0sum(29), M2)
  call TI_call_OL(0,0, momenta_1, masses2_4, T0sum(30), M2)
  call TI_call_OL(0,0, momenta_8, masses2_5, T0sum(31), M2)
  call TI_call_OL(0,0, momenta_3, masses2_5, T0sum(32), M2)
  call TI_call_OL(0,0, momenta_2, masses2_5, T0sum(33), M2)
  call TI_call_OL(0,0, momenta_1, masses2_2, T0sum(34), M2)
...
end module ol_tensor_sum_storage_ppllj_eexuuxg_2_/**/REALKIND
