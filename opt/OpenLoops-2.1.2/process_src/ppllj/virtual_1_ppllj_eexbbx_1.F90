...
module ol_vamp_1_ppllj_eexbbx_1_/**/REALKIND
contains

! **********************************************************************
subroutine vamp_1(M)
! P(0:3,nlegs) = incoming external momenta
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_ppllj_eexbbx_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_ppllj_eexbbx_1.
! **********************************************************************
  ...
  use ol_tables_storage_ppllj_eexbbx_1_/**/DREALKIND
...
! Dressing, otf merging and otf reduction calls to build loop structures
  ...
  call G0_hol_initialisation(ntryL,Gcoeff,G0H16(1),m0h(2),h0tab(:,2),[8,3,4],[nMB,nMB,0],3,1,wf4(:,5))
...
end module ol_vamp_1_ppllj_eexbbx_1_/**/REALKIND
