...
! **********************************************************************
module ol_tables_storage_ppllj_nenexccxg_1_/**/REALKIND
! **********************************************************************
...
integer(intkind2), save :: h0tab(32,21)
integer(intkind2), save :: heltab2x2(2,2,15)
integer(intkind2), save :: heltab2x4(2,4,11)
integer(intkind2), save :: heltab2x8(2,8,10)
integer(intkind2), save :: heltab2x16(2,16,17)
integer(intkind2), save :: heltab2x32(2,32,21)


  ! number of helicity states for openloops recursion steps
integer(intkind2), save :: m0h(21)
...
end module ol_tables_storage_ppllj_nenexccxg_1_/**/REALKIND

! **********************************************************************
module ol_tensor_sum_storage_ppllj_nenexccxg_1_/**/REALKIND
! **********************************************************************
  use KIND_TYPES, only: REALKIND, QREALKIND, intkind2
...
!**********************************************************************
  ...
  use ol_loop_storage_ppllj_nenexccxg_1_/**/DREALKIND, only: nhel
  use ol_data_types_/**/REALKIND, only: hol
  ...
  call hol_allocation(4,5,4,4,G1H4,2)
...
!**********************************************************************
  ...
  call hol_allocation(4,5,4,min(nhel,4),G1H4,2)
...
!**********************************************************************
  ...
  call hol_deallocation(G1H4,2,dmode)
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_ppllj_nenexccxg_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_ppllj_nenexccxg_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 0
...
end module ol_tensor_sum_storage_ppllj_nenexccxg_1_/**/REALKIND
