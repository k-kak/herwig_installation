...
! **********************************************************************
module ol_tables_storage_ppllj_nenexbbx_1_/**/REALKIND
! **********************************************************************
...
integer(intkind2), save :: h0tab(16,1)
integer(intkind2), save :: heltab2x2(2,2,1)
integer(intkind2), save :: heltab2x8(2,8,1)
integer(intkind2), save :: heltab2x16(2,16,1)


  ! number of helicity states for openloops recursion steps
integer(intkind2), save :: m0h(1)
integer(intkind2), save :: m3h2x1(3,1)
integer(intkind2), save :: m3h4x2(3,1)
integer(intkind2), save :: m3h2x8(3,1)

integer(intkind2), save :: n2h2(1)
integer(intkind2), save :: n2h8(1)
...
end module ol_tables_storage_ppllj_nenexbbx_1_/**/REALKIND

! **********************************************************************
module ol_tensor_sum_storage_ppllj_nenexbbx_1_/**/REALKIND
! **********************************************************************
  use KIND_TYPES, only: REALKIND, QREALKIND, intkind2
  ...
  type(hol), save :: G2H2(1)
  type(hol), save :: G0H8(1)
  type(hol), save :: G1H8(1)
  type(hol), save :: G0H16(1)
  type(hcl), save, dimension(5) :: G0tensor
...
integer, save :: mass3set(0:2,1)
  ...
  type(hcl), save, dimension(5) :: T0sum
...
!**********************************************************************
  ...
  use ol_loop_storage_ppllj_nenexbbx_1_/**/DREALKIND, only: nhel
  use ol_data_types_/**/REALKIND, only: hol
  use hol_initialisation_/**/REALKIND, only: hol_allocation
  implicit none

    call hol_allocation(4,5,4,2,G1H2,1)
  call hol_allocation(4,15,4,2,G2H2,1)
  call hol_allocation(4,1,4,8,G0H8,1)
  call hol_allocation(4,5,4,8,G1H8,1)
...
!**********************************************************************
  ...
  call hol_allocation(4,15,4,min(nhel,2),G2H2,1)
  call hol_allocation(4,1,4,min(nhel,8),G0H8,1)
  call hol_allocation(4,5,4,min(nhel,8),G1H8,1)
...
!**********************************************************************
  ...
  call hol_deallocation(G2H2,1,dmode)
  call hol_deallocation(G0H8,1,dmode)
  call hol_deallocation(G1H8,1,dmode)
...
!**********************************************************************
  ...
  call hcl_allocation(1,G0tensor, 5)
...
!**********************************************************************
  ...
  call hcl_deallocation(G0tensor, 5,dmode)
call hcl_deallocation(G2tensor, 1,dmode)

    call hcl_deallocation(T0sum,5,dmode)
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_ppllj_nenexbbx_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_ppllj_nenexbbx_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 0
...
#endif
  call TI_call_OL(0,0, momenta_5, masses2_4, T0sum(1), M2)
  call TI_call_OL(0,0, momenta_4, masses2_3, T0sum(2), M2)
  call TI_call_OL(0,0, momenta_3, masses2_2, T0sum(3), M2)
  call TI_call_OL(0,0, momenta_2, masses2_2, T0sum(4), M2)
  call TI_call_OL(0,0, momenta_1, masses2_1, T0sum(5), M2)
...
end module ol_tensor_sum_storage_ppllj_nenexbbx_1_/**/REALKIND
