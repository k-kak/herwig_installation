...
module ol_vamp_1_ppllj_nenexuuxg_2_/**/REALKIND
contains

! **********************************************************************
subroutine vamp_1(M)
! P(0:3,nlegs) = incoming external momenta
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_ppllj_nenexuuxg_2.
! Sets colour stripped amplitudes A from the module loop_amplitudes_ppllj_nenexuuxg_2.
! **********************************************************************
  ...
  use ol_tables_storage_ppllj_nenexuuxg_2_/**/DREALKIND
  use ol_tensor_sum_storage_ppllj_nenexuuxg_2_/**/REALKIND
  use ol_loop_handling_/**/REALKIND
  use ofred_reduction_/**/REALKIND, only: Hotf_4pt_reduction, Hotf_4pt_reduction_last
  use ofred_reduction_/**/REALKIND, only: Hotf_5pt_reduction, Hotf_5pt_reduction_last
  use ol_loop_reduction_/**/REALKIND, only: TI_bubble_red, TI_triangle_red

  use ol_loop_storage_ppllj_nenexuuxg_2_/**/REALKIND
#ifndef PRECISION_dp
  use ol_loop_storage_ppllj_nenexuuxg_2_/**/DREALKIND, only: &
...
end module ol_vamp_1_ppllj_nenexuuxg_2_/**/REALKIND
