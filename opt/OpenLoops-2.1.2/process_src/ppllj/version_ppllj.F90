...
module ol_versiondata_ppllj
  implicit none
  character(40) :: generator_revision = "a4b41a31"
  interface
    subroutine version_ppllj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_ppllj
  end interface
end module ol_versiondata_ppllj

subroutine ol_version_ppllj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_ppllj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_ppllj
