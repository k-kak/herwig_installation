...
module ol_colourmatrix_ppllj_eexbbxg_1_/**/REALKIND
...
end module ol_colourmatrix_ppllj_eexbbxg_1_/**/REALKIND



module ol_forced_parameters_ppllj_eexbbxg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllj_eexbbxg_1_/**/REALKIND


! **********************************************************************
module ol_loop_storage_ppllj_eexbbxg_1_/**/REALKIND
! **********************************************************************
...
end module ol_loop_storage_ppllj_eexbbxg_1_/**/REALKIND
...
! **********************************************************************
module ol_loop_ppllj_eexbbxg_1_/**/REALKIND
! **********************************************************************
...
!  use ol_loop_parameters_decl_/**/DREALKIND, only: DOI
  ...
  ! factors of the diagrams
    ...
    f(10) = (CI*eQED**2*gQCD**3*integralnorm*SwB)/3._/**/REALKIND
    f(11) = CI*eQED**2*gQCD**3*integralnorm*SwB
    f(12) = (eQED**2*gQCD**3*integralnorm*SwB)/3._/**/REALKIND
    ...
    f(17) = (4*eQED**2*gQCD**3*integralnorm*SwF)/3._/**/REALKIND
    f(18) = 2*eQED**2*gQCD**3*integralnorm*SwF
...
! **********************************************************************
#ifndef PRECISION_dp
  use ol_loop_storage_ppllj_eexbbxg_1_/**/DREALKIND, only: hel_states
#endif
  implicit none
...
! M2  = helicity-summed squared matrix element for e- e+ bottom anti-bottom glue -> 0
! **********************************************************************
  use ol_parameters_decl_/**/REALKIND !, only: ci, parameters_status, ZERO, scalefactor, >masses<
  use ol_parameters_init_/**/REALKIND, only: ensure_mp_init, ensure_mp_loop_init
  use ol_kinematics_/**/REALKIND, only: init_kinematics
  use ol_momenta_decl_/**/DREALKIND, only: momenta_nan_check
  use ol_settings_ppllj_eexbbxg_1, only: hel_mem_opt, loopcc
...
! 
  ...
  use ol_forced_parameters_ppllj_eexbbxg_1_/**/REALKIND, only: &
    & check_forced_parameters
  use ol_heltables_OLR_ppllj_eexbbxg_1
  ...
  call init_kinematics(P_scatt, extmasses2, P, &
     external_perm_inv_ppllj_eexbbxg_1, 5, qp_kinematics)
  ...
  call prop_A_Q(ntry, wf4(:,6), 24, MB, 1_intkind1, wf4(:,7), n2(3))
  ...
  call prop_A_Q(ntry, wf4(:,9), 24, MB, 1_intkind1, wf4(:,10), n2(4))
  ...
  call prop_Q_A(ntry, wf4(:,11), 20, MB, 1_intkind1, wf4(:,12), n2(5))
  call counter_Q_A(ctbb,5,ntry, wf4(:,3), 20, wf4(:,13), n2(6))
  call prop_A_Q(ntry, wf8(:,1), 11, MB, 1_intkind1, wf8(:,10), n2(7))
  call prop_A_Q(ntry, wf8(:,2), 11, MB, 1_intkind1, wf8(:,11), n2(8))
  call counter_A_Q(ctbb,5,ntry, wf4(:,7), 24, wf4(:,14), n2(9))
  call prop_Q_A(ntry, wf8(:,3), 7, MB, 1_intkind1, wf8(:,12), n2(10))
  call prop_Q_A(ntry, wf8(:,4), 7, MB, 1_intkind1, wf8(:,13), n2(11))
...
! K1(i,j) = <Ci|Cj>
! **********************************************************************
  use ol_colourmatrix_ppllj_eexbbxg_1_/**/REALKIND, only: K1
  implicit none
...
! K2(i,j) = <Ci|Cj>
! **********************************************************************
  use ol_colourmatrix_ppllj_eexbbxg_1_/**/REALKIND, only: K2
  implicit none
...
! **********************************************************************
  use ol_colourmatrix_ppllj_eexbbxg_1_/**/REALKIND, only: KL
  implicit none
...
! spin-correlated hard scattering factor for e- e+ bottom anti-bottom glue -> 0
! **********************************************************************
  use ol_parameters_decl_/**/REALKIND
  implicit none
  real(DREALKIND), intent(in) :: P_scatt(0:3,5)
...
subroutine assign_helicity_flip(ext_wf_hf,ext_wf_t,m)
  ...
  if(size(ext_wf_hf) == size(hflip,1)) then
    ...
    call ol_fatal("Spin-correlated HSF for ppllj_eexbbxg_1:" &
...
subroutine init_flipped_heltables(i,j)
  ...
  do k = 1, 5
    r = external_perm_inv_ppllj_eexbbxg_1(k)
    if(r == i .or. r == j) then
      l = l+1
      select case(k)
        case(1)
...
end module ol_loop_ppllj_eexbbxg_1_/**/REALKIND
