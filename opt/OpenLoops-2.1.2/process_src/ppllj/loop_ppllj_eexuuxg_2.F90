...
module ol_colourmatrix_ppllj_eexuuxg_2_/**/REALKIND
...
end module ol_colourmatrix_ppllj_eexuuxg_2_/**/REALKIND



module ol_forced_parameters_ppllj_eexuuxg_2_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllj_eexuuxg_2_/**/REALKIND


! **********************************************************************
module ol_loop_storage_ppllj_eexuuxg_2_/**/REALKIND
! **********************************************************************
...
end module ol_loop_storage_ppllj_eexuuxg_2_/**/REALKIND
...
! **********************************************************************
module ol_loop_ppllj_eexuuxg_2_/**/REALKIND
! **********************************************************************
  use KIND_TYPES, only: REALKIND, DREALKIND, intkind1, intkind2
  use ol_data_types_/**/REALKIND, only: wfun, Hpolcont
  use ol_loop_storage_ppllj_eexuuxg_2_/**/REALKIND
  implicit none
...
! **********************************************************************
#ifndef PRECISION_dp
  use ol_loop_storage_ppllj_eexuuxg_2_/**/DREALKIND, only: hel_states
#endif
  implicit none
...
! **********************************************************************
  ...
  use ol_settings_ppllj_eexuuxg_2, only: hel_mem_opt, loopcc
...
! 
  ...
  use ol_forced_parameters_ppllj_eexuuxg_2_/**/REALKIND, only: &
    & check_forced_parameters
  use ol_heltables_OLR_ppllj_eexuuxg_2
  ...
  call init_kinematics(P_scatt, extmasses2, P, &
     external_perm_inv_ppllj_eexuuxg_2, 5, qp_kinematics)
...
! K1(i,j) = <Ci|Cj>
! **********************************************************************
  use ol_colourmatrix_ppllj_eexuuxg_2_/**/REALKIND, only: K1
  implicit none
...
! K2(i,j) = <Ci|Cj>
! **********************************************************************
  use ol_colourmatrix_ppllj_eexuuxg_2_/**/REALKIND, only: K2
  implicit none
...
! **********************************************************************
  use ol_colourmatrix_ppllj_eexuuxg_2_/**/REALKIND, only: KL
  implicit none
...
subroutine assign_helicity_flip(ext_wf_hf,ext_wf_t,m)
  ...
  if(size(ext_wf_hf) == size(hflip,1)) then
    ...
    call ol_fatal("Spin-correlated HSF for ppllj_eexuuxg_2:" &
...
subroutine init_flipped_heltables(i,j)
  ...
  do k = 1, 5
    r = external_perm_inv_ppllj_eexuuxg_2(k)
    if(r == i .or. r == j) then
      l = l+1
      select case(k)
        case(1)
...
end module ol_loop_ppllj_eexuuxg_2_/**/REALKIND
