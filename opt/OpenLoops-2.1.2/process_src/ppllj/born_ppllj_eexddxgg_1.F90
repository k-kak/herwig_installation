...
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_ppllj_eexddxgg_1_/**/DREALKIND, only: &
...
! 
  ...
  use ol_external_ppllj_eexddxgg_1, only: &
    & external_perm_ppllj_eexddxgg_1, &
    & external_perm_inv_ppllj_eexddxgg_1, &
    & extcomb_perm_ppllj_eexddxgg_1, &
    & average_factor_ppllj_eexddxgg_1, &
    & photonid_ppllj_eexddxgg_1
  use ol_external_ppllj_eexddxgg_1, only: &
    & H, hel_not_initialised, hel_init, POLSEL 
  use ol_colourmatrix_ppllj_eexddxgg_1_/**/REALKIND, only: &
    & colmat_not_initialised, colourmatrix_init
  use ol_forced_parameters_ppllj_eexddxgg_1_/**/REALKIND, only: &
  ...
  call init_kinematics(P_scatt, extmasses2, P, &
      &  external_perm_inv_ppllj_eexddxgg_1, 6,.false.)
  ...
  do k = 1, nextcombs
    extcombs_permuted(k) = &
       & extcomb_perm_ppllj_eexddxgg_1(extcombs(k))
  end do
  ...
  if ( JBmunu /= 0 ) then ! POWHEGs Bmunu helicity correlation
    ...
    M2munu = M2munu / average_factor_ppllj_eexddxgg_1
  end if
  ...
  ! photon-factors
  call photon_factors(photonid_ppllj_eexddxgg_1, 0, bornphotonfactor)
...
#else
subroutine amp2tree(P, M2) &
    & bind(c,name="ol_f_amp2tree_qp_ppllj_eexddxgg_1")
#endif
