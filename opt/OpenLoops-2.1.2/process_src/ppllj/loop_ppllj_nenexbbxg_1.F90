...
module ol_colourmatrix_ppllj_nenexbbxg_1_/**/REALKIND
...
end module ol_colourmatrix_ppllj_nenexbbxg_1_/**/REALKIND



module ol_forced_parameters_ppllj_nenexbbxg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllj_nenexbbxg_1_/**/REALKIND


! **********************************************************************
module ol_loop_storage_ppllj_nenexbbxg_1_/**/REALKIND
! **********************************************************************
...
end module ol_loop_storage_ppllj_nenexbbxg_1_/**/REALKIND
...
! **********************************************************************
module ol_loop_ppllj_nenexbbxg_1_/**/REALKIND
! **********************************************************************
...
subroutine denominators()
  ...
  den(4) = 1 /((L(5,24) - MB2)+L(6,24))
  den(6) = 1 /((L(5,12))+L(6,12))
  den(8) = 1 /((L(5,11) - MB2)+L(6,11))
  den(11) = 1 /((L(5,7) - MB2)+L(6,7))
...
! **********************************************************************
#ifndef PRECISION_dp
  use ol_loop_storage_ppllj_nenexbbxg_1_/**/DREALKIND, only: hel_states
#endif
  implicit none
...
! M2  = helicity-summed squared matrix element for nu_e anti-nu_e bottom anti-bottom glue -> 0
! **********************************************************************
  use ol_parameters_decl_/**/REALKIND !, only: ci, parameters_status, ZERO, scalefactor, >masses<
  use ol_parameters_init_/**/REALKIND, only: ensure_mp_init, ensure_mp_loop_init
  use ol_kinematics_/**/REALKIND, only: init_kinematics
  use ol_momenta_decl_/**/DREALKIND, only: momenta_nan_check
  use ol_settings_ppllj_nenexbbxg_1, only: hel_mem_opt, loopcc
...
! 
  ...
  use ol_forced_parameters_ppllj_nenexbbxg_1_/**/REALKIND, only: &
    & check_forced_parameters
  use ol_heltables_OLR_ppllj_nenexbbxg_1
  ...
  call init_kinematics(P_scatt, extmasses2, P, &
     external_perm_inv_ppllj_nenexbbxg_1, 5, qp_kinematics)
  ...
  call prop_Q_A(ntry, wf4(:,2), 20, MB, 1_intkind1, wf4(:,4), n2(2))
  call vert_AZ_Q(gZd,ntry, ex4(:), wf4(:,3), wf8(:,1), n3(:,3), t3x8(:,:,1))
  call vert_AV_Q(ntry, ex4(:), ex5(:), wf4(:,5), n3(:,4), t3x4(:,:,3))
  call prop_A_Q(ntry, wf4(:,5), 24, MB, 1_intkind1, wf4(:,6), n2(3))
  call vert_ZQ_A(gZd,ntry, wf4(:,3), ex3(:), wf8(:,2), n3(:,5), t3x8(:,:,2))
  call vert_QA_V(ntry, ex3(:), ex4(:), wf4(:,7), n3(:,6), t3x4(:,:,4))
  call counter_VG_G(ntry, wf4(:,3), ex5(:), 16, wf8(:,3), 19, n3(:,7), t3x8(:,:,3))
  call counter_AZ_Q(gZd,ntry, ex4(:), wf4(:,3), wf8(:,4), n3(:,8), t3x8(:,:,4))
  call counter_AV_Q(ntry, ex4(:), ex5(:), wf4(:,8), n3(:,9), t3x4(:,:,5))
  call prop_A_Q(ntry, wf4(:,8), 24, MB, 1_intkind1, wf4(:,9), n2(4))
  call counter_ZQ_A(gZd,ntry, wf4(:,3), ex3(:), wf8(:,5), n3(:,10), t3x8(:,:,5))
  call counter_VQ_A(ntry, ex5(:), ex3(:), wf4(:,10), n3(:,11), t3x4(:,:,6))
  call prop_Q_A(ntry, wf4(:,10), 20, MB, 1_intkind1, wf4(:,11), n2(5))
  call counter_Q_A(ctbb,5,ntry, wf4(:,4), 20, wf4(:,12), n2(6))
  call prop_A_Q(ntry, wf8(:,1), 11, MB, 1_intkind1, wf8(:,6), n2(7))
  call counter_A_Q(ctbb,5,ntry, wf4(:,6), 24, wf4(:,13), n2(8))
  call prop_Q_A(ntry, wf8(:,2), 7, MB, 1_intkind1, wf8(:,7), n2(9))
...
! K1(i,j) = <Ci|Cj>
! **********************************************************************
  use ol_colourmatrix_ppllj_nenexbbxg_1_/**/REALKIND, only: K1
  implicit none
...
! K2(i,j) = <Ci|Cj>
! **********************************************************************
  use ol_colourmatrix_ppllj_nenexbbxg_1_/**/REALKIND, only: K2
  implicit none
...
! **********************************************************************
  use ol_colourmatrix_ppllj_nenexbbxg_1_/**/REALKIND, only: KL
  implicit none
...
! spin-correlated hard scattering factor for nu_e anti-nu_e bottom anti-bottom glue -> 0
! **********************************************************************
  use ol_parameters_decl_/**/REALKIND
  implicit none
  real(DREALKIND), intent(in) :: P_scatt(0:3,5)
...
subroutine assign_helicity_flip(ext_wf_hf,ext_wf_t,m)
  ...
  if(size(ext_wf_hf) == size(hflip,1)) then
    ...
    call ol_fatal("Spin-correlated HSF for ppllj_nenexbbxg_1:" &
...
subroutine init_flipped_heltables(i,j)
  ...
  do k = 1, 5
    r = external_perm_inv_ppllj_nenexbbxg_1(k)
    if(r == i .or. r == j) then
      l = l+1
      select case(k)
        case(1)
...
end module ol_loop_ppllj_nenexbbxg_1_/**/REALKIND
