...
! **********************************************************************
module ol_tables_storage_ppllj_nexeudxg_1_/**/REALKIND
! **********************************************************************
...
end module ol_tables_storage_ppllj_nexeudxg_1_/**/REALKIND

! **********************************************************************
module ol_tensor_sum_storage_ppllj_nexeudxg_1_/**/REALKIND
! **********************************************************************
  use KIND_TYPES, only: REALKIND, QREALKIND, intkind2
...
!**********************************************************************
  ...
  use ol_loop_storage_ppllj_nexeudxg_1_/**/DREALKIND, only: nhel
  use ol_data_types_/**/REALKIND, only: hol
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_ppllj_nexeudxg_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_ppllj_nexeudxg_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 0
...
end module ol_tensor_sum_storage_ppllj_nexeudxg_1_/**/REALKIND
