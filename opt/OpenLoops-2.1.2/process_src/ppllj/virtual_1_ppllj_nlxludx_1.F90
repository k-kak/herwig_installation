...
module ol_vamp_1_ppllj_nlxludx_1_/**/REALKIND
contains

! **********************************************************************
subroutine vamp_1(M)
! P(0:3,nlegs) = incoming external momenta
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_ppllj_nlxludx_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_ppllj_nlxludx_1.
! **********************************************************************
  ...
  use ol_tables_storage_ppllj_nlxludx_1_/**/DREALKIND
...
end module ol_vamp_1_ppllj_nlxludx_1_/**/REALKIND
