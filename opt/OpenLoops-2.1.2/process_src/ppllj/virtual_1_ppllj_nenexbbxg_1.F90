...
module ol_vamp_1_ppllj_nenexbbxg_1_/**/REALKIND
contains

! **********************************************************************
subroutine vamp_1(M)
! P(0:3,nlegs) = incoming external momenta
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_ppllj_nenexbbxg_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_ppllj_nenexbbxg_1.
! **********************************************************************
  ...
  use ol_tables_storage_ppllj_nenexbbxg_1_/**/DREALKIND
  use ol_tensor_sum_storage_ppllj_nenexbbxg_1_/**/REALKIND
  use ol_loop_handling_/**/REALKIND
  use ofred_reduction_/**/REALKIND, only: Hotf_4pt_reduction, Hotf_4pt_reduction_last
  use ofred_reduction_/**/REALKIND, only: Hotf_5pt_reduction, Hotf_5pt_reduction_last
  use ol_loop_reduction_/**/REALKIND, only: TI_bubble_red, TI_triangle_red

  use ol_loop_storage_ppllj_nenexbbxg_1_/**/REALKIND
#ifndef PRECISION_dp
  use ol_loop_storage_ppllj_nenexbbxg_1_/**/DREALKIND, only: &
...
G0tensor(11),G0tensor(12),G0tensor(13),G0tensor(14),G0tensor(15))
  ...
  call G0_hol_initialisation(ntryL,Gcoeff,G0H32(1),m0h(12),h0tab(:,12),[20,3,8],[nMB,nMB,0],3,2,wf4(:,4),wf4(:,3))
  ...
  call G0_hol_initialisation(ntryL,Gcoeff,G0H32(1),m0h(13),h0tab(:,13),[24,3,4],[nMB,nMB,0],3,2,wf4(:,6),wf4(:,3))
  ...
  call G0_hol_initialisation(ntryL,Gcoeff,G0H32(1),m0h(14),h0tab(:,14),[16,7,8],[nMB,0,nMB],3,1,wf8(:,7))
  call Hloop_AV_Q(ntryL,G0H32(1),ex5(:),G0H16(1),m3h2x16(:,12),heltab2x32(:,:,14))
  call Hloop_A_Q(ntryL,G0H16(1),16,nMB,G1H16(9),n2h16(11))
  Gcoeff(:)%j = (-(c(1)*M(1,:)%j)) * den(12)
  call G0_hol_initialisation(ntryL,Gcoeff,G0H32(1),m0h(15),h0tab(:,15),[16,7,8],[0,nMB,0],3,1,wf8(:,7))
  call Hloop_UV_W(ntryL,G0H32(1),0,ex5(:),16,G1H16(10),m3h2x16(:,13),heltab2x32(:,:,15))
  Gcoeff(:)%j = (-(c(2)*M(1,:)%j)) * den(9)
  call G0_hol_initialisation(ntryL,Gcoeff,G0H32(1),m0h(16),h0tab(:,16),[16,4,11],[nMB,0,nMB],3,1,wf8(:,6))
  call Hloop_AV_Q(ntryL,G0H32(1),ex5(:),G0H16(1),m3h2x16(:,14),heltab2x32(:,:,16))
  call Hloop_A_Q(ntryL,G0H16(1),16,nMB,G1H16(11),n2h16(12))
  Gcoeff(:)%j = (-(c(1)*M(1,:)%j)) * den(9)
  call G0_hol_initialisation(ntryL,Gcoeff,G0H32(1),m0h(17),h0tab(:,17),[16,4,11],[0,nMB,0],3,1,wf8(:,6))
...
call HGT_w2_invQ_OLR(G1H4(1),2,5,4)
  ...
  call Hcheck_last_A_Q(ntryL,l_switch,G1H1(1),31,nMB,G2tensor(14),n2h1(18))
  ...
  call TI_triangle_red(G3tensor(4),RedBasis(4),mass3set(:,7),G0tensor(55),G0tensor(56),G0tensor(57),G0tensor(58),M2L1R1,[nMT], &
    G0tensor(59))
  call TI_triangle_red(G2tensor(14),RedBasis(1),mass3set(:,5),G0tensor(60),G0tensor(61),G0tensor(62),G0tensor(63),M2L1R1,[nMB], &
    G0tensor(64))
  ...
  call G0_hol_initialisation(ntryL,Gcoeff,G0H32(1),m0h(18),h0tab(:,18),[20,11],[0,nMB],2,2,wf4(:,4),wf8(:,6))
  call Hloop_AQ_V(ntryL,G0H32(1),wf4(:,4),G0H8(1),m3h4x8(:,3),heltab2x32(:,:,18))
  Gcoeff(:)%j = (c(3)*M(1,:)%j) * den(13)
  call G0_hol_initialisation(ntryL,Gcoeff,G0H32(1),m0h(19),h0tab(:,19),[24,7],[nMB,0],2,2,wf4(:,6),wf8(:,7))
  ...
  call Hcheck_last_A_Q(ntryL,l_switch,G0H1(1),31,nMB,G1tensor(1),n2h1(19))
  ...
  call ol_merge_tensors(G1tensor(1),[G0tensor(62)])
...
end module ol_vamp_1_ppllj_nenexbbxg_1_/**/REALKIND
