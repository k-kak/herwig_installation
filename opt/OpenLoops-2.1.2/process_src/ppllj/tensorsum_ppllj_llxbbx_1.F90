...
! **********************************************************************
module ol_tables_storage_ppllj_llxbbx_1_/**/REALKIND
! **********************************************************************
...
integer(intkind2), save :: h0tab(16,3)
integer(intkind2), save :: heltab2x2(2,2,1)
integer(intkind2), save :: heltab2x8(2,8,3)
integer(intkind2), save :: heltab2x16(2,16,3)


  ! number of helicity states for openloops recursion steps
integer(intkind2), save :: m0h(3)
integer(intkind2), save :: m3h2x1(3,1)
integer(intkind2), save :: m3h4x2(3,3)
integer(intkind2), save :: m3h2x8(3,3)

integer(intkind2), save :: n2h2(3)
...
end module ol_tables_storage_ppllj_llxbbx_1_/**/REALKIND

! **********************************************************************
module ol_tensor_sum_storage_ppllj_llxbbx_1_/**/REALKIND
! **********************************************************************
  use KIND_TYPES, only: REALKIND, QREALKIND, intkind2
...
!**********************************************************************
  ...
  use ol_loop_storage_ppllj_llxbbx_1_/**/DREALKIND, only: nhel
  use ol_data_types_/**/REALKIND, only: hol
  ...
  call hol_allocation(4,5,4,8,G1H8,3)
...
!**********************************************************************
  ...
  call hol_allocation(4,15,4,min(nhel,2),G2H2,3)
  call hol_allocation(4,1,4,min(nhel,8),G0H8,1)
  call hol_allocation(4,5,4,min(nhel,8),G1H8,3)
...
!**********************************************************************
  ...
  call hol_deallocation(G1H8,3,dmode)
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_ppllj_llxbbx_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_ppllj_llxbbx_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 0
...
end module ol_tensor_sum_storage_ppllj_llxbbx_1_/**/REALKIND
