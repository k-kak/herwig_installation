...
module ol_tree_ppllj_eexuuxg_2_/**/REALKIND
...
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_ppllj_eexuuxg_2_/**/DREALKIND, only: &
...
#else
subroutine amp2tree(P, M2) &
    & bind(c,name="ol_f_amp2tree_qp_ppllj_eexuuxg_2")
#endif
...
end module ol_tree_ppllj_eexuuxg_2_/**/REALKIND
