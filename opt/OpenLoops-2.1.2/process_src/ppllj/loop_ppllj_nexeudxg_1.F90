...
module ol_colourmatrix_ppllj_nexeudxg_1_/**/REALKIND
...
end module ol_colourmatrix_ppllj_nexeudxg_1_/**/REALKIND



module ol_forced_parameters_ppllj_nexeudxg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllj_nexeudxg_1_/**/REALKIND


! **********************************************************************
module ol_loop_storage_ppllj_nexeudxg_1_/**/REALKIND
! **********************************************************************
...
end module ol_loop_storage_ppllj_nexeudxg_1_/**/REALKIND
...
! **********************************************************************
module ol_loop_ppllj_nexeudxg_1_/**/REALKIND
! **********************************************************************
...
! **********************************************************************
#ifndef PRECISION_dp
  use ol_loop_storage_ppllj_nexeudxg_1_/**/DREALKIND, only: hel_states
#endif
  implicit none
...
! M2  = helicity-summed squared matrix element for anti-nu_e e- up anti-down glue -> 0
! **********************************************************************
  use ol_parameters_decl_/**/REALKIND !, only: ci, parameters_status, ZERO, scalefactor, >masses<
  use ol_parameters_init_/**/REALKIND, only: ensure_mp_init, ensure_mp_loop_init
  use ol_kinematics_/**/REALKIND, only: init_kinematics
  use ol_momenta_decl_/**/DREALKIND, only: momenta_nan_check
  use ol_settings_ppllj_nexeudxg_1, only: hel_mem_opt, loopcc
...
! 
  ...
  use ol_forced_parameters_ppllj_nexeudxg_1_/**/REALKIND, only: &
    & check_forced_parameters
  use ol_heltables_OLR_ppllj_nexeudxg_1
  ...
  call init_kinematics(P_scatt, extmasses2, P, &
     external_perm_inv_ppllj_nexeudxg_1, 5, qp_kinematics)
...
! K1(i,j) = <Ci|Cj>
! **********************************************************************
  use ol_colourmatrix_ppllj_nexeudxg_1_/**/REALKIND, only: K1
  implicit none
...
! K2(i,j) = <Ci|Cj>
! **********************************************************************
  use ol_colourmatrix_ppllj_nexeudxg_1_/**/REALKIND, only: K2
  implicit none
...
! **********************************************************************
  use ol_colourmatrix_ppllj_nexeudxg_1_/**/REALKIND, only: KL
  implicit none
...
! spin-correlated hard scattering factor for anti-nu_e e- up anti-down glue -> 0
! **********************************************************************
  use ol_parameters_decl_/**/REALKIND
  implicit none
  real(DREALKIND), intent(in) :: P_scatt(0:3,5)
...
subroutine assign_helicity_flip(ext_wf_hf,ext_wf_t,m)
  ...
  if(size(ext_wf_hf) == size(hflip,1)) then
    ...
    call ol_fatal("Spin-correlated HSF for ppllj_nexeudxg_1:" &
...
subroutine init_flipped_heltables(i,j)
  ...
  do k = 1, 5
    r = external_perm_inv_ppllj_nexeudxg_1(k)
    if(r == i .or. r == j) then
      l = l+1
      select case(k)
        case(1)
...
end module ol_loop_ppllj_nexeudxg_1_/**/REALKIND
