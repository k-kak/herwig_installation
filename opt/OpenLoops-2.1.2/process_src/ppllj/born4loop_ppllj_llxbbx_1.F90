...
module ol_tree_ppllj_llxbbx_1_/**/REALKIND
  ...
  complex(DREALKIND) :: M1helarr(1,16) ! cache
#endif
...
subroutine factors_init()
  ...
  ! factors of the diagrams
    ...
    f(2) = CI*eQED**2
    f(3) = (CI*eQED**2*MB*ML)/(4._/**/REALKIND*MW**2*sw**2)
...
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_ppllj_llxbbx_1_/**/DREALKIND, only: &
...
! 
  ...
  complex(REALKIND) :: MOM_LC(4), M1(1), M1helarray(1,16)
...
subroutine colourvector(A, j, M1)
  ...
  type(polcont) :: A(:,:)
  integer, intent(in) :: j
  complex(REALKIND), intent(out) :: M1(1) ! M1helarray(1,16)
  integer :: empty(0)
...
#else
subroutine amp2tree(P, M2) &
    & bind(c,name="ol_f_amp2tree_qp_ppllj_llxbbx_1")
#endif
...
end module ol_tree_ppllj_llxbbx_1_/**/REALKIND
