...
! **********************************************************************
module ol_tables_storage_ppllj_llxbbxg_1_/**/REALKIND
! **********************************************************************
...
integer(intkind2), save :: h0tab(32,53)
integer(intkind2), save :: heltab2x2(2,2,15)
integer(intkind2), save :: heltab2x4(2,4,11)
integer(intkind2), save :: heltab2x8(2,8,30)
integer(intkind2), save :: heltab2x16(2,16,39)
integer(intkind2), save :: heltab2x32(2,32,53)


  ! number of helicity states for openloops recursion steps
integer(intkind2), save :: m0h(53)
...
integer(intkind2), save :: m3h4x2(3,15)
integer(intkind2), save :: m3h8x2(3,6)
integer(intkind2), save :: m3h2x4(3,3)
integer(intkind2), save :: m3h4x4(3,24)
integer(intkind2), save :: m3h2x8(3,9)
integer(intkind2), save :: m3h4x8(3,12)
integer(intkind2), save :: m3h2x16(3,41)

integer(intkind2), save :: n2h1(25)
integer(intkind2), save :: n2h2(18)
integer(intkind2), save :: n2h4(24)
integer(intkind2), save :: n2h8(18)
integer(intkind2), save :: n2h16(32)
...
end module ol_tables_storage_ppllj_llxbbxg_1_/**/REALKIND

! **********************************************************************
module ol_tensor_sum_storage_ppllj_llxbbxg_1_/**/REALKIND
! **********************************************************************
  use KIND_TYPES, only: REALKIND, QREALKIND, intkind2
  ...
  type(hcl), save, dimension(21) :: G2tensor
...
!**********************************************************************
  ...
  use ol_loop_storage_ppllj_llxbbxg_1_/**/DREALKIND, only: nhel
  use ol_data_types_/**/REALKIND, only: hol
...
!**********************************************************************
  ...
  call hol_allocation(4,5,4,min(nhel,8),G1H8,15)
...
call hcl_allocation(15,G2tensor, 21)
...
call hcl_deallocation(G2tensor, 21,dmode)
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_ppllj_llxbbxg_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_ppllj_llxbbxg_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 0
...
! **********************************************************************
  ...
  call TI_call_OL(0,0, momenta_9, masses2_13, T0sum(14), M2)
  call TI_call_OL(0,0, momenta_9, masses2_7, T0sum(15), M2)
  ...
  call TI_call_OL(0,0, momenta_8, masses2_6, T0sum(29), M2)
  call TI_call_OL(0,0, momenta_3, masses2_6, T0sum(30), M2)
  call TI_call_OL(0,0, momenta_2, masses2_6, T0sum(31), M2)
  call TI_call_OL(0,0, momenta_1, masses2_3, T0sum(32), M2)
  call TI_call_OL(0,0, momenta_8, masses2_1, T0sum(33), M2)
  call TI_call_OL(0,0, momenta_3, masses2_1, T0sum(34), M2)
...
end module ol_tensor_sum_storage_ppllj_llxbbxg_1_/**/REALKIND
