...
module ol_vamp_1_ppllj_nenexddxg_2_/**/REALKIND
contains

! **********************************************************************
subroutine vamp_1(M)
! P(0:3,nlegs) = incoming external momenta
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_ppllj_nenexddxg_2.
! Sets colour stripped amplitudes A from the module loop_amplitudes_ppllj_nenexddxg_2.
! **********************************************************************
  ...
  use ol_tables_storage_ppllj_nenexddxg_2_/**/DREALKIND
  use ol_tensor_sum_storage_ppllj_nenexddxg_2_/**/REALKIND
  use ol_loop_handling_/**/REALKIND
  use ofred_reduction_/**/REALKIND, only: Hotf_4pt_reduction, Hotf_4pt_reduction_last
  use ofred_reduction_/**/REALKIND, only: Hotf_5pt_reduction, Hotf_5pt_reduction_last
  use ol_loop_reduction_/**/REALKIND, only: TI_bubble_red, TI_triangle_red

  use ol_loop_storage_ppllj_nenexddxg_2_/**/REALKIND
#ifndef PRECISION_dp
  use ol_loop_storage_ppllj_nenexddxg_2_/**/DREALKIND, only: &
...
G0tensor(11),G0tensor(12),G0tensor(13),G0tensor(14),G0tensor(15))
  ...
  call G0_hol_initialisation(ntryL,Gcoeff,G0H32(1),m0h(14),h0tab(:,14),[20,3,8],[0,0,0],3,2,wf4(:,4),wf4(:,3))
  ...
  call G0_hol_initialisation(ntryL,Gcoeff,G0H32(1),m0h(15),h0tab(:,15),[24,3,4],[0,0,0],3,2,wf4(:,6),wf4(:,3))
  ...
  call G0_hol_initialisation(ntryL,Gcoeff,G0H32(1),m0h(16),h0tab(:,16),[16,7,8],[0,0,0],3,1,wf8(:,7))
  call Hloop_AV_Q(ntryL,G0H32(1),ex5(:),G0H16(1),m3h2x16(:,14),heltab2x32(:,:,16))
  call Hloop_A_Q(ntryL,G0H16(1),16,0,G1H16(11),n2h16(13))
  Gcoeff(:)%j = (-(c(1)*M(1,:)%j)) * den(12)
  call G0_hol_initialisation(ntryL,Gcoeff,G0H32(1),m0h(17),h0tab(:,17),[16,7,8],[0,0,0],3,1,wf8(:,7))
  call Hloop_UV_W(ntryL,G0H32(1),0,ex5(:),16,G1H16(12),m3h2x16(:,15),heltab2x32(:,:,17))
  Gcoeff(:)%j = (-(c(2)*M(1,:)%j)) * den(9)
  call G0_hol_initialisation(ntryL,Gcoeff,G0H32(1),m0h(18),h0tab(:,18),[16,4,11],[0,0,0],3,1,wf8(:,6))
  call Hloop_AV_Q(ntryL,G0H32(1),ex5(:),G0H16(1),m3h2x16(:,16),heltab2x32(:,:,18))
  call Hloop_A_Q(ntryL,G0H16(1),16,0,G1H16(13),n2h16(14))
  Gcoeff(:)%j = (-(c(1)*M(1,:)%j)) * den(9)
  call G0_hol_initialisation(ntryL,Gcoeff,G0H32(1),m0h(19),h0tab(:,19),[16,4,11],[0,0,0],3,1,wf8(:,6))
...
call HGT_w2_invQ_OLR(G1H4(1),2,5,4)
  ...
  call Hcheck_last_A_Q(ntryL,l_switch,G1H1(1),31,0,G2tensor(14),n2h1(20))
  ...
  call ol_merge_tensors(G3tensor(4),[G3tensor(1),G2tensor(8),G2tensor(5),G1tensor(15),G1tensor(10),G0tensor(15),G0tensor(10)])
  ...
  call TI_triangle_red(G3tensor(4),RedBasis(4),mass3set(:,1),G0tensor(12),G0tensor(2),G0tensor(14),G0tensor(4),M2L1R1)
  ...
  call TI_triangle_red(G3tensor(5),RedBasis(4),mass3set(:,2),G0tensor(37),G0tensor(38),G0tensor(39),G0tensor(40),M2L1R1,[nMC], &
    G0tensor(41))
  call TI_triangle_red(G3tensor(6),RedBasis(4),mass3set(:,3),G0tensor(42),G0tensor(43),G0tensor(44),G0tensor(45),M2L1R1,[nMT], &
    G0tensor(46))
  call TI_triangle_red(G3tensor(8),RedBasis(4),mass3set(:,4),G0tensor(47),G0tensor(48),G0tensor(49),G0tensor(50),M2L1R1,[nMB], &
    G0tensor(51))
  ...
  call G0_hol_initialisation(ntryL,Gcoeff,G0H32(1),m0h(20),h0tab(:,20),[20,11],[0,0],2,2,wf4(:,4),wf8(:,6))
  call Hloop_AQ_V(ntryL,G0H32(1),wf4(:,4),G0H8(1),m3h4x8(:,3),heltab2x32(:,:,20))
  Gcoeff(:)%j = (c(3)*M(1,:)%j) * den(13)
  call G0_hol_initialisation(ntryL,Gcoeff,G0H32(1),m0h(21),h0tab(:,21),[24,7],[0,0],2,2,wf4(:,6),wf8(:,7))
  ...
  call Hcheck_last_A_Q(ntryL,l_switch,G0H1(1),31,0,G1tensor(1),n2h1(21))
...
call TI_bubble_red(G1tensor(6),24,mass2set(:,1),G0tensor(7),M2L1R1)
  call ol_merge_tensors(T0sum(16),[G0tensor(34)])
  call ol_merge_tensors(T0sum(17),[G0tensor(1)])
  call ol_merge_tensors(T0sum(18),[G0tensor(32)])
  call ol_merge_tensors(T0sum(19),[G0tensor(19)])
  call ol_merge_tensors(T0sum(20),[G0tensor(35)])
  call ol_merge_tensors(T0sum(21),[G0tensor(36)])
  call ol_merge_tensors(T0sum(22),[G0tensor(7)])
  call ol_merge_tensors(T0sum(23),[G0tensor(38)])
  call ol_merge_tensors(T0sum(24),[G0tensor(39)])
  call ol_merge_tensors(T0sum(25),[G0tensor(40)])
  call ol_merge_tensors(T0sum(26),[G0tensor(41)])
  call ol_merge_tensors(T0sum(27),[G0tensor(43)])
  call ol_merge_tensors(T0sum(28),[G0tensor(44)])
  call ol_merge_tensors(T0sum(29),[G0tensor(45)])
  call ol_merge_tensors(T0sum(30),[G0tensor(46)])
  call ol_merge_tensors(T0sum(31),[G0tensor(48)])
  call ol_merge_tensors(T0sum(32),[G0tensor(49)])
  call ol_merge_tensors(T0sum(33),[G0tensor(50)])
  call ol_merge_tensors(T0sum(34),[G0tensor(51)])
! end of process
...
end module ol_vamp_1_ppllj_nenexddxg_2_/**/REALKIND
