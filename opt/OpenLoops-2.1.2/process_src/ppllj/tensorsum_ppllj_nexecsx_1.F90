...
! **********************************************************************
module ol_tables_storage_ppllj_nexecsx_1_/**/REALKIND
! **********************************************************************
...
end module ol_tables_storage_ppllj_nexecsx_1_/**/REALKIND

! **********************************************************************
module ol_tensor_sum_storage_ppllj_nexecsx_1_/**/REALKIND
! **********************************************************************
  use KIND_TYPES, only: REALKIND, QREALKIND, intkind2
...
!**********************************************************************
  ...
  use ol_loop_storage_ppllj_nexecsx_1_/**/DREALKIND, only: nhel
  use ol_data_types_/**/REALKIND, only: hol
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_ppllj_nexecsx_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_ppllj_nexecsx_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 0
...
! **********************************************************************
  ...
  call TI_call_OL(0,0, momenta_4, masses2_2, T0sum(2), M2)
  call TI_call_OL(0,0, momenta_3, masses2_3, T0sum(3), M2)
  call TI_call_OL(0,0, momenta_2, masses2_1, T0sum(4), M2)
  call TI_call_OL(0,0, momenta_1, masses2_2, T0sum(5), M2)
...
end module ol_tensor_sum_storage_ppllj_nexecsx_1_/**/REALKIND
