...
module ol_colourmatrix_ppllj_llxuuxg_1_/**/REALKIND
...
end module ol_colourmatrix_ppllj_llxuuxg_1_/**/REALKIND



module ol_forced_parameters_ppllj_llxuuxg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllj_llxuuxg_1_/**/REALKIND


! **********************************************************************
module ol_loop_storage_ppllj_llxuuxg_1_/**/REALKIND
! **********************************************************************
...
end module ol_loop_storage_ppllj_llxuuxg_1_/**/REALKIND
...
! **********************************************************************
module ol_loop_ppllj_llxuuxg_1_/**/REALKIND
! **********************************************************************
  use KIND_TYPES, only: REALKIND, DREALKIND, intkind1, intkind2
  use ol_data_types_/**/REALKIND, only: wfun, Hpolcont
  use ol_loop_storage_ppllj_llxuuxg_1_/**/REALKIND
  implicit none
...
!  use ol_loop_parameters_decl_/**/DREALKIND, only: DOI
  ...
  ! factors of the diagrams
    ...
    f(11) = (2*CI*eQED**2*gQCD**3*integralnorm*SwB)/3._/**/REALKIND
    f(12) = CI*eQED**2*gQCD**3*integralnorm*SwB
    f(13) = (2*eQED**2*gQCD**3*integralnorm*SwB)/3._/**/REALKIND
...
! **********************************************************************
#ifndef PRECISION_dp
  use ol_loop_storage_ppllj_llxuuxg_1_/**/DREALKIND, only: hel_states
#endif
  implicit none
...
#else
recursive subroutine amp2(P_scatt, M02, qp_kinematics, M2ct, M2colint)
  use ol_loop_storage_ppllj_llxuuxg_1_/**/DREALKIND, only: &
  nhel, Hel, hel_states
#endif
! P_scatt(0:3,Npart) = incoming external momenta
! M2  = helicity-summed squared matrix element for tau- tau+ up anti-up glue -> 0
! **********************************************************************
  use ol_parameters_decl_/**/REALKIND !, only: ci, parameters_status, ZERO, scalefactor, >masses<
  use ol_parameters_init_/**/REALKIND, only: ensure_mp_init, ensure_mp_loop_init
  use ol_kinematics_/**/REALKIND, only: init_kinematics
  use ol_momenta_decl_/**/DREALKIND, only: momenta_nan_check
  use ol_settings_ppllj_llxuuxg_1, only: hel_mem_opt, loopcc
...
! 
  ...
  use ol_external_ppllj_llxuuxg_1, only: &
    & external_perm_ppllj_llxuuxg_1, &
    & external_perm_inv_ppllj_llxuuxg_1, &
    & extcomb_perm_ppllj_llxuuxg_1, &
    & average_factor_ppllj_llxuuxg_1
  use ol_external_ppllj_llxuuxg_1, only: &
    & H, hel_not_initialised, hel_init, POLSEL 
  use ol_colourmatrix_ppllj_llxuuxg_1_/**/REALKIND, only: &
    & colmat_not_initialised, colourmatrix_init
  use ol_forced_parameters_ppllj_llxuuxg_1_/**/REALKIND, only: &
    & check_forced_parameters
  use ol_heltables_OLR_ppllj_llxuuxg_1
  ...
  call init_kinematics(P_scatt, extmasses2, P, &
     external_perm_inv_ppllj_llxuuxg_1, 5, qp_kinematics)
  ...
  call vert_AZ_Q(gZu,ntry, ex4(:), wf4(:,5), wf8(:,2), n3(:,5), t3x8(:,:,2))
  ...
  call vert_ZQ_A(gZu,ntry, wf4(:,5), ex3(:), wf8(:,4), n3(:,8), t3x8(:,:,4))
  ...
  call counter_AZ_Q(gZu,ntry, ex4(:), wf4(:,5), wf8(:,8), n3(:,14), t3x8(:,:,8))
...
! K1(i,j) = <Ci|Cj>
! **********************************************************************
  use ol_colourmatrix_ppllj_llxuuxg_1_/**/REALKIND, only: K1
  implicit none
...
! K2(i,j) = <Ci|Cj>
! **********************************************************************
  use ol_colourmatrix_ppllj_llxuuxg_1_/**/REALKIND, only: K2
  implicit none
...
! **********************************************************************
  use ol_colourmatrix_ppllj_llxuuxg_1_/**/REALKIND, only: KL
  implicit none
...
#endif
! M2tree = helicity-summed squared tree matrix element for tau- tau+ up anti-up glue -> 0
! M2hsf  = formula (66) of 1011.3918. Tree level
! spin-correlated hard scattering factor for tau- tau+ up anti-up glue -> 0
! **********************************************************************
  use ol_parameters_decl_/**/REALKIND
  implicit none
  real(DREALKIND), intent(in) :: P_scatt(0:3,5)
...
subroutine assign_helicity_flip(ext_wf_hf,ext_wf_t,m)
  ...
  if(size(ext_wf_hf) == size(hflip,1)) then
    ...
    call ol_fatal("Spin-correlated HSF for ppllj_llxuuxg_1:" &
...
subroutine init_flipped_heltables(i,j)
  ...
  do k = 1, 5
    r = external_perm_inv_ppllj_llxuuxg_1(k)
    if(r == i .or. r == j) then
      l = l+1
      select case(k)
        case(1)
...
end module ol_loop_ppllj_llxuuxg_1_/**/REALKIND
