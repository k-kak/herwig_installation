...
module ol_colourmatrix_ppllj_llxbbxg_1_/**/REALKIND
...
end module ol_colourmatrix_ppllj_llxbbxg_1_/**/REALKIND



module ol_forced_parameters_ppllj_llxbbxg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllj_llxbbxg_1_/**/REALKIND


! **********************************************************************
module ol_loop_storage_ppllj_llxbbxg_1_/**/REALKIND
! **********************************************************************
...
! **********************************************************************
module ol_loop_ppllj_llxbbxg_1_/**/REALKIND
! **********************************************************************
...
!  use ol_loop_parameters_decl_/**/DREALKIND, only: DOI
  ...
  ! factors of the diagrams
    ...
    f( 2) = CI*eQED**2*gQCD
    f( 3) = (CI*countertermnorm*eQED**2*gQCD**3)/3._/**/REALKIND
    f( 4) = CI*countertermnorm*eQED**2*gQCD**3
    f( 5) = (CI*countertermnorm*ctGbb*eQED**2*gQCD**3)/3._/**/REALKIND
    f( 6) = CI*countertermnorm*ctGbb*eQED**2*gQCD**3
    f( 7) = (CI*countertermnorm*ctVbb*eQED**2*gQCD**3)/3._/**/REALKIND
    f( 8) = CI*countertermnorm*ctVbb*eQED**2*gQCD**3
    f( 9) = countertermnorm*ctZGG*eQED**2*gQCD**3
    f(10) = (CI*eQED**2*gQCD*MB*ML)/(4._/**/REALKIND*MW**2*sw**2)
    f(11) = (CI*countertermnorm*eQED**2*gQCD**3*MB*ML)/(4._/**/REALKIND*MW**2*sw**2)
    f(12) = (CI*countertermnorm*ctGbb*eQED**2*gQCD**3*MB*ML)/(4._/**/REALKIND*MW**2*sw**2)
    f(13) = (CI*countertermnorm*ctSbb*eQED**2*gQCD**3*MB*ML)/(4._/**/REALKIND*MW**2*sw**2)
    f(14) = (CI*countertermnorm*ctHGG*eQED**2*gQCD**3*ML)/(2._/**/REALKIND*MW*sw)
    f(15) = (CI*eQED**2*gQCD**3*integralnorm*SwB)/3._/**/REALKIND
    f(16) = CI*eQED**2*gQCD**3*integralnorm*SwB
    f(17) = (eQED**2*gQCD**3*integralnorm*SwB)/3._/**/REALKIND
    f(18) = eQED**2*gQCD**3*integralnorm*SwB
    f(19) = (CI*eQED**2*gQCD**3*integralnorm*MB*ML*SwB)/(4._/**/REALKIND*MW**2*sw**2)
    f(20) = (eQED**2*gQCD**3*integralnorm*MB*ML*SwB)/(MW**2*sw**2*4._/**/REALKIND)
    f(21) = (eQED**2*gQCD**3*integralnorm*SwF)/3._/**/REALKIND
    f(22) = (2*eQED**2*gQCD**3*integralnorm*SwF)/3._/**/REALKIND
    f(23) = eQED**2*gQCD**3*integralnorm*SwF
    f(24) = (4*eQED**2*gQCD**3*integralnorm*SwF)/3._/**/REALKIND
    f(25) = 2*eQED**2*gQCD**3*integralnorm*SwF
    f(26) = (eQED**2*gQCD**3*integralnorm*MB*ML*SwF)/(MW**2*sw**2*4._/**/REALKIND)
    f(27) = (eQED**2*gQCD**3*integralnorm*ML*MT*SwF)/(MW**2*sw**2*4._/**/REALKIND)

  c = [ 9*CI*f(15), 9*CI*f(16), f(17), 8*f(17), f(18), 8*f(18), 9*CI*f(19), f(20), 8*f(20), 3*f(21), 3*f(22), 3*f(23), 3*f(24) &
    , 3*f(25), 3*f(26), 3*f(27) ]
  c = (1._/**/REALKIND / 6) * c
...
subroutine denominators()
  ...
  den(15) = 1 /((L(5,11) - MB2)+L(6,11))
  den(22) = 1 /((L(5,7) - MB2)+L(6,7))
...
! **********************************************************************
#ifndef PRECISION_dp
  use ol_loop_storage_ppllj_llxbbxg_1_/**/DREALKIND, only: hel_states
#endif
  implicit none
  ...
  allocate(A(hel_states,26))
  allocate(M1helarray(1,hel_states))
  allocate(M1helarray_ct(1,hel_states))
  allocate(M0_col1_helarray(1,hel_states))
  A(1:hel_states,1:26)%j = 0
  A(1:hel_states,1:26)%e = 0
  A(1:hel_states,1:26)%hf = 0
  A(1:hel_states,1:26)%s = 0
#if 1 > 0
...
! M2  = helicity-summed squared matrix element for tau- tau+ bottom anti-bottom glue -> 0
! **********************************************************************
  use ol_parameters_decl_/**/REALKIND !, only: ci, parameters_status, ZERO, scalefactor, >masses<
  use ol_parameters_init_/**/REALKIND, only: ensure_mp_init, ensure_mp_loop_init
  use ol_kinematics_/**/REALKIND, only: init_kinematics
  use ol_momenta_decl_/**/DREALKIND, only: momenta_nan_check
  use ol_settings_ppllj_llxbbxg_1, only: hel_mem_opt, loopcc
...
! 
  ...
  use ol_external_ppllj_llxbbxg_1, only: &
    & external_perm_ppllj_llxbbxg_1, &
    & external_perm_inv_ppllj_llxbbxg_1, &
    & extcomb_perm_ppllj_llxbbxg_1, &
    & average_factor_ppllj_llxbbxg_1
  use ol_external_ppllj_llxbbxg_1, only: &
    & H, hel_not_initialised, hel_init, POLSEL 
  use ol_colourmatrix_ppllj_llxbbxg_1_/**/REALKIND, only: &
    & colmat_not_initialised, colourmatrix_init
  use ol_forced_parameters_ppllj_llxbbxg_1_/**/REALKIND, only: &
    & check_forced_parameters
  use ol_heltables_OLR_ppllj_llxbbxg_1
  ...
  extmasses2 = [ nML, nML, nMB, nMB, 0 ]
  ! Convert 2 -> n-2 PS-point to n -> 0 (so that P(1) + ... + P(n) = 0) and compute
  ! internal-propagator momenta in light-cone representation
  call init_kinematics(P_scatt, extmasses2, P, &
     external_perm_inv_ppllj_llxbbxg_1, 5, qp_kinematics)
  ...
  call pol_wf_Q(P(:,1), rML, H1, ex1, POLSEL(1),1)
  call pol_wf_A(P(:,2), rML, H2, ex2, POLSEL(2),2)
  ...
  call vert_QA_V(ntry, ex1(:), ex2(:), wf4(:,4), n3(:,4), t3x4(:,:,3))
  call vert_AV_Q(ntry, ex4(:), wf4(:,4), wf8(:,2), n3(:,5), t3x8(:,:,2))
  call vert_QA_Z(gZl,ntry, ex1(:), ex2(:), wf4(:,5), n3(:,6), t3x4(:,:,4))
  call prop_W_W(ntry, wf4(:,5), 3, MZ, 1_intkind1, wf4(:,6), n2(2))
  call vert_AZ_Q(gZd,ntry, ex4(:), wf4(:,6), wf8(:,3), n3(:,7), t3x8(:,:,3))
  call vert_AV_Q(ntry, ex4(:), ex5(:), wf4(:,7), n3(:,8), t3x4(:,:,5))
  call prop_A_Q(ntry, wf4(:,7), 24, MB, 1_intkind1, wf4(:,8), n2(3))
  call vert_QS_A(gH,ntry, ex3(:), wf4(:,1), wf8(:,4), n3(:,9), t3x8(:,:,4))
  call vert_VQ_A(ntry, wf4(:,4), ex3(:), wf8(:,5), n3(:,10), t3x8(:,:,5))
  call vert_ZQ_A(gZd,ntry, wf4(:,6), ex3(:), wf8(:,6), n3(:,11), t3x8(:,:,6))
  call vert_QA_V(ntry, ex3(:), ex4(:), wf4(:,9), n3(:,12), t3x4(:,:,6))
  call counter_SG_G(ntry, wf4(:,1), ex5(:), wf8(:,7), n3(:,13), t3x8(:,:,7))
  call counter_VG_G(ntry, wf4(:,6), ex5(:), 16, wf8(:,8), 19, n3(:,14), t3x8(:,:,8))
  call counter_SA_Q(gH,ntry, wf4(:,1), ex4(:), wf8(:,9), n3(:,15), t3x8(:,:,9))
  call counter_AV_Q(ntry, ex4(:), wf4(:,4), wf8(:,10), n3(:,16), t3x8(:,:,10))
  call counter_AZ_Q(gZd,ntry, ex4(:), wf4(:,6), wf8(:,11), n3(:,17), t3x8(:,:,11))
  call counter_AV_Q(ntry, ex4(:), ex5(:), wf4(:,10), n3(:,18), t3x4(:,:,7))
  call prop_A_Q(ntry, wf4(:,10), 24, MB, 1_intkind1, wf4(:,11), n2(4))
  call counter_QS_A(gH,ntry, ex3(:), wf4(:,1), wf8(:,12), n3(:,19), t3x8(:,:,12))
  call counter_VQ_A(ntry, wf4(:,4), ex3(:), wf8(:,13), n3(:,20), t3x8(:,:,13))
  call counter_ZQ_A(gZd,ntry, wf4(:,6), ex3(:), wf8(:,14), n3(:,21), t3x8(:,:,14))
  call counter_VQ_A(ntry, ex5(:), ex3(:), wf4(:,12), n3(:,22), t3x4(:,:,8))
  call prop_Q_A(ntry, wf4(:,12), 20, MB, 1_intkind1, wf4(:,13), n2(5))
  call counter_Q_A(ctbb,5,ntry, wf4(:,3), 20, wf4(:,14), n2(6))
  call prop_A_Q(ntry, wf8(:,1), 11, MB, 1_intkind1, wf8(:,15), n2(7))
  call prop_A_Q(ntry, wf8(:,2), 11, MB, 1_intkind1, wf8(:,16), n2(8))
  call prop_A_Q(ntry, wf8(:,3), 11, MB, 1_intkind1, wf8(:,17), n2(9))
  call counter_A_Q(ctbb,5,ntry, wf4(:,8), 24, wf4(:,15), n2(10))
  call prop_Q_A(ntry, wf8(:,4), 7, MB, 1_intkind1, wf8(:,18), n2(11))
  call prop_Q_A(ntry, wf8(:,5), 7, MB, 1_intkind1, wf8(:,19), n2(12))
  call prop_Q_A(ntry, wf8(:,6), 7, MB, 1_intkind1, wf8(:,20), n2(13))
...
subroutine diagrams()
  ...
  ! e.g. call cont_VV(nsync, wf3, wf6, A(:,1), n64, t64, nhel, den(5)) ...
    ...
    call Hcont_QA(nsync, wf4(:,3), wf8(:,1), A(:,1), n3(:,23), t3x32(:,:,1), nhel, den(3))
    call Hcont_QA(nsync, wf4(:,3), wf8(:,2), A(:,2), n3(:,24), t3x32(:,:,2), nhel, den(5))
    call Hcont_QA(nsync, wf4(:,3), wf8(:,3), A(:,3), n3(:,25), t3x32(:,:,3), nhel, den(7))
    call Hcont_QA(nsync, wf4(:,8), wf8(:,4), A(:,4), n3(:,26), t3x32(:,:,4), nhel, den(9))
    call Hcont_QA(nsync, wf4(:,8), wf8(:,5), A(:,5), n3(:,27), t3x32(:,:,5), nhel, den(10))
    call Hcont_QA(nsync, wf4(:,8), wf8(:,6), A(:,6), n3(:,28), t3x32(:,:,6), nhel, den(11))

    call Hcont_VV(nsync, wf4(:,9), wf8(:,7), A(:,7), n3(:,29), t3x32(:,:,7), nhel, den(13))
    call Hcont_VV(nsync, wf4(:,9), wf8(:,8), A(:,8), n3(:,30), t3x32(:,:,8), nhel, den(14))
    call Hcont_QA(nsync, wf4(:,3), wf8(:,9), A(:,9), n3(:,31), t3x32(:,:,9), nhel, den(3))
    call Hcont_QA(nsync, wf4(:,3), wf8(:,10), A(:,10), n3(:,32), t3x32(:,:,10), nhel, den(5))
    call Hcont_QA(nsync, wf4(:,3), wf8(:,11), A(:,11), n3(:,33), t3x32(:,:,11), nhel, den(7))
    call Hcont_QA(nsync, wf8(:,4), wf4(:,11), A(:,12), n3(:,34), t3x32(:,:,12), nhel, den(9))
    call Hcont_QA(nsync, wf8(:,5), wf4(:,11), A(:,13), n3(:,35), t3x32(:,:,13), nhel, den(10))
    call Hcont_QA(nsync, wf8(:,6), wf4(:,11), A(:,14), n3(:,36), t3x32(:,:,14), nhel, den(11))
    call Hcont_QA(nsync, wf4(:,8), wf8(:,12), A(:,15), n3(:,37), t3x32(:,:,15), nhel, den(9))
    call Hcont_QA(nsync, wf4(:,8), wf8(:,13), A(:,16), n3(:,38), t3x32(:,:,16), nhel, den(10))
    call Hcont_QA(nsync, wf4(:,8), wf8(:,14), A(:,17), n3(:,39), t3x32(:,:,17), nhel, den(11))
    call Hcont_QA(nsync, wf8(:,1), wf4(:,13), A(:,18), n3(:,40), t3x32(:,:,18), nhel, den(3))
    call Hcont_QA(nsync, wf8(:,2), wf4(:,13), A(:,19), n3(:,41), t3x32(:,:,19), nhel, den(5))
    call Hcont_QA(nsync, wf8(:,3), wf4(:,13), A(:,20), n3(:,42), t3x32(:,:,20), nhel, den(7))
    call Hcont_QA(nsync, wf4(:,14), wf8(:,15), A(:,21), n3(:,43), t3x32(:,:,21), nhel, den(17))
    call Hcont_QA(nsync, wf4(:,14), wf8(:,16), A(:,22), n3(:,44), t3x32(:,:,22), nhel, den(19))
    call Hcont_QA(nsync, wf4(:,14), wf8(:,17), A(:,23), n3(:,45), t3x32(:,:,23), nhel, den(21))
    call Hcont_QA(nsync, wf4(:,15), wf8(:,18), A(:,24), n3(:,46), t3x32(:,:,24), nhel, den(24))
    call Hcont_QA(nsync, wf4(:,15), wf8(:,19), A(:,25), n3(:,47), t3x32(:,:,25), nhel, den(26))
    call Hcont_QA(nsync, wf4(:,15), wf8(:,20), A(:,26), n3(:,48), t3x32(:,:,26), nhel, den(28))
...
subroutine colourvectors(A, j, M1, M2)
  ...
  M1(1)%j = ((A(j,2)%j+A(j,5)%j)*f(1)+(A(j,3)%j+A(j,6)%j)*f(2)+(-A(j,1)%j-A(j,4)%j)*f(10))

  M2(1)%j = ((-A(j,22)%j-A(j,25)%j)*f(3)+(-A(j,23)%j-A(j,26)%j)*f(4)+(A(j,13)%j+A(j,19)%j)*f(5)+(A(j,14)%j+A(j,20)%j)*f(6) &
       +(A(j,10)%j+A(j,16)%j)*f(7)+(A(j,11)%j+A(j,17)%j)*f(8)-A(j,8)%j*f(9)+(A(j,21)%j+A(j,24)%j)*f(11)+(-A(j,12)%j &
       -A(j,18)%j)*f(12)+(-A(j,9)%j-A(j,15)%j)*f(13)-A(j,7)%j*f(14))
...
! K1(i,j) = <Ci|Cj>
! **********************************************************************
  use ol_colourmatrix_ppllj_llxbbxg_1_/**/REALKIND, only: K1
  implicit none
...
! K2(i,j) = <Ci|Cj>
! **********************************************************************
  use ol_colourmatrix_ppllj_llxbbxg_1_/**/REALKIND, only: K2
  implicit none
...
! **********************************************************************
  use ol_colourmatrix_ppllj_llxbbxg_1_/**/REALKIND, only: KL
  implicit none
...
#endif
! M2tree = helicity-summed squared tree matrix element for tau- tau+ bottom anti-bottom glue -> 0
! M2hsf  = formula (66) of 1011.3918. Tree level
! spin-correlated hard scattering factor for tau- tau+ bottom anti-bottom glue -> 0
! **********************************************************************
  use ol_parameters_decl_/**/REALKIND
  implicit none
  real(DREALKIND), intent(in) :: P_scatt(0:3,5)
...
subroutine assign_helicity_flip(ext_wf_hf,ext_wf_t,m)
  ...
  if(size(ext_wf_hf) == size(hflip,1)) then
    ...
    call ol_fatal("Spin-correlated HSF for ppllj_llxbbxg_1:" &
...
subroutine init_flipped_heltables(i,j)
  ...
  do k = 1, 5
    r = external_perm_inv_ppllj_llxbbxg_1(k)
    if(r == i .or. r == j) then
      l = l+1
      select case(k)
        case(1)
...
end module ol_loop_ppllj_llxbbxg_1_/**/REALKIND
