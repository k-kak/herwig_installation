...
module ol_tree_ppllj_llxbbxg_1_/**/REALKIND
  ...
  complex(DREALKIND) :: M1helarr(1,32) ! cache
#endif
...
subroutine factors_init()
  ...
  ! factors of the diagrams
    ...
    f(2) = CI*eQED**2*gQCD
    f(3) = (CI*eQED**2*gQCD*MB*ML)/(4._/**/REALKIND*MW**2*sw**2)
...
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_ppllj_llxbbxg_1_/**/DREALKIND, only: &
...
#else
subroutine amp2tree(P, M2) &
    & bind(c,name="ol_f_amp2tree_qp_ppllj_llxbbxg_1")
#endif
...
end module ol_tree_ppllj_llxbbxg_1_/**/REALKIND
