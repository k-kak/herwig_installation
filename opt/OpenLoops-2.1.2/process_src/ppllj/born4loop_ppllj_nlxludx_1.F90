...
module ol_tree_ppllj_nlxludx_1_/**/REALKIND
...
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_ppllj_nlxludx_1_/**/DREALKIND, only: &
...
! 
  ...
  use ol_forced_parameters_ppllj_nlxludx_1_/**/REALKIND, only: &
...
! i=j=0 -> 0 means no colour insertion.
! **********************************************************************
  use ol_colourmatrix_ppllj_nlxludx_1_/**/REALKIND, only: K1
  implicit none
...
#else
subroutine amp2tree(P, M2) &
    & bind(c,name="ol_f_amp2tree_qp_ppllj_nlxludx_1")
#endif
...
end module ol_tree_ppllj_nlxludx_1_/**/REALKIND
