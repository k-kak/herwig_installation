...
module ol_colourmatrix_ppllj_nenexuuxg_2_/**/REALKIND
...
end module ol_colourmatrix_ppllj_nenexuuxg_2_/**/REALKIND



module ol_forced_parameters_ppllj_nenexuuxg_2_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllj_nenexuuxg_2_/**/REALKIND


! **********************************************************************
module ol_loop_storage_ppllj_nenexuuxg_2_/**/REALKIND
! **********************************************************************
...
end module ol_loop_storage_ppllj_nenexuuxg_2_/**/REALKIND
...
! **********************************************************************
module ol_loop_ppllj_nenexuuxg_2_/**/REALKIND
! **********************************************************************
...
! **********************************************************************
#ifndef PRECISION_dp
  use ol_loop_storage_ppllj_nenexuuxg_2_/**/DREALKIND, only: hel_states
#endif
  implicit none
...
! M2  = helicity-summed squared matrix element for nu_e anti-nu_e up anti-up glue -> 0
! **********************************************************************
  use ol_parameters_decl_/**/REALKIND !, only: ci, parameters_status, ZERO, scalefactor, >masses<
  use ol_parameters_init_/**/REALKIND, only: ensure_mp_init, ensure_mp_loop_init
  use ol_kinematics_/**/REALKIND, only: init_kinematics
  use ol_momenta_decl_/**/DREALKIND, only: momenta_nan_check
  use ol_settings_ppllj_nenexuuxg_2, only: hel_mem_opt, loopcc
...
! 
  ...
  use ol_forced_parameters_ppllj_nenexuuxg_2_/**/REALKIND, only: &
    & check_forced_parameters
  use ol_heltables_OLR_ppllj_nenexuuxg_2
  ...
  call init_kinematics(P_scatt, extmasses2, P, &
     external_perm_inv_ppllj_nenexuuxg_2, 5, qp_kinematics)
  ...
  call counter_Q_A(ctqq,2,ntry, wf4(:,4), 20, wf4(:,12), n2(6))
  call prop_A_Q(ntry, wf8(:,1), 11, ZERO, 0_intkind1, wf8(:,6), n2(7))
  call counter_A_Q(ctqq,2,ntry, wf4(:,6), 24, wf4(:,13), n2(8))
...
! K1(i,j) = <Ci|Cj>
! **********************************************************************
  use ol_colourmatrix_ppllj_nenexuuxg_2_/**/REALKIND, only: K1
  implicit none
...
! K2(i,j) = <Ci|Cj>
! **********************************************************************
  use ol_colourmatrix_ppllj_nenexuuxg_2_/**/REALKIND, only: K2
  implicit none
...
! **********************************************************************
  use ol_colourmatrix_ppllj_nenexuuxg_2_/**/REALKIND, only: KL
  implicit none
...
! spin-correlated hard scattering factor for nu_e anti-nu_e up anti-up glue -> 0
! **********************************************************************
  use ol_parameters_decl_/**/REALKIND
  implicit none
  real(DREALKIND), intent(in) :: P_scatt(0:3,5)
...
subroutine assign_helicity_flip(ext_wf_hf,ext_wf_t,m)
  ...
  if(size(ext_wf_hf) == size(hflip,1)) then
    ...
    call ol_fatal("Spin-correlated HSF for ppllj_nenexuuxg_2:" &
...
subroutine init_flipped_heltables(i,j)
  ...
  do k = 1, 5
    r = external_perm_inv_ppllj_nenexuuxg_2(k)
    if(r == i .or. r == j) then
      l = l+1
      select case(k)
        case(1)
...
end module ol_loop_ppllj_nenexuuxg_2_/**/REALKIND
