...
module ol_vamp_ppllj_nllxuxd_1_/**/REALKIND
...
! **********************************************************************
  ...
  use ol_tensor_sum_storage_ppllj_nllxuxd_1_/**/REALKIND
...
! **********************************************************************
  ...
  use ol_tensor_sum_storage_ppllj_nllxuxd_1_/**/REALKIND
  use ol_loop_storage_ppllj_nllxuxd_1_/**/DREALKIND, only: &
    merge_step, hel_states

  use ol_vamp_1_ppllj_nllxuxd_1_/**/REALKIND, only: vamp_1
...
! **********************************************************************
  ...
  use ol_colourmatrix_ppllj_nllxuxd_1_/**/REALKIND ! colmat_not_initialised, K1, K2, KL, KL2, KL2ct, KL2ct2
  ...
  use ol_tensor_sum_storage_ppllj_nllxuxd_1_/**/REALKIND, only: &
  ...
  use ol_tables_storage_ppllj_nllxuxd_1_/**/DREALKIND, only: HOL_m3_init
  use ol_loop_ppllj_nllxuxd_1_/**/REALKIND, only: amp2
  use ol_loop_ppllj_nllxuxd_1_/**/DREALKIND, only: init_merging_tables, update_merging_tables
  use ol_loop_storage_ppllj_nllxuxd_1_/**/REALKIND, only: &
    & fac_status_loop1, fac_status_loop2, M0_col1_helarray
  use ol_i_operator_/**/REALKIND, only: intdip
  use ol_loop_storage_ppllj_nllxuxd_1_/**/DREALKIND, only: ntryL, nhel, p_switch, &
...
! **********************************************************************
  ...
  use ol_external_ppllj_nllxuxd_1, only: &
    & photonid_ppllj_nllxuxd_1
  use ol_colourmatrix_ppllj_nllxuxd_1_/**/REALKIND, only: &
...
! **********************************************************************
  ...
  use ol_external_ppllj_nllxuxd_1, only: & 
    ...
    & average_factor_ppllj_nllxuxd_1, &
    & photonid_ppllj_nllxuxd_1
  use ol_loop_storage_ppllj_nllxuxd_1_/**/REALKIND, only: M2ctcc, M0M1_hel_cc
  use ol_tensor_sum_storage_ppllj_nllxuxd_1_/**/REALKIND, only: reset_tensor_sum, &
    & integrate_tensor_sum
  use ol_debug, only: ol_fatal
  use ol_colourmatrix_ppllj_nllxuxd_1_/**/REALKIND, only: Cas
  ...
  M2L1 = M2L1cache
#else
  call ol_fatal("born-loop colour correlators not available for process ppllj_nllxuxd_1")
#endif
...
! **********************************************************************
 ...
 &  photonid_ppllj_nllxuxd_1
  use ol_momenta_decl_/**/DREALKIND, only: momenta_nan_check
  use ol_loop_ppllj_nllxuxd_1_/**/REALKIND, only: hsfamp2
  use ol_ew_renormalisation_/**/REALKIND, only: photon_factors
  implicit none
  real(DREALKIND), intent(in) :: P_scatt(0:3,4)
...
end module ol_vamp_ppllj_nllxuxd_1_/**/REALKIND


#ifdef DUMMY_qp
module ol_vamp_ppllj_nllxuxd_1_/**/QREALKIND
  implicit none
  contains
  subroutine vamp2pc(P_scatt, M2L0, M2L1, IRL1, M2L2, IRL2, mode)
...
end module ol_vamp_ppllj_nllxuxd_1_/**/QREALKIND
#endif
...
!   use ol_data_types_/**/REALKIND, only: Hpolcont
!   use ol_tensor_sum_storage_ppllj_nllxuxd_1_/**/DREALKIND, only: HOL_memory_allocation
    use ol_stability, only: finish_histograms
    use ol_vamp_ppllj_nllxuxd_1_/**/DREALKIND, only: vamp
    use ol_tensor_sum_storage_ppllj_nllxuxd_1_/**/DREALKIND, only: &
      & HOL_memory_deallocation_/**/DREALKIND, HCL_memory_deallocation_/**/DREALKIND
#ifndef DUMMY_qp
    use ol_tensor_sum_storage_ppllj_nllxuxd_1_/**/QREALKIND, only: &
...
!   call vamp(Mdummy)
  ...
  subroutine vamp2(P_scatt, M2L0, M2L1, IRL1, M2L2, IRL2) &
    ...
    use ol_vamp_ppllj_nllxuxd_1_/**/DREALKIND, only: vamp2dp => vamp2pc
    use ol_vamp_ppllj_nllxuxd_1_/**/QREALKIND, only: vamp2qp => vamp2pc
  ...
  subroutine ctamp2(P_scatt, M2tree, M2ct) &
    ...
    use KIND_TYPES, only: DREALKIND
    use ol_vamp_ppllj_nllxuxd_1_/**/DREALKIND, only: ctamp2base
    implicit none
    real(DREALKIND), intent(in)  :: P_scatt(0:3,4)
  ...
  subroutine iopamp2(P_scatt, M2tree, IRL1) &
    ...
    use KIND_TYPES, only: DREALKIND
    use ol_vamp_ppllj_nllxuxd_1_/**/DREALKIND, only: iopamp2base
    implicit none
    real(DREALKIND), intent(in)  :: P_scatt(0:3,4)
  ...
  subroutine schsfamp2(P_scatt, M2tree, i, j, M2hsf) &
    ...
    use KIND_TYPES, only: DREALKIND
    use ol_vamp_ppllj_nllxuxd_1_/**/DREALKIND, only: schsfamp2base
    implicit none
    real(DREALKIND), intent(in)  :: P_scatt(0:3,4)
    integer, intent(in)  :: i, j
  ...
  subroutine vampcr2(P_scatt, M2L0, M2L1, M2L2, crtype, &
    ...
    use ol_vamp_ppllj_nllxuxd_1_/**/DREALKIND, only: vamp2cache
    use ol_data_types_/**/DREALKIND, only: correlator
    implicit none
