...
module ol_vamp_1_ppllj_nexeudxg_1_/**/REALKIND
contains

! **********************************************************************
subroutine vamp_1(M)
! P(0:3,nlegs) = incoming external momenta
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_ppllj_nexeudxg_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_ppllj_nexeudxg_1.
! **********************************************************************
  ...
  use ol_tables_storage_ppllj_nexeudxg_1_/**/DREALKIND
  ...
  use ol_loop_storage_ppllj_nexeudxg_1_/**/REALKIND
#ifndef PRECISION_dp
...
G0tensor(11),G0tensor(12),G0tensor(13),G0tensor(14),G0tensor(15))
  ...
  call Hloop_A_Q(ntryL,G0H16(1),16,0,G1H16(3),n2h16(4))
...
call HGT_w2_invQ_OLR(G1H4(1),2,5,4)
  ...
  call Hcheck_last_A_Q(ntryL,l_switch,G1H1(1),31,0,G2tensor(14),n2h1(12))
  ...
  call Hcheck_last_A_Q(ntryL,l_switch,G0H1(1),31,0,G1tensor(1),n2h1(13))
...
end module ol_vamp_1_ppllj_nexeudxg_1_/**/REALKIND
