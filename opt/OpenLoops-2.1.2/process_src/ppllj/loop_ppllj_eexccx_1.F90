...
module ol_colourmatrix_ppllj_eexccx_1_/**/REALKIND
...
end module ol_colourmatrix_ppllj_eexccx_1_/**/REALKIND



module ol_forced_parameters_ppllj_eexccx_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllj_eexccx_1_/**/REALKIND


! **********************************************************************
module ol_loop_storage_ppllj_eexccx_1_/**/REALKIND
! **********************************************************************
...
end module ol_loop_storage_ppllj_eexccx_1_/**/REALKIND
...
! **********************************************************************
module ol_loop_ppllj_eexccx_1_/**/REALKIND
! **********************************************************************
  use KIND_TYPES, only: REALKIND, DREALKIND, intkind1, intkind2
  use ol_data_types_/**/REALKIND, only: wfun, Hpolcont
  use ol_loop_storage_ppllj_eexccx_1_/**/REALKIND
  implicit none
...
!  use ol_loop_parameters_decl_/**/DREALKIND, only: DOI
  ...
  ! factors of the diagrams
    ...
    f(2) = CI*eQED**2
    f(3) = (2*CI*countertermnorm*ctVcc*eQED**2*gQCD**2)/3._/**/REALKIND
...
! **********************************************************************
#ifndef PRECISION_dp
  use ol_loop_storage_ppllj_eexccx_1_/**/DREALKIND, only: hel_states
#endif
  implicit none
...
! 
  ...
  use ol_forced_parameters_ppllj_eexccx_1_/**/REALKIND, only: &
...
! K1(i,j) = <Ci|Cj>
! **********************************************************************
  use ol_colourmatrix_ppllj_eexccx_1_/**/REALKIND, only: K1
  implicit none
...
! K2(i,j) = <Ci|Cj>
! **********************************************************************
  use ol_colourmatrix_ppllj_eexccx_1_/**/REALKIND, only: K2
  implicit none
...
! **********************************************************************
  use ol_colourmatrix_ppllj_eexccx_1_/**/REALKIND, only: KL
  implicit none
...
end module ol_loop_ppllj_eexccx_1_/**/REALKIND
