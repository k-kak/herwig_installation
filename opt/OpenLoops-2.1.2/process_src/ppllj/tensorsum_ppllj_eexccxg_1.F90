...
! **********************************************************************
module ol_tables_storage_ppllj_eexccxg_1_/**/REALKIND
! **********************************************************************
...
integer(intkind2), save :: h0tab(32,42)
integer(intkind2), save :: heltab2x2(2,2,15)
integer(intkind2), save :: heltab2x4(2,4,12)
integer(intkind2), save :: heltab2x8(2,8,20)
integer(intkind2), save :: heltab2x16(2,16,32)
integer(intkind2), save :: heltab2x32(2,32,42)


  ! number of helicity states for openloops recursion steps
integer(intkind2), save :: m0h(42)
integer(intkind2), save :: m3h2x1(3,15)
integer(intkind2), save :: m3h4x1(3,10)
...
end module ol_tables_storage_ppllj_eexccxg_1_/**/REALKIND

! **********************************************************************
module ol_tensor_sum_storage_ppllj_eexccxg_1_/**/REALKIND
! **********************************************************************
  use KIND_TYPES, only: REALKIND, QREALKIND, intkind2
...
integer, save :: mass4set(0:3,2)
  ...
  type(hcl), save, dimension(40) :: T0sum
...
!**********************************************************************
  ...
  use ol_loop_storage_ppllj_eexccxg_1_/**/DREALKIND, only: nhel
  use ol_data_types_/**/REALKIND, only: hol
  ...
  call hol_allocation(4,15,4,4,G2H4,18)
  ...
  call hol_allocation(4,5,4,16,G1H16,28)
...
!**********************************************************************
  ...
  call hol_allocation(4,15,4,min(nhel,4),G2H4,18)
  ...
  call hol_allocation(4,5,4,min(nhel,16),G1H16,28)
...
!**********************************************************************
  ...
  call hol_deallocation(G2H4,18,dmode)
  ...
  call hol_deallocation(G1H16,28,dmode)
...
!**********************************************************************
  ...
  call hcl_deallocation(G0tensor, 69,dmode)
call hcl_deallocation(G1tensor, 15,dmode)
call hcl_deallocation(G2tensor, 18,dmode)
call hcl_deallocation(G3tensor, 8,dmode)

    call hcl_deallocation(T0sum,40,dmode)
...
!**********************************************************************
  ...
  implicit none
    ...
    call hcl_allocation(1,T0sum,40)
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_ppllj_eexccxg_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_ppllj_eexccxg_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 0
...
! **********************************************************************
  ...
  masses2_9 = [ 0, 0, 0 ]
  masses2_10 = [ 0, 0, nMC ]
  masses2_11 = [ nMC, 0, nMC ]
  masses2_12 = [ nMB, nMB, nMB ]
  masses2_13 = [ nMC, nMC, 0 ]
  masses2_14 = [ 0, nMC, nMC ]
  masses2_15 = [ nMC, nMC, nMC ]
  masses2_16 = [ nMT, nMT, nMT ]
  masses2_17 = [ 0, 0, nMC, nMC ]
  masses2_18 = [ nMC, nMC, nMC, 0 ]
...
#endif
  call TI_call_OL(0,0, momenta_20, masses2_17, T0sum(1), M2)
  call TI_call_OL(0,0, momenta_19, masses2_18, T0sum(2), M2)
  call TI_call_OL(0,0, momenta_18, masses2_18, T0sum(3), M2)
  call TI_call_OL(0,0, momenta_10, masses2_10, T0sum(4), M2)
  call TI_call_OL(0,0, momenta_15, masses2_14, T0sum(5), M2)
  call TI_call_OL(0,0, momenta_9, masses2_15, T0sum(6), M2)
  call TI_call_OL(0,0, momenta_16, masses2_14, T0sum(7), M2)
  call TI_call_OL(0,0, momenta_17, masses2_11, T0sum(8), M2)
  call TI_call_OL(0,0, momenta_11, masses2_10, T0sum(9), M2)
  call TI_call_OL(0,0, momenta_14, masses2_13, T0sum(10), M2)
  call TI_call_OL(0,0, momenta_12, masses2_13, T0sum(11), M2)
  call TI_call_OL(0,0, momenta_13, masses2_13, T0sum(12), M2)
  call TI_call_OL(0,0, momenta_11, masses2_13, T0sum(13), M2)
  call TI_call_OL(0,0, momenta_9, masses2_9, T0sum(14), M2)
  call TI_call_OL(0,0, momenta_9, masses2_16, T0sum(15), M2)
  call TI_call_OL(0,0, momenta_9, masses2_12, T0sum(16), M2)
  call TI_call_OL(0,0, momenta_10, masses2_13, T0sum(17), M2)
  call TI_call_OL(0,0, momenta_7, masses2_3, T0sum(18), M2)
  call TI_call_OL(0,0, momenta_4, masses2_6, T0sum(19), M2)
  call TI_call_OL(0,0, momenta_2, masses2_1, T0sum(20), M2)
  call TI_call_OL(0,0, momenta_1, masses2_3, T0sum(21), M2)
  call TI_call_OL(0,0, momenta_8, masses2_7, T0sum(22), M2)
  call TI_call_OL(0,0, momenta_5, masses2_6, T0sum(23), M2)
  call TI_call_OL(0,0, momenta_3, masses2_7, T0sum(24), M2)
  call TI_call_OL(0,0, momenta_2, masses2_7, T0sum(25), M2)
  call TI_call_OL(0,0, momenta_7, masses2_6, T0sum(26), M2)
  call TI_call_OL(0,0, momenta_6, masses2_6, T0sum(27), M2)
  call TI_call_OL(0,0, momenta_6, masses2_3, T0sum(28), M2)
  call TI_call_OL(0,0, momenta_5, masses2_3, T0sum(29), M2)
  call TI_call_OL(0,0, momenta_8, masses2_1, T0sum(30), M2)
  call TI_call_OL(0,0, momenta_3, masses2_1, T0sum(31), M2)
  call TI_call_OL(0,0, momenta_8, masses2_8, T0sum(32), M2)
  call TI_call_OL(0,0, momenta_3, masses2_8, T0sum(33), M2)
  call TI_call_OL(0,0, momenta_2, masses2_8, T0sum(34), M2)
  call TI_call_OL(0,0, momenta_1, masses2_4, T0sum(35), M2)
  call TI_call_OL(0,0, momenta_8, masses2_5, T0sum(36), M2)
  call TI_call_OL(0,0, momenta_3, masses2_5, T0sum(37), M2)
  call TI_call_OL(0,0, momenta_2, masses2_5, T0sum(38), M2)
  call TI_call_OL(0,0, momenta_1, masses2_2, T0sum(39), M2)
  call TI_call_OL(0,0, momenta_4, masses2_3, T0sum(40), M2)
...
end module ol_tensor_sum_storage_ppllj_eexccxg_1_/**/REALKIND
