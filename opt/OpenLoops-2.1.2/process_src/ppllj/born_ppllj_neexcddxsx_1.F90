...
module ol_colourmatrix_ppllj_neexcddxsx_1_/**/REALKIND
  use KIND_TYPES, only: REALKIND
  implicit none
  logical, save           :: colmat_not_initialised = .true.
  complex(REALKIND), save :: K1(0,0)
  contains
...
end module ol_colourmatrix_ppllj_neexcddxsx_1_/**/REALKIND



module ol_forced_parameters_ppllj_neexcddxsx_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllj_neexcddxsx_1_/**/REALKIND

module ol_tree_ppllj_neexcddxsx_1_/**/REALKIND
  use KIND_TYPES, only: REALKIND, DREALKIND, intkind1, intkind2
  use ol_debug, only: ol_msg
  implicit none
  integer,           save :: factors_status = -1
  complex(REALKIND), save :: f(0)
  ...
  complex(DREALKIND) :: M1helarr(0,64) ! cache
#endif
...
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu) &
    & bind(c,name="ol_f_amp2_ppllj_neexcddxsx_1")
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_ppllj_neexcddxsx_1_/**/DREALKIND, only: &
    & ntry, nhel, Hel, M1helarr
#endif
! P_scatt(0:3,Npart) = incoming external momenta
! M2  = helicity-summed squared matrix element for nu_e e+ charm down anti-down anti-strange -> 0
...
! 
  ...
  use ol_external_ppllj_neexcddxsx_1, only: &
    & external_perm_ppllj_neexcddxsx_1, &
    & external_perm_inv_ppllj_neexcddxsx_1, &
    & extcomb_perm_ppllj_neexcddxsx_1, &
    & average_factor_ppllj_neexcddxsx_1, &
    & photonid_ppllj_neexcddxsx_1
  use ol_external_ppllj_neexcddxsx_1, only: &
    & H, hel_not_initialised, hel_init, POLSEL 
  use ol_colourmatrix_ppllj_neexcddxsx_1_/**/REALKIND, only: &
    & colmat_not_initialised, colourmatrix_init
  use ol_forced_parameters_ppllj_neexcddxsx_1_/**/REALKIND, only: &
    & check_forced_parameters
  use ol_heltables_ppllj_neexcddxsx_1
  ...
  complex(REALKIND) :: MOM_LC(4), M1(0), M1helarray(0,64)
...
StringDrop[StringReplace[StringJoin[  type(wfun) :: , StringDrop[, -2],  ], Condition[StringExpression[Pattern[piece$, BlankNullSequence[]], Pattern[cut$,  ]], Less[StringLength[piece$], Plus[OptionValue[{Indent -> 2, MaxLength -> 132}, {Indent -> 3}, MaxLength], Times[-1, currentindent$5652], -1, Times[-1, lastcutlength$5652]]]] :> CompoundExpression[Set[currentindent$5652, indent$5652], Set[lastcutlength$5652, StringLength[cut$]], StringJoin[piece$,  &
, spaces$5652, cut$]]], -7]
  ...
  call init_kinematics(P_scatt, extmasses2, P, &
      &  external_perm_inv_ppllj_neexcddxsx_1, 6,.false.)
  ...
  JBmunu = 0
  if (I > 0) then
    ReplacePol = external_perm_ppllj_neexcddxsx_1(I)
  else if (I < 0) then
    JBmunu = external_perm_ppllj_neexcddxsx_1(-I)
  end if

  do k = 1, nextcombs
    extcombs_permuted(k) = &
       & extcomb_perm_ppllj_neexcddxsx_1(extcombs(k))
  end do
  ...
  if ( JBmunu /= 0 ) then ! POWHEGs Bmunu helicity correlation
    ...
    M2munu = M2munu / average_factor_ppllj_neexcddxsx_1
  end if

  ! Colour and helicity average and symmetry factor of outgoing particles
  M2add = M2 / average_factor_ppllj_neexcddxsx_1

  do k = 0, 1-1
    M2(k) = M2add(extcomb_perm_ppllj_neexcddxsx_1(k))
  end do

  ! photon-factors
  call photon_factors(photonid_ppllj_neexcddxsx_1, 0, bornphotonfactor)
...
subroutine colourvector(A, j, M1)
  ...
  type(polcont) :: A(:,:)
  integer, intent(in) :: j
  complex(REALKIND), intent(out) :: M1(0) ! M1helarray(0,64)
  integer :: empty(0)
...
! i=j=0 -> 0 means no colour insertion.
! **********************************************************************
  use ol_colourmatrix_ppllj_neexcddxsx_1_/**/REALKIND, only: K1
  implicit none

  complex(REALKIND), intent(in)  :: M(0)
...
! **********************************************************************
  ...
  complex(REALKIND), intent(in)  :: M1(0), M2(0)
  real(REALKIND),    intent(out) :: M2colint(0:1-1)
  integer,           intent(in)  :: extcombs(:)
  integer :: extcomb, colmatpos, i, j, eco
...
! **********************************************************************
  ...
  complex(REALKIND), intent(in)  :: M1(0)
  complex(REALKIND), intent(in)  :: M2(0)
...
subroutine colourvector(M1out, nhelout) &
  & bind(c,name="ol_tree_colvect_ppllj_neexcddxsx_1")
  ! Retrieve M1helarr from cache. Cache must have been filled before by calling amp2().
  ! [out] M1out(:,h): colour vector for each helicity configuration h
  ! [out] nhelout: number of non-vanishing helicity configurations
  implicit none
  complex(DREALKIND) :: M1out(0,64)
...
subroutine amp2tree(P, M2) &
    & bind(c,name="ol_f_amp2tree_ppllj_neexcddxsx_1")
#else
subroutine amp2tree(P, M2) &
    & bind(c,name="ol_f_amp2tree_qp_ppllj_neexcddxsx_1")
#endif
...
subroutine amp2ccone(P, M2, I, J) &
    & bind(c,name="ol_f_amp2ccone_ppllj_neexcddxsx_1")
#else
subroutine amp2ccone(P, M2, I, J)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2ccall(P, M2) &
    & bind(c,name="ol_f_amp2ccall_ppllj_neexcddxsx_1")
#else
subroutine amp2ccall(P, M2)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcone(P, M2, I, J, MOM) &
    & bind(c,name="ol_f_amp2hcone_ppllj_neexcddxsx_1")
#else
subroutine amp2hcone(P, M2, I, J, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcall(P, M2, I, MOM) &
    & bind(c,name="ol_f_amp2hcall_ppllj_neexcddxsx_1")
#else
subroutine amp2hcall(P, M2, I, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2tree_c(p, m2) &
    & bind(c,name="ol_amp2tree_ppllj_neexcddxsx_1")
...
subroutine amp2ccone_c(p, m2, i, j) &
    & bind(c,name="ol_amp2ccone_ppllj_neexcddxsx_1")
...
subroutine amp2ccall_c(p, m2) &
    & bind(c,name="ol_amp2ccall_ppllj_neexcddxsx_1")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
...
subroutine amp2hcone_c(p, m2, i, j, mom) &
    & bind(c,name="ol_amp2hcone_ppllj_neexcddxsx_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_c(p, m2, i, mom) &
    & bind(c,name="ol_amp2hcall_ppllj_neexcddxsx_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
...
end module ol_tree_ppllj_neexcddxsx_1_/**/REALKIND
