...
c decide on expansion
            if (apv_ok) then
              if (abs(detx3*D(0,0,0,0)**2).gt.1d-8) then
...
c        if ((abs(p1/0.646818062499999996D+04-1d0).lt.1d-7).and.
c     &      (abs(p2/0.223727166963834257D+06-1d0).lt.1d-7).and.
c     &      (p3.eq.0d0).and.
c     &      (abs(p4/0.646818062499999996D+04-1d0).lt.1d-7).and.
c     &      (abs(p12/0.154097405959037540D+06-1d0).lt.1d-7).and.
c     &      (abs(p23/0.462023815914427687D+05-1d0).lt.1d-7).and.
c     &      (m02.eq.0d0).and.
c     &      (abs(m12/0.303804900000000052D+05-1d0).lt.1d-7).and.
c     &      (abs(m22/0.303804900000000052D+05-1d0).lt.1d-7).and.
c     &      (abs(m32/0.303804900000000052D+05-1d0).lt.1d-7) ) then
c
