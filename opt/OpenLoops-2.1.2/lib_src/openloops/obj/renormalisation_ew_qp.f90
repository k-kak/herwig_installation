...
module ol_ew_renormalisation_qp
  use kind_types, only: qp, intkind1
  implicit none
  complex(qp), save      ::   IRrational = -1 ! Rational contribution from IR divergent fermion self energies
  contains
...
! **********************************************************************
  ...
  use ol_parameters_decl_dp, only: LeadingColour, ew_renorm_scheme, cms_on, delta_alphamz_dimreg, &
   & photon_selfenergy

  use ol_loop_parameters_decl_qp
  use ol_self_energy_integrals_qp

  use ol_loop_parameters_decl_dp, only: &
    & nc, nf, nfa, N_lf, N_lu, N_ld, N_ll, nq_nondecoupl, CT_is_on, R2_is_on, TP_is_on, SwF, SwB, &
    & qedreg_on, debug_ew_renorm

  implicit none
  integer, optional :: select_ew_renorm

  real(qp) :: deB_UV, deB_IR, deT_UV, deT_IR
  real(qp) :: eps=1.e-17
  logical :: zeromasses(6)  ! maximal allowed number of quarks

!for debugging with ABC
  real(qp), save         :: debug_norm = 1._qp

! self energies
  complex(qp), save      ::   Tadpole   = 0
  complex(qp), save      ::   SiW    = 0
  complex(qp), save      ::   SiW0  = 0
  complex(qp), save      ::   dSiW   = 0
  complex(qp), save      ::   SiZZ   = 0
  complex(qp), save      ::   dSiZZ  = 0
  complex(qp), save      ::   SiAZZ  = 0
  complex(qp), save      ::   dSiAZZ  = 0
  complex(qp), save      ::   SiAZ0  = 0
  complex(qp), save      ::   dSiAAheavy0  = 0
  complex(qp), save      ::   dSiAA0  = 0
  complex(qp), save      ::   PiAAlightZ  = 0
  complex(qp), save      ::   dAlphaQED_MZ = 0
  complex(qp), save      ::   dSiAAZ  = 0
  complex(qp), save      ::   SiH    = 0
  complex(qp), save      ::   dSiH   = 0
  complex(qp), save      ::   SitL   = 0
  complex(qp), save      ::   SitR   = 0
  complex(qp), save      ::   SitS   = 0
  complex(qp), save      ::   dSitL  = 0
  complex(qp), save      ::   dSitR  = 0
  complex(qp), save      ::   dSitS  = 0
  complex(qp), save      ::   SibL   = 0
  complex(qp), save      ::   SibR   = 0
  complex(qp), save      ::   SibS   = 0
  complex(qp), save      ::   dSibL  = 0
  complex(qp), save      ::   dSibR  = 0
  complex(qp), save      ::   dSibS  = 0
  complex(qp), save      ::   SiuL   = 0
  complex(qp), save      ::   SiuR   = 0
  complex(qp), save      ::   SidL   = 0
  complex(qp), save      ::   SidR   = 0
  complex(qp), save      ::   SieL   = 0
  complex(qp), save      ::   SieR   = 0
  complex(qp), save      ::   SieS   = 0
  complex(qp), save      ::   SimL   = 0
  complex(qp), save      ::   SimR   = 0
  complex(qp), save      ::   SimS   = 0
  complex(qp), save      ::   SinL   = 0
  complex(qp), save      ::   SinlL  = 0
  complex(qp), save      ::   SilL   = 0
  complex(qp), save      ::   SilR   = 0
  complex(qp), save      ::   SilS   = 0
  complex(qp), save      ::   dSilL  = 0
  complex(qp), save      ::   dSilR  = 0
  complex(qp), save      ::   dSilS  = 0
  complex(qp), save      ::   dSieL  = 0
  complex(qp), save      ::   dSieR  = 0
  complex(qp), save      ::   dSieS  = 0
  complex(qp), save      ::   dSimL  = 0
  complex(qp), save      ::   dSimR  = 0
  complex(qp), save      ::   dSimS  = 0

  complex(qp), save      ::   dSitLRS = 0
  complex(qp), save      ::   dSibLRS = 0
  complex(qp), save      ::   dSilLRS = 0
  complex(qp), save      ::   dSieLRS = 0
  complex(qp), save      ::   dSimLRS = 0

! one-point functions
  complex(qp), save      ::   A0W = 0
  complex(qp), save      ::   A0Z = 0
  complex(qp), save      ::   A0H = 0
  complex(qp), save      ::   A0T = 0
  complex(qp), save      ::   A0B = 0
  complex(qp), save      ::   A0L = 0

! two-point
  complex(qp), save      ::  B0000   = 0
  complex(qp), save      ::  B00WW   = 0
  complex(qp), save      ::  dB00WW  = 0
  complex(qp), save      ::  B00W0   = 0
  complex(qp), save      ::  dB00W0  = 0
  complex(qp), save      ::  B0WW0   = 0
  complex(qp), save      ::  dB0WW0  = 0
  complex(qp), save      ::  B0ZWW   = 0
  complex(qp), save      ::  dB0ZWW  = 0
  complex(qp), save      ::  B00HH   = 0
  complex(qp), save      ::  B00ZZ   = 0
  complex(qp), save      ::  B0ZZH   = 0
  complex(qp), save      ::  dB0ZZH  = 0
  complex(qp), save      ::  dB00ZH  = 0
  complex(qp), save      ::  B00ZH   = 0
  complex(qp), save      ::  B00WH   = 0
  complex(qp), save      ::  dB00WH  = 0
  complex(qp), save      ::  B0WWH   = 0
  complex(qp), save      ::  dB0WWH  = 0
  complex(qp), save      ::  B00WZ   = 0
  complex(qp), save      ::  dB00WZ  = 0
  complex(qp), save      ::  B0WWZ   = 0
  complex(qp), save      ::  dB0WWZ  = 0
  complex(qp), save      ::  B0HHH   = 0
  complex(qp), save      ::  dB0HHH  = 0
  complex(qp), save      ::  B0HWW   = 0
  complex(qp), save      ::  dB0HWW  = 0
  complex(qp), save      ::  B0HZZ   = 0
  complex(qp), save      ::  dB0HZZ  = 0
  complex(qp), save      ::  B0BTW   = 0
  complex(qp), save      ::  dB0BTW  = 0
  complex(qp), save      ::  B0TBW   = 0
  complex(qp), save      ::  dB0TBW  = 0
  complex(qp), save      ::  B0WTB   = 0
  complex(qp), save      ::  dB0WTB  = 0
  complex(qp), save      ::  B1TBW   = 0
  complex(qp), save      ::  dB1TBW  = 0
  complex(qp), save      ::  B1BTW   = 0
  complex(qp), save      ::  dB1BTW  = 0
  complex(qp), save      ::  B0TT0   = 0
  complex(qp), save      ::  dB0TT0  = 0
  complex(qp), save      ::  B00TT   = 0
  complex(qp), save      ::  dB00TT  = 0
  complex(qp), save      ::  B1TT0   = 0
  complex(qp), save      ::  dB1TT0  = 0
  complex(qp), save      ::  B0TTZ   = 0
  complex(qp), save      ::  dB0TTZ  = 0
  complex(qp), save      ::  B1TTZ   = 0
  complex(qp), save      ::  dB1TTZ  = 0
  complex(qp), save      ::  B0ZTT  = 0
  complex(qp), save      ::  dB0ZTT  = 0
  complex(qp), save      ::  B0TTH   = 0
  complex(qp), save      ::  dB0TTH  = 0
  complex(qp), save      ::  B0HTT   = 0
  complex(qp), save      ::  dB0HTT  = 0
  complex(qp), save      ::  B1TTH   = 0
  complex(qp), save      ::  dB1TTH  = 0
  complex(qp), save      ::  B0BB0   = 0
  complex(qp), save      ::  dB0BB0  = 0
  complex(qp), save      ::  B00BB   = 0
  complex(qp), save      ::  dB00BB  = 0
  complex(qp), save      ::  B1BB0   = 0
  complex(qp), save      ::  dB1BB0  = 0
  complex(qp), save      ::  B0BBZ   = 0
  complex(qp), save      ::  dB0BBZ  = 0
  complex(qp), save      ::  B1BBZ   = 0
  complex(qp), save      ::  dB1BBZ  = 0
  complex(qp), save      ::  B0BBH   = 0
  complex(qp), save      ::  dB0BBH  = 0
  complex(qp), save      ::  B0HBB   = 0
  complex(qp), save      ::  dB0HBB  = 0
  complex(qp), save      ::  B1BBH   = 0
  complex(qp), save      ::  dB1BBH  = 0
  complex(qp), save      ::  B00TB   = 0
  complex(qp), save      ::  dB00TB  = 0
  complex(qp), save      ::  B100W   = 0
  complex(qp), save      ::  B1000   = 0
  complex(qp), save      ::  B100Z   = 0
  complex(qp), save      ::  B0Z00   = 0
  complex(qp), save      ::  dB0Z00  = 0
  complex(qp), save      ::  B0W00   = 0
  complex(qp), save      ::  dB0W00  = 0
  complex(qp), save      ::  B0ZBB   = 0
  complex(qp), save      ::  dB0ZBB  = 0

  complex(qp), save      ::  B0L0W   = 0
  complex(qp), save      ::  dB0L0W  = 0
  complex(qp), save      ::  B0W0L  = 0
  complex(qp), save      ::  dB0W0L  = 0
  complex(qp), save      ::  B10LW   = 0
  complex(qp), save      ::  dB10LW  = 0
  complex(qp), save      ::  B1L0W   = 0
  complex(qp), save      ::  dB1L0W  = 0
  complex(qp), save      ::  B0LL0   = 0
  complex(qp), save      ::  dB0LL0  = 0
  complex(qp), save      ::  B00LL   = 0
  complex(qp), save      ::  dB00LL  = 0
  complex(qp), save      ::  B1LL0   = 0
  complex(qp), save      ::  dB1LL0  = 0
  complex(qp), save      ::  B0LLZ   = 0
  complex(qp), save      ::  dB0LLZ  = 0
  complex(qp), save      ::  B1LLZ   = 0
  complex(qp), save      ::  dB1LLZ  = 0
  complex(qp), save      ::  B0LLH   = 0
  complex(qp), save      ::  dB0LLH  = 0
  complex(qp), save      ::  B0HLL   = 0
  complex(qp), save      ::  dB0HLL  = 0
  complex(qp), save      ::  B1LLH   = 0
  complex(qp), save      ::  dB1LLH  = 0
  complex(qp), save      ::  B000L   = 0
  complex(qp), save      ::  dB000L  = 0
  complex(qp), save      ::  B0ZLL   = 0
  complex(qp), save      ::  dB0ZLL  = 0
  
!   for massive electron
  complex(qp), save      ::  B0EE0   = 0
  complex(qp), save      ::  dB0EE0  = 0
!   complex(qp), save      ::  B00EE   = 0
!   complex(qp), save      ::  dB00EE  = 0
  complex(qp), save      ::  B1EE0   = 0
  complex(qp), save      ::  dB1EE0  = 0
  complex(qp), save      ::  B0EEZ   = 0
  complex(qp), save      ::  dB0EEZ  = 0
  complex(qp), save      ::  B1EEZ   = 0
  complex(qp), save      ::  dB1EEZ  = 0
!   for massive muon
  complex(qp), save      ::  B0MM0   = 0
  complex(qp), save      ::  dB0MM0  = 0
!   complex(qp), save      ::  B00MM   = 0
!   complex(qp), save      ::  dB00MM  = 0
  complex(qp), save      ::  B1MM0   = 0
  complex(qp), save      ::  dB1MM0  = 0
  complex(qp), save      ::  B0MMZ   = 0
  complex(qp), save      ::  dB0MMZ  = 0
  complex(qp), save      ::  B1MMZ   = 0
  complex(qp), save      ::  dB1MMZ  = 0

  complex(qp), save      ::  Va0Z0Z00 = 0
  complex(qp), save      ::  Va0Z0W00 = 0
  complex(qp), save      ::  Vb0Z00WW = 0
  complex(qp), save      ::  C00Z0Z00 = 0
  complex(qp), save      ::  C10Z0Z00 = 0
  complex(qp), save      ::  C20Z0Z00 = 0
  complex(qp), save      ::  C00Z0W00 = 0
  complex(qp), save      ::  C10Z0W00 = 0
  complex(qp), save      ::  C20Z0W00 = 0
  complex(qp), save      ::  C00Z00WW = 0
  complex(qp), save      ::  C10Z00WW = 0
  complex(qp), save      ::  C20Z00WW = 0

  complex(qp), save      ::   cTW = 0
  complex(qp), save      ::   cTZ = 0
  complex(qp), save      ::   cTAZ = 0
  complex(qp), save      ::   cTH = 0
  complex(qp), save      ::   cTT = 0
  complex(qp), save      ::   cTB = 0
  complex(qp), save      ::   cTL = 0
  complex(qp), save      ::   cTe = 0
  complex(qp), save      ::   cTmu = 0

!  complex(qp), save      ::   lambda  = 0   ! fictous photon mass. Not used atm.

  complex(qp), save      ::   dZuLPole   = 0.
  complex(qp), save      ::   dZuRPole   = 0.
  complex(qp), save      ::   dZtLPole   = 0.
  complex(qp), save      ::   dZtRPole   = 0.

  complex(qp), save      ::   dZeQEDEWPole, dcwEWPole, dswEWPole, dZAAEWPole, dZZAEWPole, dZAZEWPole
  complex(qp), save      ::   dZMZ2EWPole, dZMW2EWPole, dZZZEWPole, dZWEWPole
  ...
  if (weak_on .and. (ME /= 0 .or. MM /= 0)) then
    call ol_error(2, 'in ew_renormalisation:')
    call ol_msg( 'massive electron and/or muon is not supported in combination with weak corrections.')
    call ol_fatal()
  end if

  if (weak_on .and. .not. photon_selfenergy) then
    call ol_error(2, 'in ew_renormalisation:')
    call ol_msg( 'photon selfenergies are required in combination with weak corrections.')
    call ol_fatal()
  end if

  if (.not. weak_on .and. photon_selfenergy) then
    call ol_error(2, 'in ew_renormalisation:')
    call ol_msg( 'pure QED currently not supported with photon selfenergies.')
    call ol_fatal()
  end if
...
! Do not use complex masses if CMS is not used --> only for debug & model=sm_vaux
  if ( cms_on == 0 ) then
    call masspowers(rME, 0._qp, ME, ME2, rME2)
    call masspowers(rMM, 0._qp, MM, MM2, rMM2)
    call masspowers(rML, 0._qp, ML, ML2, rML2)
    call masspowers(rMU, 0._qp, MU, MU2, rMU2)
    call masspowers(rMD, 0._qp, MD, MD2, rMD2)
    call masspowers(rMS, 0._qp, MS, MS2, rMS2)
    call masspowers(rMC, 0._qp, MC, MC2, rMC2)
    call masspowers(rMB, 0._qp, MB, MB2, rMB2)
    call masspowers(rMT, 0._qp, MT, MT2, rMT2)
    call masspowers(rMW, 0._qp, MW, MW2, rMW2)
    call masspowers(rMZ, 0._qp, MZ, MZ2, rMZ2)
    call masspowers(rMH, 0._qp, MH, MH2, rMH2)
  end if
  ...
  if (ME /= 0._qp) then
    B0EE0   = calcB0(ME2,ME2,ZERO)
    dB0EE0  = calcdB0(ME2,ME2,ZERO)
    B1EE0   = calcB1(ME2,ME2,ZERO)
    dB1EE0  = calcdB1(ME2,ME2,ZERO)
    B0EEZ   = calcB0(ME2,ME2,MZ2)
    dB0EEZ  = calcdB0(ME2,ME2,MZ2)
    B1EEZ   = calcB1(ME2,ME2,MZ2)
    dB1EEZ  = calcdB1(ME2,ME2,MZ2)
  end if

  if (MM /= 0._qp) then
    B0MM0   = calcB0(MM2,MM2,ZERO)
    dB0MM0  = calcdB0(MM2,MM2,ZERO)
    B1MM0   = calcB1(MM2,MM2,ZERO)
    dB1MM0  = calcdB1(MM2,MM2,ZERO)
    B0MMZ   = calcB0(MM2,MM2,MZ2)
    dB0MMZ  = calcdB0(MM2,MM2,MZ2)
    B1MMZ   = calcB1(MM2,MM2,MZ2)
    dB1MMZ  = calcdB1(MM2,MM2,MZ2)
  end if
  ...
  ! calculate renormalisation constants
    ...
    !This is the bosonic part of page 105-107 from Denner92 evaluated in selfenergies.nb
     ...
     if (photon_selfenergy .and. weak_on) then
    ...
    if (weak_on) then
      ...
      dSiW=dSiW+(-2*(1._qp/3. + 5*B0WW0 + (MW2**2*(-B00W0 + B0WW0))/rMW2**2  &
          - (MW2**2*dB0WW0)/rMW2 + (2*MW2 + 5*rMW2)*dB0WW0))/3. &
          - (-2._qp/3. - B0WWH + ((-MH2 + MW2)**2*(-B00WH + B0WWH))/rMW2**2 &
    ...
    if (qed_on) then
      if (qedreg_on) then
        SieL= - (1. + 2.*B100Z)*Ql2               ! Photon(MZ)
        SieR= - (1. + 2.*B100Z)*Ql2               ! Photon(MZ)

        if (ML /= 0._qp) then
          SilL=-1. - 2.*B1LLZ   ! Photon(MZ)
          SilR=-1. - 2.*B1LLZ   ! Photon(MZ)
          SilS=(2. - 4.*B0LLZ) ! Photon(MZ)
          dSilL=-2.*dB1LLZ     ! Photon(MZ)
          dSilR=-2.*dB1LLZ     ! Photon(MZ)
          dSilS=-4.*dB0LLZ     ! Photon(MZ)
        else
          SilL=SieL
          SilR=SieR
        end if
        ...
        if (MM /= 0._qp) then
          SimL=-1. - 2.*B1MMZ   ! Photon(MZ)
          SimR=-1. - 2.*B1MMZ   ! Photon(MZ)
          SimS=(2. - 4.*B0MMZ) ! Photon(MZ)
          dSimL=-2.*dB1MMZ     ! Photon(MZ)
          dSimR=-2.*dB1MMZ     ! Photon(MZ)
          dSimS=-4.*dB0MMZ     ! Photon(MZ)
        else
          SimL=SieL
          SimR=SieR
        end if
        ...
        if (ME /= 0._qp) then
          SieL=-1. - 2.*B1EEZ   ! Photon(MZ)
          SieR=-1. - 2.*B1EEZ   ! Photon(MZ)
          SieS=(2. - 4.*B0EEZ) ! Photon(MZ)
          dSieL=-2.*dB1EEZ     ! Photon(MZ)
          dSieR=-2.*dB1EEZ     ! Photon(MZ)
          dSieS=-4.*dB0EEZ     ! Photon(MZ)
        end if

        SiuL= - (1. + 2.*B100Z)*Qu2               ! Photon(MZ)
        SiuR= - (1. + 2.*B100Z)*Qu2               ! Photon(MZ)

        SidL= - (1. + 2.*B100Z)*Qd2               ! Photon(MZ)
        SidR= - (1. + 2.*B100Z)*Qd2               ! Photon(MZ)

        SitL= - (1 + 2*B1TTZ)*Qu2                 ! Photon(MZ)
        SitR= - (1 + 2*B1TTZ)*Qu2                 ! Photon(MZ)
        SitS= - (-2 + 4*B0TTZ)*Qu2                ! Photon(MZ)
        dSitL= - 2*dB1TTZ*Qu2                    ! Photon(MZ)
        dSitR= - 2*dB1TTZ*Qu2                    ! Photon(MZ)
        dSitS= - 4*dB0TTZ*Qu2                    ! Photon(MZ)

        if (MB /= 0._qp) then
          SibL= - (1 + 2*B1BBZ)*Qd2                ! Photon(MZ)
          SibR= - (1 + 2*B1BBZ)*Qd2                ! Photon(MZ)
          SibS= - (-2 + 4*B0BBZ)*Qd2                 ! Photon(MZ)
          dSibL= - 2*dB1BBZ*Qd2                 ! Photon(MZ)
          dSibR= - 2*dB1BBZ*Qd2                 ! Photon(MZ)
          dSibS= - 4*dB0BBZ*Qd2                 ! Photon(MZ)
        else
        ...
        SieL= - (1. + IRrational + 2.*B1000)*Ql2  ! Photon
        SieR= - (1. + IRrational + 2.*B1000)*Ql2  ! Photon

        if (ML /= 0._qp) then
          SilL=-1. - 2.*B1LL0   ! Photon
          SilR=-1. - 2.*B1LL0   ! Photon
          SilS=+(2. - 4.*B0LL0) ! Photon
          dSilL=-2.*dB1LL0     ! Photon
          dSilR=-2.*dB1LL0     ! Photon
          dSilS=-4.*dB0LL0     ! Photon
        else
          SilL=SieL
          SilR=SieR
        end if
        ...
        if (MM /= 0._qp) then
          SimL=-1. - 2.*B1MM0   ! Photon
          SimR=-1. - 2.*B1MM0   ! Photon
          SimS=+(2. - 4.*B0MM0) ! Photon
          dSimL=-2.*dB1MM0     ! Photon
          dSimR=-2.*dB1MM0     ! Photon
          dSimS=-4.*dB0MM0     ! Photon
        else
          SimL=SieL
          SimR=SieR
        end if
        ...
        if (ME /= 0._qp) then
          SieL=-1. - 2.*B1EE0   ! Photon
          SieR=-1. - 2.*B1EE0   ! Photon
          SieS=+(2. - 4.*B0EE0) ! Photon
          dSieL=-2.*dB1EE0     ! Photon
          dSieR=-2.*dB1EE0     ! Photon
          dSieS=-4.*dB0EE0     ! Photon
        end if

        SiuL= - (1. + IRrational + 2.*B1000)*Qu2  ! Photon
        SiuR= - (1. + IRrational + 2.*B1000)*Qu2  ! Photon

        SidL= - (1. + IRrational + 2.*B1000)*Qd2  ! Photon
        SidR= - (1. + IRrational + 2.*B1000)*Qd2  ! Photon

        SitL= - (1 + 2*B1TT0)*Qu2                 ! Photon
        SitR= - (1 + 2*B1TT0)*Qu2                 ! Photon
        SitS= - (-2 + 4*B0TT0)*Qu2                ! Photon
        dSitL= - 2*dB1TT0*Qu2                    ! Photon
        dSitR= - 2*dB1TT0*Qu2                    ! Photon
        dSitS= - 4*dB0TT0*Qu2                    ! Photon

        if (MB /= 0._qp) then
          SibL=+(-1 - 2*B1BB0)*Qd2                ! Photon
          SibR=+(-1 - 2*B1BB0)*Qd2                ! Photon
          SibS=+(2 - 4*B0BB0)*Qd2                 ! Photon
          dSibL=+(-2*dB1BB0)*Qd2                 ! Photon
          dSibR=+(-2*dB1BB0)*Qd2                 ! Photon
          dSibS=+(-4*dB0BB0)*Qd2                 ! Photon
        else
          SibL=+(-1 - IRrational - 2*B1BB0)*Qd2   ! Photon
          SibR=+(-1 - IRrational - 2*B1BB0)*Qd2   ! Photon
        end if
  ...
  !This is the fermionic part based on page 105-107 from Denner92
   ...
   if (photon_selfenergy .and. qed_on) then
        ! contributions from light fermions incl. bottom
        if (nfa > 0) PiAAlightZ=PiAAlightZ - 4.*rMZ2*(1._qp/3. - B0Z00)/3.       ! e-lepton
        if (nfa > 1) PiAAlightZ=PiAAlightZ - 4.*rMZ2*(1._qp/3. - B0Z00)/3.       ! mu-lepton
        if (nfa > 2) PiAAlightZ=PiAAlightZ - 4.*(rMZ2*(1._qp/3. - B0ZLL) - 2.*ML2*(B0ZLL-B00LL))/3.  ! tau-lepton
        if (nfa > 3) PiAAlightZ=PiAAlightZ - 2*20*nc*rMZ2*(1._qp/3. - B0Z00)/27.        ! light-quarks
        if (nfa > 3) PiAAlightZ=PiAAlightZ -    4*nc*(rMZ2*(1._qp/3. - B0ZBB) - 2.*MB2*(B0ZBB-B00BB))/27. ! b-quark

        ! contributions from heavy fermions = top-quark
        if (nfa > 4) dSiAAheavy0=dSiAAheavy0-(16*nc*(1-3*B00TT-6*MT2*dB00TT))/81.

        ! contribution from heavy + light fermions (in dimreg)
        if (nfa > 0) dSiAA0=dSiAA0+4._qp/3.*(B0000) ! e-leptons
        if (nfa > 1) dSiAA0=dSiAA0+4._qp/3.*(B0000) ! mu-leptons
        if (nfa > 2) dSiAA0=dSiAA0+4._qp/3.*(B00LL) ! tau-leptons
        if (nfa > 3) dSiAA0=dSiAA0+4._qp/3.*nc*1._qp/9*( 2.*B0000) ! down-quarks
        if (nfa > 3) dSiAA0=dSiAA0+4._qp/3.*nc*4._qp/9*( 2.*B0000) ! up-quarks
        if (nfa > 3) dSiAA0=dSiAA0+4._qp/3.*nc*1._qp/9*( B00BB )   ! b-quark
        if (nfa > 4) dSiAA0=dSiAA0+4._qp/3.*nc*4._qp/9*( B00TT )   ! t-quark
    end if
    ...
    if (weak_on) then
      ...
      dSiAAZ=dSiAAZ &
           - 2.*4.*(1._qp/3.-B0Z00-rMZ2*dB0Z00)/3. &               ! light-leptons
           -        4.*(1._qp/3.-B0ZLL-(2.*ML2+rMZ2)*dB0ZLL)/3. &  ! tau-lepton
           - 2.*20.*nc*(1._qp/3.-B0Z00-rMZ2*dB0Z00)/27. &          ! light-quarks
           -     4.*nc*(1._qp/3.-B0ZBB-(2.*MB2+rMZ2)*dB0ZBB)/27. & ! b-quark
           -    16.*nc*(1._qp/3.-B0ZTT-(2.*MT2+rMZ2)*dB0ZTT)/27.   ! t-quark
...
!      SiAZ0=SiAZ0+0 !no fermionic contribution
      ...
      SiAZZ=SiAZZ-2._qp/3.*( &
          ...
          - 2.*nc*(rMZ2/3. - rMZ2*B0Z00)*(gZu(1) + gZu(2))*2._qp/3. & ! up-quark
          +   nc*(rMZ2/3. + 2*MB2*B00BB + (-2*MB2 - rMZ2)*B0ZBB)*(gZd(1) + gZd(2))/3. &     ! b-quark
          -   nc*(rMZ2/3. + 2*MT2*B00TT + (-2*MT2 - rMZ2)*B0ZTT)*(gZu(1) + gZu(2))*2._qp/3. &  ! top-quark
          )

      dSiAZZ=dSiAZZ-2._qp/9.*( &
          ...
          + 2.*nc*(-1 + 3*B0Z00 + 3*rMZ2*dB0Z00)*(gZu(1) + gZu(2))*2._qp/3. & ! up-quark
          -    nc*(-1 + 3*B0ZBB + 3*(2*MB2 + rMZ2)*dB0ZBB)*(gZd(1) + gZd(2))/3. & ! b-quark
          +    nc*(-1 + 3*B0ZTT + 3*(2*MT2 + rMZ2)*dB0ZTT)*(gZu(1) + gZu(2))*2._qp/3. & ! top-quark
         )
      ...
      dSiW=dSiW+( &
           - 2*(1._qp/3.- B0W00 - rMW2*dB0W00) & ! light-leptons
           - 1._qp/2.*(2._qp/3.+ ML2**2*(B000L - B0W0L)/rMW2**2 - 2*B0W0L & ! heavy-leptons
                    +  ML2**2*dB0W0L/rMW2 + (ML2 - 2*rMW2)*dB0W0L) &
           - 2*nc*(1._qp/3. - B0W00 - rMW2*dB0W00) & ! light-quark
           -   nc/2.*(2._qp/3. + ((MB2 - MT2)**2* (B00TB - B0WTB))/rMW2**2 - 2*B0WTB & ! heavy-quark
...
!   dZeREW = -SieR
  ...
  !electron
  if (ME /= 0._qp) then
    dSieLRS = dSieL+dSieR+2.*dSieS
    dZeLEW = -(SieL+rME2*dSieLRS)
    dZeREW = -(SieR+rME2*dSieLRS)
    if (cms_on == 0) then ! on-shell
      dZeLEW = -real(dZeLEW)
      dZeREW = -real(dZeREW)
      dZMEEW  = real(dZMEEW)
    else if (imag(ME2) /= 0 .and. cms_on > 0) then ! CMS
      cTe     = -(rME2-ME2)*dSieLRS+(rME2-ME2)/rME2*1.*4. ! 1st order expansion & C^l term
      dZMEEW  = ME*0.5*(SieL+SieR+2.*SieS + cTe)
    else if (imag(ME2) == 0 .and. cms_on > 0) then ! CMS-I & CMS-II
      dZMEEW = ME*0.5*(SieL+SieR+2.*SieS)
    else
      call ol_fatal('on-shell EW renormalization with finite width not supported!')
    end if
  else
  ...
  !muon
  if (MM /= 0._qp) then
    dSimLRS = dSimL+dSimR+2.*dSimS
    dZmuLEW = -(SimL+rMM2*dSimLRS)
    dZmuREW = -(SimR+rMM2*dSimLRS)
    if (cms_on == 0) then ! on-shell
      dZmuLEW = -real(dZmuLEW)
      dZmuREW = -real(dZmuREW)
      dZMMEW  = real(dZMMEW)
    else if (imag(MM2) /= 0 .and. cms_on > 0) then ! CMS
      cTmu    = -(rMM2-MM2)*dSimLRS+(rMM2-MM2)/rMM2*1.*4. ! 1st order expansion & C^l term
      dZMMEW  = MM*0.5*(SimL+SimR+2.*SimS + cTmu)
    else if (imag(MM2) == 0 .and. cms_on > 0) then ! CMS-I & CMS-II
      dZMMEW = MM*0.5*(SimL+SimR+2.*SimS)
    else
      call ol_fatal('on-shell EW renormalization with finite width not supported!')
    end if
  else
  ...
  if (cms_on == 0) then ! on-shell
    ...
    cTT    = -(rMT2-MT2)*dSitLRS+(rMT2-MT2)/rMT2*4._qp/9.*4. ! 1st order expansion & C^t term
  ...
  if (MB /= 0._qp) then
    ...
    if (cms_on == 0) then ! on-shell
      ...
      cTB     = -(rMB2-MB2)*dSibLRS+(rMB2-MB2)/rMB2*1._qp/9.*4 ! 1st order expansion & C^b term
...
! weak mixing angle
  if (ew_renorm_scheme == 20 .or. ew_renorm_scheme == 21 .or. ew_renorm_scheme == 22) then ! sinTheta2 schemes from 1906.11569
    ...
    dVLEW = gZl(2)**2*Va0Z0Z00+0.5_qp/sw2*gZn(2)/gZl(2)*Va0Z0W00-cw/sw3/2./gZl(2)*Vb0Z00WW
...
! print rs constans
  if (debug_ew_renorm .ge. 1) then
    ...
    print*, "dZmuREW " , real(dZmuREW*debug_norm), aimag(dZmuREW*debug_norm)
    print*, "dZmuLEW " , real(dZmuLEW*debug_norm), aimag(dZmuLEW*debug_norm)
    ...
    print*, "dZMEEW  " , real(dZMEEW*debug_norm), aimag(dZMEEW*debug_norm)
    print*, "dZMMEW  " , real(dZMMEW*debug_norm), aimag(dZMMEW*debug_norm)
...
! calculate counterterms & R2
  ...
  sumMQ2Q2 = 4._qp/9.*MU2 + 1._qp/9.*MD2 + 4._qp/9.*MS2 + 1._qp/9.*MC2
  sumMQ2QI = 2._qp/6.*MU2 + 1._qp/6.*MD2 + 2._qp/6.*MS2 + 1._qp/6.*MC2
  sumMQ2QUD = 2._qp/3.*MD2+1._qp/3.*MU2 + 2._qp/3.*MS2+1._qp/3.*MC2   ! Sum(Qu*mD2 - Qd*mU2)
  ...
  if (nf > 4) then
    sumMQ2 = sumMQ2 + MB2
    sumMQ2Q2 = sumMQ2Q2 + 1._qp/9.*MB2
    sumMQ2QI = sumMQ2QI + 1._qp/6.*MB2
    sumMQ2QUD = sumMQ2QUD + 2._qp/3.*MB2
    sumMQ4 = sumMQ4 + MB2**2
    sumMD2 = sumMD2 + MB2
    sumMD4 = sumMD4 + MB2**2
  end if
  if (nf > 5) then
    sumMQ2 = sumMQ2 + MT2
    sumMQ2Q2 = sumMQ2Q2 + 4._qp/9.*MT2
    sumMQ2QI = sumMQ2QI + 2._qp/6.*MT2
    sumMQ2QUD = sumMQ2QUD + 1._qp/3.*MT2
    sumMQ4 = sumMQ4 + MT2**2
    sumMUD = sumMUD + MT*MB
...
!    EWctPW = (dZWEW + dZMW2EW/MW2)
    ...
    EWctee   = [ 0.5*(dZeREW+dZeREWcc), 0.5*(dZeLEW+dZeLEWcc), ME/2.*(dZeREW+dZeLEWcc)+dZMEEW , ME/2.*(dZeLEW+dZeREWcc)+dZMEEW ]
    EWctmm   = [ 0.5*(dZmuREW+dZmuREWcc), 0.5*(dZmuLEW+dZmuLEWcc),  &
                MM/2.*(dZmuREW+dZmuLEWcc)+dZMMEW , MM/2.*(dZmuLEW+dZmuREWcc)+dZMMEW]
    ...
    ! Aff
    EWctAuu  = [ -2._qp/3. * (dZeQEDEW + 0.5*dZAAEW + 0.5*(dZuREW+dZuREWcc))  + gZu(1)/2.*dZZAEW , &
                 -2._qp/3. * (dZeQEDEW + 0.5*dZAAEW + 0.5*(dZuLEW+dZuLEWcc))  + gZu(2)/2.*dZZAEW ]
    EWctAdd  = [  1._qp/3. * (dZeQEDEW + 0.5*dZAAEW + 0.5*(dZdREW+dZdREWcc))  + gZd(1)/2.*dZZAEW , &
                  1._qp/3. * (dZeQEDEW+  0.5*dZAAEW + 0.5*(dZdLEW+dZdLEWcc))  + gZd(2)/2.*dZZAEW ]
    EWctAtt  = [ -2._qp/3. * (dZeQEDEW + 0.5*dZAAEW + 0.5*(dZtREW+dZtREWcc))  + gZu(1)/2.*dZZAEW , &
                 -2._qp/3. * (dZeQEDEW + 0.5*dZAAEW + 0.5*(dZtLEW+dZtLEWcc))  + gZu(2)/2.*dZZAEW ]
    EWctAbb  = [  1._qp/3. * (dZeQEDEW + 0.5*dZAAEW + 0.5*(dZbREW+dZbREWcc))  + gZd(1)/2.*dZZAEW , &
                  1._qp/3. * (dZeQEDEW + 0.5*dZAAEW + 0.5*(dZbLEW+dZbLEWcc))  + gZd(2)/2.*dZZAEW ]
    EWctAee  = [  (dZeQEDEW + 0.5*dZAAEW + 0.5*(dZeREW+dZeREWcc))  + gZl(1)/2.*dZZAEW , &
                  (dZeQEDEW + 0.5*dZAAEW + 0.5*(dZeLEW+dZeLEWcc))  + gZl(2)/2.*dZZAEW ]
    EWctAmm  = [  (dZeQEDEW + 0.5*dZAAEW + 0.5*(dZmuREW+dZmuREWcc))+ gZl(1)/2.*dZZAEW , &
                  (dZeQEDEW + 0.5*dZAAEW + 0.5*(dZmuLEW+dZmuLEWcc))+ gZl(2)/2.*dZZAEW ]
    ...
    EWctVuu  = [ dgZu(1) + gZu(1) * (0.5*dZZZEW + 0.5*(dZuREW+dZuREWcc)) - 2._qp/6.*dZAZEW , &
                 dgZu(2) + gZu(2) * (0.5*dZZZEW + 0.5*(dZuLEW+dZuLEWcc)) - 2._qp/6.*dZAZEW ]
    EWctVdd  = [ dgZd(1) + gZd(1) * (0.5*dZZZEW + 0.5*(dZdREW+dZdREWcc)) + 1._qp/6.*dZAZEW , &
                 dgZd(2) + gZd(2) * (0.5*dZZZEW + 0.5*(dZdLEW+dZdLEWcc)) + 1._qp/6.*dZAZEW ]
    EWctVtt  = [ dgZu(1) + gZu(1) * (0.5*dZZZEW + 0.5*(dZtREW+dZtREWcc)) - 2._qp/6.*dZAZEW , &
                 dgZu(2) + gZu(2) * (0.5*dZZZEW + 0.5*(dZtLEW+dZtLEWcc)) - 2._qp/6.*dZAZEW ]
    EWctVbb  = [ dgZd(1) + gZd(1) * (0.5*dZZZEW + 0.5*(dZbREW+dZbREWcc)) + 1._qp/6.*dZAZEW , &
                 dgZd(2) + gZd(2) * (0.5*dZZZEW + 0.5*(dZbLEW+dZbLEWcc)) + 1._qp/6.*dZAZEW ]
    EWctVee  = [ dgZl(1) + gZl(1) * (0.5*dZZZEW + 0.5*(dZeREW+dZeREWcc)) + 0.5*dZAZEW , &
                 dgZl(2) + gZl(2) * (0.5*dZZZEW + 0.5*(dZeLEW+dZeLEWcc)) + 0.5*dZAZEW ]
    EWctVmm  = [ dgZl(1) + gZl(1) * (0.5*dZZZEW + 0.5*(dZmuREW+dZmuREWcc)) + 0.5*dZAZEW , &
                 dgZl(2) + gZl(2) * (0.5*dZZZEW + 0.5*(dZmuLEW+dZmuLEWcc)) + 0.5*dZAZEW ]
...
!     EWctVmn  = dZeQEDEW-dswEW/sw+0.5*dZWEW+0.5*(dZmuLEW + dZnmLEWcc)
!     EWctVnm  = dZeQEDEW-dswEW/sw+0.5*dZWEW+0.5*(dZmuLEWcc + dZnmLEW)
    ...
    if (ME /= 0._qp) then
      EWctHee = -0.5/sw*( dZeQEDEW - dswEW/sw + dZMEEW/ME - 0.5*dZMW2EW/MW2 + 0.5*dZHEW) &
                -0.5/sw*0.5*[dZeREW+dZeLEWcc,dZeREWcc+dZeLEW ]
    end if

    if (MM /= 0._qp) then
      EWctHmm = -0.5/sw*( dZeQEDEW - dswEW/sw + dZMMEW/MM - 0.5*dZMW2EW/MW2 + 0.5*dZHEW) &
                -0.5/sw*0.5*[dZmuREW+dZmuLEWcc,dZmuREWcc+dZmuLEW ]
    end if
    ...
    if (ME /= 0._qp) then
      EWctXee = -CI/sw*0.5*( dZeQEDEW - dswEW/sw + dZMEEW/ME - 0.5*dZMW2EW/MW2 )*[1,-1] &
                -CI/sw*0.25*[(dZeREW+dZeLEWcc),-1.*(dZeREWcc+dZeLEW)]
    end if

    if (MM /= 0._qp) then
      EWctXmm = -CI/sw*0.5*( dZeQEDEW - dswEW/sw + dZMMEW/MM - 0.5*dZMW2EW/MW2 )*[1,-1] &
                -CI/sw*0.25*[(dZmuREW+dZmuLEWcc),-1.*(dZmuREWcc+dZmuLEW)]
    end if
...
! twopoint
        if (photon_selfenergy) then
          EWctAA=EWctAA+[cONE*(-3. - (10._qp*nc)/9.), &
               2.*MW2 + 4*nc*sumMQ2Q2 + 4*sumML2Q2,cONE*(2._qp/3.)]
        end if
        ...
        if (qed_on) then
          ...
          EWctee=EWctee+[Ql2,Ql2,2*Ql2*ME,2*Ql2*ME]*(-1.)
          EWctmm=EWctmm+[Ql2,Ql2,2*Ql2*MM,2*Ql2*MM]*(-1.)
        ...
        if (weak_on) then
          ...
          EWctmm=EWctmm+[-Ql2+1./cw2,-Ql2+(1. + 2*cw2)/(4.*cw2*sw2),ZERO,ZERO]*(-1.)
...
! three-point
        ...
        if (qed_on) then
          EWctHee = EWctHee + [2*Ql2/sw, 2*Ql2/sw]
          EWctHmm = EWctHmm + [2*Ql2/sw, 2*Ql2/sw]
          EWctHll = EWctHll + [2*Ql2/sw, 2*Ql2/sw]
        end if
        if (weak_on) then
          EWctHee=EWctHee+[-2*Ql2/sw+(ME*(1 - 16*sw2 + cw2*(2 + 32*sw2) + 32*sw4))/(16.*cw2*sw3), &
                   -2*Ql2/sw+(ME*(1 - 16*sw2 + cw2*(2 + 32*sw2) + 32*sw4))/(16.*cw2*sw3)]
          EWctHmm=EWctHmm+[-2*Ql2/sw+(MM*(1 - 16*sw2 + cw2*(2 + 32*sw2) + 32*sw4))/(16.*cw2*sw3), &
                   -2*Ql2/sw+(MM*(1 - 16*sw2 + cw2*(2 + 32*sw2) + 32*sw4))/(16.*cw2*sw3)]
          EWctHll=EWctHll+[-2*Ql2/sw+(ML*(1 - 16*sw2 + cw2*(2 + 32*sw2) + 32*sw4))/(16.*cw2*sw3), &
                   -2*Ql2/sw+(ML*(1 - 16*sw2 + cw2*(2 + 32*sw2) + 32*sw4))/(16.*cw2*sw3)]
        ...
        if (qed_on) then
          EWctXee=EWctXee+[2*Ql2*CI/sw,-2*Ql2*CI/sw]
          EWctXmm=EWctXmm+[2*Ql2*CI/sw,-2*Ql2*CI/sw]
          EWctXll=EWctXll+[2*Ql2*CI/sw,-2*Ql2*CI/sw]
        end if
        if (weak_on) then
          EWctXee=EWctXee+[+2*Ql2*CI*ME/MW/SW-(CI*ME*(1 - 16*sw2 + cw2*(2 + 32*sw2) + 32*sw4))/(16.*cw2*sw3), &
                   -2*Ql2*CI*ME/MW/SW+(CI*ME*(1 - 16*sw2 + cw2*(2 + 32*sw2) + 32*sw4))/(16.*cw2*sw3)]
          EWctXmm=EWctXmm+[+2*Ql2*CI*MM/MW/SW-(CI*MM*(1 - 16*sw2 + cw2*(2 + 32*sw2) + 32*sw4))/(16.*cw2*sw3), &
                   -2*Ql2*CI*MM/MW/SW+(CI*MM*(1 - 16*sw2 + cw2*(2 + 32*sw2) + 32*sw4))/(16.*cw2*sw3)]
          EWctXll=EWctXll+[+2*Ql2*CI*ML/MW/SW-(CI*ML*(1 - 16*sw2 + cw2*(2 + 32*sw2) + 32*sw4))/(16.*cw2*sw3), &
                   -2*Ql2*CI*ML/MW/SW+(CI*ML*(1 - 16*sw2 + cw2*(2 + 32*sw2) + 32*sw4))/(16.*cw2*sw3)]
        end if
        ...
        if (weak_on) then
          ...
          EWctAbb=EWctAbb+[-2*Qd3-2/(27.*cw2) + MB2/(12.*MW2*sw2), &
                  ...
                  MT2/(6.*MW2*sw2)]
          EWctAee=EWctAee+[-2.*Ql3 - 2/cw2 - ME2/(4.*MW2*sw2), &
                -2.*Ql3 - 1/sw2 - 1/(2.*cw2*sw2) - ME2/(4.*MW2*sw2)]
          EWctAmm=EWctAmm+[-2.*Ql3 - 2/cw2 - MM2/(4.*MW2*sw2), &
                -2.*Ql3 - 1/sw2 - 1/(2.*cw2*sw2) - MM2/(4.*MW2*sw2)]
        ...
        if (qed_on) then
          ...
          EWctVmm=EWctVmm+[(-2*sw)/cw,1./(cw*sw) - (2*sw)/cw]
          EWctVll=EWctVll+[(-2*sw)/cw,1./(cw*sw) - (2*sw)/cw]
        end if
        if (weak_on) then
          EWctVee=EWctVee+[- (2*sw3)/cw3 -ME2/(4.*MW2*sw)/cw, &
                 - 3/(2.*cw3*sw) - ME2/(4*cw*MW2*sw) &
                 + (3*sw)/cw3 - 1/(2.*cw*sw3) + cw/sw3 + 1/(4.*cw3*sw3) - (2*sw3)/cw3]
          EWctVmm=EWctVmm+[- (2*sw3)/cw3 -MM2/(4.*MW2*sw)/cw, &
                 - 3/(2.*cw3*sw) - MM2/(4*cw*MW2*sw) &
                 + (3*sw)/cw3 - 1/(2.*cw*sw3) + cw/sw3 + 1/(4.*cw3*sw3) - (2*sw3)/cw3]
...
! four-point
        if (qed_on) then
          EWctR2AAAA=4._qp/3*(2._qp + (17*nc)/27._qp)

          EWctR2AAAZ=-1/(cw*sw) + (4*cw)/(3.*sw) - nc/(3.*cw*sw) + &
                 (4*sw)/cw + (68*nc*sw)/(81.*cw)

          EWctR2AAZZ=4._qp/3 - 2._qp/cw2 - (2*nc)/(3.*cw2) - &
                 4._qp/(3.*sw2) + 1._qp/(2.*cw2*sw2) &
                  + (5*nc)/(18.*cw2*sw2) + (4*sw2)/cw2 + (68*nc*sw2)/(81.*cw2)

          EWctR2AZZZ=(-4*cw)/(3.*sw) + 3._qp/(2.*cw3*sw) + (5*nc)/(6.*cw3*sw) - &
                 (3*sw)/cw3 - (nc*sw)/cw3 + (4*cw)/(3.*sw3) - 1._qp/(4.*cw3*sw3) - &
                 nc/(4.*cw3*sw3) + (4*sw3)/cw3 + (68*nc*sw3)/(81.*cw3)

          EWctR2ZZZZ=-4._qp/3. + 3/cw4 + (5*nc)/(3.*cw4) + 8/(3.*sw2) - &
        ...
        if (weak_on) then
          ...
          EWctAAPP=EWctAAPP-1._qp/12. - 11/(6.*sw2) - sw2/(12.*cw2) &
...
! add fourpoint-Tadpoles (calculated in D=4)
  ...
  if (TP_is_on /= 0 .and. SwB /= 0 .and. weak_on) then
    ...
    if (weak_on .and. photon_selfenergy) then
...
! ****************************************************************************************
  use ol_parameters_decl_dp, only: ew_scheme, ew_renorm_scheme, &
                     &  onshell_photons_lsz, offshell_photons_lsz, delta_alphamz_dimreg
  use ol_parameters_decl_qp, only: alpha_QED, alpha_QED_0, alpha_QED_Gmu, pi
  use ol_loop_parameters_decl_qp, only: countertermnorm, &
                                              & dZeQEDEW, dZe0QEDEWnreg, dZe0QEDEWdreg, dZeGmuQEDEW, &
                                              & dZAAEW, dZAAEWdreg
  implicit none
  integer, intent(in) :: photonid(:)
  integer, intent(in) :: ew_renorm
  real(qp),  intent(out) :: bornfactor
  real(qp),  intent(out), optional :: loopfactor
...
end module ol_ew_renormalisation_qp
