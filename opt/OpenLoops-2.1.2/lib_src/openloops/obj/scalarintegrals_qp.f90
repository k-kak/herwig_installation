...
module ol_self_energy_integrals_qp
! !interfaces for scalar one-point & two-point functions
  ...
  use ol_loop_parameters_decl_qp, only: de1_UV, de1_IR
  ...
  function calcB0(p2_in,m12_in,m22_in)
    ...
    complex(qp) calcB0
    complex(qp), intent(in) :: p2_in
    complex(qp), intent(in) :: m12_in
    complex(qp), intent(in) :: m22_in
    complex(qp) p2q
    complex(dp) p2
    complex(dp) m12
    complex(dp) m22
  ...
  function calcB1(p2_in,m12_in,m22_in)
    ...
    complex(qp) :: rslt_b11(0:2), rslt_b00(0:2), rslt_b1(0:2), rslt_b0(0:2)
  ...
  function calcRB0(p2_in,m12_in,m22_in)
    complex(qp) calcRB0
    complex(qp), intent(in) :: p2_in, m12_in, m22_in
...
!-(m1^2-m0^2)/2/Q4*(real(B0(Q2,m0,m1)) - B0(0,m0,m1)) + (m1^2-m0^2-Q2)/2/Q2*real(dB0(Q2,m0,m1))
  ...
  function calcC0(p12_in,p22_in,p32_in,m12_in,m22_in,m32_in)
    ...
    complex(qp) calcC0
    complex(qp), intent(in) :: p12_in, p22_in, p32_in
    complex(qp), intent(in) :: m12_in, m22_in, m32_in
  ...
  function calcC1(p12,p02,p22,m02,m12,m22)
    complex(qp) calcC1
    complex(qp), intent(in) :: p12, p02, p22
    complex(qp), intent(in) :: m02, m12, m22
    complex(qp) :: k2, R31, R32
  ...
  function kappa2(x,y,z)
    complex(qp) kappa2
    complex(qp), intent(in) :: x,y,z
    kappa2 = x*x+y*y+z*z-2.*(x*y+y*z+z*x)
  end function kappa2

end module ol_self_energy_integrals_qp
