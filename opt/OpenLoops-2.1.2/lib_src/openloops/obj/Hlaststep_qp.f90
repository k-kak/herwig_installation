...
!******************************************************************************
  ...
  use ol_data_types_qp, only: wfun, hol, hcl
  use hel_bookkeeping_qp, only: helbookkeeping_ol_last_vert3
  use ol_last_step_qp, only: check_last_AQ_V
  ...
  complex(qp) :: G_add(size(Gtensor%cmp))
...
!******************************************************************************
  ...
  use ol_data_types_qp, only: wfun, hol, hcl
  use hel_bookkeeping_qp, only: helbookkeeping_ol_last_vert3
  use ol_last_step_qp, only: check_last_QA_V
...
!******************************************************************************
  ...
  use ol_data_types_qp, only: wfun, hol, hcl
  use hel_bookkeeping_qp, only: helbookkeeping_ol_last_vert3
  use ol_last_step_qp, only: check_last_AQ_Z
...
!******************************************************************************
  ...
  use ol_data_types_qp, only: wfun, hol, hcl
  use hel_bookkeeping_qp, only: helbookkeeping_ol_last_vert3
  use ol_last_step_qp, only: check_last_QA_Z
  use ol_parameters_init_qp, only: get_coupling
...
!******************************************************************************
  ...
  use ol_data_types_qp, only: wfun, hol, hcl
  use hel_bookkeeping_qp, only: helbookkeeping_ol_last_vert3
  use ol_last_step_qp, only: check_last_AQ_W
...
!******************************************************************************
  ...
  use ol_data_types_qp, only: wfun, hol, hcl
  use hel_bookkeeping_qp, only: helbookkeeping_ol_last_vert3
  use ol_last_step_qp, only: check_last_QA_W
...
!******************************************************************************
  use kind_types, only: qp, qp, intkind1, intkind2
  use ol_data_types_qp, only: wfun, hol, hcl
  use hel_bookkeeping_qp, only: helbookkeeping_last_prop
  use ol_last_step_qp, only: check_last_A_Q
...
!******************************************************************************
  ...
  use ol_data_types_qp, only: wfun, hol, hcl
  use hel_bookkeeping_qp, only: helbookkeeping_last_prop
  use ol_last_step_qp, only: check_last_Q_A
  use ol_kinematics_qp, only: get_LC_5,get_mass
...
!******************************************************************************
  ...
  use ol_data_types_qp, only: wfun, hol, hcl
  use hel_bookkeeping_qp, only: helbookkeeping_ol_last_vert3
  use ol_last_step_qp, only: check_last_UV_W
...
!******************************************************************************
  ...
  use ol_data_types_qp, only: wfun, hol, hcl
  use hel_bookkeeping_qp, only: helbookkeeping_ol_last_vert3
  use ol_last_step_qp, only: check_last_UW_V
  use ol_kinematics_qp, only: get_LC_4
...
!******************************************************************************
  use kind_types, only: qp, qp, intkind1, intkind2
  use ol_data_types_qp, only: wfun, hol, hcl
  use hel_bookkeeping_qp, only: helbookkeeping_ol_last_vert4
  use ol_last_step_qp, only: check_last_VE_V
...
!******************************************************************************
  ...
  use ol_data_types_qp, only: wfun, hol, hcl
  use hel_bookkeeping_qp, only: helbookkeeping_ol_last_vert4
  use ol_last_step_qp, only: check_last_EV_V
...
!******************************************************************************
  ...
  use ol_data_types_qp, only: wfun, hol, hcl
  use hel_bookkeeping_qp, only: helbookkeeping_ol_last_vert4
  use ol_last_step_qp, only: check_last_GGG_G_23
...
!******************************************************************************
  ...
  use ol_data_types_qp, only: wfun, hol, hcl
  use hel_bookkeeping_qp, only: helbookkeeping_ol_last_vert4
  use ol_last_step_qp, only: check_last_GGG_G_12
...
!******************************************************************************
  ...
  use ol_data_types_qp, only: wfun, hol, hcl
  use hel_bookkeeping_qp, only: helbookkeeping_ol_last_vert3
  use ol_last_step_qp, only: check_last_CV_D
  use ol_kinematics_qp, only: get_LC_4
...
!******************************************************************************
  ...
  use ol_data_types_qp, only: wfun, hol, hcl
  use hel_bookkeeping_qp, only: helbookkeeping_ol_last_vert3
  use ol_last_step_qp, only: check_last_DV_C
  use ol_kinematics_qp, only: get_LC_4
...
!******************************************************************************
  ...
  use ol_data_types_qp, only: wfun, hol, hcl
  use hel_bookkeeping_qp, only: helbookkeeping_ol_last_vert3
  use ol_last_step_qp, only: check_last_QA_S
  use ol_parameters_init_qp, only: get_coupling
...
!******************************************************************************
  ...
  use ol_data_types_qp, only: wfun, hol, hcl
  use hel_bookkeeping_qp, only: helbookkeeping_ol_last_vert3
  use ol_last_step_qp, only: check_last_AQ_S
  use ol_parameters_init_qp, only: get_coupling
...
!******************************************************************************
  ...
  use ol_data_types_qp, only: wfun, hol, hcl
  use hel_bookkeeping_qp, only: helbookkeeping_ol_last_vert3
  use ol_last_step_qp, only: check_last_VV_S
...
!******************************************************************************
  ...
  use ol_data_types_qp, only: wfun, hol, hcl
  use hel_bookkeeping_qp, only: helbookkeeping_ol_last_vert3
  use ol_last_step_qp, only: check_last_VS_V
...
!******************************************************************************
  ...
  use ol_data_types_qp, only: wfun, hol, hcl
  use hel_bookkeeping_qp, only: helbookkeeping_ol_last_vert3
  use ol_last_step_qp, only: check_last_SV_V
...
!******************************************************************************
  ...
  use ol_data_types_qp, only: wfun, hol, hcl
  use hel_bookkeeping_qp, only: helbookkeeping_ol_last_vert3
  use ol_last_step_qp, only: check_last_SV_T
  use ol_kinematics_qp, only: get_LC_4
...
!******************************************************************************
  ...
  use ol_data_types_qp, only: wfun, hol, hcl
  use hel_bookkeeping_qp, only: helbookkeeping_ol_last_vert3
  use ol_last_step_qp, only: check_last_TV_S
  use ol_kinematics_qp, only: get_LC_4
...
!******************************************************************************
  ...
  use ol_data_types_qp, only: wfun, hol, hcl
  use hel_bookkeeping_qp, only: helbookkeeping_ol_last_vert3
  use ol_last_step_qp, only: check_last_VS_T
  use ol_kinematics_qp, only: get_LC_4
...
!******************************************************************************
  ...
  use ol_data_types_qp, only: wfun, hol, hcl
  use hel_bookkeeping_qp, only: helbookkeeping_ol_last_vert3
  use ol_last_step_qp, only: check_last_VT_S
  use ol_kinematics_qp, only: get_LC_4
...
!******************************************************************************
  ...
  use ol_data_types_qp, only: wfun, hol, hcl
  use hel_bookkeeping_qp, only: helbookkeeping_ol_last_vert3
  use ol_last_step_qp, only: check_last_ST_V
  use ol_kinematics_qp, only: get_LC_4
...
!******************************************************************************
  ...
  use ol_data_types_qp, only: wfun, hol, hcl
  use hel_bookkeeping_qp, only: helbookkeeping_ol_last_vert3
  use ol_last_step_qp, only: check_last_TS_V
  use ol_kinematics_qp, only: get_LC_4
...
!******************************************************************************
  ...
  use ol_data_types_qp, only: wfun, hol, hcl
  use hel_bookkeeping_qp, only: helbookkeeping_ol_last_vert3
  use ol_last_step_qp, only: check_last_SS_S
...
!******************************************************************************
  ...
  use ol_data_types_qp, only: wfun, hol, hcl
  use hel_bookkeeping_qp, only: helbookkeeping_ol_last_vert4
  use ol_last_step_qp, only: check_last_SSS_S
...
!******************************************************************************
  ...
  use ol_data_types_qp, only: wfun, hol, hcl
  use hel_bookkeeping_qp, only: helbookkeeping_ol_last_vert4
  use ol_last_step_qp, only: check_last_VVS_S
...
!******************************************************************************
  ...
  use ol_data_types_qp, only: wfun, hol, hcl
  use hel_bookkeeping_qp, only: helbookkeeping_ol_last_vert4
  use ol_last_step_qp, only: check_last_SSV_V
...
!******************************************************************************
  ...
  use ol_data_types_qp, only: wfun, hol, hcl
  use hel_bookkeeping_qp, only: helbookkeeping_ol_last_vert4
  use ol_last_step_qp, only: check_last_VSS_V
...
!******************************************************************************
  ...
  use ol_data_types_qp, only: wfun, hol, hcl
  use hel_bookkeeping_qp, only: helbookkeeping_ol_last_vert4
  use ol_last_step_qp, only: check_last_SVV_S
...
!******************************************************************************
  ...
  use ol_data_types_qp, only: wfun, hol, hcl
  use hel_bookkeeping_qp, only: helbookkeeping_ol_last_vert4
  use ol_last_step_qp, only: check_last_WWV_V
...
!******************************************************************************
  ...
  use ol_data_types_qp, only: wfun, hol, hcl
  use hel_bookkeeping_qp, only: helbookkeeping_ol_last_vert4
  use ol_last_step_qp, only: check_last_VWW_V
