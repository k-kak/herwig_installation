...
end module ind_bookkeeping_dp



module ol_helicity_init_dp
...
end module ol_helicity_init_dp


module hel_bookkeeping_dp
contains
...
end module hel_bookkeeping_dp



module ol_merging_dp
  use ol_loop_handling_dp, only: hp_switch,hybrid_zero_mode, &
                                           hybrid_dp_mode,hybrid_qp_mode, &
                                           hybrid_dp_qp_mode,merge_mode
  use ol_parameters_decl_dp, only: hp_automerge
  implicit none
  contains
...
! **********************************************************************
  ...
  complex(dp) :: G_aux(size(Gin_0%j,1),size(Gin_0%j,2),size(Gin_0%j,3),size(Gin_0%j,4))

  complex(qp) :: G_aux_qp(size(Gin_0%j,1),size(Gin_0%j,2),size(Gin_0%j,3),size(Gin_0%j,4))
...
! **********************************************************************
  ...
  use ol_loop_handling_dp, only: upgrade_qp,req_qp_cmp,   &
