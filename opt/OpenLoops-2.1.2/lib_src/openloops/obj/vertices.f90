...
! **********************************************************************
  ...
  complex(dp), intent(out) :: Jout_V(4)
  complex(dp) :: J1J2, P1J2, P2J1, P1(4), P2(4)
...
! **********************************************************************
  ...
  use ol_contractions_dp, only: cont_VV
  implicit none
  complex(dp), intent(in)  :: S1(4), V2(4), P2(4), V3(4), P3(4)
  complex(dp), intent(out) :: S_out(4)
...
! **********************************************************************
  ...
  use ol_contractions_dp, only: cont_VV
  implicit none
  complex(dp), intent(in)  :: S1(4), S2(4), V3(4), P3(4), P4(4)
  complex(dp), intent(out) :: V_out(4)
...
! **********************************************************************
  ...
  use ol_contractions_dp, only: cont_VV
  implicit none
  complex(dp), intent(in)  :: S1(4), S2(4), S3(4), V4(4), P4(4), P5(4)
  complex(dp), intent(out) :: V_out(4)
...
! **********************************************************************
  ...
  use ol_contractions_dp, only: cont_VV
  implicit none
  complex(dp), intent(in)  :: S1(4), V2(4), P2(4), V3(4), P3(4), V4(4), P4(4)
  complex(dp), intent(out) :: S_out(4)
...
! **********************************************************************
  ...
  use ol_contractions_dp, only: cont_VV
  implicit none
  complex(dp), intent(in)  :: S1(4), S2(4), V3(4), P3(4), V4(4), P4(4), V5(4), P5(4)
  complex(dp), intent(out) :: S_out(4)
...
! **********************************************************************
  ...
  use ol_contractions_dp, only: cont_VV
  implicit none
  complex(dp), intent(in)  :: S1(4), S2(4), V3(4), P3(4), V4(4), P4(4), P5(4)
  complex(dp), intent(out) :: V_out(4)
...
! **********************************************************************
  ...
  use ol_contractions_dp, only: cont_VV
  implicit none
  complex(dp), intent(in)  :: S1(4), S2(4), S3(4), V4(4), P4(4), V5(4), P5(4), P6(4)
  complex(dp), intent(out) :: V_out(4)
...
! **********************************************************************
  ...
  use ol_contractions_dp, only: cont_VV
  implicit none
  complex(dp), intent(in)  :: S1(4), V2(4), V3(4), V4(4), V5(4)
  complex(dp), intent(out) :: S_out(4)
...
! **********************************************************************
  ...
  use ol_contractions_dp, only: cont_VV
  implicit none
  complex(dp), intent(in)  :: S1(4), S2(4), V3(4), V4(4), V5(4), V6(4)
  complex(dp), intent(out) :: S_out(4)
...
! **********************************************************************
  ...
  use ol_contractions_dp, only: cont_VV
  implicit none
  complex(dp), intent(in)  :: S1(4), S2(4), V3(4), V4(4), V5(4)
  complex(dp), intent(out) :: V_out(4)
...
! **********************************************************************
  ...
  use ol_contractions_dp, only: cont_VV
  implicit none
  complex(dp), intent(in)  :: S1(4), S2(4), S3(4), V4(4), V5(4), V6(4)
  complex(dp), intent(out) :: V_out(4)
...
! **********************************************************************
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: J_S(4), J_V(4), P(4), P_out(4)
  complex(dp), intent(out) :: Jout_V(4)
  Jout_V = J_S(1) * J_V
...
! **********************************************************************
  ...
  implicit none
  complex(dp), intent(in)  :: J_S(4), J_V(4), P1(4), P2(4)
  complex(dp), intent(out) :: Jout_V(4)
...
! **********************************************************************
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: g_RL(2), J_Z(4), J_Q(4), S(4)
  complex(dp), intent(out) :: Jout_Q(4)
  Jout_Q(1) = g_RL(2) * ( - J_Z(2)*J_Q(3) + J_Z(4)*J_Q(4))
  Jout_Q(2) = g_RL(2) * ( - J_Z(1)*J_Q(4) + J_Z(3)*J_Q(3))
  Jout_Q(3) = g_RL(1) * ( - J_Z(1)*J_Q(1) - J_Z(4)*J_Q(2))
...
! **********************************************************************
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: g_RL(2), J_A(4), J_Z(4), S(4)
  complex(dp), intent(out) :: Jout_A(4)
  Jout_A(1) = g_RL(1) * ( - J_Z(1)*J_A(3) - J_Z(3)*J_A(4))
  Jout_A(2) = g_RL(1) * ( - J_Z(2)*J_A(4) - J_Z(4)*J_A(3))
  Jout_A(3) = g_RL(2) * ( - J_Z(2)*J_A(1) + J_Z(3)*J_A(2))
...
! **********************************************************************
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: g_RL(2), J_Q(4), J_A(4), S(4)
  complex(dp), intent(out) :: Jout_Z(4)
  Jout_Z(1) = - g_RL(2)*J_A(1)*J_Q(3) - g_RL(1)*J_A(4)*J_Q(2)
  Jout_Z(2) = - g_RL(2)*J_A(2)*J_Q(4) - g_RL(1)*J_A(3)*J_Q(1)
  Jout_Z(3) = - g_RL(2)*J_A(1)*J_Q(4) + g_RL(1)*J_A(3)*J_Q(2)
...
! **********************************************************************
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: J_Q(4), J_A(4), S(4)
  complex(dp), intent(out) :: Jout_V(4)
  Jout_V(1) = - J_A(1)*J_Q(3) - J_A(4)*J_Q(2)
  Jout_V(2) = - J_A(2)*J_Q(4) - J_A(3)*J_Q(1)
  Jout_V(3) = - J_A(1)*J_Q(4) + J_A(3)*J_Q(2)
...
!   use ol_h_contractions_dp, only: cont_PP
  ...
  P1half = 0.5_dp * get_LC_4(mom1)
  P2half = 0.5_dp * get_LC_4(mom2)
  P12  = P1half - P2half
  P112 = P1half + P1half + P2half
  P122 = P1half + P2half + P2half
  do h = 1, n(1)
...
! **********************************************************************
  ...
  complex(dp), intent(in)    :: P2(4), P3(4)
  type(wfun),        intent(out)   :: V_out(n(3))
  integer :: h
  do h = 1, n(3)
...
! **********************************************************************
  ...
  integer(intkind2), intent(inout) :: n(4), t(3,n(4))
  type(wfun),        intent(in)    :: V1(n(1)), V2(n(2)), V3(n(3))
  complex(dp), intent(in)    :: P1(4), P2(4), P3(4)
  type(wfun),        intent(out)   :: S_out(n(4))
  integer :: h
  do h = 1, n(4)
...
! **********************************************************************
  ...
  complex(dp), intent(in)    :: P2(4), P3(4), P4(4)
  type(wfun),        intent(out)   :: V_out(n(4))
  complex(dp) :: P34_V2(n(2)), P42_V3(n(3))
  integer :: h
  do h = 1, n(2)
...
! **********************************************************************
  use kind_types, only: dp, intkind1, intkind2
  use ol_data_types_dp, only: wfun
  use ol_helicity_bookkeeping_dp, only: helbookkeeping_vert5, checkzero_scalar
  use ol_h_contractions_dp, only: cont_PP
  implicit none
  integer(intkind1), intent(in)    :: ntry
...
! **********************************************************************
  use kind_types, only: dp, intkind1, intkind2
  use ol_data_types_dp, only: wfun
  use ol_helicity_bookkeeping_dp, only: helbookkeeping_vert5
  use ol_h_contractions_dp, only: cont_PP
  implicit none
  integer(intkind1), intent(in)    :: ntry
  integer(intkind2), intent(inout) :: n(5), t(4,n(5))
...
! **********************************************************************
  ...
  complex(dp), intent(in)    :: P3(4), P4(4)
  type(wfun),        intent(out)   :: V_out(n(4))
  integer :: h
  do h = 1, n(4)
...
! **********************************************************************
  ...
  complex(dp), intent(in)    :: P3(4), P4(4), P5(4)
  type(wfun),        intent(out)   :: V_out(n(5))
  complex(dp) :: P45_V3(n(3)), P53_V4(n(4))
  integer :: h
  do h = 1, n(3)
...
! **********************************************************************
  use kind_types, only: dp, intkind1, intkind2
  use ol_data_types_dp, only: wfun
  use ol_helicity_bookkeeping_dp, only: helbookkeeping_vert6, checkzero_scalar
  use ol_h_contractions_dp, only: cont_PP
  implicit none
  integer(intkind1), intent(in)    :: ntry
...
! **********************************************************************
  use kind_types, only: dp, intkind1, intkind2
  use ol_data_types_dp, only: wfun
  use ol_helicity_bookkeeping_dp, only: helbookkeeping_vert6
  use ol_h_contractions_dp, only: cont_PP
  implicit none
  integer(intkind1), intent(in)    :: ntry
  integer(intkind2), intent(inout) :: n(6), t(5,n(6))
...
! **********************************************************************
  ...
  complex(dp), intent(in)    :: P4(4), P5(4)
  type(wfun),        intent(out)   :: V_out(n(5))
  integer :: h
  do h = 1, n(5)
...
! **********************************************************************
  ...
  complex(dp), intent(in)    :: P4(4), P5(4), P6(4)
  type(wfun),        intent(out)   :: V_out(n(6))
  complex(dp) :: P56_V4(n(4)), P64_V5(n(5))
  integer :: h
  do h = 1, n(4)
...
! **********************************************************************
  use kind_types, only: dp, intkind1, intkind2
  use ol_data_types_dp, only: wfun
  use ol_helicity_bookkeeping_dp, only: helbookkeeping_vert7, checkzero_scalar
  use ol_h_contractions_dp, only: cont_PP
  implicit none
  integer(intkind1), intent(in)    :: ntry
...
! **********************************************************************
  use kind_types, only: dp, intkind1, intkind2
  use ol_data_types_dp, only: wfun
  use ol_helicity_bookkeeping_dp, only: helbookkeeping_vert7
  use ol_h_contractions_dp, only: cont_PP
  implicit none
  integer(intkind1), intent(in)    :: ntry
  integer(intkind2), intent(inout) :: n(7), t(6,n(7))
...
! **********************************************************************
  use kind_types, only: dp, intkind1, intkind2
  use ol_data_types_dp, only: wfun
  use ol_h_contractions_dp, only: cont_EpPPP
  use ol_helicity_bookkeeping_dp, only: helbookkeeping_vert3
  implicit none
  integer(intkind1), intent(in)    :: ntry
  integer(intkind2), intent(inout) :: n(3), t(2,n(3))
