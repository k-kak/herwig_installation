...
! ******************************************************************************
  ...
  complex(dp), intent(in)  :: G_A(4,rank_in), J_Z(4), g_RL(2)
  complex(dp), intent(out) :: Gout_A(4,rank_out)
  integer :: l
  do l = 1, rank_in
...
! **********************************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: G_A(4,rank_in), J_Q(4), g_RL(2)
  complex(dp), intent(out) :: Gout_Z(4,rank_out)
  integer :: l
  do l = 1, rank_in
...
! ***********************************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: G_Z(4,rank_in), J_A(4), g_RL(2)
  complex(dp), intent(out) :: Gout_A(4,rank_out)
  integer :: l
  do l = 1, rank_in
...
! ***************************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: G_Q(4,rank_in), J_Z(4), g_RL(2)
  complex(dp), intent(out) :: Gout_Q(4,rank_out)
  integer :: l
  do l = 1, rank_in
...
! ************************************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: G_Q(4,rank_in), J_A(4), g_RL(2)
  complex(dp), intent(out) :: Gout_Z(4,rank_out)
  integer :: l
  do l = 1, rank_in
...
! **********************************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: G_Z(4,rank_in), J_Q(4), g_RL(2)
  complex(dp), intent(out) :: Gout_Q(4,rank_out)
  integer :: l
  do l = 1, rank_in
...
! ******************************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: G_A(4,rank_in), J_W(4)
  complex(dp), intent(out) :: Gout_A(4,rank_out)
  integer :: l
  do l = 1, rank_in
    Gout_A(1:2,l) = 0
...
! ***************************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: G_A(4,rank_in), J_Q(4)
  complex(dp), intent(out) :: Gout_W(4,rank_out)
  integer :: l
  do l = 1, rank_in
...
! ****************************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: G_W(4,rank_in), J_A(4)
  complex(dp), intent(out) :: Gout_A(4,rank_out)
  integer :: l
  do l = 1, rank_in
    Gout_A(1:2,l) = 0
...
! *********************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: G_Q(4,rank_in), J_W(4)
  complex(dp), intent(out) :: Gout_Q(4,rank_out)
  integer :: l
  do l = 1, rank_in
...
! *****************************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: G_Q(4,rank_in), J_A(4)
  complex(dp), intent(out) :: Gout_W(4,rank_out)
  integer :: l
  do l = 1, rank_in
...
! ***************************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: G_W(4,rank_in), J_Q(4)
  complex(dp), intent(out) :: Gout_Q(4,rank_out)
  integer :: l
  do l = 1, rank_in
...
! ***********************************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: G_A(4,rank_in), J_V(4)
  complex(dp), intent(out) :: Gout_A(4,rank_out)
  integer :: l
  do l = 1, rank_in
...
! *****************************************************************************
  ...
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: G_A(4,rank_in), J_Q(4)
  complex(dp), intent(out) :: Gout_V(4,rank_out)
  integer :: l
  do l = 1, rank_in
...
! *********************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: G_V(4,rank_in), J_A(4)
  complex(dp), intent(out) :: Gout_A(4,rank_out)
  integer :: l
  do l = 1, rank_in
...
! ************************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: G_Q(4,rank_in), J_V(4)
  complex(dp), intent(out) :: Gout_Q(4,rank_out)
  integer :: l
  do l = 1, rank_in
...
! *********************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: G_V(4,rank_in), J_Q(4)
  complex(dp), intent(out) :: Gout_Q(4,rank_out)
  integer :: l
  do l = 1, rank_in
...
!******************************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: Gin_V(4,rank_in), J_V(4), Ploop(4), Ptree(4)
  complex(dp), intent(out) :: Gout_V(4,rank_out)
  complex(dp) :: Ac, Bc, C, Jhalf(4), Jtwo(4), Ptmp(4,3)
  integer           :: beta, l
...
!****************************************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: Gin_V(4,rank_in), J1(4), J2(4)
  complex(dp), intent(out) :: Gout_V(4,rank_out)
  complex(dp) :: GJ1, GJ2
  integer           :: l, beta
...
!*******************************************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: Gin_C(rank_in), Ploop(4), J_V(4), Ptree(4)
  complex(dp), intent(out) :: Gout_C(rank_out)
  complex(dp) :: Ptot(4), JPtot
  integer           :: l
  ...
  do l = 1, rank_in
    Gout_C(HR(1,l)) = Gout_C(HR(1,l)) + 0.5_dp*Gin_C(l)*J_V(2) ! J_V covariant components
    Gout_C(HR(2,l)) = Gout_C(HR(2,l)) + 0.5_dp*Gin_C(l)*J_V(1) ! J_V covariant components
    Gout_C(HR(3,l)) = Gout_C(HR(3,l)) - 0.5_dp*Gin_C(l)*J_V(4) ! J_V covariant components
    Gout_C(HR(4,l)) = Gout_C(HR(4,l)) - 0.5_dp*Gin_C(l)*J_V(3) ! J_V covariant components
...
!*****************************************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: Gin_D(rank_in), Ploop(4), J_V(4)
  complex(dp), intent(out) :: Gout_D(rank_out)
  complex(dp) :: JPloop
  integer           :: l
  ...
  do l = 1, rank_in
    Gout_D(HR(1,l)) = Gout_D(HR(1,l)) - 0.5_dp*Gin_D(l)*J_V(2) ! -J_V covariant components
    Gout_D(HR(2,l)) = Gout_D(HR(2,l)) - 0.5_dp*Gin_D(l)*J_V(1) ! -J_V covariant components
    Gout_D(HR(3,l)) = Gout_D(HR(3,l)) + 0.5_dp*Gin_D(l)*J_V(4) ! -J_V covariant components
    Gout_D(HR(4,l)) = Gout_D(HR(4,l)) + 0.5_dp*Gin_D(l)*J_V(3) ! -J_V covariant components
...
! ***************************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: G_Q(4,rank_in), J_S, g_RL(2)
  complex(dp), intent(out) :: Gout_Q(4,rank_out)
  integer :: l
  do l = 1, rank_in
...
! ***************************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: G_S(rank_in), J_Q(4), g_RL(2)
  complex(dp), intent(out) :: Gout_Q(4,rank_out)
  integer :: l
  do l = 1, rank_in
...
! ***************************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: G_A(4,rank_in), J_S, g_RL(2)
  complex(dp), intent(out) :: Gout_A(4,rank_out)
  integer :: l
  do l = 1, rank_in
...
! ***************************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: G_S(rank_in), J_A(4), g_RL(2)
  complex(dp), intent(out) :: Gout_A(4,rank_out)
  integer :: l
  do l = 1, rank_in
...
! ***************************************************************************
  ...
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: G_Q(4,rank_in), J_A(4), g_RL(2)
  complex(dp), intent(out) :: Gout_S(rank_out)
  integer :: l
  do l = 1, rank_in
...
! ***************************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: G_V(4,rank_in), J_V(4)
  complex(dp), intent(out) :: Gout_S(rank_out)
  integer :: l
  do l = 1, rank_in
...
! ***************************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: G_V(4,rank_in), J_S
  complex(dp), intent(out) :: Gout_V(4,rank_out)
  integer :: l
  do l = 1, rank_in
    Gout_V(:,l) = G_V(:,l)*J_S
...
! ***************************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: G_S(rank_in), J_V(4)
  complex(dp), intent(out) :: Gout_V(4,rank_out)
  integer :: l
  do l = 1, rank_in
    Gout_V(:,l) = G_S(l)*J_V
...
!*****************************************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: Gin_S(rank_in), Ploop(4), J_V(4), Ptree(4)
  complex(dp), intent(out) :: Gout_S(rank_out)
  complex(dp) :: JP
  integer           :: l
...
!*****************************************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: Gin_V(4,rank_in), Ploop(4), J_S, Ptree(4)
  complex(dp), intent(out) :: Gout_S(rank_out)
  integer :: l
  ...
  do l = 1, rank_in
    Gout_S(HR(1,l)) = Gout_S(HR(1,l)) + 0.5_dp*Gin_V(2,l)*J_S
    Gout_S(HR(2,l)) = Gout_S(HR(2,l)) + 0.5_dp*Gin_V(1,l)*J_S
    Gout_S(HR(3,l)) = Gout_S(HR(3,l)) - 0.5_dp*Gin_V(4,l)*J_S
    Gout_S(HR(4,l)) = Gout_S(HR(4,l)) - 0.5_dp*Gin_V(3,l)*J_S
...
!*****************************************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: Gin_S(rank_in), Ploop(4), J_S, Ptree(4)
  complex(dp), intent(out) :: Gout_V(4,rank_out)
  integer :: l
...
! ***************************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: G_S(rank_in), J_S
  complex(dp), intent(out) :: Gout_S(rank_out)
  integer :: l
  do l = 1, rank_in
    Gout_S(l) = G_S(l)*J_S
...
! ***************************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: G_S(rank_in), J_S1, J_S2
  complex(dp), intent(out) :: Gout_S(rank_out)
  integer :: l
  do l = 1, rank_in
...
! ***************************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: G_V(4,rank_in), J_V(4), J_S
  complex(dp), intent(out) :: Gout_S(rank_out)
  integer :: l
  do l = 1, rank_in
...
! ***************************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: G_S(rank_in), J_V(4), J_S
  complex(dp), intent(out) :: Gout_V(4,rank_out)
  integer :: l
  do l = 1, rank_in
...
! ***************************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: G_V(4,rank_in), J_S1, J_S2
  complex(dp), intent(out) :: Gout_V(4,rank_out)
  integer :: l
  do l = 1, rank_in
...
! ***************************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: G_S(rank_in), J_V1(4), J_V2(4)
  complex(dp), intent(out) :: Gout_S(rank_out)
  integer :: l
  do l = 1, rank_in
...
! ***************************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: G_V(4,rank_in), J_V1(4), J_V2(4)
  complex(dp), intent(out) :: Gout_V(4,rank_out)
  complex(dp) :: GJ1(rank_in), GJ2(rank_in), J1J2
  integer           :: l
...
subroutine vert_loop_GH_G(rank_in, rank_out, Gin_V, pi, J_S, Gout_V, po)
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: Gin_V(4,rank_in), pi(4), J_S(4), po(4)
  complex(dp), intent(out) :: Gout_V(4,rank_out)
  integer :: l

  complex(dp) :: s2, pi2(4), po2(4), poS(4), pio2(4), pipoS, Gpo, Gin2(4), GinS(4)
...
subroutine vert_loop_GHG_G(rank_in, rank_out, Gin_V, plin, J_S, J_V, p3, Gout_V, plout)
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: Gin_V(4,rank_in), plin(4), J_S(4), J_V(4), p3(4), plout(4)
  complex(dp), intent(out) :: Gout_V(4,rank_out)
  complex(dp) :: SV(4), Ac, Bc, C, Jhalf(4), Jtwo(4), Ptmp(4,3)
  integer :: l
...
subroutine vert_loop_GHGG_G_12(rank_in, rank_out, Gin_V, J_S, J_V3, J_V4, Gout_V)
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: Gin_V(4,rank_in), J_S(4), J_V3(4), J_V4(4)
  complex(dp), intent(out) :: Gout_V(4,rank_out)
  complex(dp) :: SV4(4), SV3V4, GV4
  integer :: l
  SV4 = J_S(1) * J_V4
...
subroutine vert_loop_GHH_G(rank_in, rank_out, Gin_V, pi, J_S1, J_S2, Gout_V, po)
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: Gin_V(4,rank_in), pi(4), J_S1(4), J_S2(4), po(4)
  complex(dp), intent(out) :: Gout_V(4,rank_out)
  integer :: l

  complex(dp) :: ss2, pi2(4), po2(4), poS(4), pio2(4), pipoS, Gpo, Gin2(4), GinSS(4)

  Gout_V = 0
  ss2 = (0.5_dp * J_S1(1) * J_S2(1))
  pi2 = ss2 * pi
  po2 = ss2 * po
...
subroutine vert_loop_GHHG_G(rank_in, rank_out, Gin_V, plin, J_S1, J_S2, J_V, p3, Gout_V, plout)
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: Gin_V(4,rank_in), plin(4), J_S1(4), J_S2(4), J_V(4), p3(4), plout(4)
  complex(dp), intent(out) :: Gout_V(4,rank_out)
  complex(dp) :: SSV(4), Ac, Bc, C, Jhalf(4), Jtwo(4), Ptmp(4,3)
  integer :: l
...
subroutine vert_loop_GHHGG_G_12(rank_in, rank_out, Gin_V, J_S1, J_S2, J_V3, J_V4, Gout_V)
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: Gin_V(4,rank_in), J_S1(4), J_S2(4), J_V3(4), J_V4(4)
  complex(dp), intent(out) :: Gout_V(4,rank_out)
  complex(dp) :: SSV4(4), SSV3V4, GV4
  integer :: l
...
subroutine vert_loop_GHHH_G(rank_in, rank_out, Gin_V, pi, J_S1, J_S2, J_S3, Gout_V, po)
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: Gin_V(4,rank_in), pi(4), J_S1(4), J_S2(4), J_S3(4), po(4)
  complex(dp), intent(out) :: Gout_V(4,rank_out)
  integer :: l
  ...
  Gout_V = 0
  ss2 = (0.5_dp * J_S1(1) * J_S2(1) * J_S3(1))
  pi2 = ss2 * pi
  po2 = ss2 * po
  poS = J_S1(1) * J_S2(1) * po
  pio2(1) = - (pi2(2)+po2(2)) ! -S/2*(pi+pi)_rho, covariant
...
subroutine vert_loop_GHHHG_G(rank_in, rank_out, Gin_V, plin, J_S1, J_S2, J_S3, J_V, p3, Gout_V, plout)
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: Gin_V(4,rank_in), plin(4), J_S1(4), J_S2(4), J_S3(4), J_V(4), p3(4), plout(4)
  complex(dp), intent(out) :: Gout_V(4,rank_out)
  complex(dp) :: SSV(4), Ac, Bc, C, Jhalf(4), Jtwo(4), Ptmp(4,3)
  integer :: l
...
subroutine vert_loop_GHHHGG_G_12(rank_in, rank_out, Gin_V, J_S1, J_S2, J_S3, J_V3, J_V4, Gout_V)
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: Gin_V(4,rank_in), J_S1(4), J_S2(4), J_S3(4), J_V3(4), J_V4(4)
  complex(dp), intent(out) :: Gout_V(4,rank_out)
  complex(dp) :: SSSV4(4), SSSV3V4, GV4
  integer :: l
...
! ******************************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: G_A(4,rank_in), J_Z(4), S(4), g_RL(2)
  complex(dp), intent(out) :: Gout_A(4,rank_out)
  integer :: l
  do l = 1, rank_in
    Gout_A(1,l) = g_RL(1) * ( - J_Z(1)*G_A(3,l) - J_Z(3)*G_A(4,l))
...
! ************************************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: G_Q(4,rank_in), S(4), J_A(4), g_RL(2)
  complex(dp), intent(out) :: Gout_Z(4,rank_out)
  integer :: l
  do l = 1, rank_in
    Gout_Z(1,l) = - g_RL(2)*G_Q(3,l)*J_A(1) - g_RL(1)*G_Q(2,l)*J_A(4)
...
! **********************************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: G_A(4,rank_in), S(4), J_Q(4), g_RL(2)
  complex(dp), intent(out) :: Gout_Z(4,rank_out)
  integer :: l
  do l = 1, rank_in
    Gout_Z(1,l) = - g_RL(2)*G_A(1,l)*J_Q(3) - g_RL(1)*G_A(4,l)*J_Q(2)
...
! ***********************************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: G_Z(4,rank_in), S(4), J_A(4), g_RL(2)
  complex(dp), intent(out) :: Gout_A(4,rank_out)
  integer :: l
  do l = 1, rank_in
...
! **********************************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: G_Z(4,rank_in), S(4), J_Q(4), g_RL(2)
  complex(dp), intent(out) :: Gout_Q(4,rank_out)
  integer :: l
  do l = 1, rank_in
...
! ************************************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: G_Q(4,rank_in), J_A(4), S(4), g_RL(2)
  complex(dp), intent(out) :: Gout_Z(4,rank_out)
  integer :: l
  do l = 1, rank_in
    Gout_Z(1,l) = - g_RL(2)*G_Q(3,l)*J_A(1) - g_RL(1)*G_Q(2,l)*J_A(4)
...
! ***************************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: G_V(4,rank_in), J_S(4), P(4), P_out(4)
  complex(dp), intent(out) :: Gout_V(4,rank_out)
  integer :: l
  do l = 1, rank_in
    Gout_V(:,l) = G_V(:,l)*J_S
...
end module ol_loop_vertices_dp
...
module ol_vert_interface_dp
  use ol_loop_vertices_dp
  implicit none
  contains
...
subroutine loop_AZ_Q(G_A, J_Z, Gout_A, g_RL)
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: g_RL(2), G_A(:,:,:), J_Z(4)
  complex(dp), intent(out) :: Gout_A(:,:,:)
...
subroutine loop_AQ_Z(G_A, J_Q, Gout_Z, g_RL)
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: g_RL(2), G_A(:,:,:), J_Q(4)
  complex(dp), intent(out) :: Gout_Z(:,:,:)
  integer :: rank_in, rank_out
  rank_in  = size(G_A,2)
...
subroutine loop_ZA_Q(G_Z, J_A, Gout_A, g_RL)
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: g_RL(2), G_Z(:,:,:), J_A(4)
  complex(dp), intent(out) :: Gout_A(:,:,:)
  integer :: rank_in, rank_out
  rank_in  = size(G_Z,2)
  rank_out = size(Gout_A,2)
...
subroutine loop_QZ_A(G_Q, J_Z, Gout_Q, g_RL)
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: g_RL(2), G_Q(:,:,:), J_Z(4)
  complex(dp), intent(out) :: Gout_Q(:,:,:)
  integer :: rank_in, rank_out
  rank_in  = size(G_Q,2)
...
subroutine loop_QA_Z(G_Q, J_A, Gout_Z, g_RL)
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: g_RL(2), G_Q(:,:,:), J_A(4)
  complex(dp), intent(out) :: Gout_Z(:,:,:)
  integer :: rank_in, rank_out
  rank_in  = size(G_Q,2)
  rank_out = size(Gout_Z,2)
...
subroutine loop_ZQ_A(G_Z, J_Q, Gout_Q, g_RL)
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: g_RL(2), G_Z(:,:,:), J_Q(4)
  complex(dp), intent(out) :: Gout_Q(:,:,:)
  integer :: rank_in, rank_out
  rank_in  = size(G_Z,2)
  rank_out = size(Gout_Q,2)
...
subroutine loop_AW_Q(G_A, J_W, Gout_A)
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: G_A(:,:,:), J_W(4)
  complex(dp), intent(out) :: Gout_A(:,:,:)
  integer :: rank_in, rank_out
  rank_in  = size(G_A,2)
  rank_out = size(Gout_A,2)
...
subroutine loop_WA_Q(G_W, J_A, Gout_A)
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: G_W(:,:,:), J_A(4)
  complex(dp), intent(out) :: Gout_A(:,:,:)
  integer :: rank_in, rank_out
  rank_in  = size(G_W,2)
  rank_out = size(Gout_A,2)
...
subroutine loop_QW_A(G_Q, J_W, Gout_Q)
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: G_Q(:,:,:), J_W(4)
  complex(dp), intent(out) :: Gout_Q(:,:,:)
  integer :: rank_in, rank_out
  rank_in  = size(G_Q,2)
  rank_out = size(Gout_Q,2)
...
subroutine loop_WQ_A(G_W, J_Q, Gout_Q)
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: G_W(:,:,:), J_Q(4)
  complex(dp), intent(out) :: Gout_Q(:,:,:)
  integer :: rank_in, rank_out
  rank_in  = size(G_W,2)
  rank_out = size(Gout_Q,2)
...
subroutine loop_AV_Q(G_A, J_V, Gout_A)
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: G_A(:,:,:), J_V(4)
  complex(dp), intent(out) :: Gout_A(:,:,:)
  integer :: rank_in, rank_out
  rank_in  = size(G_A,2)
  rank_out = size(Gout_A,2)
...
subroutine loop_VA_Q(G_V, J_A, Gout_A)
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: G_V(:,:,:), J_A(4)
  complex(dp), intent(out) :: Gout_A(:,:,:)
  integer :: rank_in, rank_out
  rank_in  = size(G_V,2)
  rank_out = size(Gout_A,2)
...
subroutine loop_QV_A(G_Q, J_V, Gout_Q)
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: G_Q(:,:,:), J_V(4)
  complex(dp), intent(out) :: Gout_Q(:,:,:)
  integer :: rank_in, rank_out
  rank_in  = size(G_Q,2)
  rank_out = size(Gout_Q,2)
...
subroutine loop_VQ_A(G_V, J_Q, Gout_Q)
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: G_V(:,:,:), J_Q(4)
  complex(dp), intent(out) :: Gout_Q(:,:,:)
  integer :: rank_in, rank_out
  rank_in  = size(G_V,2)
  rank_out = size(Gout_Q,2)
...
subroutine loop_UV_W(Gin_V, Ploop, J_V, Ptree, Gout_V)
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: Gin_V(:,:,:), J_V(4), Ploop(4), Ptree(4)
  complex(dp), intent(out) :: Gout_V(:,:,:)
  integer :: rank_in, rank_out
...
subroutine loop_VE_V(Gin_V, J1, J2, Gout_V)
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: Gin_V(:,:,:), J1(4), J2(4)
  complex(dp), intent(out) :: Gout_V(:,:,:)
  integer :: rank_in, rank_out
  rank_in  = size(Gin_V,2)
  rank_out = size(Gout_V,2)
...
subroutine loop_CV_D(Gin_C, Ploop, J_V, Ptree, Gout_C)
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: Gin_C(:,:,:), J_V(4), Ploop(4), Ptree(4)
  complex(dp), intent(out) :: Gout_C(:,:,:)
  integer :: rank_in, rank_out
...
subroutine loop_DV_C(Gin_D, Ploop, J_V,Gout_D)
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: Gin_D(:,:,:), J_V(4), Ploop(4)
  complex(dp), intent(out) :: Gout_D(:,:,:)
  integer :: rank_in, rank_out
...
subroutine loop_AS_Q(G_A, J_S, Gout_A, g_RL)
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: g_RL(2), G_A(:,:,:), J_S(4)
  complex(dp), intent(out) :: Gout_A(:,:,:)
  integer :: rank_in, rank_out
  rank_in  = size(G_A,2)
  rank_out = size(Gout_A,2)
...
subroutine loop_SA_Q(G_S, J_A, Gout_A, g_RL)
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: g_RL(2), G_S(:,:,:), J_A(4)
  complex(dp), intent(out) :: Gout_A(:,:,:)
  integer :: rank_in, rank_out
  rank_in  = size(G_S,2)
  rank_out = size(Gout_A,2)
...
subroutine loop_QS_A(G_Q, J_S, Gout_Q, g_RL)
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: g_RL(2), G_Q(:,:,:), J_S(4)
  complex(dp), intent(out) :: Gout_Q(:,:,:)
  integer :: rank_in, rank_out
  rank_in  = size(G_Q,2)
  rank_out = size(Gout_Q,2)
...
subroutine loop_SQ_A(G_S, J_Q, Gout_Q, g_RL)
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: g_RL(2), G_S(:,:,:), J_Q(4)
  complex(dp), intent(out) :: Gout_Q(:,:,:)
  integer :: rank_in, rank_out
  rank_in  = size(G_S,2)
  rank_out = size(Gout_Q,2)
...
subroutine loop_GH_G(G_V, plin, J_S, Gout_V, plout)
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: G_V(:,:,:), plin(4), J_S(4), plout(4)
  complex(dp), intent(out) :: Gout_V(:,:,:)
  integer :: rank_in, rank_out
  rank_in  = size(G_V,2)
  rank_out = size(Gout_V,2)
...
subroutine loop_GHG_G(G_V, plin, J_S, J_V3, p3, Gout_V, plout)
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: G_V(:,:,:), plin(4), J_S(4), J_V3(4), p3(4), plout(4)
  complex(dp), intent(out) :: Gout_V(:,:,:)
  integer :: rank_in, rank_out
  rank_in  = size(G_V,2)
  rank_out = size(Gout_V,2)
...
subroutine loop_GHGG_G_12(G_V, J_S, J_V3, J_V4, Gout_V)
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: G_V(:,:,:), J_S(4), J_V3(4), J_V4(4)
  complex(dp), intent(out) :: Gout_V(:,:,:)
  integer :: rank_in, rank_out
  rank_in  = size(G_V,2)
  rank_out = size(Gout_V,2)
...
subroutine loop_GHH_G(G_V, plin, J_S1, J_S2, Gout_V, plout)
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: G_V(:,:,:), plin(4), J_S1(4), J_S2(4), plout(4)
  complex(dp), intent(out) :: Gout_V(:,:,:)
  integer :: rank_in, rank_out
  rank_in  = size(G_V,2)
  rank_out = size(Gout_V,2)
...
subroutine loop_GHHG_G(G_V, plin, J_S1, J_S2, J_V3, p3, Gout_V, plout)
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: G_V(:,:,:), plin(4), J_S1(4), J_S2(4), J_V3(4), p3(4), plout(4)
  complex(dp), intent(out) :: Gout_V(:,:,:)
  integer :: rank_in, rank_out
  rank_in  = size(G_V,2)
  rank_out = size(Gout_V,2)
...
subroutine loop_GHHGG_G_12(G_V, J_S1, J_S2, J_V3, J_V4, Gout_V)
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: G_V(:,:,:), J_S1(4), J_S2(4), J_V3(4), J_V4(4)
  complex(dp), intent(out) :: Gout_V(:,:,:)
  integer :: rank_in, rank_out
  rank_in  = size(G_V,2)
  rank_out = size(Gout_V,2)
...
subroutine loop_GHHH_G(G_V, plin, J_S1, J_S2, J_S3, Gout_V, plout)
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: G_V(:,:,:), plin(4), J_S1(4), J_S2(4), J_S3(4), plout(4)
  complex(dp), intent(out) :: Gout_V(:,:,:)
  integer :: rank_in, rank_out
  rank_in  = size(G_V,2)
  rank_out = size(Gout_V,2)
...
subroutine loop_GHHHG_G(G_V, plin, J_S1, J_S2, J_S3, J_V4, p4, Gout_V, plout)
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: G_V(:,:,:), plin(4), J_S1(4), J_S2(4), J_S3(4), J_V4(4), p4(4), plout(4)
  complex(dp), intent(out) :: Gout_V(:,:,:)
  integer :: rank_in, rank_out
  rank_in  = size(G_V,2)
  rank_out = size(Gout_V,2)
...
subroutine loop_GHHHGG_G_12(G_V, J_S1, J_S2, J_S3, J_V4, J_V5, Gout_V)
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: G_V(:,:,:), J_S1(4), J_S2(4), J_S3(4), J_V4(4), J_V5(4)
  complex(dp), intent(out) :: Gout_V(:,:,:)
  integer :: rank_in, rank_out
  rank_in  = size(G_V,2)
  rank_out = size(Gout_V,2)
...
subroutine loop_AZS_Q(G_A, J_Z, S, Gout_A, g_RL)
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: g_RL(2), G_A(:,:,:), J_Z(4), S(4)
  complex(dp), intent(out) :: Gout_A(:,:,:)
  integer :: rank_in, rank_out
  rank_in  = size(G_A,2)
  rank_out = size(Gout_A,2)
...
subroutine loop_SQA_Z(G_Q, S, J_A, Gout_Z, g_RL)
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: g_RL(2), G_Q(:,:,:), J_A(4), S(4)
  complex(dp), intent(out) :: Gout_Z(:,:,:)
  integer :: rank_in, rank_out
  rank_in  = size(G_Q,2)
  rank_out = size(Gout_Z,2)
...
subroutine loop_ASQ_Z(G_A, S, J_Q, Gout_Z, g_RL)
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: g_RL(2), G_A(:,:,:), J_Q(4), S(4)
  complex(dp), intent(out) :: Gout_Z(:,:,:)
  integer :: rank_in, rank_out
  rank_in  = size(G_A,2)
  rank_out = size(Gout_Z,2)
...
subroutine loop_ZSA_Q(G_Z, S, J_A, Gout_A, g_RL)
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: g_RL(2), G_Z(:,:,:), J_A(4), S(4)
  complex(dp), intent(out) :: Gout_A(:,:,:)
  integer :: rank_in, rank_out
  rank_in  = size(G_Z,2)
  rank_out = size(Gout_A,2)
...
subroutine loop_ZSQ_A(G_Z, S, J_Q, Gout_Q, g_RL)
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: g_RL(2), G_Z(:,:,:), S(4), J_Q(4)
  complex(dp), intent(out) :: Gout_Q(:,:,:)
  integer :: rank_in, rank_out
  rank_in  = size(G_Z,2)
  rank_out = size(Gout_Q,2)
...
subroutine loop_VS_V_kap(G_V, P, J_S, Gout_V, P_out)
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: G_V(:,:,:), J_S(4), P(4), P_out(4)
  complex(dp), intent(out) :: Gout_V(:,:,:)
  integer :: rank_in, rank_out
  rank_in  = size(G_V,2)
  rank_out = size(Gout_V,2)
...
end module ol_vert_interface_dp
