...
!*******************************************************
  use kind_types, only: dp
  use ol_vert_interface_dp, only: loop_GH_G
  use ol_loop_routines_dp, only: loop_trace, loop_cont_VV
  use ol_pseudotree_dp, only: exloop
  use ol_tensor_bookkeeping, only: HR
  implicit none
...
!*******************************************************
  use kind_types, only: dp
  use ol_vert_interface_dp, only: loop_GHG_G
  use ol_loop_routines_dp, only: loop_trace, loop_cont_VV
  use ol_pseudotree_dp, only: exloop
  use ol_tensor_bookkeeping, only: HR
  implicit none
...
!*******************************************************
  use kind_types, only: dp
  use ol_vert_interface_dp, only: loop_GHGG_G_12
  use ol_loop_routines_dp, only: loop_trace, loop_cont_VV
  use ol_pseudotree_dp, only: exloop
  implicit none
...
!*******************************************************
  use kind_types, only: dp
  use ol_vert_interface_dp, only: loop_GHGG_G_23
  use ol_loop_routines_dp, only: loop_trace, loop_cont_VV
  use ol_pseudotree_dp, only: exloop
  implicit none
  complex(dp), intent(in)  :: G_V(:,:,:), J_S(4), J_V3(4), J_V4(4)
...
!*******************************************************
  use kind_types, only: dp
  use ol_vert_interface_dp, only: loop_GHH_G
  use ol_loop_routines_dp, only: loop_trace, loop_cont_VV
  use ol_pseudotree_dp, only: exloop
  use ol_tensor_bookkeeping, only: HR
  implicit none
...
!*******************************************************
  use kind_types, only: dp
  use ol_vert_interface_dp, only: loop_GHHG_G
  use ol_loop_routines_dp, only: loop_trace, loop_cont_VV
  use ol_pseudotree_dp, only: exloop
  use ol_tensor_bookkeeping, only: HR
  implicit none
...
!*******************************************************
  use kind_types, only: dp
  use ol_vert_interface_dp, only: loop_GHHGG_G_12
  use ol_loop_routines_dp, only: loop_trace, loop_cont_VV
  use ol_pseudotree_dp, only: exloop
  implicit none
...
!*******************************************************
  use kind_types, only: dp
  use ol_vert_interface_dp, only: loop_GHHGG_G_23
  use ol_loop_routines_dp, only: loop_trace, loop_cont_VV
  use ol_pseudotree_dp, only: exloop
  implicit none
  complex(dp), intent(in)  :: G_V(:,:,:), J_S1(4), J_S2(4), J_V3(4), J_V4(4)
...
!*******************************************************
  use kind_types, only: dp
  use ol_vert_interface_dp, only: loop_GHHH_G
  use ol_loop_routines_dp, only: loop_trace, loop_cont_VV
  use ol_pseudotree_dp, only: exloop
  use ol_tensor_bookkeeping, only: HR
  implicit none
...
!*******************************************************
  use kind_types, only: dp
  use ol_vert_interface_dp, only: loop_GHHHG_G
  use ol_loop_routines_dp, only: loop_trace, loop_cont_VV
  use ol_pseudotree_dp, only: exloop
  use ol_tensor_bookkeeping, only: HR
  implicit none
  complex(dp), intent(in)  :: G_V(:,:,:), plin(4), J_S1(4), J_S2(4), J_S3(4), J_V3(4), p3(4), plout(4)
  integer,           intent(in)  :: switch
  complex(dp), intent(out) :: Gtensor(:)
  complex(dp), allocatable :: Gout_V(:,:,:)
  if (switch == 0) then
...
!*******************************************************
  use kind_types, only: dp
  use ol_vert_interface_dp, only: loop_GHHHGG_G_12
  use ol_loop_routines_dp, only: loop_trace, loop_cont_VV
  use ol_pseudotree_dp, only: exloop
  implicit none
  complex(dp), intent(in)  :: G_V(:,:,:), J_S1(4), J_S2(4), J_S3(4), J_V3(4), J_V4(4)
  integer,           intent(in)  :: switch
  complex(dp), intent(out) :: Gtensor(:)
  complex(dp), allocatable :: Gout_V(:,:,:)
  if (switch == 0) then
...
!*******************************************************
  use kind_types, only: dp
  use ol_vert_interface_dp, only: loop_GHHHGG_G_23
  use ol_loop_routines_dp, only: loop_trace, loop_cont_VV
  use ol_pseudotree_dp, only: exloop
  implicit none
  complex(dp), intent(in)  :: G_V(:,:,:), J_S1(4), J_S2(4), J_S3(4), J_V3(4), J_V4(4)
...
!*******************************************************
  ...
  use ol_contractions_dp, only: cont_VV
  implicit none
  complex(dp), intent(in)  :: Gin_V(:,:,:), pi(4), J_S(4), po(4)
  complex(dp), intent(out) :: Gtensor(:)
  complex(dp) :: s2, pi2(4), po2(4), poS(4), pio2(4), pipoS, Gpo(4), Gin2(10), GinS
  integer :: l
...
!*******************************************************
  ...
  use ol_contractions_dp, only: cont_VV
  implicit none
  complex(dp), intent(in)  :: Gin_V(:,:,:), plin(4), J_S(4), J_V(4), p3(4), plout(4)
  complex(dp), intent(out) :: Gtensor(:)
  complex(dp) :: SV(4), A(4), B(4), C, Jhalf(4), Jtwo(4), Ptmp(4,3)
  integer           :: l
...
!*******************************************************
  ...
  use ol_contractions_dp, only: cont_VV
  implicit none
  complex(dp), intent(in)  :: Gin(:,:,:), J_S(4), J_V3(4), J_V4(4)
  complex(dp), intent(out) :: Gtensor(:)
  complex(dp) :: SV4(4), SV3V4
  integer :: l
  SV4 = J_S(1) * J_V4
...
!*******************************************************
  ...
  use ol_contractions_dp, only: cont_VV
  implicit none
  complex(dp), intent(in)  :: Gin_V(:,:,:), pi(4), J_S1(4), J_S2(4), po(4)
  complex(dp), intent(out) :: Gtensor(:)
  complex(dp) :: s2, pi2(4), po2(4), poS(4), pio2(4), pipoS, Gpo(4), Gin2(10), GinS
  integer :: l

  Gtensor = 0
  s2 = (0.5_dp * J_S1(1) * J_S2(1))
  pi2 = s2 * pi
  po2 = s2 * po
...
!*******************************************************
  ...
  use ol_contractions_dp, only: cont_VV
  implicit none
  complex(dp), intent(in)  :: Gin_V(:,:,:), plin(4), J_S1(4), J_S2(4), J_V(4), p3(4), plout(4)
  complex(dp), intent(out) :: Gtensor(:)
  complex(dp) :: SV(4), A(4), B(4), C, Jhalf(4), Jtwo(4), Ptmp(4,3)
  integer           :: l
...
!*******************************************************
  ...
  use ol_contractions_dp, only: cont_VV
  implicit none
  complex(dp), intent(in)  :: Gin(:,:,:), J_S1(4), J_S2(4), J_V3(4), J_V4(4)
  complex(dp), intent(out) :: Gtensor(:)
  complex(dp) :: SV4(4), SV3V4
  integer :: l
...
!*******************************************************
  ...
  use ol_contractions_dp, only: cont_VV
  implicit none
  complex(dp), intent(in)  :: Gin_V(:,:,:), pi(4), J_S1(4), J_S2(4), J_S3(4), po(4)
  complex(dp), intent(out) :: Gtensor(:)
  complex(dp) :: s2, pi2(4), po2(4), poS(4), pio2(4), pipoS, Gpo(4), Gin2(10), GinS
  integer :: l

  Gtensor = 0
  s2 = (0.5_dp * J_S1(1) * J_S2(1) * J_S3(1))
  pi2 = s2 * pi
  po2 = s2 * po
...
!*******************************************************
  ...
  use ol_contractions_dp, only: cont_VV
  implicit none
  complex(dp), intent(in)  :: Gin_V(:,:,:), plin(4), J_S1(4), J_S2(4), J_S3(4), J_V(4), p3(4), plout(4)
  complex(dp), intent(out) :: Gtensor(:)
  complex(dp) :: SV(4), A(4), B(4), C, Jhalf(4), Jtwo(4), Ptmp(4,3)
  integer           :: l
...
!*******************************************************
  ...
  use ol_contractions_dp, only: cont_VV
  implicit none
  complex(dp), intent(in)  :: Gin(:,:,:), J_S1(4), J_S2(4), J_S3(4), J_V3(4), J_V4(4)
  complex(dp), intent(out) :: Gtensor(:)
  complex(dp) :: SV4(4), SV3V4
  integer :: l
