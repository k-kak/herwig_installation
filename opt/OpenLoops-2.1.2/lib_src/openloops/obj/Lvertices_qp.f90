...
subroutine vert_loop_GH_G(rank_in, rank_out, Gin_V, pi, J_S, Gout_V, po)
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(qp), intent(in)  :: Gin_V(4,rank_in), pi(4), J_S(4), po(4)
  complex(qp), intent(out) :: Gout_V(4,rank_out)
  integer :: l

  complex(qp) :: s2, pi2(4), po2(4), poS(4), pio2(4), pipoS, Gpo, Gin2(4), GinS(4)
...
subroutine vert_loop_GHG_G(rank_in, rank_out, Gin_V, plin, J_S, J_V, p3, Gout_V, plout)
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(qp), intent(in)  :: Gin_V(4,rank_in), plin(4), J_S(4), J_V(4), p3(4), plout(4)
  complex(qp), intent(out) :: Gout_V(4,rank_out)
  complex(qp) :: SV(4), Ac, Bc, C, Jhalf(4), Jtwo(4), Ptmp(4,3)
  integer :: l
...
subroutine vert_loop_GHGG_G_12(rank_in, rank_out, Gin_V, J_S, J_V3, J_V4, Gout_V)
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(qp), intent(in)  :: Gin_V(4,rank_in), J_S(4), J_V3(4), J_V4(4)
  complex(qp), intent(out) :: Gout_V(4,rank_out)
  complex(qp) :: SV4(4), SV3V4, GV4
  integer :: l
  SV4 = J_S(1) * J_V4
...
subroutine vert_loop_GHH_G(rank_in, rank_out, Gin_V, pi, J_S1, J_S2, Gout_V, po)
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(qp), intent(in)  :: Gin_V(4,rank_in), pi(4), J_S1(4), J_S2(4), po(4)
  complex(qp), intent(out) :: Gout_V(4,rank_out)
  integer :: l

  complex(qp) :: ss2, pi2(4), po2(4), poS(4), pio2(4), pipoS, Gpo, Gin2(4), GinSS(4)

  Gout_V = 0
  ss2 = (0.5_qp * J_S1(1) * J_S2(1))
  pi2 = ss2 * pi
  po2 = ss2 * po
...
subroutine vert_loop_GHHG_G(rank_in, rank_out, Gin_V, plin, J_S1, J_S2, J_V, p3, Gout_V, plout)
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(qp), intent(in)  :: Gin_V(4,rank_in), plin(4), J_S1(4), J_S2(4), J_V(4), p3(4), plout(4)
  complex(qp), intent(out) :: Gout_V(4,rank_out)
  complex(qp) :: SSV(4), Ac, Bc, C, Jhalf(4), Jtwo(4), Ptmp(4,3)
  integer :: l
...
subroutine vert_loop_GHHGG_G_12(rank_in, rank_out, Gin_V, J_S1, J_S2, J_V3, J_V4, Gout_V)
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(qp), intent(in)  :: Gin_V(4,rank_in), J_S1(4), J_S2(4), J_V3(4), J_V4(4)
  complex(qp), intent(out) :: Gout_V(4,rank_out)
  complex(qp) :: SSV4(4), SSV3V4, GV4
  integer :: l
...
subroutine vert_loop_GHHH_G(rank_in, rank_out, Gin_V, pi, J_S1, J_S2, J_S3, Gout_V, po)
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(qp), intent(in)  :: Gin_V(4,rank_in), pi(4), J_S1(4), J_S2(4), J_S3(4), po(4)
  complex(qp), intent(out) :: Gout_V(4,rank_out)
  integer :: l
  ...
  Gout_V = 0
  ss2 = (0.5_qp * J_S1(1) * J_S2(1) * J_S3(1))
  pi2 = ss2 * pi
  po2 = ss2 * po
  poS = J_S1(1) * J_S2(1) * po
  pio2(1) = - (pi2(2)+po2(2)) ! -S/2*(pi+pi)_rho, covariant
...
subroutine vert_loop_GHHHG_G(rank_in, rank_out, Gin_V, plin, J_S1, J_S2, J_S3, J_V, p3, Gout_V, plout)
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(qp), intent(in)  :: Gin_V(4,rank_in), plin(4), J_S1(4), J_S2(4), J_S3(4), J_V(4), p3(4), plout(4)
  complex(qp), intent(out) :: Gout_V(4,rank_out)
  complex(qp) :: SSV(4), Ac, Bc, C, Jhalf(4), Jtwo(4), Ptmp(4,3)
  integer :: l
...
subroutine vert_loop_GHHHGG_G_12(rank_in, rank_out, Gin_V, J_S1, J_S2, J_S3, J_V3, J_V4, Gout_V)
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(qp), intent(in)  :: Gin_V(4,rank_in), J_S1(4), J_S2(4), J_S3(4), J_V3(4), J_V4(4)
  complex(qp), intent(out) :: Gout_V(4,rank_out)
  complex(qp) :: SSSV4(4), SSSV3V4, GV4
  integer :: l
...
! ******************************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(qp), intent(in)  :: G_A(4,rank_in), J_Z(4), S(4), g_RL(2)
  complex(qp), intent(out) :: Gout_A(4,rank_out)
  integer :: l
  do l = 1, rank_in
    Gout_A(1,l) = g_RL(1) * ( - J_Z(1)*G_A(3,l) - J_Z(3)*G_A(4,l))
...
! ************************************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(qp), intent(in)  :: G_Q(4,rank_in), S(4), J_A(4), g_RL(2)
  complex(qp), intent(out) :: Gout_Z(4,rank_out)
  integer :: l
  do l = 1, rank_in
    Gout_Z(1,l) = - g_RL(2)*G_Q(3,l)*J_A(1) - g_RL(1)*G_Q(2,l)*J_A(4)
...
! **********************************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(qp), intent(in)  :: G_A(4,rank_in), S(4), J_Q(4), g_RL(2)
  complex(qp), intent(out) :: Gout_Z(4,rank_out)
  integer :: l
  do l = 1, rank_in
    Gout_Z(1,l) = - g_RL(2)*G_A(1,l)*J_Q(3) - g_RL(1)*G_A(4,l)*J_Q(2)
...
! ***********************************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(qp), intent(in)  :: G_Z(4,rank_in), S(4), J_A(4), g_RL(2)
  complex(qp), intent(out) :: Gout_A(4,rank_out)
  integer :: l
  do l = 1, rank_in
...
! **********************************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(qp), intent(in)  :: G_Z(4,rank_in), S(4), J_Q(4), g_RL(2)
  complex(qp), intent(out) :: Gout_Q(4,rank_out)
  integer :: l
  do l = 1, rank_in
...
! ************************************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(qp), intent(in)  :: G_Q(4,rank_in), J_A(4), S(4), g_RL(2)
  complex(qp), intent(out) :: Gout_Z(4,rank_out)
  integer :: l
  do l = 1, rank_in
    Gout_Z(1,l) = - g_RL(2)*G_Q(3,l)*J_A(1) - g_RL(1)*G_Q(2,l)*J_A(4)
...
! ***************************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(qp), intent(in)  :: G_V(4,rank_in), J_S(4), P(4), P_out(4)
  complex(qp), intent(out) :: Gout_V(4,rank_out)
  integer :: l
  do l = 1, rank_in
    Gout_V(:,l) = G_V(:,l)*J_S
...
subroutine loop_GHHHG_G(G_V, plin, J_S1, J_S2, J_S3, J_V4, p4, Gout_V, plout)
  use kind_types, only: qp
  implicit none
  complex(qp), intent(in)  :: G_V(:,:,:), plin(4), J_S1(4), J_S2(4), J_S3(4), J_V4(4), p4(4), plout(4)
  complex(qp), intent(out) :: Gout_V(:,:,:)
  integer :: rank_in, rank_out
  rank_in  = size(G_V,2)
  rank_out = size(Gout_V,2)
...
subroutine loop_GHHHGG_G_12(G_V, J_S1, J_S2, J_S3, J_V4, J_V5, Gout_V)
  use kind_types, only: qp
  implicit none
  complex(qp), intent(in)  :: G_V(:,:,:), J_S1(4), J_S2(4), J_S3(4), J_V4(4), J_V5(4)
  complex(qp), intent(out) :: Gout_V(:,:,:)
  integer :: rank_in, rank_out
  rank_in  = size(G_V,2)
  rank_out = size(Gout_V,2)
...
subroutine loop_AZS_Q(G_A, J_Z, S, Gout_A, g_RL)
  use kind_types, only: qp
  implicit none
  complex(qp), intent(in)  :: g_RL(2), G_A(:,:,:), J_Z(4), S(4)
  complex(qp), intent(out) :: Gout_A(:,:,:)
  integer :: rank_in, rank_out
  rank_in  = size(G_A,2)
  rank_out = size(Gout_A,2)
...
subroutine loop_SQA_Z(G_Q, S, J_A, Gout_Z, g_RL)
  use kind_types, only: qp
  implicit none
  complex(qp), intent(in)  :: g_RL(2), G_Q(:,:,:), J_A(4), S(4)
  complex(qp), intent(out) :: Gout_Z(:,:,:)
  integer :: rank_in, rank_out
  rank_in  = size(G_Q,2)
  rank_out = size(Gout_Z,2)
...
subroutine loop_ASQ_Z(G_A, S, J_Q, Gout_Z, g_RL)
  use kind_types, only: qp
  implicit none
  complex(qp), intent(in)  :: g_RL(2), G_A(:,:,:), J_Q(4), S(4)
  complex(qp), intent(out) :: Gout_Z(:,:,:)
  integer :: rank_in, rank_out
  rank_in  = size(G_A,2)
  rank_out = size(Gout_Z,2)
...
subroutine loop_ZSA_Q(G_Z, S, J_A, Gout_A, g_RL)
  use kind_types, only: qp
  implicit none
  complex(qp), intent(in)  :: g_RL(2), G_Z(:,:,:), J_A(4), S(4)
  complex(qp), intent(out) :: Gout_A(:,:,:)
  integer :: rank_in, rank_out
  rank_in  = size(G_Z,2)
  rank_out = size(Gout_A,2)
...
subroutine loop_ZSQ_A(G_Z, S, J_Q, Gout_Q, g_RL)
  use kind_types, only: qp
  implicit none
  complex(qp), intent(in)  :: g_RL(2), G_Z(:,:,:), S(4), J_Q(4)
  complex(qp), intent(out) :: Gout_Q(:,:,:)
  integer :: rank_in, rank_out
  rank_in  = size(G_Z,2)
  rank_out = size(Gout_Q,2)
...
subroutine loop_VS_V_kap(G_V, P, J_S, Gout_V, P_out)
  use kind_types, only: qp
  implicit none
  complex(qp), intent(in)  :: G_V(:,:,:), J_S(4), P(4), P_out(4)
  complex(qp), intent(out) :: Gout_V(:,:,:)
  integer :: rank_in, rank_out
  rank_in  = size(G_V,2)
  rank_out = size(Gout_V,2)
