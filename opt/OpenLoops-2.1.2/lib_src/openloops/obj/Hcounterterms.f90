...
! **********************************************************************
  ...
  use KIND_TYPES_BW
  use ol_data_types_dp, only: wfun
  use ol_h_helicity_bookkeeping_dp, only: helbookkeeping_prop
  use ol_qcd_offshell_selfenergiesdp, only: quark_ofsse
  ...
  use ol_kinematics_dp, only: get_LC_5, get_LC_mass2
...
! **********************************************************************
  ...
  use ol_data_types_dp, only: wfun
  use ol_h_helicity_bookkeeping_dp, only: helbookkeeping_prop
  use ol_qcd_offshell_selfenergiesdp, only: gluon_ofsse
  use ol_parameters_decl_dp, only: bubble_vertex
  use ol_kinematics_dp, only: get_LC_mass2, get_LC_4
  implicit none
  integer(intkind1), intent(in)    :: ntry
...
! **********************************************************************
  use kind_types, only: dp, intkind1, intkind2
  use ol_data_types_dp, only: wfun
  use ol_h_helicity_bookkeeping_dp, only: helbookkeeping_prop, checkzero_scalar
  use ol_contractions_dp, only: cont_V
  use ol_kinematics_dp, only: get_LC_4
  implicit none
  integer(intkind1), intent(in)    :: ntry
  integer(intkind2), intent(inout) :: n
  complex(dp), intent(in)    :: ctSS(2)
  integer,           intent(in)    :: mom
...
! **********************************************************************
  use kind_types, only: dp, intkind1, intkind2
  use ol_data_types_dp, only: wfun
  use ol_h_helicity_bookkeeping_dp, only: helbookkeeping_vert4
  use ol_contractions_dp, only: cont_VV
  implicit none
...
! **********************************************************************
  ...
  use KIND_TYPES_BW
  use ol_data_types_dp, only: wfun
  use ol_h_helicity_bookkeeping_dp, only: helbookkeeping_vert3
  implicit none
  integer(intkind1), intent(in)    :: ntry
...
! **********************************************************************
  ...
  complex(dp) :: J1J2(n(3)), P1J2(n(2)), P2J1(n(1))
...
! **********************************************************************
  ...
  use ol_contractions_dp, only: cont_VV
  use ol_data_types_dp, only: wfun
  use ol_h_helicity_bookkeeping_dp, only: helbookkeeping_vert4, checkzero_scalar
  implicit none
  integer(intkind1), intent(in)    :: ntry
  integer(intkind2), intent(inout) :: n(4), t(:,:)
...
! **********************************************************************
  use kind_types, only: dp, intkind1, intkind2
  use ol_data_types_dp, only: wfun
  use ol_h_helicity_bookkeeping_dp, only: helbookkeeping_vert3, checkzero_scalar
  use ol_contractions_dp, only: cont_VV
  implicit none
  integer(intkind1), intent(in)    :: ntry
  integer(intkind2), intent(inout) :: n(3), t(:,:)
...
end module ol_h_counterterms_dp
