...
! **********************************************************************
  ...
  use ol_loop_routines_qp, only: loop_trace, loop_cont_VV
  use ol_pseudotree_qp, only: exloop
  implicit none
  complex(qp), intent(in)  :: G_A(:,:,:), J_Q(4)
  integer,           intent(in)  :: switch
  complex(qp), intent(out) :: Gtensor(size(G_A,2))
  complex(qp) :: Gout_V(4,size(G_A,2),4)
...
! **********************************************************************
  ...
  integer,           intent(in)  :: switch
  complex(qp), intent(out) :: Gtensor(size(G_Q,2))
  complex(qp) :: Gout_V(4,size(G_Q,2),4)
...
! **********************************************************************
  ...
  use ol_pseudotree_qp, only: exloop
  implicit none
  complex(qp), intent(in)  :: G_A(:,:,:), J_Q(4), g_RL(2)
  integer,           intent(in)  :: switch
  complex(qp), intent(out) :: Gtensor(size(G_A,2))
  complex(qp) :: Gout_Z(4,size(G_A,2),4)
...
! **********************************************************************
  ...
  use ol_pseudotree_qp, only: exloop
  implicit none
  complex(qp), intent(in)  :: G_Q(:,:,:), J_A(4), g_RL(2)
  integer,           intent(in)  :: switch
  complex(qp), intent(out) :: Gtensor(size(G_Q,2))
  complex(qp) :: Gout_Z(4,size(G_Q,2),4)
...
! **********************************************************************
  ...
  integer,           intent(in)  :: switch
  complex(qp), intent(out) :: Gtensor(size(G_A,2))
  complex(qp) :: Gout_W(4,size(G_A,2),4)
...
! **********************************************************************
  ...
  integer,           intent(in)  :: switch
  complex(qp), intent(out) :: Gtensor(size(G_Q,2))
  complex(qp) :: Gout_W(4,size(G_Q,2),4)
...
! **********************************************************************
  ...
  use ol_loop_routines_qp, only: loop_trace, loop_cont_QA
  use ol_pseudotree_qp, only: exloop
  use ol_tensor_bookkeeping, only: HR
  implicit none
  complex(qp), intent(in)  :: G_A(:,:,:), K(5), M
  integer,           intent(in)  :: switch
  complex(qp), intent(out) :: Gtensor(:)
  complex(qp), allocatable :: Gout_A(:,:,:)
...
! **********************************************************************
  ...
  use ol_tensor_bookkeeping, only: HR
  implicit none
  complex(qp), intent(in)  :: G_Q(:,:,:), K(5), M
  integer,           intent(in)  :: switch
  complex(qp), intent(out) :: Gtensor(:)
  complex(qp), allocatable :: Gout_Q(:,:,:)
...
!************************************************************
  ...
  use ol_tensor_bookkeeping, only: HR
  implicit none
  complex(qp), intent(in)  :: Gin_V(:,:,:), Ploop(4), J_V(4), Ptree(4)
  integer,           intent(in)  :: switch
  complex(qp), intent(out) :: Gtensor(:)
  complex(qp), allocatable :: Gout_V(:,:,:)
...
!*******************************************************
  ...
  use ol_pseudotree_qp, only: exloop
  implicit none
  complex(qp), intent(in)  :: Gin(:,:,:), J1(4), J2(4)
  integer,           intent(in)  :: switch
  complex(qp), intent(out) :: Gtensor(:)
  complex(qp) :: Gout(4,size(Gin,2),4)
...
!*******************************************************
  ...
  use ol_pseudotree_qp, only: exloop
  implicit none
  complex(qp), intent(in)  :: Gin(:,:,:), J_V(4), Ploop(4), Ptree(4)
  integer,           intent(in)  :: switch
  complex(qp), intent(out) :: Gtensor(:)
...
!*******************************************************
  ...
  use ol_pseudotree_qp, only: exloop
  implicit none
  complex(qp), intent(in)  :: Gin(:,:,:), J_V(4), Ploop(4)
  integer,           intent(in)  :: switch
  complex(qp), intent(out) :: Gtensor(:)
...
!*******************************************************
  ...
  integer,           intent(in)  :: switch
  complex(qp), intent(out) :: Gtensor(:)
  complex(qp)              :: Gout_V(4,size(G_V,2),4)
...
!*******************************************************
  ...
  integer,           intent(in)  :: switch
  complex(qp), intent(out) :: Gtensor(:)
  complex(qp)              :: Gout_V(4,size(G_S,2),4)
...
!*******************************************************
  ...
  use ol_pseudotree_qp, only: exloop
  implicit none
  complex(qp), intent(in)  :: G_V(:,:,:), JV1(4), JV2(4)
  integer,           intent(in)  :: switch
  complex(qp), intent(out) :: Gtensor(:)
  complex(qp) :: Gout_V(4,size(G_V,2),4)
...
!*******************************************************
  use kind_types, only: qp
  use ol_vert_interface_qp, only: loop_GH_G
  use ol_loop_routines_qp, only: loop_trace, loop_cont_VV
  use ol_pseudotree_qp, only: exloop
  use ol_tensor_bookkeeping, only: HR
  implicit none
  complex(qp), intent(in)  :: G_V(:,:,:), plin(4), J_S(4), plout(4)
  integer,           intent(in)  :: switch
  complex(qp), intent(out) :: Gtensor(:)
  complex(qp), allocatable :: Gout_V(:,:,:)
  if (switch == 0) then
...
!*******************************************************
  use kind_types, only: qp
  use ol_vert_interface_qp, only: loop_GHG_G
  use ol_loop_routines_qp, only: loop_trace, loop_cont_VV
  use ol_pseudotree_qp, only: exloop
  use ol_tensor_bookkeeping, only: HR
  implicit none
  complex(qp), intent(in)  :: G_V(:,:,:), plin(4), J_S(4), J_V3(4), p3(4), plout(4)
  integer,           intent(in)  :: switch
  complex(qp), intent(out) :: Gtensor(:)
  complex(qp), allocatable :: Gout_V(:,:,:)
  if (switch == 0) then
...
!*******************************************************
  use kind_types, only: qp
  use ol_vert_interface_qp, only: loop_GHGG_G_12
  use ol_loop_routines_qp, only: loop_trace, loop_cont_VV
  use ol_pseudotree_qp, only: exloop
  implicit none
  complex(qp), intent(in)  :: G_V(:,:,:), J_S(4), J_V3(4), J_V4(4)
  integer,           intent(in)  :: switch
  complex(qp), intent(out) :: Gtensor(:)
  complex(qp), allocatable :: Gout_V(:,:,:)
  if (switch == 0) then
...
!*******************************************************
  use kind_types, only: qp
  use ol_vert_interface_qp, only: loop_GHGG_G_23
  use ol_loop_routines_qp, only: loop_trace, loop_cont_VV
  use ol_pseudotree_qp, only: exloop
  implicit none
  complex(qp), intent(in)  :: G_V(:,:,:), J_S(4), J_V3(4), J_V4(4)
...
!*******************************************************
  use kind_types, only: qp
  use ol_vert_interface_qp, only: loop_GHH_G
  use ol_loop_routines_qp, only: loop_trace, loop_cont_VV
  use ol_pseudotree_qp, only: exloop
  use ol_tensor_bookkeeping, only: HR
  implicit none
  complex(qp), intent(in)  :: G_V(:,:,:), plin(4), J_S1(4), J_S2(4), plout(4)
  integer,           intent(in)  :: switch
  complex(qp), intent(out) :: Gtensor(:)
  complex(qp), allocatable :: Gout_V(:,:,:)
  if (switch == 0) then
...
!*******************************************************
  use kind_types, only: qp
  use ol_vert_interface_qp, only: loop_GHHG_G
  use ol_loop_routines_qp, only: loop_trace, loop_cont_VV
  use ol_pseudotree_qp, only: exloop
  use ol_tensor_bookkeeping, only: HR
  implicit none
  complex(qp), intent(in)  :: G_V(:,:,:), plin(4), J_S1(4), J_S2(4), J_V3(4), p3(4), plout(4)
  integer,           intent(in)  :: switch
  complex(qp), intent(out) :: Gtensor(:)
  complex(qp), allocatable :: Gout_V(:,:,:)
  if (switch == 0) then
...
!*******************************************************
  use kind_types, only: qp
  use ol_vert_interface_qp, only: loop_GHHGG_G_12
  use ol_loop_routines_qp, only: loop_trace, loop_cont_VV
  use ol_pseudotree_qp, only: exloop
  implicit none
  complex(qp), intent(in)  :: G_V(:,:,:), J_S1(4), J_S2(4), J_V3(4), J_V4(4)
  integer,           intent(in)  :: switch
  complex(qp), intent(out) :: Gtensor(:)
  complex(qp), allocatable :: Gout_V(:,:,:)
  if (switch == 0) then
...
!*******************************************************
  use kind_types, only: qp
  use ol_vert_interface_qp, only: loop_GHHGG_G_23
  use ol_loop_routines_qp, only: loop_trace, loop_cont_VV
  use ol_pseudotree_qp, only: exloop
  implicit none
  complex(qp), intent(in)  :: G_V(:,:,:), J_S1(4), J_S2(4), J_V3(4), J_V4(4)
...
!*******************************************************
  use kind_types, only: qp
  use ol_vert_interface_qp, only: loop_GHHH_G
  use ol_loop_routines_qp, only: loop_trace, loop_cont_VV
  use ol_pseudotree_qp, only: exloop
  use ol_tensor_bookkeeping, only: HR
  implicit none
  complex(qp), intent(in)  :: G_V(:,:,:), plin(4), J_S1(4), J_S2(4), J_S3(4), plout(4)
  integer,           intent(in)  :: switch
  complex(qp), intent(out) :: Gtensor(:)
  complex(qp), allocatable :: Gout_V(:,:,:)
  if (switch == 0) then
...
!*******************************************************
  use kind_types, only: qp
  use ol_vert_interface_qp, only: loop_GHHHG_G
  use ol_loop_routines_qp, only: loop_trace, loop_cont_VV
  use ol_pseudotree_qp, only: exloop
  use ol_tensor_bookkeeping, only: HR
  implicit none
  complex(qp), intent(in)  :: G_V(:,:,:), plin(4), J_S1(4), J_S2(4), J_S3(4), J_V3(4), p3(4), plout(4)
  integer,           intent(in)  :: switch
  complex(qp), intent(out) :: Gtensor(:)
  complex(qp), allocatable :: Gout_V(:,:,:)
  if (switch == 0) then
...
!*******************************************************
  use kind_types, only: qp
  use ol_vert_interface_qp, only: loop_GHHHGG_G_12
  use ol_loop_routines_qp, only: loop_trace, loop_cont_VV
  use ol_pseudotree_qp, only: exloop
  implicit none
  complex(qp), intent(in)  :: G_V(:,:,:), J_S1(4), J_S2(4), J_S3(4), J_V3(4), J_V4(4)
  integer,           intent(in)  :: switch
  complex(qp), intent(out) :: Gtensor(:)
  complex(qp), allocatable :: Gout_V(:,:,:)
  if (switch == 0) then
...
!*******************************************************
  use kind_types, only: qp
  use ol_vert_interface_qp, only: loop_GHHHGG_G_23
  use ol_loop_routines_qp, only: loop_trace, loop_cont_VV
  use ol_pseudotree_qp, only: exloop
  implicit none
  complex(qp), intent(in)  :: G_V(:,:,:), J_S1(4), J_S2(4), J_S3(4), J_V3(4), J_V4(4)
...
!************************************************************
  ...
  complex(qp), intent(in)  :: Gin_V(:,:,:), Ploop(4), J_V(4), Ptree(4)
  complex(qp), intent(out) :: Gtensor(:)
  complex(qp) :: A(4), B(4), C, Jhalf(4), Jtwo(4), Ptmp(4,3)
  integer           :: l, length_in
...
!****************************************************
  use kind_types, only: qp
  use ol_vert_interface_qp, only: vert_loop_CV_D
  implicit none
  complex(qp), intent(in)  :: Gin(:,:,:), J_V(4), Ploop(4), Ptree(4)
  complex(qp), intent(out) :: Gtensor(:)
...
!****************************************************
  use kind_types, only: qp
  use ol_vert_interface_qp, only: vert_loop_DV_C
  implicit none
  complex(qp), intent(in)  :: Gin(:,:,:), J_V(4), Ploop(4)
  complex(qp), intent(out) :: Gtensor(:)
  integer :: rank_in, rank_out
...
!****************************************************
  use kind_types, only: qp
  use ol_vert_interface_qp, only: vert_loop_QA_S
  implicit none
  complex(qp), intent(in)  :: G_Q(:,:,:), J_A(4), g_RL(2)
  complex(qp), intent(out) :: Gtensor(:)
  integer :: rank_in, rank_out
...
!****************************************************
  use kind_types, only: qp
  use ol_vert_interface_qp, only: vert_loop_AQ_S
  implicit none
  complex(qp), intent(in)  :: G_A(:,:,:), J_Q(4), g_RL(2)
  complex(qp), intent(out) :: Gtensor(:)
  integer :: rank_in, rank_out
...
!****************************************************
  use kind_types, only: qp
  use ol_vert_interface_qp, only: vert_loop_VV_S
  implicit none
  complex(qp), intent(in)  :: G_V(:,:,:), J_V(4)
  complex(qp), intent(out) :: Gtensor(:)
  integer :: rank_in, rank_out
...
!****************************************************
  use kind_types, only: qp
  use ol_vert_interface_qp, only: vert_loop_SV_T
  implicit none
  complex(qp), intent(in)  :: G_S(:,:,:), Ploop(4), J_V(4), Ptree(4)
  complex(qp), intent(out) :: Gtensor(:)
  integer :: rank_in, rank_out
...
!****************************************************
  use kind_types, only: qp
  use ol_vert_interface_qp, only: vert_loop_TV_S
  implicit none
  complex(qp), intent(in)  :: G_S(:,:,:), Ploop(4), J_V(4), Ptree(4)
  complex(qp), intent(out) :: Gtensor(:)
  integer :: rank_in, rank_out
...
!****************************************************
  use kind_types, only: qp
  use ol_vert_interface_qp, only: vert_loop_VS_T
  implicit none
  complex(qp), intent(in)  :: G_V(:,:,:), Ploop(4), J_S(4), Ptree(4)
  complex(qp), intent(out) :: Gtensor(:)
  integer :: rank_in, rank_out
...
!****************************************************
  use kind_types, only: qp
  use ol_vert_interface_qp, only: vert_loop_VT_S
  implicit none
  complex(qp), intent(in)  :: G_V(:,:,:), Ploop(4), J_S(4), Ptree(4)
  complex(qp), intent(out) :: Gtensor(:)
  integer :: rank_in, rank_out
...
!****************************************************
  use kind_types, only: qp
  use ol_vert_interface_qp, only: vert_loop_SS_S
  implicit none
  complex(qp), intent(in)  :: G_S(:,:,:), J_S(4)
  complex(qp), intent(out) :: Gtensor(:)
  integer :: rank_in, rank_out
...
!****************************************************
  use kind_types, only: qp
  use ol_vert_interface_qp, only: vert_loop_SSS_S
  implicit none
  complex(qp), intent(in)  :: G_S(:,:,:), J_S1(4), J_S2(4)
  complex(qp), intent(out) :: Gtensor(:)
  integer :: rank_in, rank_out
...
!****************************************************
  use kind_types, only: qp
  use ol_vert_interface_qp, only: vert_loop_VVS_S
  implicit none
  complex(qp), intent(in)  :: G_V(:,:,:), J_V(4), J_S(4)
  complex(qp), intent(out) :: Gtensor(:)
  integer :: rank_in, rank_out
...
!****************************************************
  use kind_types, only: qp
  use ol_vert_interface_qp, only: vert_loop_SVV_S
  implicit none
  complex(qp), intent(in)  :: G_S(:,:,:), J_V1(4), J_V2(4)
  complex(qp), intent(out) :: Gtensor(:)
  integer :: rank_in, rank_out
...
!*******************************************************
  ...
  use ol_contractions_qp, only: cont_VV
  implicit none
  complex(qp), intent(in)  :: Gin_V(:,:,:), pi(4), J_S(4), po(4)
  complex(qp), intent(out) :: Gtensor(:)
  complex(qp) :: s2, pi2(4), po2(4), poS(4), pio2(4), pipoS, Gpo(4), Gin2(10), GinS
  integer :: l
...
!*******************************************************
  ...
  use ol_contractions_qp, only: cont_VV
  implicit none
  complex(qp), intent(in)  :: Gin_V(:,:,:), plin(4), J_S(4), J_V(4), p3(4), plout(4)
  complex(qp), intent(out) :: Gtensor(:)
  complex(qp) :: SV(4), A(4), B(4), C, Jhalf(4), Jtwo(4), Ptmp(4,3)
  integer           :: l
...
!*******************************************************
  ...
  use ol_contractions_qp, only: cont_VV
  implicit none
  complex(qp), intent(in)  :: Gin(:,:,:), J_S(4), J_V3(4), J_V4(4)
  complex(qp), intent(out) :: Gtensor(:)
  complex(qp) :: SV4(4), SV3V4
  integer :: l
  SV4 = J_S(1) * J_V4
...
!*******************************************************
  ...
  use ol_contractions_qp, only: cont_VV
  implicit none
  complex(qp), intent(in)  :: Gin_V(:,:,:), pi(4), J_S1(4), J_S2(4), po(4)
  complex(qp), intent(out) :: Gtensor(:)
  complex(qp) :: s2, pi2(4), po2(4), poS(4), pio2(4), pipoS, Gpo(4), Gin2(10), GinS
  integer :: l

  Gtensor = 0
  s2 = (0.5_qp * J_S1(1) * J_S2(1))
  pi2 = s2 * pi
  po2 = s2 * po
...
!*******************************************************
  ...
  use ol_contractions_qp, only: cont_VV
  implicit none
  complex(qp), intent(in)  :: Gin_V(:,:,:), plin(4), J_S1(4), J_S2(4), J_V(4), p3(4), plout(4)
  complex(qp), intent(out) :: Gtensor(:)
  complex(qp) :: SV(4), A(4), B(4), C, Jhalf(4), Jtwo(4), Ptmp(4,3)
  integer           :: l
...
!*******************************************************
  ...
  use ol_contractions_qp, only: cont_VV
  implicit none
  complex(qp), intent(in)  :: Gin(:,:,:), J_S1(4), J_S2(4), J_V3(4), J_V4(4)
  complex(qp), intent(out) :: Gtensor(:)
  complex(qp) :: SV4(4), SV3V4
  integer :: l
...
!*******************************************************
  ...
  use ol_contractions_qp, only: cont_VV
  implicit none
  complex(qp), intent(in)  :: Gin_V(:,:,:), pi(4), J_S1(4), J_S2(4), J_S3(4), po(4)
  complex(qp), intent(out) :: Gtensor(:)
  complex(qp) :: s2, pi2(4), po2(4), poS(4), pio2(4), pipoS, Gpo(4), Gin2(10), GinS
  integer :: l

  Gtensor = 0
  s2 = (0.5_qp * J_S1(1) * J_S2(1) * J_S3(1))
  pi2 = s2 * pi
  po2 = s2 * po
...
!*******************************************************
  ...
  use ol_contractions_qp, only: cont_VV
  implicit none
  complex(qp), intent(in)  :: Gin_V(:,:,:), plin(4), J_S1(4), J_S2(4), J_S3(4), J_V(4), p3(4), plout(4)
  complex(qp), intent(out) :: Gtensor(:)
  complex(qp) :: SV(4), A(4), B(4), C, Jhalf(4), Jtwo(4), Ptmp(4,3)
  integer           :: l
...
!*******************************************************
  ...
  use ol_contractions_qp, only: cont_VV
  implicit none
  complex(qp), intent(in)  :: Gin(:,:,:), J_S1(4), J_S2(4), J_S3(4), J_V3(4), J_V4(4)
  complex(qp), intent(out) :: Gtensor(:)
  complex(qp) :: SV4(4), SV3V4
  integer :: l
