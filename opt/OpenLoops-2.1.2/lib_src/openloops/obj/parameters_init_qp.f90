...
subroutine parameters_init()
  ...
  use ol_parameters_decl_dp, only: scalefactor_dp => scalefactor
...
subroutine init_kin_arrays(Npart)
  use ol_momenta_decl_qp, only: Q, L, QInvariantsMatrix
  use ol_external_decl_qp, only: P_ex, M_ex, binom2, crossing, inverse_crossing, gf_array, Ward_array
  use ol_external_decl_qp, only: allocatedNpart
  implicit none
...
subroutine init_kin_arrays_quad(Npart)
  use ol_momenta_decl_qp, only: Q_qp, L_qp, QInvariantsMatrix_qp
  use ol_external_decl_qp, only: P_ex, binom2, crossing, inverse_crossing, gf_array, Ward_array
  use ol_external_decl_qp, only: allocatedNpart
  implicit none
  integer, intent(in) :: Npart
  integer :: n_
...
subroutine clean_kin_arrays
  use ol_external_decl_qp, only: allocatedNpart
  use ol_momenta_decl_qp, only: Q, L, QInvariantsMatrix, Q_qp, QInvariantsMatrix_qp, L_qp
  use ol_external_decl_qp, only: P_ex, M_ex, binom2, crossing, inverse_crossing, gf_array, Ward_array
  implicit none
...
subroutine tensorrank_init(rank)
  ...
  use ol_tensor_storage_qp, only: tensor_stored, tensor_storage_maxrank
...
subroutine loop_parameters_init
  ...
  use ol_tensor_storage_qp, only: tensor_storage_maxrank
  use ol_parameters_decl_qp, only: pi2_6
  use ol_parameters_decl_qp, only: reset_scalefactor
  use ol_parameters_decl_dp, only: nosplash
  use ol_loop_parameters_decl_qp
  use ol_loop_parameters_decl_qp, only: scalefactor, mureg
  use ol_loop_parameters_decl_dp, only: reset_mureg, reset_olo
  ...
  use ol_loop_parameters_decl_dp, only: opprootsvalue, opprootsvalue_unscaled
...
subroutine qcd_parameters_init(is_loop_in)
  use ol_parameters_decl_qp, only: alpha_QCD, G2_QCD, gQCD, pi

  use ol_parameters_decl_dp, only: alpha_QCD_dp => alpha_QCD

  use ol_loop_parameters_decl_dp, only: muren_unscaled, do_qcd_renorm
  use ol_loop_parameters_decl_qp, only: muren, muren2, scalefactor
  use ol_qcd_renormalisation_qp, only: qcd_renormalisation
  implicit none
...
!#endif
  ...
  use ol_parameters_decl_dp, only: model, ew_scheme, ew_renorm_scheme, install_path
