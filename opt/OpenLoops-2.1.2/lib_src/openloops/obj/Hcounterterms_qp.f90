...
! **********************************************************************
  ...
  use KIND_TYPES_BW
  use ol_data_types_qp, only: wfun
  use ol_h_helicity_bookkeeping_qp, only: helbookkeeping_prop
  use ol_qcd_offshell_selfenergiesqp, only: quark_ofsse
  use ol_momenta_decl_qp, only: softconf
  use ol_parameters_decl_dp, only: bubble_vertex, ir_hacks
  use ol_contractions_qp, only: cont_VV
  use ol_kinematics_qp, only: get_LC_5, get_LC_mass2
...
! **********************************************************************
  ...
  use ol_data_types_qp, only: wfun
  use ol_h_helicity_bookkeeping_qp, only: helbookkeeping_prop
  use ol_qcd_offshell_selfenergiesqp, only: gluon_ofsse
  use ol_parameters_decl_dp, only: bubble_vertex
  use ol_kinematics_qp, only: get_LC_mass2, get_LC_4
  implicit none
  integer(intkind1), intent(in)    :: ntry
...
! **********************************************************************
  use kind_types, only: qp, intkind1, intkind2
  use ol_data_types_qp, only: wfun
  use ol_h_helicity_bookkeeping_qp, only: helbookkeeping_prop, checkzero_scalar
  use ol_contractions_qp, only: cont_V
  use ol_kinematics_qp, only: get_LC_4
  implicit none
  integer(intkind1), intent(in)    :: ntry
  integer(intkind2), intent(inout) :: n
  complex(qp), intent(in)    :: ctSS(2)
  integer,           intent(in)    :: mom
...
! **********************************************************************
  use kind_types, only: qp, intkind1, intkind2
  use ol_data_types_qp, only: wfun
  use ol_h_helicity_bookkeeping_qp, only: helbookkeeping_vert4
  use ol_contractions_qp, only: cont_VV
  implicit none
...
! **********************************************************************
  ...
  use KIND_TYPES_BW
  use ol_data_types_qp, only: wfun
  use ol_h_helicity_bookkeeping_qp, only: helbookkeeping_vert3
  implicit none
  integer(intkind1), intent(in)    :: ntry
...
! **********************************************************************
  ...
  complex(qp) :: J1J2(n(3)), P1J2(n(2)), P2J1(n(1))
...
! **********************************************************************
  ...
  use ol_contractions_qp, only: cont_VV
  use ol_data_types_qp, only: wfun
  use ol_h_helicity_bookkeeping_qp, only: helbookkeeping_vert4, checkzero_scalar
  implicit none
  integer(intkind1), intent(in)    :: ntry
  integer(intkind2), intent(inout) :: n(4), t(:,:)
...
! **********************************************************************
  use kind_types, only: qp, intkind1, intkind2
  use ol_data_types_qp, only: wfun
  use ol_h_helicity_bookkeeping_qp, only: helbookkeeping_vert3, checkzero_scalar
  use ol_contractions_qp, only: cont_VV
  implicit none
  integer(intkind1), intent(in)    :: ntry
  integer(intkind2), intent(inout) :: n(3), t(:,:)
...
end module ol_h_counterterms_qp
