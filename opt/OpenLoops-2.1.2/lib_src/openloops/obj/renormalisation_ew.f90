...
module ol_ew_renormalisation_dp
  use kind_types, only: dp, intkind1
  implicit none
  complex(dp), save      ::   IRrational = -1 ! Rational contribution from IR divergent fermion self energies
  contains
...
! **********************************************************************
  ...
  use ol_self_energy_integrals_dp

  implicit none
  integer, optional :: select_ew_renorm

  real(dp) :: deB_UV, deB_IR, deT_UV, deT_IR
  real(dp) :: eps=1.e-17
  logical :: zeromasses(6)  ! maximal allowed number of quarks

!for debugging with ABC
  real(dp), save         :: debug_norm = 1._dp

! self energies
  complex(dp), save      ::   Tadpole   = 0
  complex(dp), save      ::   SiW    = 0
  complex(dp), save      ::   SiW0  = 0
  complex(dp), save      ::   dSiW   = 0
  complex(dp), save      ::   SiZZ   = 0
  complex(dp), save      ::   dSiZZ  = 0
  complex(dp), save      ::   SiAZZ  = 0
  complex(dp), save      ::   dSiAZZ  = 0
  complex(dp), save      ::   SiAZ0  = 0
  complex(dp), save      ::   dSiAAheavy0  = 0
  complex(dp), save      ::   dSiAA0  = 0
  complex(dp), save      ::   PiAAlightZ  = 0
  complex(dp), save      ::   dAlphaQED_MZ = 0
  complex(dp), save      ::   dSiAAZ  = 0
  complex(dp), save      ::   SiH    = 0
  complex(dp), save      ::   dSiH   = 0
  complex(dp), save      ::   SitL   = 0
  complex(dp), save      ::   SitR   = 0
  complex(dp), save      ::   SitS   = 0
  complex(dp), save      ::   dSitL  = 0
  complex(dp), save      ::   dSitR  = 0
  complex(dp), save      ::   dSitS  = 0
  complex(dp), save      ::   SibL   = 0
  complex(dp), save      ::   SibR   = 0
  complex(dp), save      ::   SibS   = 0
  complex(dp), save      ::   dSibL  = 0
  complex(dp), save      ::   dSibR  = 0
  complex(dp), save      ::   dSibS  = 0
  complex(dp), save      ::   SiuL   = 0
  complex(dp), save      ::   SiuR   = 0
  complex(dp), save      ::   SidL   = 0
  complex(dp), save      ::   SidR   = 0
  complex(dp), save      ::   SieL   = 0
  complex(dp), save      ::   SieR   = 0
  complex(dp), save      ::   SieS   = 0
  complex(dp), save      ::   SimL   = 0
  complex(dp), save      ::   SimR   = 0
  complex(dp), save      ::   SimS   = 0
  complex(dp), save      ::   SinL   = 0
  complex(dp), save      ::   SinlL  = 0
  complex(dp), save      ::   SilL   = 0
  complex(dp), save      ::   SilR   = 0
  complex(dp), save      ::   SilS   = 0
  complex(dp), save      ::   dSilL  = 0
  complex(dp), save      ::   dSilR  = 0
  complex(dp), save      ::   dSilS  = 0
  complex(dp), save      ::   dSieL  = 0
  complex(dp), save      ::   dSieR  = 0
  complex(dp), save      ::   dSieS  = 0
  complex(dp), save      ::   dSimL  = 0
  complex(dp), save      ::   dSimR  = 0
  complex(dp), save      ::   dSimS  = 0

  complex(dp), save      ::   dSitLRS = 0
  complex(dp), save      ::   dSibLRS = 0
  complex(dp), save      ::   dSilLRS = 0
  complex(dp), save      ::   dSieLRS = 0
  complex(dp), save      ::   dSimLRS = 0

! one-point functions
  complex(dp), save      ::   A0W = 0
  complex(dp), save      ::   A0Z = 0
  complex(dp), save      ::   A0H = 0
  complex(dp), save      ::   A0T = 0
  complex(dp), save      ::   A0B = 0
  complex(dp), save      ::   A0L = 0

! two-point
  complex(dp), save      ::  B0000   = 0
  complex(dp), save      ::  B00WW   = 0
  complex(dp), save      ::  dB00WW  = 0
  complex(dp), save      ::  B00W0   = 0
  complex(dp), save      ::  dB00W0  = 0
  complex(dp), save      ::  B0WW0   = 0
  complex(dp), save      ::  dB0WW0  = 0
  complex(dp), save      ::  B0ZWW   = 0
  complex(dp), save      ::  dB0ZWW  = 0
  complex(dp), save      ::  B00HH   = 0
  complex(dp), save      ::  B00ZZ   = 0
  complex(dp), save      ::  B0ZZH   = 0
  complex(dp), save      ::  dB0ZZH  = 0
  complex(dp), save      ::  dB00ZH  = 0
  complex(dp), save      ::  B00ZH   = 0
  complex(dp), save      ::  B00WH   = 0
  complex(dp), save      ::  dB00WH  = 0
  complex(dp), save      ::  B0WWH   = 0
  complex(dp), save      ::  dB0WWH  = 0
  complex(dp), save      ::  B00WZ   = 0
  complex(dp), save      ::  dB00WZ  = 0
  complex(dp), save      ::  B0WWZ   = 0
  complex(dp), save      ::  dB0WWZ  = 0
  complex(dp), save      ::  B0HHH   = 0
  complex(dp), save      ::  dB0HHH  = 0
  complex(dp), save      ::  B0HWW   = 0
  complex(dp), save      ::  dB0HWW  = 0
  complex(dp), save      ::  B0HZZ   = 0
  complex(dp), save      ::  dB0HZZ  = 0
  complex(dp), save      ::  B0BTW   = 0
  complex(dp), save      ::  dB0BTW  = 0
  complex(dp), save      ::  B0TBW   = 0
  complex(dp), save      ::  dB0TBW  = 0
  complex(dp), save      ::  B0WTB   = 0
  complex(dp), save      ::  dB0WTB  = 0
  complex(dp), save      ::  B1TBW   = 0
  complex(dp), save      ::  dB1TBW  = 0
  complex(dp), save      ::  B1BTW   = 0
  complex(dp), save      ::  dB1BTW  = 0
  complex(dp), save      ::  B0TT0   = 0
  complex(dp), save      ::  dB0TT0  = 0
  complex(dp), save      ::  B00TT   = 0
  complex(dp), save      ::  dB00TT  = 0
  complex(dp), save      ::  B1TT0   = 0
  complex(dp), save      ::  dB1TT0  = 0
  complex(dp), save      ::  B0TTZ   = 0
  complex(dp), save      ::  dB0TTZ  = 0
  complex(dp), save      ::  B1TTZ   = 0
  complex(dp), save      ::  dB1TTZ  = 0
  complex(dp), save      ::  B0ZTT  = 0
  complex(dp), save      ::  dB0ZTT  = 0
  complex(dp), save      ::  B0TTH   = 0
  complex(dp), save      ::  dB0TTH  = 0
  complex(dp), save      ::  B0HTT   = 0
  complex(dp), save      ::  dB0HTT  = 0
  complex(dp), save      ::  B1TTH   = 0
  complex(dp), save      ::  dB1TTH  = 0
  complex(dp), save      ::  B0BB0   = 0
  complex(dp), save      ::  dB0BB0  = 0
  complex(dp), save      ::  B00BB   = 0
  complex(dp), save      ::  dB00BB  = 0
  complex(dp), save      ::  B1BB0   = 0
  complex(dp), save      ::  dB1BB0  = 0
  complex(dp), save      ::  B0BBZ   = 0
  complex(dp), save      ::  dB0BBZ  = 0
  complex(dp), save      ::  B1BBZ   = 0
  complex(dp), save      ::  dB1BBZ  = 0
  complex(dp), save      ::  B0BBH   = 0
  complex(dp), save      ::  dB0BBH  = 0
  complex(dp), save      ::  B0HBB   = 0
  complex(dp), save      ::  dB0HBB  = 0
  complex(dp), save      ::  B1BBH   = 0
  complex(dp), save      ::  dB1BBH  = 0
  complex(dp), save      ::  B00TB   = 0
  complex(dp), save      ::  dB00TB  = 0
  complex(dp), save      ::  B100W   = 0
  complex(dp), save      ::  B1000   = 0
  complex(dp), save      ::  B100Z   = 0
  complex(dp), save      ::  B0Z00   = 0
  complex(dp), save      ::  dB0Z00  = 0
  complex(dp), save      ::  B0W00   = 0
  complex(dp), save      ::  dB0W00  = 0
  complex(dp), save      ::  B0ZBB   = 0
  complex(dp), save      ::  dB0ZBB  = 0

  complex(dp), save      ::  B0L0W   = 0
  complex(dp), save      ::  dB0L0W  = 0
  complex(dp), save      ::  B0W0L  = 0
  complex(dp), save      ::  dB0W0L  = 0
  complex(dp), save      ::  B10LW   = 0
  complex(dp), save      ::  dB10LW  = 0
  complex(dp), save      ::  B1L0W   = 0
  complex(dp), save      ::  dB1L0W  = 0
  complex(dp), save      ::  B0LL0   = 0
  complex(dp), save      ::  dB0LL0  = 0
  complex(dp), save      ::  B00LL   = 0
  complex(dp), save      ::  dB00LL  = 0
  complex(dp), save      ::  B1LL0   = 0
  complex(dp), save      ::  dB1LL0  = 0
  complex(dp), save      ::  B0LLZ   = 0
  complex(dp), save      ::  dB0LLZ  = 0
  complex(dp), save      ::  B1LLZ   = 0
  complex(dp), save      ::  dB1LLZ  = 0
  complex(dp), save      ::  B0LLH   = 0
  complex(dp), save      ::  dB0LLH  = 0
  complex(dp), save      ::  B0HLL   = 0
  complex(dp), save      ::  dB0HLL  = 0
  complex(dp), save      ::  B1LLH   = 0
  complex(dp), save      ::  dB1LLH  = 0
  complex(dp), save      ::  B000L   = 0
  complex(dp), save      ::  dB000L  = 0
  complex(dp), save      ::  B0ZLL   = 0
  complex(dp), save      ::  dB0ZLL  = 0
  
!   for massive electron
  complex(dp), save      ::  B0EE0   = 0
  complex(dp), save      ::  dB0EE0  = 0
!   complex(dp), save      ::  B00EE   = 0
!   complex(dp), save      ::  dB00EE  = 0
  complex(dp), save      ::  B1EE0   = 0
  complex(dp), save      ::  dB1EE0  = 0
  complex(dp), save      ::  B0EEZ   = 0
  complex(dp), save      ::  dB0EEZ  = 0
  complex(dp), save      ::  B1EEZ   = 0
  complex(dp), save      ::  dB1EEZ  = 0
!   for massive muon
  complex(dp), save      ::  B0MM0   = 0
  complex(dp), save      ::  dB0MM0  = 0
!   complex(dp), save      ::  B00MM   = 0
!   complex(dp), save      ::  dB00MM  = 0
  complex(dp), save      ::  B1MM0   = 0
  complex(dp), save      ::  dB1MM0  = 0
  complex(dp), save      ::  B0MMZ   = 0
  complex(dp), save      ::  dB0MMZ  = 0
  complex(dp), save      ::  B1MMZ   = 0
  complex(dp), save      ::  dB1MMZ  = 0

  complex(dp), save      ::  Va0Z0Z00 = 0
  complex(dp), save      ::  Va0Z0W00 = 0
  complex(dp), save      ::  Vb0Z00WW = 0
  complex(dp), save      ::  C00Z0Z00 = 0
  complex(dp), save      ::  C10Z0Z00 = 0
  complex(dp), save      ::  C20Z0Z00 = 0
  complex(dp), save      ::  C00Z0W00 = 0
  complex(dp), save      ::  C10Z0W00 = 0
  complex(dp), save      ::  C20Z0W00 = 0
  complex(dp), save      ::  C00Z00WW = 0
  complex(dp), save      ::  C10Z00WW = 0
  complex(dp), save      ::  C20Z00WW = 0

  complex(dp), save      ::   cTW = 0
  complex(dp), save      ::   cTZ = 0
  complex(dp), save      ::   cTAZ = 0
  complex(dp), save      ::   cTH = 0
  complex(dp), save      ::   cTT = 0
  complex(dp), save      ::   cTB = 0
  complex(dp), save      ::   cTL = 0
  complex(dp), save      ::   cTe = 0
  complex(dp), save      ::   cTmu = 0

!  complex(dp), save      ::   lambda  = 0   ! fictous photon mass. Not used atm.

  complex(dp), save      ::   dZuLPole   = 0.
  complex(dp), save      ::   dZuRPole   = 0.
  complex(dp), save      ::   dZtLPole   = 0.
  complex(dp), save      ::   dZtRPole   = 0.

  complex(dp), save      ::   dZeQEDEWPole, dcwEWPole, dswEWPole, dZAAEWPole, dZZAEWPole, dZAZEWPole
  complex(dp), save      ::   dZMZ2EWPole, dZMW2EWPole, dZZZEWPole, dZWEWPole
...
! Do not use complex masses if CMS is not used --> only for debug & model=sm_vaux
  if ( cms_on == 0 ) then
    call masspowers(rME, 0._dp, ME, ME2, rME2)
    call masspowers(rMM, 0._dp, MM, MM2, rMM2)
    call masspowers(rML, 0._dp, ML, ML2, rML2)
    call masspowers(rMU, 0._dp, MU, MU2, rMU2)
    call masspowers(rMD, 0._dp, MD, MD2, rMD2)
    call masspowers(rMS, 0._dp, MS, MS2, rMS2)
    call masspowers(rMC, 0._dp, MC, MC2, rMC2)
    call masspowers(rMB, 0._dp, MB, MB2, rMB2)
    call masspowers(rMT, 0._dp, MT, MT2, rMT2)
    call masspowers(rMW, 0._dp, MW, MW2, rMW2)
    call masspowers(rMZ, 0._dp, MZ, MZ2, rMZ2)
    call masspowers(rMH, 0._dp, MH, MH2, rMH2)
  end if
  ...
  ! calculate renormalisation constants
    ...
    if (weak_on) then
      ...
      dSiW=dSiW+(-2*(1._dp/3. + 5*B0WW0 + (MW2**2*(-B00W0 + B0WW0))/rMW2**2  &
          - (MW2**2*dB0WW0)/rMW2 + (2*MW2 + 5*rMW2)*dB0WW0))/3. &
          - (-2._dp/3. - B0WWH + ((-MH2 + MW2)**2*(-B00WH + B0WWH))/rMW2**2 &
  ...
  !This is the fermionic part based on page 105-107 from Denner92
   ...
   if (photon_selfenergy .and. qed_on) then
        ...
        if (nfa > 0) PiAAlightZ=PiAAlightZ - 4.*rMZ2*(1._dp/3. - B0Z00)/3.       ! e-lepton
        if (nfa > 1) PiAAlightZ=PiAAlightZ - 4.*rMZ2*(1._dp/3. - B0Z00)/3.       ! mu-lepton
        if (nfa > 2) PiAAlightZ=PiAAlightZ - 4.*(rMZ2*(1._dp/3. - B0ZLL) - 2.*ML2*(B0ZLL-B00LL))/3.  ! tau-lepton
        if (nfa > 3) PiAAlightZ=PiAAlightZ - 2*20*nc*rMZ2*(1._dp/3. - B0Z00)/27.        ! light-quarks
        if (nfa > 3) PiAAlightZ=PiAAlightZ -    4*nc*(rMZ2*(1._dp/3. - B0ZBB) - 2.*MB2*(B0ZBB-B00BB))/27. ! b-quark
        ...
        if (nfa > 0) dSiAA0=dSiAA0+4._dp/3.*(B0000) ! e-leptons
        if (nfa > 1) dSiAA0=dSiAA0+4._dp/3.*(B0000) ! mu-leptons
        if (nfa > 2) dSiAA0=dSiAA0+4._dp/3.*(B00LL) ! tau-leptons
        if (nfa > 3) dSiAA0=dSiAA0+4._dp/3.*nc*1._dp/9*( 2.*B0000) ! down-quarks
        if (nfa > 3) dSiAA0=dSiAA0+4._dp/3.*nc*4._dp/9*( 2.*B0000) ! up-quarks
        if (nfa > 3) dSiAA0=dSiAA0+4._dp/3.*nc*1._dp/9*( B00BB )   ! b-quark
        if (nfa > 4) dSiAA0=dSiAA0+4._dp/3.*nc*4._dp/9*( B00TT )   ! t-quark
    end if
    ...
    if (weak_on) then
      ...
      dSiAAZ=dSiAAZ &
           - 2.*4.*(1._dp/3.-B0Z00-rMZ2*dB0Z00)/3. &               ! light-leptons
           -        4.*(1._dp/3.-B0ZLL-(2.*ML2+rMZ2)*dB0ZLL)/3. &  ! tau-lepton
           - 2.*20.*nc*(1._dp/3.-B0Z00-rMZ2*dB0Z00)/27. &          ! light-quarks
           -     4.*nc*(1._dp/3.-B0ZBB-(2.*MB2+rMZ2)*dB0ZBB)/27. & ! b-quark
           -    16.*nc*(1._dp/3.-B0ZTT-(2.*MT2+rMZ2)*dB0ZTT)/27.   ! t-quark
...
!      SiAZ0=SiAZ0+0 !no fermionic contribution
      ...
      SiAZZ=SiAZZ-2._dp/3.*( &
          ...
          - 2.*nc*(rMZ2/3. - rMZ2*B0Z00)*(gZu(1) + gZu(2))*2._dp/3. & ! up-quark
          +   nc*(rMZ2/3. + 2*MB2*B00BB + (-2*MB2 - rMZ2)*B0ZBB)*(gZd(1) + gZd(2))/3. &     ! b-quark
          -   nc*(rMZ2/3. + 2*MT2*B00TT + (-2*MT2 - rMZ2)*B0ZTT)*(gZu(1) + gZu(2))*2._dp/3. &  ! top-quark
          )

      dSiAZZ=dSiAZZ-2._dp/9.*( &
          ...
          + 2.*nc*(-1 + 3*B0Z00 + 3*rMZ2*dB0Z00)*(gZu(1) + gZu(2))*2._dp/3. & ! up-quark
          -    nc*(-1 + 3*B0ZBB + 3*(2*MB2 + rMZ2)*dB0ZBB)*(gZd(1) + gZd(2))/3. & ! b-quark
          +    nc*(-1 + 3*B0ZTT + 3*(2*MT2 + rMZ2)*dB0ZTT)*(gZu(1) + gZu(2))*2._dp/3. & ! top-quark
         )
      ...
      dSiW=dSiW+( &
           - 2*(1._dp/3.- B0W00 - rMW2*dB0W00) & ! light-leptons
           - 1._dp/2.*(2._dp/3.+ ML2**2*(B000L - B0W0L)/rMW2**2 - 2*B0W0L & ! heavy-leptons
                    +  ML2**2*dB0W0L/rMW2 + (ML2 - 2*rMW2)*dB0W0L) &
           - 2*nc*(1._dp/3. - B0W00 - rMW2*dB0W00) & ! light-quark
           -   nc/2.*(2._dp/3. + ((MB2 - MT2)**2* (B00TB - B0WTB))/rMW2**2 - 2*B0WTB & ! heavy-quark
...
!   dZeREW = -SieR
  ...
  if (cms_on == 0) then ! on-shell
    ...
    cTT    = -(rMT2-MT2)*dSitLRS+(rMT2-MT2)/rMT2*4._dp/9.*4. ! 1st order expansion & C^t term
  ...
  if (MB /= 0._dp) then
    ...
    if (cms_on == 0) then ! on-shell
      ...
      cTB     = -(rMB2-MB2)*dSibLRS+(rMB2-MB2)/rMB2*1._dp/9.*4 ! 1st order expansion & C^b term
...
! weak mixing angle
  if (ew_renorm_scheme == 20 .or. ew_renorm_scheme == 21 .or. ew_renorm_scheme == 22) then ! sinTheta2 schemes from 1906.11569
    ...
    dVLEW = gZl(2)**2*Va0Z0Z00+0.5_dp/sw2*gZn(2)/gZl(2)*Va0Z0W00-cw/sw3/2./gZl(2)*Vb0Z00WW
...
! calculate counterterms & R2
  ...
  sumMQ2Q2 = 4._dp/9.*MU2 + 1._dp/9.*MD2 + 4._dp/9.*MS2 + 1._dp/9.*MC2
  sumMQ2QI = 2._dp/6.*MU2 + 1._dp/6.*MD2 + 2._dp/6.*MS2 + 1._dp/6.*MC2
  sumMQ2QUD = 2._dp/3.*MD2+1._dp/3.*MU2 + 2._dp/3.*MS2+1._dp/3.*MC2   ! Sum(Qu*mD2 - Qd*mU2)
  ...
  if (nf > 4) then
    sumMQ2 = sumMQ2 + MB2
    sumMQ2Q2 = sumMQ2Q2 + 1._dp/9.*MB2
    sumMQ2QI = sumMQ2QI + 1._dp/6.*MB2
    sumMQ2QUD = sumMQ2QUD + 2._dp/3.*MB2
    sumMQ4 = sumMQ4 + MB2**2
    sumMD2 = sumMD2 + MB2
    sumMD4 = sumMD4 + MB2**2
  end if
  if (nf > 5) then
    sumMQ2 = sumMQ2 + MT2
    sumMQ2Q2 = sumMQ2Q2 + 4._dp/9.*MT2
    sumMQ2QI = sumMQ2QI + 2._dp/6.*MT2
    sumMQ2QUD = sumMQ2QUD + 1._dp/3.*MT2
    sumMQ4 = sumMQ4 + MT2**2
    sumMUD = sumMUD + MT*MB
...
!    EWctPW = (dZWEW + dZMW2EW/MW2)
    ...
    ! Aff
    EWctAuu  = [ -2._dp/3. * (dZeQEDEW + 0.5*dZAAEW + 0.5*(dZuREW+dZuREWcc))  + gZu(1)/2.*dZZAEW , &
                 -2._dp/3. * (dZeQEDEW + 0.5*dZAAEW + 0.5*(dZuLEW+dZuLEWcc))  + gZu(2)/2.*dZZAEW ]
    EWctAdd  = [  1._dp/3. * (dZeQEDEW + 0.5*dZAAEW + 0.5*(dZdREW+dZdREWcc))  + gZd(1)/2.*dZZAEW , &
                  1._dp/3. * (dZeQEDEW+  0.5*dZAAEW + 0.5*(dZdLEW+dZdLEWcc))  + gZd(2)/2.*dZZAEW ]
    EWctAtt  = [ -2._dp/3. * (dZeQEDEW + 0.5*dZAAEW + 0.5*(dZtREW+dZtREWcc))  + gZu(1)/2.*dZZAEW , &
                 -2._dp/3. * (dZeQEDEW + 0.5*dZAAEW + 0.5*(dZtLEW+dZtLEWcc))  + gZu(2)/2.*dZZAEW ]
    EWctAbb  = [  1._dp/3. * (dZeQEDEW + 0.5*dZAAEW + 0.5*(dZbREW+dZbREWcc))  + gZd(1)/2.*dZZAEW , &
                  1._dp/3. * (dZeQEDEW + 0.5*dZAAEW + 0.5*(dZbLEW+dZbLEWcc))  + gZd(2)/2.*dZZAEW ]
    ...
    EWctVuu  = [ dgZu(1) + gZu(1) * (0.5*dZZZEW + 0.5*(dZuREW+dZuREWcc)) - 2._dp/6.*dZAZEW , &
                 dgZu(2) + gZu(2) * (0.5*dZZZEW + 0.5*(dZuLEW+dZuLEWcc)) - 2._dp/6.*dZAZEW ]
    EWctVdd  = [ dgZd(1) + gZd(1) * (0.5*dZZZEW + 0.5*(dZdREW+dZdREWcc)) + 1._dp/6.*dZAZEW , &
                 dgZd(2) + gZd(2) * (0.5*dZZZEW + 0.5*(dZdLEW+dZdLEWcc)) + 1._dp/6.*dZAZEW ]
    EWctVtt  = [ dgZu(1) + gZu(1) * (0.5*dZZZEW + 0.5*(dZtREW+dZtREWcc)) - 2._dp/6.*dZAZEW , &
                 dgZu(2) + gZu(2) * (0.5*dZZZEW + 0.5*(dZtLEW+dZtLEWcc)) - 2._dp/6.*dZAZEW ]
    EWctVbb  = [ dgZd(1) + gZd(1) * (0.5*dZZZEW + 0.5*(dZbREW+dZbREWcc)) + 1._dp/6.*dZAZEW , &
                 dgZd(2) + gZd(2) * (0.5*dZZZEW + 0.5*(dZbLEW+dZbLEWcc)) + 1._dp/6.*dZAZEW ]
...
! twopoint
        if (photon_selfenergy) then
          EWctAA=EWctAA+[cONE*(-3. - (10._dp*nc)/9.), &
               2.*MW2 + 4*nc*sumMQ2Q2 + 4*sumML2Q2,cONE*(2._dp/3.)]
        end if
...
! four-point
        if (qed_on) then
          EWctR2AAAA=4._dp/3*(2._dp + (17*nc)/27._dp)

          EWctR2AAAZ=-1/(cw*sw) + (4*cw)/(3.*sw) - nc/(3.*cw*sw) + &
                 (4*sw)/cw + (68*nc*sw)/(81.*cw)

          EWctR2AAZZ=4._dp/3 - 2._dp/cw2 - (2*nc)/(3.*cw2) - &
                 4._dp/(3.*sw2) + 1._dp/(2.*cw2*sw2) &
                  + (5*nc)/(18.*cw2*sw2) + (4*sw2)/cw2 + (68*nc*sw2)/(81.*cw2)

          EWctR2AZZZ=(-4*cw)/(3.*sw) + 3._dp/(2.*cw3*sw) + (5*nc)/(6.*cw3*sw) - &
                 (3*sw)/cw3 - (nc*sw)/cw3 + (4*cw)/(3.*sw3) - 1._dp/(4.*cw3*sw3) - &
                 nc/(4.*cw3*sw3) + (4*sw3)/cw3 + (68*nc*sw3)/(81.*cw3)

          EWctR2ZZZZ=-4._dp/3. + 3/cw4 + (5*nc)/(3.*cw4) + 8/(3.*sw2) - &
        ...
        if (weak_on) then
          ...
          EWctAAPP=EWctAAPP-1._dp/12. - 11/(6.*sw2) - sw2/(12.*cw2) &
...
! ****************************************************************************************
  ...
  use ol_parameters_decl_dp, only: alpha_QED, alpha_QED_0, alpha_QED_Gmu, pi
  use ol_loop_parameters_decl_dp, only: countertermnorm, &
                                              & dZeQEDEW, dZe0QEDEWnreg, dZe0QEDEWdreg, dZeGmuQEDEW, &
                                              & dZAAEW, dZAAEWdreg
  implicit none
  integer, intent(in) :: photonid(:)
  integer, intent(in) :: ew_renorm
  real(dp),  intent(out) :: bornfactor
  real(dp),  intent(out), optional :: loopfactor
...
end module ol_ew_renormalisation_dp
