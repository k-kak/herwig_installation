...
! **********************************************************************
  ...
  complex(dp), intent(in)  :: G_A(4,rank_in), K(5), M
...
! **********************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(dp), intent(in)  :: G_Q(4,rank_in), K(5), M
  complex(dp), intent(inout) :: Gout_Q(4,rank_out)
  integer :: l
...
end module ol_loop_propagators_dp
...
! **********************************************************************
  use kind_types, only: dp
  use ol_loop_propagators_dp
  implicit none
  complex(dp), intent(in)  :: Gin(:,:,:), K(5), M
  complex(dp), intent(out) :: Gout(:,:,:)
...
end module ol_prop_interface_dp
