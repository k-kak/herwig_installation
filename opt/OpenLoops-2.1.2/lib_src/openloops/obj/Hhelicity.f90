...
module ol_h_helicity_bookkeeping_dp
  implicit none
  contains
...
! **********************************************************************
  ...
  use ol_generic, only: to_string
  use ol_debug, only: ol_error, ol_fatal
  use ol_data_types_dp, only: wfun, polcont, Hpolcont
  implicit none
...
! **********************************************************************
  ...
  use ol_generic, only: to_string
  use ol_debug, only: ol_error, ol_fatal
  use ol_data_types_dp, only: polcont, Hpolcont
  implicit none
  integer(intkind1), intent(in)    :: nsync
...
end module ol_h_helicity_bookkeeping_dp
