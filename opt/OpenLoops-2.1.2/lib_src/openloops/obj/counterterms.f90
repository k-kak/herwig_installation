...
! **********************************************************************
  ...
  use ol_contractions_dp, only: cont_V
  implicit none
  complex(dp), intent(in)  :: ctSV, J_S(4), K(4)
  complex(dp), intent(out) :: Jout_V(4)
  Jout_V =  - ctSV * K * J_S(1)
...
! **********************************************************************
  ...
  use ol_contractions_dp, only: cont_V
  implicit none
  complex(dp), intent(in)  :: ctSV, J_V(4), K(4)
  complex(dp), intent(out) :: Jout_S(4)
...
!   implicit none
!
!   complex(dp), intent(in)  :: J_V1(4), J_V2(4), J_V3(4), ctWWVV(3)
!   complex(dp), intent(out) :: Jout_V(4)
!   complex(dp) :: J1J2, J1J3, J2J3
!
!   J1J2 = cont_VV(J_V1, J_V2)
...
! **********************************************************************
  use kind_types, only: dp
  use ol_contractions_dp, only: cont_VV, cont_V
  implicit none
  real(dp), intent(in)     :: f(5)
  complex(dp), intent(in)  :: S(4), V2(4), P2(4), P3(4)
  complex(dp), intent(out) :: V_out(4)
  complex(dp) :: P3V2, P2V2  ,  P2P3, P2P2, P3P3
  P3V2 = cont_VV(P3,V2)
  P2V2 = cont_VV(P2,V2)
...
! **********************************************************************
  ...
  implicit none
  real(dp), intent(in)     :: f(5)
  complex(dp), intent(in)  :: V1(4), P1(4), V2(4), P2(4)
  complex(dp), intent(out) :: S_out(4)
  complex(dp) :: P1V1, P2V2, P1V2, P2V1  ,  V1V2, P1P2, P1P1, P2P2
  P1V1 = cont_VV(P1,V1)
  P2V2 = cont_VV(P2,V2)
  P1V2 = cont_VV(P1,V2)
  P2V1 = cont_VV(P2,V1)
...
! **********************************************************************
  ...
  use ol_contractions_dp, only: cont_VV
  implicit none
  complex(dp), intent(in)  :: V1(4), P1(4), V2(4), P2(4), V3(4), P3(4)
  complex(dp), intent(out) :: S_out(4)
...
! **********************************************************************
  ...
  use ol_contractions_dp, only: cont_VV
  implicit none
  complex(dp), intent(in)  :: S(4), V2(4), P2(4), V3(4), P3(4), P4(4)
  complex(dp), intent(out) :: V_out(4)
...
! **********************************************************************
  ...
  use ol_contractions_dp, only: cont_VV
  implicit none
  complex(dp), intent(in)  :: S(4), V2(4), V3(4), V4(4)
  complex(dp), intent(out) :: V_out(4)
...
! **********************************************************************
  ...
  use ol_contractions_dp, only: cont_VV
  implicit none
  complex(dp), intent(in)  :: V1(4), V2(4), V3(4), V4(4)
  complex(dp), intent(out) :: S_out(4)
...
! **********************************************************************
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: JA(4), PA(4), JQ(4), PQ(4)
  complex(dp), intent(out) :: S_out(4)
  complex(dp) :: P(4)
  P = PQ-PA
...
! **********************************************************************
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: JQ(4), PQ(4), S(4), PA(4)
  complex(dp), intent(out) :: JA_out(4)
  complex(dp) :: P(4)
  P = PQ+PA
...
! **********************************************************************
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: S(4), JA(4), PA(4), PQ(4)
  complex(dp), intent(out) :: JQ_out(4)
  complex(dp) :: P(4)
  P = -PQ-PA
...
! **********************************************************************
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: S(4), J_Q(4), J_A(4)
  complex(dp), intent(out) :: Jout_V(4)
  Jout_V(1) = - J_A(1)*J_Q(3) - J_A(4)*J_Q(2)
  Jout_V(2) = - J_A(2)*J_Q(4) - J_A(3)*J_Q(1)
  Jout_V(3) = - J_A(1)*J_Q(4) + J_A(3)*J_Q(2)
...
! **********************************************************************
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: J_V(4), S(4), J_Q(4)
  complex(dp), intent(out) :: Jout_Q(4)
  Jout_Q(1) = - J_V(2)*J_Q(3)+J_V(4)*J_Q(4)
  Jout_Q(2) = - J_V(1)*J_Q(4)+J_V(3)*J_Q(3)
  Jout_Q(3) = - J_V(1)*J_Q(1)-J_V(4)*J_Q(2)
...
! **********************************************************************
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: J_A(4), J_V(4), S(4)
  complex(dp), intent(out) :: Jout_A(4)
  Jout_A(1) = - J_V(1)*J_A(3) - J_V(3)*J_A(4)
  Jout_A(2) = - J_V(2)*J_A(4) - J_V(4)*J_A(3)
  Jout_A(3) = - J_V(2)*J_A(1) + J_V(3)*J_A(2)
...
! **********************************************************************
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: J_Q(4), J_A(4), J_V(4)
  complex(dp), intent(out) :: S_out(4)
...
! **********************************************************************
  ...
  implicit none
  real(dp), intent(in)     :: f(5)
  complex(dp), intent(in)  :: S1(4), S2(4), V2(4), P2(4), P3(4)
  complex(dp), intent(out) :: V_out(4)
  complex(dp) :: P3V2, P2V2
  P3V2 = cont_VV(P3,V2)
  P2V2 = cont_VV(P2,V2)
  V_out = P3*(-f(1)*P2V2+f(3)*P3V2) + P2*(-f(2)*P3V2+f(3)*P2V2) &
...
! **********************************************************************
  ...
  implicit none
  real(dp), intent(in)     :: f(5)
  complex(dp), intent(in)  :: S_in(4), V1(4), P1(4), V2(4), P2(4)
  complex(dp), intent(out) :: S_out(4)
  complex(dp) :: P1V1, P2V2, P1V2, P2V1
  P1V1 = cont_VV(P1,V1)
  P2V2 = cont_VV(P2,V2)
  P1V2 = cont_VV(P1,V2)
  P2V1 = cont_VV(P2,V1)
...
! **********************************************************************
  ...
  use ol_contractions_dp, only: cont_VV
  implicit none
  complex(dp), intent(in)  :: S_in(4), V1(4), P1(4), V2(4), P2(4), V3(4), P3(4)
  complex(dp), intent(out) :: S_out(4)
  S_out(1) = cont_VV(V1,V2)*cont_VV(P1-P2,V3) + cont_VV(V2,V3)*cont_VV(P2-P3,V1) + cont_VV(V3,V1)*cont_VV(P3-P1,V2)
  S_out(1) = S_out(1)*S_in(1)
...
! **********************************************************************
  ...
  use ol_contractions_dp, only: cont_VV
  implicit none
  complex(dp), intent(in)  :: S1(4), S2(4), V2(4), P2(4), V3(4), P3(4), P4(4)
  complex(dp), intent(out) :: V_out(4)
...
! **********************************************************************
  ...
  use ol_contractions_dp, only: cont_VV
  implicit none
  complex(dp), intent(in)  :: S1(4), S2(4), V2(4), V3(4), V4(4)
  complex(dp), intent(out) :: V_out(4)
...
! **********************************************************************
  ...
  use ol_contractions_dp, only: cont_VV
  implicit none
  complex(dp), intent(in)  :: S1(4), V1(4), V2(4), V3(4), V4(4)
  complex(dp), intent(out) :: S_out(4)
...
! **********************************************************************
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: S_in(4), JA(4), PA(4), JQ(4), PQ(4)
  complex(dp), intent(out) :: S_out(4)
  complex(dp) :: P(4)
  P = PQ-PA
  S_out(1) = (-JA(3)*P(1)-JA(4)*P(3))*JQ(1) + (-JA(4)*P(2)-JA(3)*P(4))*JQ(2) &
...
! **********************************************************************
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: JQ(4), PQ(4), S1(4), S2(4), PA(4)
  complex(dp), intent(out) :: JA_out(4)
  complex(dp) :: P(4)
  P = PQ+PA
  JA_out(1) = - P(2)*JQ(3) + P(4)*JQ(4)
...
! **********************************************************************
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: S1(4), S2(4), JA(4), PA(4), PQ(4)
  complex(dp), intent(out) :: JQ_out(4)
  complex(dp) :: P(4)
  P = -PQ-PA
  JQ_out(1) = -JA(3)*P(1)-JA(4)*P(3)
...
! **********************************************************************
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: S1(4), S2(4), J_Q(4), J_A(4)
  complex(dp), intent(out) :: Jout_V(4)
  Jout_V(1) = - J_A(1)*J_Q(3) - J_A(4)*J_Q(2)
  Jout_V(2) = - J_A(2)*J_Q(4) - J_A(3)*J_Q(1)
  Jout_V(3) = - J_A(1)*J_Q(4) + J_A(3)*J_Q(2)
...
! **********************************************************************
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: J_V(4), S1(4), S2(4), J_Q(4)
  complex(dp), intent(out) :: Jout_Q(4)
  Jout_Q(1) = - J_V(2)*J_Q(3)+J_V(4)*J_Q(4)
  Jout_Q(2) = - J_V(1)*J_Q(4)+J_V(3)*J_Q(3)
  Jout_Q(3) = - J_V(1)*J_Q(1)-J_V(4)*J_Q(2)
...
! **********************************************************************
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: J_A(4), J_V(4), S1(4), S2(4)
  complex(dp), intent(out) :: Jout_A(4)
  Jout_A(1) = - J_V(1)*J_A(3) - J_V(3)*J_A(4)
  Jout_A(2) = - J_V(2)*J_A(4) - J_V(4)*J_A(3)
  Jout_A(3) = - J_V(2)*J_A(1) + J_V(3)*J_A(2)
...
! **********************************************************************
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: S_in(4), J_Q(4), J_A(4), J_V(4)
  complex(dp), intent(out) :: S_out(4)
  S_out(1) = (-J_A(3)*J_V(1)-J_A(4)*J_V(3))*J_Q(1) + (-J_A(4)*J_V(2)-J_A(3)*J_V(4))*J_Q(2) &
         & + (-J_A(1)*J_V(2)+J_A(2)*J_V(3))*J_Q(3) + (-J_A(2)*J_V(1)+J_A(1)*J_V(4))*J_Q(4)
  S_out(1) = S_out(1)*S_in(1)
...
! **********************************************************************
  ...
  implicit none
  real(dp), intent(in)     :: f(5)
  complex(dp), intent(in)  :: S1(4), S2(4), S3(4), V2(4), P2(4), P3(4)
  complex(dp), intent(out) :: V_out(4)
  complex(dp) :: P3V2, P2V2
  P3V2 = cont_VV(P3,V2)
  P2V2 = cont_VV(P2,V2)
...
! **********************************************************************
  ...
  implicit none
  real(dp), intent(in)     :: f(5)
  complex(dp), intent(in)  :: S1(4), S2(4), V1(4), P1(4), V2(4), P2(4)
  complex(dp), intent(out) :: S_out(4)
  complex(dp) :: P1V1, P2V2, P1V2, P2V1
  P1V1 = cont_VV(P1,V1)
  P2V2 = cont_VV(P2,V2)
...
! **********************************************************************
  ...
  use ol_contractions_dp, only: cont_VV
  implicit none
  complex(dp), intent(in)  :: S1(4), S2(4), V1(4), P1(4), V2(4), P2(4), V3(4), P3(4)
  complex(dp), intent(out) :: S_out(4)
  S_out(1) = cont_VV(V1,V2)*cont_VV(P1-P2,V3) + cont_VV(V2,V3)*cont_VV(P2-P3,V1) + cont_VV(V3,V1)*cont_VV(P3-P1,V2)
  S_out(1) = S_out(1)*S1(1)*S2(1)
...
! **********************************************************************
  ...
  use ol_contractions_dp, only: cont_VV
  implicit none
  complex(dp), intent(in)  :: S1(4), S2(4), S3(4), V2(4), P2(4), V3(4), P3(4), P4(4)
  complex(dp), intent(out) :: V_out(4)
  V_out = cont_VV(V2,V3)*(P2-P3) + cont_VV(P3+P4,V2)*V3 - cont_VV(P4+P2,V3)*V2
  V_out = S1(1)*S2(1)*S3(1)*V_out
...
! **********************************************************************
  ...
  use ol_contractions_dp, only: cont_VV
  implicit none
  complex(dp), intent(in)  :: S1(4), S2(4), S3(4), V2(4), V3(4), V4(4)
  complex(dp), intent(out) :: V_out(4)
...
! **********************************************************************
  ...
  use ol_contractions_dp, only: cont_VV
  implicit none
  complex(dp), intent(in)  :: S1(4), S2(4), V1(4), V2(4), V3(4), V4(4)
  complex(dp), intent(out) :: S_out(4)
...
! **********************************************************************
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: S1(4), S2(4), JA(4), PA(4), JQ(4), PQ(4)
  complex(dp), intent(out) :: S_out(4)
  complex(dp) :: P(4)
  P = PQ-PA
  S_out(1) = (-JA(3)*P(1)-JA(4)*P(3))*JQ(1) + (-JA(4)*P(2)-JA(3)*P(4))*JQ(2) &
...
! **********************************************************************
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: JQ(4), PQ(4), S1(4), S2(4), S3(4), PA(4)
  complex(dp), intent(out) :: JA_out(4)
  complex(dp) :: P(4)
  P = PQ+PA
  JA_out(1) = - P(2)*JQ(3) + P(4)*JQ(4)
...
! **********************************************************************
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: S1(4), S2(4), S3(4), JA(4), PA(4), PQ(4)
  complex(dp), intent(out) :: JQ_out(4)
  complex(dp) :: P(4)
  P = -PQ-PA
  JQ_out(1) = -JA(3)*P(1)-JA(4)*P(3)
...
! **********************************************************************
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: S1(4), S2(4), S3(4), J_Q(4), J_A(4)
  complex(dp), intent(out) :: Jout_V(4)
  Jout_V(1) = - J_A(1)*J_Q(3) - J_A(4)*J_Q(2)
  Jout_V(2) = - J_A(2)*J_Q(4) - J_A(3)*J_Q(1)
  Jout_V(3) = - J_A(1)*J_Q(4) + J_A(3)*J_Q(2)
...
! **********************************************************************
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: J_V(4), S1(4), S2(4), S3(4), J_Q(4)
  complex(dp), intent(out) :: Jout_Q(4)
  Jout_Q(1) = - J_V(2)*J_Q(3)+J_V(4)*J_Q(4)
  Jout_Q(2) = - J_V(1)*J_Q(4)+J_V(3)*J_Q(3)
  Jout_Q(3) = - J_V(1)*J_Q(1)-J_V(4)*J_Q(2)
...
! **********************************************************************
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: J_A(4), J_V(4), S1(4), S2(4), S3(4)
  complex(dp), intent(out) :: Jout_A(4)
  Jout_A(1) = - J_V(1)*J_A(3) - J_V(3)*J_A(4)
  Jout_A(2) = - J_V(2)*J_A(4) - J_V(4)*J_A(3)
  Jout_A(3) = - J_V(2)*J_A(1) + J_V(3)*J_A(2)
...
! **********************************************************************
  use kind_types, only: dp
  implicit none
  complex(dp), intent(in)  :: S1(4), S2(4), J_Q(4), J_A(4), J_V(4)
  complex(dp), intent(out) :: S_out(4)
  S_out(1) = (-J_A(3)*J_V(1)-J_A(4)*J_V(3))*J_Q(1) + (-J_A(4)*J_V(2)-J_A(3)*J_V(4))*J_Q(2) &
         & + (-J_A(1)*J_V(2)+J_A(2)*J_V(3))*J_Q(3) + (-J_A(2)*J_V(1)+J_A(1)*J_V(4))*J_Q(4)
  S_out(1) = S_out(1)*S1(1)*S2(1)
...
! **********************************************************************
  use kind_types, only: dp
  implicit none
  complex(dp) :: J_A(4), J_Z(4), S(4), Jout_A(4)
  complex(dp) :: g_RL(2)
...
! **********************************************************************
  use kind_types, only: dp
  implicit none
  complex(dp) :: S(4), J_Q(4), J_A(4), Jout_Z(4)
  complex(dp) :: g_RL(2)
  Jout_Z(1) = - g_RL(2)*J_A(1)*J_Q(3) - g_RL(1)*J_A(4)*J_Q(2)
  Jout_Z(2) = - g_RL(2)*J_A(2)*J_Q(4) - g_RL(1)*J_A(3)*J_Q(1)
  Jout_Z(3) = - g_RL(2)*J_A(1)*J_Q(4) + g_RL(1)*J_A(3)*J_Q(2)
...
! **********************************************************************
  use kind_types, only: dp
  implicit none
  complex(dp) :: J_Q(4), J_Z(4), S(4), Jout_Q(4)
  complex(dp) :: g_RL(2)
