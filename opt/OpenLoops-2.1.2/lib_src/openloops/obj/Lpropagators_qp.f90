...
! **********************************************************************
  ...
  complex(qp), intent(in)  :: G_A(4,rank_in), K(5), M
...
! **********************************************************************
  ...
  implicit none
  integer,           intent(in)  :: rank_in, rank_out
  complex(qp), intent(in)  :: G_Q(4,rank_in), K(5), M
  complex(qp), intent(inout) :: Gout_Q(4,rank_out)
  integer :: l
...
end module ol_loop_propagators_qp
...
! **********************************************************************
  use kind_types, only: qp
  use ol_loop_propagators_qp
  implicit none
  complex(qp), intent(in)  :: Gin(:,:,:), K(5), M
  complex(qp), intent(out) :: Gout(:,:,:)
...
end module ol_prop_interface_qp
