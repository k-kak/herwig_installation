...
end module ind_bookkeeping_qp



module ol_helicity_init_qp
...
end module ol_helicity_init_qp


module hel_bookkeeping_qp
contains
...
end module hel_bookkeeping_qp



module ol_merging_qp
  use ol_loop_handling_qp, only: hp_switch,hybrid_zero_mode, &
                                           hybrid_dp_mode,hybrid_qp_mode, &
                                           hybrid_dp_qp_mode,merge_mode
  use ol_parameters_decl_qp, only: hp_automerge
  implicit none
  contains
...
! **********************************************************************
  ...
  complex(qp) :: G_aux(size(Gin_0%j,1),size(Gin_0%j,2),size(Gin_0%j,3),size(Gin_0%j,4))
...
! **********************************************************************
  ...
  use ol_merging_dp, only: helicity_matching_check
