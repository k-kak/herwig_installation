...
! **********************************************************************
  ...
  implicit none
  complex(dp), intent(in)  :: J_Q(4), K(4), M
...
! **********************************************************************
  use kind_types, only: dp, intkind1
  implicit none
  complex(dp), intent(in)  :: J_A(4), K(4), M
...
! **********************************************************************
  ...
  implicit none
  complex(dp), intent(in)  :: J_V(4), K(4), M
...
end module ol_propagators_dp



! **********************************************************************
module ol_s_propagators_dp
...
end module ol_s_propagators_dp



! **********************************************************************
module ol_h_propagators_dp
! Routines to dressing a wave function with a propagator
! - prop_Q_A: fermion
! - prop_A_Q: anti-fermion
! - prop_W_W: massive vector boson in unitary gauge
...
! **********************************************************************
  ...
  use ol_data_types_dp, only: wfun
  use ol_helicity_bookkeeping_dp, only: helbookkeeping_prop
  implicit none
...
end module ol_h_propagators_dp
