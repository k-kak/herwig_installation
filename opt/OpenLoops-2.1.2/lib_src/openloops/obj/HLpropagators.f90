...
! **********************************************************************
  ...
  use hel_bookkeeping_dp, only: helbookkeeping_prop
  use ol_kinematics_dp, only: get_LC_5,get_mass

  use ol_prop_interface_qp, only: loop_A_Q_qp => loop_A_Q
  use ol_kinematics_qp, only: get_LC_5_qp=>get_LC_5, &
...
!**********************************************************************
  ...
  use ol_prop_interface_qp, only: loop_Q_A_qp => loop_Q_A
  use ol_kinematics_qp, only: get_LC_5_qp=>get_LC_5, &
                                         get_mass_qp=>get_mass
...
end module ol_h_prop_interface_dp
