...
module ol_colourmatrix_ppllj_llxbbxg_1_dp
...
end module ol_colourmatrix_ppllj_llxbbxg_1_dp



module ol_forced_parameters_ppllj_llxbbxg_1_dp
  implicit none
  contains
...
end module ol_forced_parameters_ppllj_llxbbxg_1_dp


! **********************************************************************
module ol_loop_storage_ppllj_llxbbxg_1_dp
! **********************************************************************
...
! **********************************************************************
module ol_loop_ppllj_llxbbxg_1_dp
! **********************************************************************
  use kind_types, only: dp, dp, intkind1, intkind2
  use ol_data_types_dp, only: wfun, Hpolcont
  use ol_loop_storage_ppllj_llxbbxg_1_dp
  implicit none
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 5) = (CI*countertermnorm*ctGbb*eQED**2*gQCD**3)/3._dp
    f( 6) = CI*countertermnorm*ctGbb*eQED**2*gQCD**3
    f( 7) = (CI*countertermnorm*ctVbb*eQED**2*gQCD**3)/3._dp
    f( 8) = CI*countertermnorm*ctVbb*eQED**2*gQCD**3
    f( 9) = countertermnorm*ctZGG*eQED**2*gQCD**3
    f(10) = (CI*eQED**2*gQCD*MB*ML)/(4._dp*MW**2*sw**2)
    f(11) = (CI*countertermnorm*eQED**2*gQCD**3*MB*ML)/(4._dp*MW**2*sw**2)
    f(12) = (CI*countertermnorm*ctGbb*eQED**2*gQCD**3*MB*ML)/(4._dp*MW**2*sw**2)
    f(13) = (CI*countertermnorm*ctSbb*eQED**2*gQCD**3*MB*ML)/(4._dp*MW**2*sw**2)
    f(14) = (CI*countertermnorm*ctHGG*eQED**2*gQCD**3*ML)/(2._dp*MW*sw)
    f(15) = (CI*eQED**2*gQCD**3*integralnorm*SwB)/3._dp
    f(16) = CI*eQED**2*gQCD**3*integralnorm*SwB
    f(17) = (eQED**2*gQCD**3*integralnorm*SwB)/3._dp
    f(18) = eQED**2*gQCD**3*integralnorm*SwB
    f(19) = (CI*eQED**2*gQCD**3*integralnorm*MB*ML*SwB)/(4._dp*MW**2*sw**2)
    f(20) = (eQED**2*gQCD**3*integralnorm*MB*ML*SwB)/(MW**2*sw**2*4._dp)
    f(21) = (eQED**2*gQCD**3*integralnorm*SwF)/3._dp
    f(22) = (2*eQED**2*gQCD**3*integralnorm*SwF)/3._dp
    f(23) = eQED**2*gQCD**3*integralnorm*SwF
    f(24) = (4*eQED**2*gQCD**3*integralnorm*SwF)/3._dp
    f(25) = 2*eQED**2*gQCD**3*integralnorm*SwF
    f(26) = (eQED**2*gQCD**3*integralnorm*MB*ML*SwF)/(MW**2*sw**2*4._dp)
    f(27) = (eQED**2*gQCD**3*integralnorm*ML*MT*SwF)/(MW**2*sw**2*4._dp)
...
! 
  ...
  use ol_colourmatrix_ppllj_llxbbxg_1_dp, only: &
    & colmat_not_initialised, colourmatrix_init
  use ol_forced_parameters_ppllj_llxbbxg_1_dp, only: &
...
! K1(i,j) = <Ci|Cj>
! **********************************************************************
  use ol_colourmatrix_ppllj_llxbbxg_1_dp, only: K1
  implicit none
...
! K2(i,j) = <Ci|Cj>
! **********************************************************************
  use ol_colourmatrix_ppllj_llxbbxg_1_dp, only: K2
  implicit none
...
! **********************************************************************
  use ol_colourmatrix_ppllj_llxbbxg_1_dp, only: KL
  implicit none
...
end module ol_loop_ppllj_llxbbxg_1_dp
