...
module ol_colourmatrix_ppllj_nexecsxg_1_dp
...
end module ol_colourmatrix_ppllj_nexecsxg_1_dp



module ol_forced_parameters_ppllj_nexecsxg_1_dp
  implicit none
  contains
...
end module ol_forced_parameters_ppllj_nexecsxg_1_dp


! **********************************************************************
module ol_loop_storage_ppllj_nexecsxg_1_dp
! **********************************************************************
...
end module ol_loop_storage_ppllj_nexecsxg_1_dp
...
! **********************************************************************
module ol_loop_ppllj_nexecsxg_1_dp
! **********************************************************************
...
! M2  = helicity-summed squared matrix element for anti-nu_e e- charm anti-strange glue -> 0
! **********************************************************************
  ...
  use ol_settings_ppllj_nexecsxg_1, only: hel_mem_opt, loopcc
...
! 
  ...
  use ol_forced_parameters_ppllj_nexecsxg_1_dp, only: &
    & check_forced_parameters
  use ol_heltables_OLR_ppllj_nexecsxg_1
  ...
  call init_kinematics(P_scatt, extmasses2, P, &
     external_perm_inv_ppllj_nexecsxg_1, 5, qp_kinematics)
  ...
  call prop_Q_A(ntry, wf4(:,9), 20, MC, 1_intkind1, wf4(:,10), n2(5))
  call counter_Q_A(ctcc,4,ntry, wf4(:,4), 20, wf4(:,11), n2(6))
  call prop_A_Q(ntry, wf8(:,1), 11, MC, 1_intkind1, wf8(:,5), n2(7))
  call counter_A_Q(ctqq,3,ntry, wf4(:,6), 24, wf4(:,12), n2(8))
...
! K1(i,j) = <Ci|Cj>
! **********************************************************************
  use ol_colourmatrix_ppllj_nexecsxg_1_dp, only: K1
  implicit none
...
! K2(i,j) = <Ci|Cj>
! **********************************************************************
  use ol_colourmatrix_ppllj_nexecsxg_1_dp, only: K2
  implicit none
...
! **********************************************************************
  use ol_colourmatrix_ppllj_nexecsxg_1_dp, only: KL
  implicit none
...
! spin-correlated hard scattering factor for anti-nu_e e- charm anti-strange glue -> 0
! **********************************************************************
  use ol_parameters_decl_dp
  implicit none
  real(dp), intent(in) :: P_scatt(0:3,5)
...
subroutine assign_helicity_flip(ext_wf_hf,ext_wf_t,m)
  ...
  if(size(ext_wf_hf) == size(hflip,1)) then
    ...
    call ol_fatal("Spin-correlated HSF for ppllj_nexecsxg_1:" &
...
subroutine init_flipped_heltables(i,j)
  ...
  do k = 1, 5
    r = external_perm_inv_ppllj_nexecsxg_1(k)
    if(r == i .or. r == j) then
      l = l+1
      select case(k)
        case(1)
...
end module ol_loop_ppllj_nexecsxg_1_dp
