...
module ol_colourmatrix_ppllj_llxuuxg_1_dp
...
end module ol_colourmatrix_ppllj_llxuuxg_1_dp



module ol_forced_parameters_ppllj_llxuuxg_1_dp
  implicit none
  contains
...
end module ol_forced_parameters_ppllj_llxuuxg_1_dp


! **********************************************************************
module ol_loop_storage_ppllj_llxuuxg_1_dp
! **********************************************************************
...
! **********************************************************************
module ol_loop_ppllj_llxuuxg_1_dp
! **********************************************************************
  use kind_types, only: dp, dp, intkind1, intkind2
  use ol_data_types_dp, only: wfun, Hpolcont
  use ol_loop_storage_ppllj_llxuuxg_1_dp
  implicit none
...
! **********************************************************************
  ...
  ! factors of the diagrams
    f( 1) = (2*CI*eQED**2*gQCD)/3._dp
    f( 2) = CI*eQED**2*gQCD
    f( 3) = (2*CI*countertermnorm*eQED**2*gQCD**3)/3._dp
    f( 4) = CI*countertermnorm*eQED**2*gQCD**3
    f( 5) = (2*CI*countertermnorm*ctGqq*eQED**2*gQCD**3)/3._dp
    f( 6) = CI*countertermnorm*ctGqq*eQED**2*gQCD**3
    f( 7) = (2*CI*countertermnorm*ctVqq*eQED**2*gQCD**3)/3._dp
    f( 8) = CI*countertermnorm*ctVqq*eQED**2*gQCD**3
    f( 9) = countertermnorm*ctZGG*eQED**2*gQCD**3
    f(10) = (CI*countertermnorm*ctHGG*eQED**2*gQCD**3*ML)/(2._dp*MW*sw)
    f(11) = (2*CI*eQED**2*gQCD**3*integralnorm*SwB)/3._dp
    f(12) = CI*eQED**2*gQCD**3*integralnorm*SwB
    f(13) = (2*eQED**2*gQCD**3*integralnorm*SwB)/3._dp
    f(14) = eQED**2*gQCD**3*integralnorm*SwB
    f(15) = (eQED**2*gQCD**3*integralnorm*SwF)/3._dp
    f(16) = (2*eQED**2*gQCD**3*integralnorm*SwF)/3._dp
    f(17) = eQED**2*gQCD**3*integralnorm*SwF
    f(18) = (4*eQED**2*gQCD**3*integralnorm*SwF)/3._dp
    f(19) = 2*eQED**2*gQCD**3*integralnorm*SwF
    f(20) = (eQED**2*gQCD**3*integralnorm*MB*ML*SwF)/(MW**2*sw**2*4._dp)
    f(21) = (eQED**2*gQCD**3*integralnorm*ML*MT*SwF)/(MW**2*sw**2*4._dp)
...
! 
  ...
  use ol_colourmatrix_ppllj_llxuuxg_1_dp, only: &
    & colmat_not_initialised, colourmatrix_init
  use ol_forced_parameters_ppllj_llxuuxg_1_dp, only: &
...
! K1(i,j) = <Ci|Cj>
! **********************************************************************
  use ol_colourmatrix_ppllj_llxuuxg_1_dp, only: K1
  implicit none
...
! K2(i,j) = <Ci|Cj>
! **********************************************************************
  use ol_colourmatrix_ppllj_llxuuxg_1_dp, only: K2
  implicit none
...
! **********************************************************************
  use ol_colourmatrix_ppllj_llxuuxg_1_dp, only: KL
  implicit none
...
end module ol_loop_ppllj_llxuuxg_1_dp
