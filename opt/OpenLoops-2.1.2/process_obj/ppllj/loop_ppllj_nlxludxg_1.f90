...
module ol_colourmatrix_ppllj_nlxludxg_1_dp
...
end module ol_colourmatrix_ppllj_nlxludxg_1_dp



module ol_forced_parameters_ppllj_nlxludxg_1_dp
  implicit none
  contains
...
end module ol_forced_parameters_ppllj_nlxludxg_1_dp


! **********************************************************************
module ol_loop_storage_ppllj_nlxludxg_1_dp
! **********************************************************************
...
! **********************************************************************
module ol_loop_ppllj_nlxludxg_1_dp
! **********************************************************************
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(3) = (CI*countertermnorm*ctGqq*eQED**2*gQCD**3)/(2._dp*sw**2)
    f(4) = (CI*countertermnorm*ctVqq*eQED**2*gQCD**3)/(2._dp*sw**2)
    f(5) = (CI*eQED**2*gQCD**3*integralnorm*SwB)/(2._dp*sw**2)
    f(6) = (eQED**2*gQCD**3*integralnorm*SwB)/(sw**2*2._dp)
...
! 
  ...
  use ol_forced_parameters_ppllj_nlxludxg_1_dp, only: &
...
! K1(i,j) = <Ci|Cj>
! **********************************************************************
  use ol_colourmatrix_ppllj_nlxludxg_1_dp, only: K1
  implicit none
...
! K2(i,j) = <Ci|Cj>
! **********************************************************************
  use ol_colourmatrix_ppllj_nlxludxg_1_dp, only: K2
  implicit none
...
! **********************************************************************
  use ol_colourmatrix_ppllj_nlxludxg_1_dp, only: KL
  implicit none
...
end module ol_loop_ppllj_nlxludxg_1_dp
