...
module ol_colourmatrix_ppllj_eexccxg_1_dp
...
end module ol_colourmatrix_ppllj_eexccxg_1_dp



module ol_forced_parameters_ppllj_eexccxg_1_dp
  implicit none
  contains
...
end module ol_forced_parameters_ppllj_eexccxg_1_dp


! **********************************************************************
module ol_loop_storage_ppllj_eexccxg_1_dp
! **********************************************************************
...
end module ol_loop_storage_ppllj_eexccxg_1_dp
...
! **********************************************************************
module ol_loop_ppllj_eexccxg_1_dp
! **********************************************************************
  use kind_types, only: dp, dp, intkind1, intkind2
  use ol_data_types_dp, only: wfun, Hpolcont
  use ol_loop_storage_ppllj_eexccxg_1_dp
  implicit none
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 5) = (2*CI*countertermnorm*ctGcc*eQED**2*gQCD**3)/3._dp
    f( 6) = CI*countertermnorm*ctGcc*eQED**2*gQCD**3
    f( 7) = (2*CI*countertermnorm*ctVcc*eQED**2*gQCD**3)/3._dp
    f( 8) = CI*countertermnorm*ctVcc*eQED**2*gQCD**3
    f( 9) = countertermnorm*ctZGG*eQED**2*gQCD**3
    f(10) = (2*CI*eQED**2*gQCD**3*integralnorm*SwB)/3._dp
    f(11) = CI*eQED**2*gQCD**3*integralnorm*SwB
    f(12) = (2*eQED**2*gQCD**3*integralnorm*SwB)/3._dp
...
! K2(i,j) = <Ci|Cj>
! **********************************************************************
  use ol_colourmatrix_ppllj_eexccxg_1_dp, only: K2
  implicit none
...
! **********************************************************************
  use ol_colourmatrix_ppllj_eexccxg_1_dp, only: KL
  implicit none
...
end module ol_loop_ppllj_eexccxg_1_dp
