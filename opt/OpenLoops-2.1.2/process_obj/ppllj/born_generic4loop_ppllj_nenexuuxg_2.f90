...
! **********************************************************************
module ol_heltables_ppllj_nenexuuxg_2
! **********************************************************************
  ...
  integer(intkind2), save :: n2(3), n3(3,7)

  ! helicity tables used in the construction of the h helicity states of a wave function (amplitude)
  ! from an v-point vertex (contraction): t<v>x<h>(v-1,h,sz)
  integer(intkind2), save :: t3x8(2,8,2), t3x32(2,32,2), t3x4(2,4,3)
...
! **********************************************************************
  ...
  call heltable([4,8,32], n3(:,7), t3x32(:,:,2))

  heltables_not_init = .false.

end subroutine init_heltables

end module ol_heltables_ppllj_nenexuuxg_2
