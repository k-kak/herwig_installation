...
! **********************************************************************
module ol_heltables_ppllj_llxbbxg_1
! **********************************************************************
  ...
  integer(intkind2), save :: n2(3), n3(3,17)

  ! helicity tables used in the construction of the h helicity states of a wave function (amplitude)
  ! from an v-point vertex (contraction): t<v>x<h>(v-1,h,sz)
  integer(intkind2), save :: t3x4(2,4,5), t3x8(2,8,6), t3x32(2,32,6)
...
end module ol_heltables_ppllj_llxbbxg_1
