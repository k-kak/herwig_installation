...
! **********************************************************************
module ol_tables_storage_ppllj_nenexccx_1_dp
! **********************************************************************
...
end module ol_tables_storage_ppllj_nenexccx_1_dp

! **********************************************************************
module ol_tensor_sum_storage_ppllj_nenexccx_1_dp
! **********************************************************************
  use kind_types, only: dp, qp, intkind2
...
!**********************************************************************
  ...
  use ol_loop_storage_ppllj_nenexccx_1_dp, only: nhel
  use ol_data_types_dp, only: hol
...
end module ol_tensor_sum_storage_ppllj_nenexccx_1_dp
