...
module ol_vamp_1_ppllj_nenexbbxg_1_dp
contains
...
! **********************************************************************
  ...
  use ol_last_step_dp
  use ol_tables_storage_ppllj_nenexbbxg_1_dp
  use ol_tensor_sum_storage_ppllj_nenexbbxg_1_dp
  ...
  use ol_loop_storage_ppllj_nenexbbxg_1_dp
...
end module ol_vamp_1_ppllj_nenexbbxg_1_dp
