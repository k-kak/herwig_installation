...
module ol_colourmatrix_ppllj_eexbbxg_2_dp
...
end module ol_colourmatrix_ppllj_eexbbxg_2_dp



module ol_forced_parameters_ppllj_eexbbxg_2_dp
  implicit none
  contains
...
end module ol_forced_parameters_ppllj_eexbbxg_2_dp


! **********************************************************************
module ol_loop_storage_ppllj_eexbbxg_2_dp
! **********************************************************************
...
end module ol_loop_storage_ppllj_eexbbxg_2_dp
...
! **********************************************************************
module ol_loop_ppllj_eexbbxg_2_dp
! **********************************************************************
  use kind_types, only: dp, dp, intkind1, intkind2
  use ol_data_types_dp, only: wfun, Hpolcont
  use ol_loop_storage_ppllj_eexbbxg_2_dp
  implicit none
...
! K2(i,j) = <Ci|Cj>
! **********************************************************************
  use ol_colourmatrix_ppllj_eexbbxg_2_dp, only: K2
  implicit none
...
! **********************************************************************
  use ol_colourmatrix_ppllj_eexbbxg_2_dp, only: KL
  implicit none
...
end module ol_loop_ppllj_eexbbxg_2_dp
