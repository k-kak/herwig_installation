...
module ol_colourmatrix_ppllj_llxbbx_1_dp
  use kind_types, only: dp
  implicit none
  logical, save           :: colmat_not_initialised = .true.
  complex(dp), save :: K1(12,1), K2(12,1), KL(12,1), Cas(4) = 0
  contains
...
end module ol_colourmatrix_ppllj_llxbbx_1_dp



module ol_forced_parameters_ppllj_llxbbx_1_dp
  implicit none
  contains
...
end module ol_forced_parameters_ppllj_llxbbx_1_dp


! **********************************************************************
module ol_loop_storage_ppllj_llxbbx_1_dp
! **********************************************************************
  ...
  complex(dp), save :: f(9), c(3)

  !Vector in helicity and colour space for Born-Loop interference
  type(Hpolcont),   save, allocatable :: M0_col1_helarray(:,:), M0M1_hel_cc(:,:,:)
  complex(dp), save :: M2ctcc(11)

end module ol_loop_storage_ppllj_llxbbx_1_dp
...
! **********************************************************************
module ol_loop_ppllj_llxbbx_1_dp
! **********************************************************************
  use kind_types, only: dp, dp, intkind1, intkind2
  use ol_data_types_dp, only: wfun, Hpolcont
  use ol_loop_storage_ppllj_llxbbx_1_dp
  implicit none
...
! **********************************************************************
  ...
  ! factors of the diagrams
    f(1) = (CI*eQED**2)/3._dp
    f(2) = CI*eQED**2
    f(3) = (CI*countertermnorm*ctVbb*eQED**2*gQCD**2)/3._dp
    f(4) = CI*countertermnorm*ctVbb*eQED**2*gQCD**2
    f(5) = (CI*eQED**2*MB*ML)/(4._dp*MW**2*sw**2)
    f(6) = (CI*countertermnorm*ctSbb*eQED**2*gQCD**2*MB*ML)/(4._dp*MW**2*sw**2)
    f(7) = (eQED**2*gQCD**2*integralnorm*SwB)/3._dp
    f(8) = eQED**2*gQCD**2*integralnorm*SwB
    f(9) = (eQED**2*gQCD**2*integralnorm*MB*ML*SwB)/(MW**2*sw**2*4._dp)
...
! 
  ...
  use ol_forced_parameters_ppllj_llxbbx_1_dp, only: &
  ...
  real(dp),  intent(out), optional :: M2colint(11)
  real(dp) :: iM2ct
  real(dp) :: iM2colint(11)
  ...
  real(dp)    :: M2add, M2add_ct, M2add_colint(11)
  complex(dp) :: M1(1), M2(1)
  real(dp)    :: P_scatt_intern(0:3,4)
...
! K1(i,j) = <Ci|Cj>
! **********************************************************************
  use ol_colourmatrix_ppllj_llxbbx_1_dp, only: K1
  implicit none
...
! K2(i,j) = <Ci|Cj>
! **********************************************************************
  use ol_colourmatrix_ppllj_llxbbx_1_dp, only: K2
  implicit none
...
! **********************************************************************
  use ol_colourmatrix_ppllj_llxbbx_1_dp, only: KL
  implicit none
...
end module ol_loop_ppllj_llxbbx_1_dp
