...
module ol_colourmatrix_ppllj_eexuuxg_1_dp
...
end module ol_colourmatrix_ppllj_eexuuxg_1_dp



module ol_forced_parameters_ppllj_eexuuxg_1_dp
  implicit none
  contains
...
end module ol_forced_parameters_ppllj_eexuuxg_1_dp


! **********************************************************************
module ol_loop_storage_ppllj_eexuuxg_1_dp
! **********************************************************************
...
! **********************************************************************
module ol_loop_ppllj_eexuuxg_1_dp
! **********************************************************************
  use kind_types, only: dp, dp, intkind1, intkind2
  use ol_data_types_dp, only: wfun, Hpolcont
  use ol_loop_storage_ppllj_eexuuxg_1_dp
  implicit none
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(17) = (4*eQED**2*gQCD**3*integralnorm*SwF)/3._dp
...
! **********************************************************************
  ...
  use ol_settings_ppllj_eexuuxg_1, only: hel_mem_opt, loopcc
...
! 
  ...
  use ol_heltables_OLR_ppllj_eexuuxg_1
  ...
  call init_kinematics(P_scatt, extmasses2, P, &
     external_perm_inv_ppllj_eexuuxg_1, 5, qp_kinematics)
...
! K2(i,j) = <Ci|Cj>
! **********************************************************************
  use ol_colourmatrix_ppllj_eexuuxg_1_dp, only: K2
  implicit none
...
! **********************************************************************
  use ol_colourmatrix_ppllj_eexuuxg_1_dp, only: KL
  implicit none
...
! spin-correlated hard scattering factor for e- e+ up anti-up glue -> 0
! **********************************************************************
  use ol_parameters_decl_dp
  implicit none
  real(dp), intent(in) :: P_scatt(0:3,5)
...
subroutine assign_helicity_flip(ext_wf_hf,ext_wf_t,m)
  ...
  if(size(ext_wf_hf) == size(hflip,1)) then
    ...
    call ol_fatal("Spin-correlated HSF for ppllj_eexuuxg_1:" &
...
subroutine init_flipped_heltables(i,j)
  ...
  do k = 1, 5
    r = external_perm_inv_ppllj_eexuuxg_1(k)
    if(r == i .or. r == j) then
      l = l+1
      select case(k)
        case(1)
...
end module ol_loop_ppllj_eexuuxg_1_dp
