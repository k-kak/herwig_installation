...
module ol_colourmatrix_ppllj_nllxuxdg_1_dp
...
end module ol_colourmatrix_ppllj_nllxuxdg_1_dp



module ol_forced_parameters_ppllj_nllxuxdg_1_dp
  implicit none
  contains
...
end module ol_forced_parameters_ppllj_nllxuxdg_1_dp


! **********************************************************************
module ol_loop_storage_ppllj_nllxuxdg_1_dp
! **********************************************************************
...
end module ol_loop_storage_ppllj_nllxuxdg_1_dp
...
! **********************************************************************
module ol_loop_ppllj_nllxuxdg_1_dp
! **********************************************************************
...
! 
  ...
  use ol_forced_parameters_ppllj_nllxuxdg_1_dp, only: &
...
! K1(i,j) = <Ci|Cj>
! **********************************************************************
  use ol_colourmatrix_ppllj_nllxuxdg_1_dp, only: K1
  implicit none
...
! K2(i,j) = <Ci|Cj>
! **********************************************************************
  use ol_colourmatrix_ppllj_nllxuxdg_1_dp, only: K2
  implicit none
...
! **********************************************************************
  use ol_colourmatrix_ppllj_nllxuxdg_1_dp, only: KL
  implicit none
...
end module ol_loop_ppllj_nllxuxdg_1_dp
