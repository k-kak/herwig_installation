     ...
     #     p1(3)*p2(3)
      ...
      function dotrcabs(p1,p2)
      implicit none      
      real * 8 p1(0:3)
      complex * 16  p2(0:3),dotrcabs
      dotrcabs = p1(0)*p2(0) + p1(1)*p2(1) + p1(2)*p2(2) + p1(3)*p2(3)
      end

      function dotccabs(p1,p2)
      implicit none      
      complex * 16 dotccabs,p1(0:3),p2(0:3)
      dotccabs = p1(0)*p2(0)+ p1(1)*p2(1)+ p1(2)*p2(2)+ p1(3)*p2(3)
      end
