...
C This is valid for general kinematics pisq<=>0
      function E0finG_c(m0s,m1s,m2s,m3s,m4s,
     &   p1s,p2s,p3s,p4s,p5s,s12,s23,s34,s45,s15, 
     &     D02345,D01345,D01245,D01235,D01234)
      implicit none
      complex * 16 E0finG_c,D02345,D01345,D01245,D01235,D01234
c      complex*16 m0,m1,m2,m3,m4
      complex*16 m0s,m1s,m2s,m3s,m4s
      real * 8 p1s,p2s,p3s,p4s,p5s,s12,s23,s34,s45,s15
      complex*16  Y01,Y02,Y03,Y04,Y12,Y13,Y14,Y23,Y24,Y34
      complex*16  Y01s,Y02s,Y03s,Y04s,Y12s,Y13s,Y14s,Y23s,Y24s,Y34s     
      complex*16 d,x1,x2,x3,x4,x5
...
c      m4s=m4*m4
      ...
      Y34s=Y34*Y34
       ...
       d=2*(-4*m2s*m3s*m4s*Y01s-4*m1s*m3s*m4s*Y02s-4*m1s*m2s*m4s*Y03s-
     ...
     -   s*Y24+m2s*(4*m3s-2*Y34)+Y23*(-Y23+Y24+Y34)))
       ...
       E0finG_c=-(x1*D02345+x2*D01345+x3*D01245+x4*D01235+x5*D01234)/d
