       subroutine H3jCrossIF66T(M,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,ps
...
c************************************************************************************
     ...
     &   36I, B045R,B045I, B046R,B046I, B056R,B056I
       Integer ngluon, posgluon,Div
        if(Div.eq.0) then
         call  H3jCrossIF66(M,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,ps
     &   i_p2,barpsi_p4,mup3,musq,comp,result,resultn)

           else
         call H3jCrossIF66_Div(M,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,ps
     &   i_p2,barpsi_p4,mup3,musq,comp,result,resultn)   
        endif
        return
        end
       ...
       subroutine H3jCrossIF67T(M,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,ps
     &   i_p2,barpsi_p4,mup3,musq,comp,result,resultn,Div)
       IMPLICIT NONE
      Complex*16 SMB(95),Fa(40),F(203)
       Complex*16 SMB0(16),SMB11(0:3),SMB12(0:3),SMB13(0:3),SMB14(0:3)
...
c************************************************************************************
     ...
     &   36I, B045R,B045I, B046R,B046I, B056R,B056I
       Integer ngluon, posgluon,Div
        if(Div.eq.0) then
         call  H3jCrossIF67(M,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,ps
     &   i_p2,barpsi_p4,mup3,musq,comp,result,resultn)

           else
         call H3jCrossIF67_Div(M,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,ps
     &   i_p2,barpsi_p4,mup3,musq,comp,result,resultn)   
        endif
        return
        end

       subroutine H3jCrossIF76T(M,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,ps
     &   i_p2,barpsi_p4,mup3,musq,comp,result,resultn,Div)
       IMPLICIT NONE
      Complex*16 SMB(95),Fa(40),F(203)
       Complex*16 SMB0(16),SMB11(0:3),SMB12(0:3),SMB13(0:3),SMB14(0:3)
...
c************************************************************************************
     ...
     &   36I, B045R,B045I, B046R,B046I, B056R,B056I
       Integer ngluon, posgluon,Div
        if(Div.eq.0) then
         call  H3jCrossIF76(M,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,ps
     &   i_p2,barpsi_p4,mup3,musq,comp,result,resultn)

           else
         call H3jCrossIF76_Div(M,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,ps
     &   i_p2,barpsi_p4,mup3,musq,comp,result,resultn)   
        endif
        return
        end
       ...
       subroutine H3jCrossIF77T(M,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,ps
     &   i_p2,barpsi_p4,mup3,musq,comp,result,resultn,Div)
       IMPLICIT NONE
      Complex*16 SMB(95),Fa(40),F(203)
       Complex*16 SMB0(16),SMB11(0:3),SMB12(0:3),SMB13(0:3),SMB14(0:3)
...
c************************************************************************************
     ...
     &   36I, B045R,B045I, B046R,B046I, B056R,B056I
       Integer ngluon, posgluon,Div
        if(Div.eq.0) then
         call  H3jCrossIF77(M,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,ps
     &   i_p2,barpsi_p4,mup3,musq,comp,result,resultn)

           else
         call H3jCrossIF77_Div(M,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,ps
     &   i_p2,barpsi_p4,mup3,musq,comp,result,resultn)   
        endif
        return
        end
