...
c************************************************************************************
c************************************************************************************
       subroutine H3jCrossIF67_Div(M,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,ps
...
c************************************************************************************
     ...
     &   36I, B045R,B045I, B046R,B046I, B056R,B056I
       ...
       if(comp.gt.0) then
       call FgetCrossIF_Div(M,p1,p2,p3,p4,p5,p6,musq,Div)
...
c************************************************************************************
c************************************************************************************
       SMB0(1) = SC1c(barpsi_p4_M,mup3,psi_p2_M,-1)
       ...
       SMB0(6) = SC1r(barpsi_p4_M,p5,psi_p2_M,-1)
       SMB0(7) = SC1c(barpsi_p6_P,mup3,psi_p1_P,+1)
       SMB0(8) = SC1r(barpsi_p4_M,p1,psi_p2_M,-1)
       ...
       SMB0(12) = SC1r(barpsi_p4_M,p6,psi_p2_M,-1)
       SMB0(13) = SC3rrr(barpsi_p4_M,p6,p5,p1,psi_p2_M,-1)
       SMB0(14) = SC3crr(barpsi_p4_M,mup3,p5,p1,psi_p2_M,-1)
       SMB0(15) = SC3crr(barpsi_p4_M,mup3,p6,p1,psi_p2_M,-1)
       SMB0(16) = SC3crr(barpsi_p4_M,mup3,p6,p5,psi_p2_M,-1)
c************************************************************************************
c************************************************************************************
      do i=0,3
        v1(0)=delta(i,0)
        ...
        v1(2)=delta(i,2)
        v1(3)=delta(i,3)
       SMB11(i) = SC1c(barpsi_p4_M,v1,psi_p2_M,-1)
       SMB12(i) = SC1c(barpsi_p6_P,v1,psi_p1_P,+1)
       SMB13(i) = SC3crc(barpsi_p4_M,mup3,p5,v1,psi_p2_M,-1)
...
c************************************************************************************
       ...
       SMB(8) = 0
       SMB(9) = SMB1(7)
       SMB(10) = 2*p6mup3*SMB1(5)-2*SMB1(21)
       SMB(11) = SMB1(10)
       SMB(12) = SMB1(11)
       SMB(13) = SMB1(12)
       SMB(14) = SMB1(16)
       ...
       SMB(28) = SMB1(37)
       SMB(29) = SMB1(31)
       SMB(30) = -2*SMB1(2)+2*p4mup3*SMB1(5)
       SMB(31) = -2*SMB1(3)+2*SMB1(6)+SMB1(7)
       SMB(32) = 0
       SMB(33) = SMB1(13)
       SMB(34) = SMB1(14)
       SMB(35) = SMB1(18)
       ...
       SMB(41) = 2*SMB1(24)
       SMB(42) = 0
       SMB(43) = 2*(2*SMB1(6)+SMB1(7)-SMB1(38))
       SMB(44) = 0
       SMB(45) = 0
       SMB(46) = 0
       SMB(47) = 0
       SMB(48) = 0
       SMB(49) = -2*(p5sq+s123-s45-s56)*SMB1(3)+(p5sq+s123-s45-s56)*SM
     &   B1(7)-2*(p5sq-s45)*SMB1(21)-2*SMB1(27)
       SMB(50) = 2*(p5sq-s56)*SMB1(3)-2*p5sq*p6mup3*SMB1(5)+(-p5sq+s56
     &   )*SMB1(7)+4*p6mup3*SMB1(17)+2*p5sq*SMB1(21)
       SMB(51) = 0
       SMB(52) = 0
       SMB(53) = 2*(s12+s16-s345)*SMB1(3)+2*p6mup3*(-s16+s234-s34+s345
     &   )*SMB1(5)-(s12+s16-s345)*SMB1(7)+4*p6mup3*SMB1(16)+2*(s16-s2
     &   34+s34-s345)*SMB1(21)-2*SMB1(26)
       SMB(54) = 0
       SMB(55) = 2*(2*SMB1(3)-SMB1(7)+SMB1(38))
       SMB(56) = 0
       SMB(57) = 0
       SMB(58) = 0
       SMB(59) = 0
       ...
       SMB(64) = 0
       SMB(65) = SMB1(4)
       SMB(66) = (-p5sq+s45)*SMB1(5)-2*SMB1(8)
       SMB(67) = SMB1(15)
       SMB(68) = SMB1(20)
       SMB(69) = SMB1(27)
       SMB(70) = 2*(s16-s234+s56)*SMB1(2)-2*p4mup3*(s16-s234+s56)*SMB1
     &   (5)-2*(s123-s23+s234-s56)*SMB1(6)-4*p4mup3*SMB1(12)+2*SMB1(3
     &   2)+(s123-s23+s234-s56)*SMB1(38)
       SMB(71) = -2*(-(s45*SMB1(3))+p5sq*(SMB1(2)+SMB1(3)-p4mup3*SMB1(
     &   5))+2*p4mup3*SMB1(17))
       SMB(72) = 2*p6mup3*(-p5sq+s45)*SMB1(5)+2*(p5sq+s123-s45-s56)*SM
     ...
     &   SMB1(38)
       ...
       SMB(80) = 0
       SMB(81) = 0
       SMB(82) = 4*(2*SMB1(3)-2*SMB1(6)+SMB1(38))
       SMB(83) = 8*p6mup3*SMB1(5)-8*SMB1(21)
       SMB(84) = 0
       SMB(85) = 0
       SMB(86) = 0
       SMB(87) = 0
       ...
       SMB(93) = 0
       SMB(94) = 0
       SMB(95) = 4*(p5sq+s123-s45-s56)*SMB1(3)-8*p4mup3*SMB1(24)
c       Print*," SMB(1) ", SMB(1)
c       Print*," SMB(2) ", SMB(2)
c       Print*," SMB(3) ", SMB(3)
c       Print*," SMB(4) ", SMB(4)
