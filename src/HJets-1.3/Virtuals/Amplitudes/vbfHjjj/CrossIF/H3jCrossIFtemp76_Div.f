...
c************************************************************************************
c************************************************************************************
       subroutine H3jCrossIF76_Div(M,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,ps
...
c************************************************************************************
       ...
       SMB0(8) = SC1r(barpsi_p4_P,p1,psi_p2_P,+1)
       ...
       SMB0(14) = SC3crr(barpsi_p4_P,mup3,p5,p1,psi_p2_P,+1)
       SMB0(15) = SC3crr(barpsi_p4_P,mup3,p6,p1,psi_p2_P,+1)
