...
c************************************************************************************
c************************************************************************************
       subroutine NoAbeH3j66_c(M1sq,p1,p2,p3,p4,p5,p6,barpsi_p1,psi_p6,barp
     &   si_p3,psi_p4,mup2,musq,comp,result,resultborn)
c************************************************************************************
c************************************************************************************
...
c************************************************************************************
       ...
       SMB0(2) = SC1r(barpsi_p3_P,p1,psi_p4_P,+1)
       SMB0(3) = SC1r(barpsi_p3_P,p5,psi_p4_P,+1)
       SMB0(4) = SC1r(barpsi_p3_P,p6,psi_p4_P,+1)
       SMB0(5) = SC3rrr(barpsi_p3_P,p6,p5,p1,psi_p4_P,+1)
       SMB0(6) = SC1r(barpsi_p1_P,p5,psi_p6_P,+1)
       SMB0(7) = SC1r(barpsi_p1_P,p3,psi_p6_P,+1)
       SMB0(8) = SC1c(barpsi_p3_P,mup2,psi_p4_P,+1)
       SMB0(9) = SC3crr(barpsi_p3_P,mup2,p6,p1,psi_p4_P,+1)
       SMB0(10) = SC3crr(barpsi_p3_P,mup2,p6,p5,psi_p4_P,+1)
       ...
       SMB0(16) = SC3crr(barpsi_p3_P,mup2,p5,p1,psi_p4_P,+1)
c************************************************************************************
c************************************************************************************
      do i=0,3
        v1(0)=delta(i,0)
       ...
       SMB12(i) = SC1c(barpsi_p3_P,v1,psi_p4_P,+1)
       SMB13(i) = SC3crc(barpsi_p1_P,mup2,p5,v1,psi_p6_P,+1)
       SMB14(i) = SC3crc(barpsi_p3_P,mup2,p5,v1,psi_p4_P,+1)
      enddo
c************************************************************************************
c************************************************************************************
c************************************************************************************
...
c************************************************************************************
       ...
       SMB1(9) = SMB0(4)*SMB0(7)
       SMB1(10) = SMB0(7)*SMB0(9)
       SMB1(11) = SMB0(7)*SMB0(10)
       SMB1(12) = SMB0(8)*SMB0(11)
       SMB1(13) = SMB0(2)*SMB0(11)
       SMB1(14) = SMB0(3)*SMB0(11)
       SMB1(15) = SMB0(4)*SMB0(11)
       SMB1(16) = SMB0(9)*SMB0(11)
       SMB1(17) = SMB0(10)*SMB0(11)
       SMB1(18) = SMB0(6)*SMB0(8)
       SMB1(19) = SMB0(6)*SMB0(9)
       SMB1(20) = SMB0(6)*SMB0(10)
       SMB1(21) = SMB0(8)*SMB0(12)
       SMB1(22) = SMB0(2)*SMB0(13)
       SMB1(23) = SMB0(2)*SMB0(14)
       SMB1(24) = SMB0(3)*SMB0(13)
       SMB1(25) = SMB0(3)*SMB0(14)
       SMB1(26) = SMB0(4)*SMB0(13)
       SMB1(27) = SMB0(4)*SMB0(14)
       SMB1(29) = SMB0(4)*SMB0(15)
       SMB1(30) = SMB0(11)*SMB0(16)
c************************************************************************************
       SMB1(5) = dotcc(SMB11,SMB12)
       SMB1(6) = dotcc(SMB12,SMB13)
       SMB1(28) = dotcc(SMB11,SMB14)
c************************************************************************************
c************************************************************************************
       SMB(1) = SMB1(5)
       SMB(2) = SMB1(3)
       SMB(3) = 0
       SMB(4) = 2*p4mup2*SMB1(5)-2*SMB1(12)
       SMB(5) = SMB1(6)
       SMB(6) = SMB1(9)
       SMB(7) = 0
       SMB(8) = 0
       SMB(9) = 0
       SMB(10) = 2*p5mup2*SMB1(5)-SMB1(6)
       SMB(11) = -2*SMB1(3)+2*p6mup2*SMB1(5)
       SMB(12) = SMB1(12)
       SMB(13) = SMB1(8)
       SMB(14) = SMB1(10)
       SMB(15) = SMB1(11)
       ...
       SMB(22) = SMB1(20)
       SMB(23) = SMB1(21)
       SMB(24) = (-p5sq+s45)*SMB1(5)-2*SMB1(14)
       SMB(25) = 4*p3mup2*SMB1(5)
       SMB(26) = 4*p4mup2*SMB1(5)
       SMB(27) = 2*(p2sq-s12+s123-s23)*SMB1(12)-4*p3mup2*SMB1(13)
       SMB(28) = -2*(s34-s345+s45)*SMB1(12)-4*p3mup2*SMB1(14)
       SMB(29) = 2*(s12-s123-s345+s45)*SMB1(12)-4*p3mup2*SMB1(15)
       SMB(30) = 2*(SMB1(6)+SMB1(28))
       SMB(31) = (2*p5mup2*(p2sq-s12+s123-s23)+2*p3mup2*(s16-s234+s56)
     &   )*SMB1(5)+(-p2sq+s12-s123+s23)*SMB1(6)
       SMB(32) = -2*p3mup2*p5sq*SMB1(5)-(s34-s345+s45)*(2*p5mup2*SMB1(
     &   5)-SMB1(6))
       SMB(33) = 2*p5mup2*(s12-s123-s345+s45)*SMB1(5)+(-s12+s123+s345-
     &   s45)*SMB1(6)-4*p3mup2*SMB1(7)
       SMB(34) = 2*((s16-s234+s56)*SMB1(12)+SMB1(30))
       SMB(35) = 2*p5mup2*(-p5sq+s45)*SMB1(5)+(p5sq-s45)*SMB1(6)-2*p5s
     &   q*SMB1(12)
       SMB(36) = 2*(p5sq-s45)*SMB1(3)-2*p6mup2*(p5sq-s45)*SMB1(5)-2*SM
     &   B1(17)
       SMB(37) = 0
       SMB(38) = 2*SMB1(7)
       SMB(39) = 16*SMB1(5)
       SMB(40) = SMB1(13)
       SMB(41) = 2*(-s123+s23-s234+s56)*SMB1(5)
       SMB(42) = SMB1(14)
       SMB(43) = 2*(-p5sq+s45)*SMB1(5)
       SMB(44) = 2*(p5sq+s123-s45-s56)*SMB1(5)
       SMB(45) = 0
       SMB(46) = -2*(s16-s234+s56)*SMB1(5)
       SMB(47) = 4*p5sq*SMB1(5)
       SMB(48) = 2*(-p5sq+s56)*SMB1(5)
       SMB(49) = -2*(s34-s345+s45)*SMB1(5)
       SMB(50) = 2*(s12-s123-s345+s45)*SMB1(5)
       SMB(51) = SMB1(1)
       SMB(52) = SMB1(2)
       SMB(53) = SMB1(4)
       SMB(54) = SMB1(22)
       ...
       SMB(58) = SMB1(26)
       SMB(59) = SMB1(27)
       SMB(60) = 4*p1mup2*SMB1(5)
       SMB(61) = 8*p5mup2*SMB1(5)-2*(SMB1(6)+SMB1(28))
       SMB(62) = 4*p6mup2*SMB1(5)
       SMB(63) = (2*p5mup2*(p2sq-s12+s123-s23)+2*p1mup2*(s34-s345+s45)
     &   )*SMB1(5)+(-p2sq+s12-s123+s23)*SMB1(28)
       SMB(64) = 2*(p2sq-s12+s123-s23)*SMB1(3)-4*p1mup2*SMB1(9)
       SMB(65) = -2*(s34-s345+s45)*SMB1(3)-2*SMB1(29)
       SMB(66) = -2*p5mup2*(s123-s23+s234-s56)*SMB1(5)-4*p1mup2*SMB1(1
     &   4)+(s123-s23+s234-s56)*SMB1(28)
       SMB(67) = -2*(s123-s23+s234-s56)*SMB1(3)-4*p1mup2*SMB1(15)
       SMB(68) = -2*(p5sq*SMB1(3)-s45*SMB1(3)+SMB1(27))
       SMB(69) = -2*p1mup2*p5sq*SMB1(5)-(s16-s234+s56)*(2*p5mup2*SMB1(
     &   5)-SMB1(28))
       SMB(70) = -2*(s16-s234+s56)*SMB1(3)-4*p1mup2*SMB1(7)
       SMB(71) = 2*p5sq*SMB1(3)
       SMB(72) = 2*(p2sq-s12+s123-s23)*SMB1(5)
c       Print*," SMB(1) ", SMB(1)
c       Print*," SMB(2) ", SMB(2)
c       Print*," SMB(3) ", SMB(3)
c       Print*," SMB(4) ", SMB(4)
