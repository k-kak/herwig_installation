       subroutine NoAbeH3j66T_c(M1sq,p1,p2,p3,p4,p5,p6,barpsi_p1,psi_p6,barpsi_p2
...
c************************************************************************************
     ...
     &   45R,B045I, B046R,B046I, B056R,B056I
       ...
       complex*16 m1sq
      if(Div.eq.0)then
       call  NoAbeH3j66_c(M1sq,p1,p2,p3,p4,p5,p6,barpsi_p1,psi_p6,barpsi_p2
     &   ,psi_p4,mup3,musq,comp,result,resultn)

      else

      call NoAbeH3j66Div_c(M1sq,p1,p2,p3,p4,p5,p6,barpsi_p1,psi_p6,barpsi_p2
     &   ,psi_p4,mup3,musq,comp,result,resultn,Div)
       ...
       subroutine NoAbeH3j67T_c(M1sq,p1,p2,p3,p4,p5,p6,barpsi_p1,psi_p6,barpsi_p2
     &   ,psi_p4,mup3,musq,comp,result,resultn,Div)
       IMPLICIT NONE
      Complex*16 SMB(95),Fa(40),F(206)
       Complex*16 SMB0(16),SMB11(0:3),SMB12(0:3),SMB13(0:3),SMB14(0:3)
...
c************************************************************************************
     ...
     &   45R,B045I, B046R,B046I, B056R,B056I
       ...
       complex*16 m1sq
      if(Div.eq.0)then
       call  NoAbeH3j67_c(M1sq,p1,p2,p3,p4,p5,p6,barpsi_p1,psi_p6,barpsi_p2
     &   ,psi_p4,mup3,musq,comp,result,resultn)

      else

      call NoAbeH3j67Div_c(M1sq,p1,p2,p3,p4,p5,p6,barpsi_p1,psi_p6,barpsi_p2
     &   ,psi_p4,mup3,musq,comp,result,resultn,Div)
       ...
       subroutine NoAbeH3j76T_c(M1sq,p1,p2,p3,p4,p5,p6,barpsi_p1,psi_p6,barpsi_p2
     &   ,psi_p4,mup3,musq,comp,result,resultn,Div)
       IMPLICIT NONE
      Complex*16 SMB(95),Fa(40),F(206)
       Complex*16 SMB0(16),SMB11(0:3),SMB12(0:3),SMB13(0:3),SMB14(0:3)
...
c************************************************************************************
     ...
     &   45R,B045I, B046R,B046I, B056R,B056I
      ...
      if(Div.eq.0)then
       call  NoAbeH3j76_c(M1sq,p1,p2,p3,p4,p5,p6,barpsi_p1,psi_p6,barpsi_p2
     &   ,psi_p4,mup3,musq,comp,result,resultn)

      else

      call NoAbeH3j76Div_c(M1sq,p1,p2,p3,p4,p5,p6,barpsi_p1,psi_p6,barpsi_p2
     &   ,psi_p4,mup3,musq,comp,result,resultn,Div)
      
      endif
      end

       subroutine NoAbeH3j77T_c(M1sq,p1,p2,p3,p4,p5,p6,barpsi_p1,psi_p6,barpsi_p2
     &   ,psi_p4,mup3,musq,comp,result,resultn,Div)
       IMPLICIT NONE
      Complex*16 SMB(95),Fa(40),F(206)
       Complex*16 SMB0(16),SMB11(0:3),SMB12(0:3),SMB13(0:3),SMB14(0:3)
...
c************************************************************************************
     ...
     &   45R,B045I, B046R,B046I, B056R,B056I
      ...
      if(Div.eq.0)then
       call  NoAbeH3j77_c(M1sq,p1,p2,p3,p4,p5,p6,barpsi_p1,psi_p6,barpsi_p2
     &   ,psi_p4,mup3,musq,comp,result,resultn)

      else

      call NoAbeH3j77Div_c(M1sq,p1,p2,p3,p4,p5,p6,barpsi_p1,psi_p6,barpsi_p2
     &   ,psi_p4,mup3,musq,comp,result,resultn,Div)
