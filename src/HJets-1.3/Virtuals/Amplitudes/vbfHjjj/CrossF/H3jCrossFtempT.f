       subroutine H3jCrossF66T(M,p1,p2,p3,p4,p5,p6,barpsi_p1,psi_p6,psi
...
c************************************************************************************
     ...
     &   6I, B045R,B045I, B046R,B046I, B056R,B056I
       Integer ngluon, posgluon,Div
         if(Div.eq.0) then
           call  H3jCrossF66(M,p1,p2,p3,p4,p5,p6,barpsi_p1,psi_p6,psi
     &   _p2,barpsi_p4,mup3,musq,comp,result,resultn)
            else
           call H3jCrossF66_Div(M,p1,p2,p3,p4,p5,p6,barpsi_p1,psi_p6,psi
     &   _p2,barpsi_p4,mup3,musq,comp,result,resultn,Div)
         endif
         return
         end
       ...
       subroutine H3jCrossF67T(M,p1,p2,p3,p4,p5,p6,barpsi_p1,psi_p6,psi
     &   _p2,barpsi_p4,mup3,musq,comp,result,resultn,Div)
       IMPLICIT NONE
      Complex*16 SMB(95),Fa(44),F(214)
       Complex*16 SMB0(16),SMB11(0:3),SMB12(0:3),SMB13(0:3),SMB14(0:3)
...
c************************************************************************************
     ...
     &   6I, B045R,B045I, B046R,B046I, B056R,B056I
       Integer ngluon, posgluon,Div
         if(Div.eq.0) then
           call  H3jCrossF67(M,p1,p2,p3,p4,p5,p6,barpsi_p1,psi_p6,psi
     &   _p2,barpsi_p4,mup3,musq,comp,result,resultn)
            else
           call H3jCrossF67_Div(M,p1,p2,p3,p4,p5,p6,barpsi_p1,psi_p6,psi
     &   _p2,barpsi_p4,mup3,musq,comp,result,resultn,Div)
         endif
         return
         end

       subroutine H3jCrossF76T(M,p1,p2,p3,p4,p5,p6,barpsi_p1,psi_p6,psi
     &   _p2,barpsi_p4,mup3,musq,comp,result,resultn,Div)
       IMPLICIT NONE
      Complex*16 SMB(95),Fa(44),F(214)
       Complex*16 SMB0(16),SMB11(0:3),SMB12(0:3),SMB13(0:3),SMB14(0:3)
...
c************************************************************************************
     ...
     &   6I, B045R,B045I, B046R,B046I, B056R,B056I
       Integer ngluon, posgluon,Div
         if(Div.eq.0) then
           call  H3jCrossF76(M,p1,p2,p3,p4,p5,p6,barpsi_p1,psi_p6,psi
     &   _p2,barpsi_p4,mup3,musq,comp,result,resultn)
            else
           call H3jCrossF76_Div(M,p1,p2,p3,p4,p5,p6,barpsi_p1,psi_p6,psi
     &   _p2,barpsi_p4,mup3,musq,comp,result,resultn,Div)
         endif
         return
         end
       ...
       subroutine H3jCrossF77T(M,p1,p2,p3,p4,p5,p6,barpsi_p1,psi_p6,psi
     &   _p2,barpsi_p4,mup3,musq,comp,result,resultn,Div)
       IMPLICIT NONE
      Complex*16 SMB(95),Fa(44),F(214)
       Complex*16 SMB0(16),SMB11(0:3),SMB12(0:3),SMB13(0:3),SMB14(0:3)
...
c************************************************************************************
     ...
     &   6I, B045R,B045I, B046R,B046I, B056R,B056I
       Integer ngluon, posgluon,Div
         if(Div.eq.0) then
           call  H3jCrossF77(M,p1,p2,p3,p4,p5,p6,barpsi_p1,psi_p6,psi
     &   _p2,barpsi_p4,mup3,musq,comp,result,resultn)
            else
           call H3jCrossF77_Div(M,p1,p2,p3,p4,p5,p6,barpsi_p1,psi_p6,psi
     &   _p2,barpsi_p4,mup3,musq,comp,result,resultn,Div)
         endif
         return
         end
