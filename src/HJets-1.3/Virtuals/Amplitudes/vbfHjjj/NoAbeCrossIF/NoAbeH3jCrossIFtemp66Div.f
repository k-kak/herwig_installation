...
c************************************************************************************
c************************************************************************************
       subroutine NoAbeH3jCrossIF66Div_C(M1sq,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_
...
c************************************************************************************
c************************************************************************************
       SMB0(1) = SC1c(barpsi_p4_P,mup2,psi_p3_P,+1)
       ...
       SMB0(6) = SC1r(barpsi_p4_P,p5,psi_p3_P,+1)
       SMB0(7) = SC1r(barpsi_p4_P,p1,psi_p3_P,+1)
       SMB0(8) = SC1c(barpsi_p6_P,mup2,psi_p1_P,+1)
       SMB0(9) = SC3crr(barpsi_p6_P,mup2,p4,p3,psi_p1_P,+1)
       SMB0(10) = SC3crr(barpsi_p6_P,mup2,p5,p3,psi_p1_P,+1)
       SMB0(11) = SC3crr(barpsi_p6_P,mup2,p5,p4,psi_p1_P,+1)
       SMB0(12) = SC1r(barpsi_p4_P,p6,psi_p3_P,+1)
       SMB0(13) = SC3rrr(barpsi_p4_P,p6,p5,p1,psi_p3_P,+1)
       SMB0(14) = SC3crr(barpsi_p4_P,mup2,p5,p1,psi_p3_P,+1)
       SMB0(15) = SC3crr(barpsi_p4_P,mup2,p6,p1,psi_p3_P,+1)
       SMB0(16) = SC3crr(barpsi_p4_P,mup2,p6,p5,psi_p3_P,+1)
c************************************************************************************
c************************************************************************************
      do i=0,3
        v1(0)=delta(i,0)
        ...
        v1(2)=delta(i,2)
        v1(3)=delta(i,3)
       SMB11(i) = SC1c(barpsi_p4_P,v1,psi_p3_P,+1)
       SMB12(i) = SC1c(barpsi_p6_P,v1,psi_p1_P,+1)
       SMB13(i) = SC3crc(barpsi_p4_P,mup2,p5,v1,psi_p3_P,+1)
