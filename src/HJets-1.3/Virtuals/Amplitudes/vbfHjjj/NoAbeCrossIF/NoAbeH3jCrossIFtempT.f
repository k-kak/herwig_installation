       subroutine NoAbeH3jCrossIF66T_c(M1sq,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,ps
     &   i_p2,barpsi_p4,mup3,musq,comp,result,resultn,Div)
       IMPLICIT NONE
...
c************************************************************************************
     ...
     -          p4mup3, p4mup4, p5mup3, p5mup4, p6mup3, p6mup4
      ...
      Complex*16 dotrc,dotcc,result(2),resultn
       Real*8 musq
      ...
      Save/NoAbeH3jCrossIFPFunctions/
       COMMON/NoAbeH3jCrossIFInvariants/p1sq,p2sq,p3sq,p4sq,p5sq,p6sq,s12,s
     &   23,s34,s45,s56,s16,s123,s234,s345
       COMMON/NoAbeH3jCrossIFFVALFunctions/F0123456R,F123456R,F0123456I,F12
     &   3456I
       COMMON/NoAbeH3jCrossIFEVALFunctions/ E012345R,E12345R,E012345I,E1234
     ...
     &   3456R,E013456I,E13456I, E023456R,E23456R,E023456I,E23456I
       COMMON/NoAbeH3jCrossIFDVALFunctions/ D01234R,D1234R,D01234I,D1234I, 
     ...
     &   3456I,D3456I
       COMMON/NoAbeH3jCrossIFCVALFunctions/ C0123R,C123R,C0123I,C123I, C012
     ...
     &   , C0456R,C456R,C0456I,C456I
       COMMON/NoAbeH3jCrossIFBVALFunctions/ B012R,B012I, B013R,B013I, B014R
     ...
     &   36I, B045R,B045I, B046R,B046I, B056R,B056I
       ...
       complex*16 m1sq
        if(Div.eq.0) then
         call  NoAbeH3jCrossIF66_c(M1sq,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,ps
     &   i_p2,barpsi_p4,mup3,musq,comp,result,resultn)

           else
         call NoAbeH3jCrossIF66Div_c(M1sq,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,ps
     &   i_p2,barpsi_p4,mup3,musq,comp,result,resultn,Div)   
        endif
        return
        end
       ...
       subroutine NoAbeH3jCrossIF67T_c(M1sq,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,ps
     &   i_p2,barpsi_p4,mup3,musq,comp,result,resultn,Div)
       IMPLICIT NONE
      Complex*16 SMB(95),Fa(40),F(203)
       Complex*16 SMB0(16),SMB11(0:3),SMB12(0:3),SMB13(0:3),SMB14(0:3)
...
c************************************************************************************
     ...
     &   36I, B045R,B045I, B046R,B046I, B056R,B056I
       ...
       complex*16 m1sq
        if(Div.eq.0) then
         call  NoAbeH3jCrossIF67_c(M1sq,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,ps
     &   i_p2,barpsi_p4,mup3,musq,comp,result,resultn)

           else
         call NoAbeH3jCrossIF67Div_c(M1sq,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,ps
     &   i_p2,barpsi_p4,mup3,musq,comp,result,resultn,Div)   
        endif
        return
        end

       subroutine NoAbeH3jCrossIF76T_c(M1sq,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,ps
     &   i_p2,barpsi_p4,mup3,musq,comp,result,resultn,Div)
       IMPLICIT NONE
      Complex*16 SMB(95),Fa(40),F(203)
       Complex*16 SMB0(16),SMB11(0:3),SMB12(0:3),SMB13(0:3),SMB14(0:3)
...
c************************************************************************************
     ...
     &   36I, B045R,B045I, B046R,B046I, B056R,B056I
       ...
       complex*16 m1sq
        if(Div.eq.0) then
         call  NoAbeH3jCrossIF76_c(M1sq,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,ps
     &   i_p2,barpsi_p4,mup3,musq,comp,result,resultn)

           else
         call NoAbeH3jCrossIF76Div_c(M1sq,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,ps
     &   i_p2,barpsi_p4,mup3,musq,comp,result,resultn,Div)   
        endif
        return
        end
       ...
       subroutine NoAbeH3jCrossIF77T_c(M1sq,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,ps
     &   i_p2,barpsi_p4,mup3,musq,comp,result,resultn,Div)
       IMPLICIT NONE
      Complex*16 SMB(95),Fa(40),F(203)
       Complex*16 SMB0(16),SMB11(0:3),SMB12(0:3),SMB13(0:3),SMB14(0:3)
...
c************************************************************************************
     ...
     &   36I, B045R,B045I, B046R,B046I, B056R,B056I
       ...
       complex*16 m1sq
        if(Div.eq.0) then
         call  NoAbeH3jCrossIF77_c(M1sq,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,ps
     &   i_p2,barpsi_p4,mup3,musq,comp,result,resultn)

           else
         call NoAbeH3jCrossIF77Div_c(M1sq,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,ps
     &   i_p2,barpsi_p4,mup3,musq,comp,result,resultn,Div)   
        endif
        return
        end
