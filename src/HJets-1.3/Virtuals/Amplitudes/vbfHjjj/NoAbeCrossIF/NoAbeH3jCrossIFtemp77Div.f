...
c************************************************************************************
c************************************************************************************
       subroutine NoAbeH3jCrossIF77Div_c(M1sq,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_
     &   p6,psi_p3,barpsi_p4,mup2,musq,comp,result,resultborn,Div)
c************************************************************************************
c************************************************************************************
...
c************************************************************************************
       IMPLICIT NONE
      Complex*16 SMB(82),Fa(26),F(183)
       Complex*16 SMB0(16),SMB11(0:3),SMB12(0:3),SMB13(0:3),SMB14(0:3)
      Complex*16 SMB1(38)
      Real*8 FI(183),FR(183)
      Complex*16 barpsi_p6_P(2),psi_p1_P(2),barpsi_p4_P(2),psi_p3_P(2) 
       Complex*16 barpsi_p6_M(2),psi_p1_M(2),barpsi_p4_M(2),psi_p3_M(2)
       Complex*16 barpsi_p6(4),psi_p1(4),barpsi_p4(4),psi_p3(4)
       Real*8 P(57)
...
c    Calling C_ij,D_ij,E_ij,F_ij Functions    
       ...
       call FgetNoAbeCrossIF_Div_c(M1SQ,p1,p2,p3,p4,p5,p6,musq,Div)            
...
c************************************************************************************
c************************************************************************************
       call NoAbeH3jCrossIFFFhl1(F(1))
       call NoAbeH3jCrossIFFFhl2(F(37))
       call NoAbeH3jCrossIFFFhl3(F(73))
       call NoAbeH3jCrossIFFFhl4(F(109))
       call NoAbeH3jCrossIFFFhl5(F(145))
c************************************************************************************
c************************************************************************************
c************************************************************************************
       endif  
...
c************************************************************************************
c************************************************************************************
       call NoAbeH3jCrossIFFa1(p1mup2,p2mup2,p3mup2,p4mup2,p5mup2,p6mu
     &   p2,Fa(1))
       call NoAbeH3jCrossIFFa2(p1mup2,p2mup2,p3mup2,p4mup2,p5mup2,p6mu
     &   p2,Fa(14))
c************************************************************************************
c************************************************************************************
c************************************************************************************
...
c************************************************************************************
c************************************************************************************
       SMB0(1) = SC1c(barpsi_p4_M,mup2,psi_p3_M,-1)
       ...
       SMB0(6) = SC1r(barpsi_p4_M,p5,psi_p3_M,-1)
       SMB0(7) = SC1r(barpsi_p4_M,p1,psi_p3_M,-1)
       SMB0(8) = SC1c(barpsi_p6_M,mup2,psi_p1_M,-1)
       SMB0(9) = SC3crr(barpsi_p6_M,mup2,p4,p3,psi_p1_M,-1)
       SMB0(10) = SC3crr(barpsi_p6_M,mup2,p5,p3,psi_p1_M,-1)
       SMB0(11) = SC3crr(barpsi_p6_M,mup2,p5,p4,psi_p1_M,-1)
       SMB0(12) = SC1r(barpsi_p4_M,p6,psi_p3_M,-1)
       SMB0(13) = SC3rrr(barpsi_p4_M,p6,p5,p1,psi_p3_M,-1)
       SMB0(14) = SC3crr(barpsi_p4_M,mup2,p5,p1,psi_p3_M,-1)
       SMB0(15) = SC3crr(barpsi_p4_M,mup2,p6,p1,psi_p3_M,-1)
       SMB0(16) = SC3crr(barpsi_p4_M,mup2,p6,p5,psi_p3_M,-1)
c************************************************************************************
c************************************************************************************
      do i=0,3
        v1(0)=delta(i,0)
        ...
        v1(2)=delta(i,2)
        v1(3)=delta(i,3)
       SMB11(i) = SC1c(barpsi_p4_M,v1,psi_p3_M,-1)
       SMB12(i) = SC1c(barpsi_p6_M,v1,psi_p1_M,-1)
       SMB13(i) = SC3crc(barpsi_p4_M,mup2,p5,v1,psi_p3_M,-1)
...
c************************************************************************************
       ...
       SMB(32) = SMB1(37)
       SMB(33) = 16*SMB1(5)
       SMB(34) = 2*(-s123+s23-s234+s56)*SMB1(5)
       SMB(35) = -2*(s16-s234+s56)*SMB1(5)
       SMB(36) = 0
       ...
       SMB(41) = s34*SMB1(5)
       SMB(42) = -((s34-s345+s45)*SMB1(5))-2*SMB1(7)
       ...
       SMB(56) = 2*(SMB1(6)+SMB1(38))
       SMB(57) = 2*((s16-s234+s56)*SMB1(1)-p3mup2*(s16-s234+s56)*SMB1(
     &   5)+(s34-s345+s45)*SMB1(8)+SMB1(13))
       SMB(58) = 2*((p5sq-s45)*SMB1(8)+SMB1(14))
       SMB(59) = -2*p5mup2*(s16-s234+s56)*SMB1(5)+(s16-s234+s56)*SMB1(
     &   6)-2*p5sq*SMB1(8)
       SMB(60) = 4*p6mup2*SMB1(5)
       SMB(61) = -2*s16*SMB1(1)+2*p3mup2*s16*SMB1(5)+2*(-s12+s123+s345
     &   -s45)*SMB1(8)+4*p6mup2*SMB1(9)
       SMB(62) = 2*(-p5sq-s123+s45+s56)*SMB1(8)+4*p6mup2*SMB1(10)
       SMB(63) = 2*p5mup2*s16*SMB1(5)-s16*SMB1(6)+2*(p5sq-s56)*SMB1(8)
     &   +4*p6mup2*SMB1(11)
       SMB(64) = 2*(p5sq-s56)*SMB1(1)+(2*p5mup2*(-s12+s123+s345-s45)-2
     &   *p3mup2*(p5sq-s56))*SMB1(5)+(s12-s123-s345+s45)*SMB1(6)+4*p6
     &   mup2*SMB1(7)
       SMB(65) = (2*p6mup2*(-p5sq+s45)-2*p5mup2*(p5sq+s123-s45-s56))*S
     &   MB1(5)+(p5sq+s123-s45-s56)*SMB1(6)
       ...
       SMB(69) = SMB1(27)
       SMB(70) = SMB1(4)
       SMB(71) = 4*p3mup2*SMB1(5)
       SMB(72) = 4*p4mup2*SMB1(5)
       SMB(73) = 8*p5mup2*SMB1(5)-2*(SMB1(6)+SMB1(38))
       SMB(74) = 2*(s123-s23+s234-s56)*SMB1(1)+2*p1mup2*s34*SMB1(5)-2*
     &   s34*SMB1(8)+4*p4mup2*SMB1(9)
       SMB(75) = 2*((s16-s234+s56)*SMB1(1)-p1mup2*(s34-s345+s45)*SMB1(
     &   5)+(s34-s345+s45)*SMB1(8)+SMB1(29))
       SMB(76) = -2*p5mup2*(s123-s23+s234-s56)*SMB1(5)-4*p4mup2*SMB1(1
     &   1)+(s123-s23+s234-s56)*SMB1(38)
       SMB(77) = 2*(p5sq-s45)*SMB1(1)+2*p5mup2*s34*SMB1(5)+4*p4mup2*SM
     &   B1(7)-s34*SMB1(38)
       SMB(78) = -2*p5sq*SMB1(1)-(s34-s345+s45)*(2*p5mup2*SMB1(5)-SMB1
     &   (38))
       SMB(79) = -2*(p4mup2*p5sq+p5mup2*(p5sq-s45))*SMB1(5)+(p5sq-s45)
     &   *SMB1(38)
       SMB(80) = 2*(-p5sq-s123+s45+s56)*SMB1(1)+4*p4mup2*SMB1(22)
       SMB(81) = -2*SMB1(31)
       SMB(82) = 2*p4mup2*(p5sq-s56)*SMB1(5)+(p5sq+s123-s45-s56)*(2*p5
     &   mup2*SMB1(5)-SMB1(38))
c       Print*," SMB(1) ", SMB(1)
c       Print*," SMB(2) ", SMB(2)
c       Print*," SMB(3) ", SMB(3)
...
c  c So, I*I=(-1)!!!
       result(1) = F(1)*SMB(1)+F(2)*SMB(2)+F(3)*SMB(3)+Fa(7)*SMB(10)+8
     &   *(-(Fa(1)*SMB(4))+Fa(5)*SMB(8)-Fa(6)*SMB(9)+Fa(8)*SMB(11)+Fa
     &   (9)*SMB(12))+F(37)*SMB(13)+Fa(10)*SMB(14)+F(43)*SMB(15)+F(44
     &   )*SMB(16)+F(45)*SMB(17)+Fa(14)*SMB(33)+Fa(15)*SMB(34)+Fa(16)
     &   *SMB(35)+Fa(18)*SMB(37)+Fa(19)*SMB(38)+Fa(20)*SMB(39)+Fa(21)
     &   *SMB(40)+Fa(23)*SMB(42)+Fa(24)*SMB(43)+Fa(25)*SMB(44)+Fa(26)
     &   *SMB(45)+F(130)*SMB(46)+F(131)*SMB(47)+F(132)*SMB(48)+F(148)
     &   *SMB(68)+F(149)*SMB(69)+4*(Fa(2)*SMB(5)+Fa(3)*SMB(6)+Fa(4)*S
     &   MB(7)+F(4)*SMB(23)+F(56)*SMB(24)+F(57)*SMB(25)+F(58)*SMB(26)
     &   +F(59)*SMB(27)-F(60)*SMB(28)+F(66)*SMB(30)+F(22)*SMB(31)+F(2
     &   5)*SMB(32)-F(5)*SMB(49)+F(55)*(SMB(22)-SMB(50))-F(133)*SMB(5
     &   1)-F(134)*SMB(52)-F(135)*SMB(53)-F(136)*SMB(54)+F(147)*SMB(6
     &   7)-F(150)*SMB(70))+2*(Fa(11)*SMB(18)+Fa(12)*SMB(19)+F(53)*SM
     &   B(20)+F(54)*SMB(21)+Fa(13)*SMB(29)+Fa(17)*SMB(36)+Fa(22)*SMB
     &   (41)-F(137)*SMB(55)-F(138)*SMB(56)+F(139)*SMB(57)+F(140)*SMB
     &   (58)+F(58)*SMB(59)-F(141)*SMB(60)+F(142)*SMB(61)+F(143)*SMB(
     &   62)+F(144)*SMB(63)+F(36)*SMB(64)+F(145)*SMB(65)+F(146)*SMB(6
     &   6)+F(151)*SMB(71)+F(152)*SMB(72)+F(153)*SMB(73)-F(154)*SMB(7
     &   4)-F(155)*SMB(75)-F(23)*SMB(76)-F(156)*SMB(77)-F(134)*SMB(78
     &   )-F(157)*SMB(79)-F(158)*SMB(80)-F(159)*SMB(81)-F(160)*SMB(82
     &   ))
       result(2) = F(161)*SMB(5)+F(162)*SMB(6)+F(163)*SMB(7)-2*(F(164)
     &   *SMB(8)+F(165)*SMB(10)+F(166)*SMB(11)+F(167)*SMB(12))+F(168)
     &   *SMB(14)+F(169)*SMB(18)+F(170)*SMB(19)+F(171)*SMB(29)+F(172)
     &   *SMB(33)+F(173)*SMB(34)+F(174)*SMB(35)+F(175)*SMB(36)+F(176)
     &   *SMB(37)+F(177)*SMB(38)+F(178)*SMB(39)+F(179)*SMB(40)+F(180)
     &   *SMB(41)+F(181)*SMB(42)+F(182)*SMB(43)+F(183)*SMB(44)
       ngluon=1
       If (ngluon.eq.0) then
     ...
     &   . Look to the heading for explanation" 
       ...
       resultborn = -((2*SMB(13)+SMB(15)+SMB(16)+SMB(17))/((M1SQ-s16)*
     &   (M1SQ-s234)*(p2sq-s23+s234-s34)))-(2*SMB(1)+2*SMB(2)+2*SMB(3
     &   )-2*(p1mup2+p5mup2+p6mup2)*SMB(14)+SMB(15)+SMB(16)+SMB(17)-2
     &   *(SMB(20)+SMB(21)))/((M1SQ-s16)*s23*(M1SQ-s234))-(2*SMB(1)+S
     &   MB(46)+SMB(47)+SMB(48))/((M1SQ-s34)*(M1SQ-s345)*(p2sq-s12-s1
     &   6+s345))-(-2*SMB(2)-2*SMB(3)+2*SMB(13)-2*(p3mup2+p4mup2+p5mu
     &   p2)*SMB(14)+2*SMB(20)+2*SMB(21)+SMB(46)+SMB(47)+SMB(48))/(s1
     &   2*(M1SQ-s34)*(M1SQ-s345))
c************************************************************************************
c************************************************************************************
c************************************************************************************
       Return
