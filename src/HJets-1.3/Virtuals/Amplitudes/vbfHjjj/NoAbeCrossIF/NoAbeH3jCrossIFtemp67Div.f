...
c************************************************************************************
c************************************************************************************
       subroutine NoAbeH3jCrossIF76Div_c(M1sq,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_
...
c************************************************************************************
       ...
       SMB0(7) = SC1c(barpsi_p6_P,mup2,psi_p1_P,+1)
       SMB0(8) = SC1r(barpsi_p4_M,p1,psi_p3_M,-1)
...
c************************************************************************************
       ...
       SMB(15) = 0
       SMB(16) = SMB1(7)
       SMB(17) = 2*p6mup2*SMB1(5)-2*SMB1(21)
       SMB(18) = 0
       SMB(19) = 0
       SMB(20) = SMB1(2)
       SMB(21) = SMB1(3)
       ...
       SMB(34) = 0
       SMB(35) = 0
       SMB(36) = (-p5sq+s45)*SMB1(5)-2*SMB1(8)
       SMB(37) = 0
       SMB(38) = 4*SMB1(17)
       SMB(39) = 0
       SMB(40) = 0
       ...
       SMB(54) = SMB1(26)
       SMB(55) = 0
       SMB(56) = 2*(2*SMB1(6)+SMB1(7)-SMB1(38))
       SMB(57) = 0
       SMB(58) = 0
       SMB(59) = 0
       SMB(60) = 0
       ...
       SMB(62) = 0
       SMB(63) = 0
       SMB(64) = -2*(s12-s123-s345+s45)*SMB1(3)+2*p6mup2*(s34-s345+s45
     &   )*SMB1(5)+(s12-s123-s345+s45)*SMB1(7)+4*p6mup2*SMB1(16)-2*(s
     &   34-s345+s45)*SMB1(21)-2*SMB1(26)
       SMB(65) = -2*(p5sq+s123-s45-s56)*SMB1(3)+(p5sq+s123-s45-s56)*SM
     &   B1(7)-2*(p5sq-s45)*SMB1(21)-2*SMB1(27)
       SMB(66) = 2*(p5sq-s56)*SMB1(3)-2*p5sq*p6mup2*SMB1(5)+(-p5sq+s56
     &   )*SMB1(7)+4*p6mup2*SMB1(17)+2*p5sq*SMB1(21)
       SMB(67) = SMB1(15)
       SMB(68) = SMB1(20)
       SMB(69) = SMB1(27)
       SMB(70) = SMB1(4)
       SMB(71) = 0
       SMB(72) = 0
       SMB(73) = 2*(2*SMB1(3)-SMB1(7)+SMB1(38))
       SMB(74) = 0
       SMB(75) = 0
       SMB(76) = 2*(s16-s234+s56)*SMB1(2)-2*p4mup2*(s16-s234+s56)*SMB1
     &   (5)-2*(s123-s23+s234-s56)*SMB1(6)-4*p4mup2*SMB1(12)+2*SMB1(3
     &   2)+(s123-s23+s234-s56)*SMB1(38)
       SMB(77) = 0
       SMB(78) = 0
       SMB(79) = -2*(-(s45*SMB1(3))+p5sq*(SMB1(2)+SMB1(3)-p4mup2*SMB1(
     &   5))+2*p4mup2*SMB1(17))
       SMB(80) = 0
       SMB(81) = 0
       SMB(82) = 2*p6mup2*(-p5sq+s45)*SMB1(5)+2*(p5sq+s123-s45-s56)*SM
     &   B1(6)+2*(p5sq-s45)*SMB1(21)-2*SMB1(34)+(-p5sq-s123+s45+s56)*
     &   SMB1(38)
c       Print*," SMB(1) ", SMB(1)
c       Print*," SMB(2) ", SMB(2)
c       Print*," SMB(3) ", SMB(3)
