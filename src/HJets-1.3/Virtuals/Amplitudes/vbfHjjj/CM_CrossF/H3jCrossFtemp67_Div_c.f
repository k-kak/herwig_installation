...
c************************************************************************************
c************************************************************************************
       subroutine H3jCrossF67_Div_c(M1sq,p1,p2,p3,p4,p5,p6,barpsi_p1,psi_p6,psi
...
c************************************************************************************
       ...
       SMB0(7) = SC1c(barpsi_p4_M,mup3,psi_p2_M,-1)
       SMB0(8) = SC3crr(barpsi_p4_M,mup3,p6,p1,psi_p2_M,-1)
       SMB0(9) = SC1r(barpsi_p1_P,p2,psi_p6_P,+1)
       SMB0(10) = SC3crr(barpsi_p4_M,mup3,p5,p1,psi_p2_M,-1)
