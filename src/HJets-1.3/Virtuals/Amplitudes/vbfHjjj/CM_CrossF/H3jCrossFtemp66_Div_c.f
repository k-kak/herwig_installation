...
c************************************************************************************
c************************************************************************************
       subroutine H3jCrossF66_Div_c(M1sq,p1,p2,p3,p4,p5,p6,barpsi_p1,psi_p6,psi
     &   _p2,barpsi_p4,mup3,musq,comp,result,resultborn,Div)
c************************************************************************************
c************************************************************************************
...
c************************************************************************************
     ...
     &   6I, B045R,B045I, B046R,B046I, B056R,B056I
       ...
       call FgetCrossF_Div_c(M1sq,p1,p2,p3,p4,p5,p6,musq,Div)
...
c************************************************************************************
       ...
       SMB0(8) = SC1c(barpsi_p4_P,mup3,psi_p2_P,+1)
       SMB0(9) = SC3crr(barpsi_p4_P,mup3,p5,p1,psi_p2_P,+1)
       SMB0(10) = SC3crr(barpsi_p4_P,mup3,p6,p1,psi_p2_P,+1)
...
c************************************************************************************
       ...
       SMB(8) = SMB1(6)
       SMB(9) = SMB1(8)
       SMB(10) = 2*p2mup3*SMB1(5)-2*SMB1(8)
       SMB(11) = SMB1(9)
       SMB(12) = SMB1(10)
       SMB(13) = SMB1(11)
       SMB(14) = SMB1(16)
       ...
       SMB(28) = SMB1(34)
       SMB(29) = SMB1(37)
       SMB(30) = -2*SMB1(3)+2*p6mup3*SMB1(5)
       SMB(31) = 4*p2mup3*SMB1(5)
       SMB(32) = 2*p5mup3*SMB1(5)-SMB1(6)
       SMB(33) = 2*(SMB1(6)+SMB1(38))
       SMB(34) = 4*p4mup3*SMB1(5)
       SMB(35) = 0
       SMB(36) = SMB1(13)
       SMB(37) = SMB1(14)
       SMB(38) = SMB1(20)
       ...
       SMB(40) = SMB1(26)
       SMB(41) = SMB1(27)
       SMB(42) = (p3sq-s23+s234-s34)*SMB1(5)
       SMB(43) = (s16-s234+s34-s345)*SMB1(5)-2*SMB1(10)
       SMB(44) = 0
       SMB(45) = 2*(s123-s23+s234-s56)*SMB1(8)+4*p4mup3*SMB1(9)
       SMB(46) = 2*p5mup3*(p3sq-s23+s234-s34)*SMB1(5)+(-p3sq+s23-s234+
     &   s34)*SMB1(6)+2*(p5sq-s45)*SMB1(8)+4*p4mup3*SMB1(10)
       SMB(47) = 2*((-p3sq+s23-s234+s34)*SMB1(3)+p6mup3*(p3sq-s23+s234
     &   -s34)*SMB1(5)+(-p5sq-s123+s45+s56)*SMB1(8)+2*p4mup3*SMB1(11)
     &   )
       SMB(48) = 2*((s16-s234+s56)*SMB1(8)+SMB1(12))
       SMB(49) = 2*p5mup3*(s16-s234+s34-s345)*SMB1(5)+(-s16+s234-s34+s
     &   345)*SMB1(6)-2*p5sq*SMB1(8)
       SMB(50) = 2*(-s16+s234-s34+s345)*SMB1(3)+2*p6mup3*(s16-s234+s34
     &   -s345)*SMB1(5)-2*SMB1(14)
       SMB(51) = (2*p4mup3*(s16-s234+s56)+2*p5mup3*(-s123+s23-s234+s56
     &   ))*SMB1(5)+(s123-s23+s234-s56)*SMB1(6)
       SMB(52) = -2*(p4mup3*p5sq+p5mup3*(p5sq-s45))*SMB1(5)+(p5sq-s45)
     &   *SMB1(6)
       SMB(53) = 2*p5mup3*(p5sq+s123-s45-s56)*SMB1(5)+(-p5sq-s123+s45+
     &   s56)*SMB1(6)-4*p4mup3*SMB1(7)
       SMB(54) = SMB1(12)
       SMB(55) = SMB1(19)
       SMB(56) = SMB1(25)
       SMB(57) = SMB1(4)
       ...
       SMB(64) = 2*p1mup3*(p5sq-s45)*SMB1(5)-(s123-s23+s234-s56)*(2*p5
     &   mup3*SMB1(5)-SMB1(38))
       SMB(65) = -2*(s123-s23+s234-s56)*SMB1(3)-4*p1mup3*SMB1(18)
       SMB(66) = -2*(p5sq*SMB1(3)-s45*SMB1(3)+SMB1(37))
       SMB(67) = -2*p1mup3*p5sq*SMB1(5)-(s16-s234+s56)*(2*p5mup3*SMB1(
     &   5)-SMB1(38))
       SMB(68) = -2*(s16-s234+s56)*SMB1(3)-4*p1mup3*SMB1(7)
       SMB(69) = 2*p5sq*SMB1(3)
       SMB(70) = 2*p5mup3*s12*SMB1(5)-4*p1mup3*SMB1(10)-s12*SMB1(38)
       SMB(71) = 2*s12*SMB1(3)-4*p1mup3*SMB1(11)
       SMB(72) = 2*(s16-s234+s34-s345)*SMB1(3)-2*SMB1(36)
       SMB(73) = 0
       SMB(74) = 16*SMB1(5)
       SMB(75) = 0
       ...
       SMB(78) = 2*s12*SMB1(5)
       SMB(79) = 2*(s16-s234+s34-s345)*SMB1(5)
       SMB(80) = -2*(s12+s16-s345)*SMB1(5)
       SMB(81) = 4*p5mup3*s12*SMB1(5)-2*s12*SMB1(6)
       SMB(82) = -4*s12*(SMB1(3)-p6mup3*SMB1(5))
       SMB(83) = -4*(s16-s234+s34-s345)*(SMB1(3)-p6mup3*SMB1(5))
       ...
       SMB(93) = 2*(s123-s23+s234-s56)*(-2*p5mup3*SMB1(5)+SMB1(6))
       SMB(94) = 4*(s123-s23+s234-s56)*(SMB1(3)-p6mup3*SMB1(5))
       SMB(95) = 4*(p5sq-s45)*(SMB1(3)-p6mup3*SMB1(5))
c       Print*," SMB(1) ", SMB(1)
c       Print*," SMB(2) ", SMB(2)
c       Print*," SMB(3) ", SMB(3)
c       Print*," SMB(4) ", SMB(4)
