...
c************************************************************************************
c************************************************************************************
       subroutine H3j66_Div_c(M1SQ,p1,p2,p3,p4,p5,p6,barpsi_p1,psi_p6,barpsi_p2
     &   ,psi_p4,mup3,musq,comp,result,resultborn,Div)
c************************************************************************************
c************************************************************************************
...
c************************************************************************************
     ...
     &   45R,B045I, B046R,B046I, B056R,B056I
       ...
       call Fget_Div_c(M1SQ,p1,p2,p3,p4,p5,p6,musq,Div)
...
c************************************************************************************
c************************************************************************************
       call H3jFa1(p1mup3,p1mup4,p2mup3,p2mup4,p3mup3,p3mup4,p4mup3,p4
     &   mup4,p5mup3,p5mup4,p6mup3,p6mup4,mup3mup4,Fa(1))
       call H3jFa2(p1mup3,p1mup4,p2mup3,p2mup4,p3mup3,p3mup4,p4mup3,p4
     &   mup4,p5mup3,p5mup4,p6mup3,p6mup4,mup3mup4,Fa(21))
c************************************************************************************
c************************************************************************************
c************************************************************************************
...
c************************************************************************************
c************************************************************************************
       SMB0(1) = SC1c(barpsi_p1_P,mup3,psi_p6_P,+1)
       SMB0(2) = SC1r(barpsi_p2_P,p1,psi_p4_P,+1)
       SMB0(3) = SC1r(barpsi_p2_P,p5,psi_p4_P,+1)
       SMB0(4) = SC1r(barpsi_p2_P,p6,psi_p4_P,+1)
       SMB0(5) = SC3rrr(barpsi_p2_P,p6,p5,p1,psi_p4_P,+1)
       SMB0(6) = SC1r(barpsi_p1_P,p5,psi_p6_P,+1)
       SMB0(7) = SC1r(barpsi_p1_P,p2,psi_p6_P,+1)
       SMB0(8) = SC1c(barpsi_p2_P,mup3,psi_p4_P,+1)
       SMB0(9) = SC3crr(barpsi_p2_P,mup3,p5,p1,psi_p4_P,+1)
       SMB0(10) = SC3crr(barpsi_p2_P,mup3,p6,p1,psi_p4_P,+1)
       SMB0(11) = SC3crr(barpsi_p2_P,mup3,p6,p5,psi_p4_P,+1)
       SMB0(12) = SC1r(barpsi_p1_P,p4,psi_p6_P,+1)
       SMB0(13) = SC3rrr(barpsi_p1_P,p5,p4,p2,psi_p6_P,+1)
       SMB0(14) = SC3crr(barpsi_p1_P,mup3,p4,p2,psi_p6_P,+1)
       SMB0(15) = SC3crr(barpsi_p1_P,mup3,p5,p2,psi_p6_P,+1)
       SMB0(16) = SC3crr(barpsi_p1_P,mup3,p5,p4,psi_p6_P,+1)
c************************************************************************************
c************************************************************************************
      do i=0,3
        v1(0)=delta(i,0)
       ...
       SMB12(i) = SC1c(barpsi_p2_P,v1,psi_p4_P,+1)
       SMB13(i) = SC3crc(barpsi_p1_P,mup3,p5,v1,psi_p6_P,+1)
       SMB14(i) = SC3crc(barpsi_p2_P,mup3,p5,v1,psi_p4_P,+1)
      enddo
c************************************************************************************
c************************************************************************************
c************************************************************************************
...
c************************************************************************************
       ...
       SMB1(15) = SMB0(8)*SMB0(12)
       SMB1(16) = SMB0(2)*SMB0(12)
       SMB1(17) = SMB0(3)*SMB0(12)
       SMB1(18) = SMB0(4)*SMB0(12)
       SMB1(19) = SMB0(9)*SMB0(12)
       SMB1(20) = SMB0(10)*SMB0(12)
       SMB1(21) = SMB0(11)*SMB0(12)
       SMB1(22) = SMB0(6)*SMB0(8)
       SMB1(23) = SMB0(2)*SMB0(6)
       SMB1(24) = SMB0(3)*SMB0(6)
       SMB1(25) = SMB0(6)*SMB0(9)
...
c************************************************************************************
       SMB(1) = SMB1(3)
       SMB(2) = SMB1(5)
       SMB(3) = 2*p4mup3*SMB1(5)-2*SMB1(15)
       SMB(4) = SMB1(6)
       SMB(5) = -2*SMB1(3)+2*p6mup3*SMB1(5)
       SMB(6) = SMB1(15)
       SMB(7) = 4*p4mup3*SMB1(5)
       SMB(8) = 2*p5mup3*SMB1(5)-SMB1(6)
       SMB(9) = 2*(SMB1(6)+SMB1(38))
       SMB(10) = SMB1(1)
       SMB(11) = SMB1(2)
       SMB(12) = 0
       SMB(13) = SMB1(8)
       ...
       SMB(31) = 0
       SMB(32) = 0
       SMB(33) = (-p5sq+s45)*SMB1(5)-2*SMB1(17)
       SMB(34) = SMB1(29)
       SMB(35) = SMB1(30)
       SMB(36) = SMB1(31)
       SMB(37) = SMB1(32)
       ...
       SMB(41) = SMB1(36)
       SMB(42) = SMB1(37)
       SMB(43) = 4*p2mup3*SMB1(5)
       SMB(44) = 2*s12*SMB1(15)-4*p2mup3*SMB1(16)
       SMB(45) = 2*(s16-s234+s34-s345)*SMB1(15)-4*p2mup3*SMB1(17)
       SMB(46) = -2*(s12+s16-s345)*SMB1(15)-4*p2mup3*SMB1(18)
       SMB(47) = 2*p5mup3*s12*SMB1(5)+2*p2mup3*(s16-s234+s56)*SMB1(5)-
     &   s12*SMB1(6)
       SMB(48) = -2*p2mup3*p5sq*SMB1(5)+(s16-s234+s34-s345)*(2*p5mup3*
     &   SMB1(5)-SMB1(6))
       SMB(49) = -2*p5mup3*(s12+s16-s345)*SMB1(5)+(s12+s16-s345)*SMB1(
     &   6)-4*p2mup3*SMB1(7)
       SMB(50) = 2*((s16-s234+s56)*SMB1(15)+SMB1(19))
       SMB(51) = 2*p5mup3*(-p5sq+s45)*SMB1(5)+(p5sq-s45)*SMB1(6)-2*p5s
     &   q*SMB1(15)
       SMB(52) = 2*(p5sq-s45)*SMB1(3)-2*p6mup3*(p5sq-s45)*SMB1(5)-2*SM
     &   B1(21)
       SMB(53) = SMB1(28)
       SMB(54) = SMB1(12)
       SMB(55) = SMB1(19)
       ...
       SMB(59) = 0
       SMB(60) = 2*SMB1(7)
       SMB(61) = 4*p1mup3*SMB1(5)
       SMB(62) = 8*p5mup3*SMB1(5)-2*(SMB1(6)+SMB1(38))
       SMB(63) = 4*p6mup3*SMB1(5)
       SMB(64) = (2*p5mup3*s12+2*p1mup3*(-s16+s234-s34+s345))*SMB1(5)-
     &   s12*SMB1(38)
       SMB(65) = 2*s12*SMB1(3)-4*p1mup3*SMB1(11)
       SMB(66) = 2*(s16-s234+s34-s345)*SMB1(3)-2*SMB1(36)
       SMB(67) = -2*p1mup3*p5sq*SMB1(5)-(s16-s234+s56)*(2*p5mup3*SMB1(
     &   5)-SMB1(38))
       SMB(68) = -2*(s16-s234+s56)*SMB1(3)-4*p1mup3*SMB1(7)
       SMB(69) = 2*p5sq*SMB1(3)
       SMB(70) = -2*p5mup3*(s123-s23+s234-s56)*SMB1(5)-4*p1mup3*SMB1(1
     &   7)+(s123-s23+s234-s56)*SMB1(38)
       SMB(71) = -2*(s123-s23+s234-s56)*SMB1(3)-4*p1mup3*SMB1(18)
       SMB(72) = -2*(p5sq*SMB1(3)-s45*SMB1(3)+SMB1(37))
       SMB(73) = 0
       SMB(74) = 16*SMB1(5)
       SMB(75) = 0
       SMB(76) = 32*p5mup3*SMB1(5)-16*SMB1(6)
       SMB(77) = 32*(-SMB1(3)+p6mup3*SMB1(5))
       SMB(78) = 2*(-s123+s23-s234+s56)*SMB1(5)
       SMB(79) = 2*(-p5sq+s45)*SMB1(5)
       SMB(80) = 2*(p5sq+s123-s45-s56)*SMB1(5)
       SMB(81) = 2*(s123-s23+s234-s56)*(-2*p5mup3*SMB1(5)+SMB1(6))
       SMB(82) = 4*(s123-s23+s234-s56)*(SMB1(3)-p6mup3*SMB1(5))
       SMB(83) = 4*(p5sq-s45)*(SMB1(3)-p6mup3*SMB1(5))
       SMB(84) = -2*(s16-s234+s56)*SMB1(5)
       SMB(85) = 4*p5sq*SMB1(5)
       SMB(86) = 2*(-p5sq+s56)*SMB1(5)
       SMB(87) = 2*(s16-s234+s56)*(-2*p5mup3*SMB1(5)+SMB1(6))
       SMB(88) = 4*(s16-s234+s56)*(SMB1(3)-p6mup3*SMB1(5))
       SMB(89) = -8*p5sq*(SMB1(3)-p6mup3*SMB1(5))
       SMB(90) = 2*s12*SMB1(5)
       SMB(91) = 2*(s16-s234+s34-s345)*SMB1(5)
       SMB(92) = -2*(s12+s16-s345)*SMB1(5)
       SMB(93) = 4*p5mup3*s12*SMB1(5)-2*s12*SMB1(6)
       SMB(94) = -4*s12*(SMB1(3)-p6mup3*SMB1(5))
       SMB(95) = -4*(s16-s234+s34-s345)*(SMB1(3)-p6mup3*SMB1(5))
c       Print*," SMB(1) ", SMB(1)
c       Print*," SMB(2) ", SMB(2)
c       Print*," SMB(3) ", SMB(3)
c       Print*," SMB(4) ", SMB(4)
...
c  c So, I*I=(-1)!!!
       result(1) = (F(3)*SMB(5)+F(4)*SMB(6)+F(5)*SMB(7)+F(6)*SMB(8)+F(
     &   7)*SMB(9)-4*(F(9)*SMB(22)-F(10)*SMB(23)-F(202)*(-(P(31)*SMB(
     &   24))+SMB(28)+SMB(29))-F(14)*SMB(55))+2*(F(1)*SMB(3)+F(2)*SMB
     &   (4)-F(8)*SMB(12)+F(11)*SMB(50)+F(12)*SMB(51)+F(13)*SMB(52)+F
     &   (15)*SMB(73))-F(204)*(SMB(75)+SMB(76)+SMB(77))+F(16)*SMB(81)
     &   +F(17)*SMB(82)+F(18)*SMB(83)+F(19)*SMB(87)+F(20)*SMB(88)+F(2
     &   1)*SMB(89))/s23
       result(2) = (F(29)*SMB(8)+F(30)*SMB(9)+F(33)*SMB(12)-16*Fa(2)*S
     &   MB(14)+8*(Fa(3)*SMB(15)-Fa(4)*SMB(16)+F(36)*SMB(17)-Fa(5)*SM
     &   B(25)+Fa(6)*SMB(26)+Fa(7)*SMB(27))+F(51)*SMB(35)+F(26)*(2*SM
     &   B(30)+SMB(43))+F(53)*SMB(47)+F(56)*SMB(57)-4*(F(22)*SMB(1)-F
     &   a(1)*SMB(2)+F(31)*SMB(10)+F(32)*SMB(11)-F(34)*SMB(13)+F(39)*
     &   SMB(18)-F(42)*SMB(24)-F(45)*SMB(28)-Fa(8)*SMB(32)+F(47)*SMB(
     &   41)-F(55)*SMB(54)-F(44)*SMB(56)+Fa(9)*SMB(58)-Fa(10)*SMB(59)
     &   +Fa(11)*SMB(60)+F(57)*SMB(64)+F(60)*SMB(65))-F(203)*(6*(SMB(
     &   61)+SMB(62)+SMB(63))-2*Fa(12)*SMB(74)+SMB(75)+SMB(76)+SMB(77
     &   ))+F(58)*(4*SMB(67)+SMB(87))+F(63)*(4*SMB(68)+SMB(88))+F(48)
     &   *(4*SMB(69)+SMB(89))+2*(F(27)*SMB(4)-F(28)*SMB(5)+F(52)*(2*S
     &   MB(38)+SMB(48))+F(54)*SMB(49)+F(59)*SMB(73)-Fa(13)*SMB(84)-F
     &   a(14)*SMB(85)+Fa(15)*SMB(86)+Fa(16)*SMB(90)-Fa(17)*SMB(91)+F
     &   a(18)*SMB(92))+F(64)*SMB(93)+F(65)*SMB(94)+F(62)*(4*SMB(66)+
     &   SMB(95)))/s34
       result(3) = Fa(19)*SMB(2)+F(75)*SMB(7)+F(77)*SMB(9)+8*(Fa(20)*S
     &   MB(16)+Fa(21)*SMB(19)+Fa(22)*SMB(20)+Fa(23)*SMB(21)+Fa(24)*S
     &   MB(27))+Fa(25)*SMB(31)+F(126)*SMB(43)+4*(F(66)*SMB(1)-F(72)*
     &   SMB(3)-F(74)*SMB(6)+F(78)*SMB(10)+F(79)*SMB(11)+F(81)*SMB(13
     &   )+F(87)*SMB(17)-F(88)*SMB(18)-F(101)*SMB(22)+F(102)*SMB(23)-
     &   F(103)*SMB(24)+F(108)*SMB(28)-F(110)*SMB(30)-Fa(26)*SMB(32)+
     &   Fa(27)*SMB(33)-F(121)*SMB(34)-F(122)*SMB(36)+F(123)*SMB(37)+
     &   F(99)*SMB(40)+F(134)*SMB(53)+F(135)*SMB(55)+F(136)*SMB(57)-F
     &   a(28)*SMB(58)+Fa(29)*SMB(59)-Fa(30)*SMB(60))-F(205)*(8*SMB(4
     &   )+SMB(75)+SMB(76)+SMB(77))+Fa(34)*SMB(80)+F(157)*(2*SMB(70)+
     &   SMB(81))+F(158)*(2*SMB(71)+SMB(82))+F(159)*(2*SMB(72)+SMB(83
     &   ))+Fa(37)*SMB(86)+F(155)*(2*SMB(67)+SMB(87))+F(156)*(2*SMB(6
     &   8)+SMB(88))+F(109)*(-4*SMB(29)+2*SMB(69)+SMB(89))+2*(F(73)*S
     &   MB(5)+F(76)*SMB(8)-F(80)*SMB(12)-F(127)*SMB(44)-F(128)*SMB(4
     &   5)-F(129)*SMB(46)+F(130)*SMB(47)-F(131)*SMB(48)-F(132)*SMB(4
     &   9)+F(133)*SMB(50)+F(124)*(2*SMB(39)+SMB(51))+F(125)*(2*SMB(4
     &   2)+SMB(52))-F(149)*SMB(61)-F(150)*SMB(62)-F(151)*SMB(63)-F(1
     &   52)*SMB(64)-F(153)*SMB(65)-F(154)*SMB(66)+F(160)*SMB(73)-Fa(
     &   31)*SMB(74)+Fa(32)*SMB(78)+Fa(33)*SMB(79)+Fa(35)*SMB(84)+Fa(
     &   36)*SMB(85)-Fa(38)*SMB(90)+Fa(39)*SMB(91)+Fa(40)*SMB(92))+F(
     &   199)*SMB(93)+F(200)*SMB(94)+F(201)*SMB(95)
       ngluon=1
       If (ngluon.eq.0) then
     ...
     &   . Look to the heading for explanation" 
       ...
       resultborn = -((SMB(5)+2*SMB(6)+SMB(8)+SMB(12))/((M1SQ-s16)*s23
     &   *(M1SQ-s234)))-(2*SMB(1)-2*(p1mup3+p5mup3+p6mup3)*SMB(2)+SMB
     &   (5)+SMB(8)+2*SMB(10)+2*SMB(11)+SMB(12)-2*(SMB(13)+SMB(24)))/
