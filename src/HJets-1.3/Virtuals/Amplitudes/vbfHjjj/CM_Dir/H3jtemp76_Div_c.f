...
c************************************************************************************
c************************************************************************************
       subroutine H3j76_Div_c(M1sq,p1,p2,p3,p4,p5,p6,barpsi_p1,psi_p6,barpsi_p2
...
c************************************************************************************
       ...
       SMB0(7) = SC1c(barpsi_p2_P,mup3,psi_p4_P,+1)
       SMB0(8) = SC3crr(barpsi_p2_P,mup3,p6,p1,psi_p4_P,+1)
       SMB0(9) = SC1r(barpsi_p1_M,p2,psi_p6_M,-1)
       SMB0(10) = SC3crr(barpsi_p2_P,mup3,p5,p1,psi_p4_P,+1)
