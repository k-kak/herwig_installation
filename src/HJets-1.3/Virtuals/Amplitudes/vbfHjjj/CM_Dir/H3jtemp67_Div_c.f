...
c************************************************************************************
c************************************************************************************
       subroutine H3j67_Div_c(M1SQ,p1,p2,p3,p4,p5,p6,barpsi_p1,psi_p6,barpsi_p2
...
c************************************************************************************
       ...
       SMB0(7) = SC1c(barpsi_p2_M,mup3,psi_p4_M,-1)
       SMB0(8) = SC3crr(barpsi_p2_M,mup3,p6,p1,psi_p4_M,-1)
       SMB0(9) = SC1r(barpsi_p1_P,p2,psi_p6_P,+1)
       SMB0(10) = SC3crr(barpsi_p2_M,mup3,p5,p1,psi_p4_M,-1)
...
c************************************************************************************
       ...
       SMB(6) = SMB1(17)
       SMB(7) = 0
       SMB(8) = -2*SMB1(2)+2*SMB1(6)+SMB1(7)
       SMB(9) = 2*(2*SMB1(6)+SMB1(7)-SMB1(38))
       SMB(10) = SMB1(1)
       SMB(11) = SMB1(2)
       SMB(12) = -2*SMB1(1)+2*p1mup3*SMB1(5)
       SMB(13) = SMB1(10)
       SMB(14) = SMB1(11)
       SMB(15) = SMB1(12)
       SMB(16) = SMB1(13)
       ...
       SMB(28) = SMB1(9)
       SMB(29) = SMB1(27)
       SMB(30) = 2*p2mup3*SMB1(5)-2*SMB1(10)
       SMB(31) = (p3sq-s23+s234-s34)*SMB1(5)
       SMB(32) = (s16-s234+s34-s345)*SMB1(5)-2*SMB1(12)
       SMB(33) = 0
       SMB(34) = SMB1(29)
       SMB(35) = SMB1(30)
       SMB(36) = SMB1(31)
       ...
       SMB(42) = SMB1(37)
       SMB(43) = 0
       SMB(44) = -2*(p3sq-s23+s234-s34)*(SMB1(1)-p1mup3*SMB1(5))
       SMB(45) = (p3sq-s23+s234-s34)*(-2*SMB1(2)+2*SMB1(6)+SMB1(7))
       SMB(46) = 0
       SMB(47) = -2*(s16-s234+s34-s345)*SMB1(1)+2*s12*SMB1(2)+2*p1mup3
     &   *(s16-s234+s34-s345)*SMB1(5)-s12*SMB1(7)+2*(s16-s234+s56)*SM
     &   B1(10)+2*SMB1(14)
       SMB(48) = 2*p2mup3*p5sq*SMB1(5)+2*(s16-s234+s34-s345)*SMB1(6)-2
     &   *p5sq*SMB1(10)-4*p2mup3*SMB1(24)
       SMB(49) = -2*(s12+s16-s345)*SMB1(2)+2*p2mup3*(-p5sq+s56)*SMB1(5
     &   )+(s12+s16-s345)*SMB1(7)-2*SMB1(16)-4*p2mup3*SMB1(25)
       SMB(50) = 0
       SMB(51) = 0
       SMB(52) = 0
       SMB(53) = SMB1(28)
       ...
       SMB(63) = 0
       SMB(64) = -2*(s16-s234+s34-s345)*SMB1(1)-2*p2mup3*(s16-s234+s56
     &   )*SMB1(5)+2*s12*SMB1(6)+2*(s16-s234+s56)*SMB1(10)+2*SMB1(30)
     &   -s12*SMB1(38)
       SMB(65) = 2*s16*(p2mup3*SMB1(5)-SMB1(10))
       SMB(66) = 2*(p5sq-s56)*(-(p2mup3*SMB1(5))+SMB1(10))
     ...
     &   q*SMB1(5)-4*p1mup3*SMB1(24)
       ...
       SMB(70) = 2*(p5sq-s45)*SMB1(1)+2*p1mup3*(-p5sq+s45)*SMB1(5)-2*(
     &   s123-s23+s234-s56)*SMB1(6)-4*p1mup3*SMB1(19)+2*SMB1(31)+(s12
     &   3-s23+s234-s56)*SMB1(38)
       SMB(71) = 0
       SMB(72) = 0
       SMB(73) = -2*SMB1(9)
       SMB(74) = 4*SMB1(5)
       ...
       SMB(93) = 0
       SMB(94) = 0
       SMB(95) = -4*(s12+s16-s345)*SMB1(6)-8*p2mup3*SMB1(25)
c       Print*," SMB(1) ", SMB(1)
c       Print*," SMB(2) ", SMB(2)
c       Print*," SMB(3) ", SMB(3)
c       Print*," SMB(4) ", SMB(4)
