...
c************************************************************************************
c************************************************************************************
       subroutine H3jCross76_Div_c(M1sq,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,barp
...
c************************************************************************************
     ...
     &   I, B045R,B045I, B046R,B046I, B056R,B056I
       ...
       call FgetCross_Div_c(M1sq,p1,p2,p3,p4,p5,p6,musq,Div)
...
c************************************************************************************
       ...
       SMB0(7) = SC1c(barpsi_p6_M,mup3,psi_p1_M,-1)
       SMB0(8) = SC1r(barpsi_p2_P,p1,psi_p4_P,+1)
       ...
       SMB0(14) = SC3crr(barpsi_p2_P,mup3,p5,p1,psi_p4_P,+1)
       SMB0(15) = SC3crr(barpsi_p2_P,mup3,p6,p1,psi_p4_P,+1)
...
c************************************************************************************
       ...
       SMB(6) = SMB1(21)
       SMB(7) = SMB1(7)
       SMB(8) = 2*p6mup3*SMB1(5)-2*SMB1(21)
       SMB(9) = SMB1(2)
       SMB(10) = SMB1(10)
       SMB(11) = SMB1(11)
       SMB(12) = SMB1(12)
       ...
       SMB(28) = SMB1(37)
       SMB(29) = SMB1(31)
       SMB(30) = -2*SMB1(1)+2*p2mup3*SMB1(5)
       SMB(31) = 0
       SMB(32) = -2*SMB1(3)+2*SMB1(6)+SMB1(7)
       SMB(33) = SMB1(13)
       SMB(34) = SMB1(15)
       SMB(35) = SMB1(18)
       SMB(36) = SMB1(20)
       ...
       SMB(47) = 0
       SMB(48) = 0
       SMB(49) = 2*(s12+s16-s345)*SMB1(3)-(s12+s16-s345)*SMB1(7)+2*(s1
     &   6-s234+s34-s345)*SMB1(21)-2*SMB1(26)
       SMB(50) = 2*(p5sq-s56)*SMB1(3)-2*p5sq*p6mup3*SMB1(5)+(-p5sq+s56
     &   )*SMB1(7)+4*p6mup3*SMB1(17)+2*p5sq*SMB1(21)
       SMB(51) = 0
       SMB(52) = 2*(2*SMB1(3)-SMB1(7)+SMB1(38))
       SMB(53) = 0
       SMB(54) = 0
       SMB(55) = -2*(p5sq+s123-s45-s56)*SMB1(3)+2*p6mup3*(p5sq-s45)*SM
     &   B1(5)+(p5sq+s123-s45-s56)*SMB1(7)+4*p6mup3*SMB1(16)-2*(p5sq-
     &   s45)*SMB1(21)-2*SMB1(27)
       SMB(56) = SMB1(14)
       SMB(57) = SMB1(19)
       SMB(58) = SMB1(26)
       SMB(59) = SMB1(4)
       SMB(60) = (p3sq-s23+s234-s34)*SMB1(5)
       SMB(61) = (s16-s234+s34-s345)*SMB1(5)-2*SMB1(8)
       SMB(62) = 0
       SMB(63) = 2*(s16-s234+s56)*SMB1(1)-2*p2mup3*(s16-s234+s56)*SMB1
     &   (5)+2*s12*SMB1(6)-4*p2mup3*SMB1(12)+2*SMB1(29)-s12*SMB1(38)
       SMB(64) = (p3sq-s23+s234-s34)*(2*SMB1(3)-2*SMB1(6)+SMB1(38))
       SMB(65) = -2*p5sq*SMB1(1)+2*(s16-s234+s34-s345)*SMB1(3)+2*p2mup
     &   3*p5sq*SMB1(5)-4*p2mup3*SMB1(17)
       SMB(66) = 2*(p3sq-s23+s234-s34)*(p6mup3*SMB1(5)-SMB1(21))
       SMB(67) = 2*p6mup3*(s16-s234+s34-s345)*SMB1(5)-2*(s12+s16-s345)
     &   *SMB1(6)-2*(s16-s234+s34-s345)*SMB1(21)-2*SMB1(31)+(s12+s16-
     &   s345)*SMB1(38)
       SMB(68) = 0
       SMB(69) = 0
       SMB(70) = 0
       ...
       SMB(93) = 0
       SMB(94) = 0
       SMB(95) = -4*(s12+s16-s345)*SMB1(3)-8*p2mup3*SMB1(24)
c       Print*," SMB(1) ", SMB(1)
c       Print*," SMB(2) ", SMB(2)
c       Print*," SMB(3) ", SMB(3)
c       Print*," SMB(4) ", SMB(4)
