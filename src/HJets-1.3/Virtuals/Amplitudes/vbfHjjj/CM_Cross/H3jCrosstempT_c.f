       subroutine H3jCross66T_c(M1sq,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,barp
...
c************************************************************************************
     ...
     &   I, B045R,B045I, B046R,B046I, B056R,B056I
       ...
       complex*16 m1sq
       if(Div.eq.0) then
        call  H3jCross66_c(M1sq,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,barp
     &   si_p2,psi_p4,mup3,musq,comp,result,resultn)
       else
        call  H3jCross66_Div_c(M1sq,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,barp
     &   si_p2,psi_p4,mup3,musq,comp,result,resultn,Div)
       endif
       end


       subroutine H3jCross67T_c(M1sq,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,barp
     &   si_p2,psi_p4,mup3,musq,comp,result,resultn,Div)
       IMPLICIT NONE
      Complex*16 SMB(95),Fa(44),F(218)
       Complex*16 SMB0(16),SMB11(0:3),SMB12(0:3),SMB13(0:3),SMB14(0:3)
...
c************************************************************************************
     ...
     &   I, B045R,B045I, B046R,B046I, B056R,B056I
       ...
       complex*16 m1sq
       if(Div.eq.0) then
        call  H3jCross67_c(M1sq,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,barp
     &   si_p2,psi_p4,mup3,musq,comp,result,resultn)
       else
        call  H3jCross67_Div_c(M1sq,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,barp
     &   si_p2,psi_p4,mup3,musq,comp,result,resultn,Div)
       endif
       end

       subroutine H3jCross76T_c(M1sq,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,barp
     &   si_p2,psi_p4,mup3,musq,comp,result,resultn,Div)
       IMPLICIT NONE
      Complex*16 SMB(95),Fa(44),F(218)
       Complex*16 SMB0(16),SMB11(0:3),SMB12(0:3),SMB13(0:3),SMB14(0:3)
...
c************************************************************************************
     ...
     &   I, B045R,B045I, B046R,B046I, B056R,B056I
       ...
       complex*16 m1sq
       if(Div.eq.0) then
        call  H3jCross76_c(M1sq,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,barp
     &   si_p2,psi_p4,mup3,musq,comp,result,resultn)
       else
        call  H3jCross76_Div_c(M1sq,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,barp
     &   si_p2,psi_p4,mup3,musq,comp,result,resultn,Div)
       endif
       end
       ...
       subroutine H3jCross77T_c(M1sq,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,barp
     &   si_p2,psi_p4,mup3,musq,comp,result,resultn,Div)
       IMPLICIT NONE
      Complex*16 SMB(95),Fa(44),F(218)
       Complex*16 SMB0(16),SMB11(0:3),SMB12(0:3),SMB13(0:3),SMB14(0:3)
...
c************************************************************************************
     ...
     &   I, B045R,B045I, B046R,B046I, B056R,B056I
       ...
       complex*16 m1sq
       if(Div.eq.0) then
        call  H3jCross77_c(M1sq,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,barp
     &   si_p2,psi_p4,mup3,musq,comp,result,resultn)
       else
        call  H3jCross77_Div_c(M1sq,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,barp
     &   si_p2,psi_p4,mup3,musq,comp,result,resultn,Div)
       endif
       end
