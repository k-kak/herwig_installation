       subroutine NoAbeH3jCrossF66T_c(M1sq,p1,p2,p3,p4,p5,p6,barpsi_p1,psi_p6,psi
     &   _p2,barpsi_p4,mup3,musq,comp,result,resultn,Div)
       IMPLICIT NONE
...
c************************************************************************************
     ...
     -          p4mup3, p4mup4, p5mup3, p5mup4, p6mup3, p6mup4
      ...
      Save/NoAbeH3jCrossFPFunctions/
       COMMON/NoAbeH3jCrossFInvariants/p1sq,p2sq,p3sq,p4sq,p5sq,p6sq,s12,s2
     &   3,s34,s45,s56,s16,s123,s234,s345
       COMMON/NoAbeH3jCrossFFVALFunctions/F0123456R,F123456R,F0123456I,F123
     &   456I
       COMMON/NoAbeH3jCrossFEVALFunctions/ E012345R,E12345R,E012345I,E12345
     ...
     &   456R,E013456I,E13456I, E023456R,E23456R,E023456I,E23456I
       COMMON/NoAbeH3jCrossFDVALFunctions/ D01234R,D1234R,D01234I,D1234I, D
     ...
     &   456I,D3456I
       COMMON/NoAbeH3jCrossFCVALFunctions/ C0123R,C123R,C0123I,C123I, C0124
     ...
     &    C0456R,C456R,C0456I,C456I
       COMMON/NoAbeH3jCrossFBVALFunctions/ B012R,B012I, B013R,B013I, B014R,
     ...
     &   6I, B045R,B045I, B046R,B046I, B056R,B056I
       ...
       complex*16 m1sq
         if(Div.eq.0) then
           call  NoAbeH3jCrossF66_c(M1sq,p1,p2,p3,p4,p5,p6,barpsi_p1,psi_p6,psi
     &   _p2,barpsi_p4,mup3,musq,comp,result,resultn)
            else
           call NoAbeH3jCrossF66Div_C(M1sq,p1,p2,p3,p4,p5,p6,barpsi_p1,psi_p6,psi
     &   _p2,barpsi_p4,mup3,musq,comp,result,resultn,Div)
         endif
         return
         end
       ...
       subroutine NoAbeH3jCrossF67T_c(M1sq,p1,p2,p3,p4,p5,p6,barpsi_p1,psi_p6,psi
     &   _p2,barpsi_p4,mup3,musq,comp,result,resultn,Div)
       IMPLICIT NONE
      Complex*16 SMB(95),Fa(44),F(214)
       Complex*16 SMB0(16),SMB11(0:3),SMB12(0:3),SMB13(0:3),SMB14(0:3)
...
c************************************************************************************
     ...
     &   6I, B045R,B045I, B046R,B046I, B056R,B056I
       ...
       complex*16 m1sq
         if(Div.eq.0) then
           call  NoAbeH3jCrossF67_c(M1sq,p1,p2,p3,p4,p5,p6,barpsi_p1,psi_p6,psi
     &   _p2,barpsi_p4,mup3,musq,comp,result,resultn)
            else
           call NoAbeH3jCrossF67Div_c(M1sq,p1,p2,p3,p4,p5,p6,barpsi_p1,psi_p6,psi
     &   _p2,barpsi_p4,mup3,musq,comp,result,resultn,Div)
         endif
         return
         end

       subroutine NoAbeH3jCrossF76T_c(M1sq,p1,p2,p3,p4,p5,p6,barpsi_p1,psi_p6,psi
     &   _p2,barpsi_p4,mup3,musq,comp,result,resultn,Div)
       IMPLICIT NONE
      Complex*16 SMB(95),Fa(44),F(214)
       Complex*16 SMB0(16),SMB11(0:3),SMB12(0:3),SMB13(0:3),SMB14(0:3)
...
c************************************************************************************
     ...
     &   6I, B045R,B045I, B046R,B046I, B056R,B056I
       ...
       complex*16 m1sq
         if(Div.eq.0) then
           call  NoAbeH3jCrossF76_c(M1sq,p1,p2,p3,p4,p5,p6,barpsi_p1,psi_p6,psi
     &   _p2,barpsi_p4,mup3,musq,comp,result,resultn)
            else
           call NoAbeH3jCrossF76Div_c(M1sq,p1,p2,p3,p4,p5,p6,barpsi_p1,psi_p6,psi
     &   _p2,barpsi_p4,mup3,musq,comp,result,resultn,Div)
         endif
         return
         end
       ...
       subroutine NoAbeH3jCrossF77T_c(M1sq,p1,p2,p3,p4,p5,p6,barpsi_p1,psi_p6,psi
     &   _p2,barpsi_p4,mup3,musq,comp,result,resultn,Div)
       IMPLICIT NONE
      Complex*16 SMB(95),Fa(44),F(214)
       Complex*16 SMB0(16),SMB11(0:3),SMB12(0:3),SMB13(0:3),SMB14(0:3)
...
c************************************************************************************
     ...
     &   6I, B045R,B045I, B046R,B046I, B056R,B056I
       ...
       complex*16 m1sq
         if(Div.eq.0) then
           call  NoAbeH3jCrossF77_c(M1sq,p1,p2,p3,p4,p5,p6,barpsi_p1,psi_p6,psi
     &   _p2,barpsi_p4,mup3,musq,comp,result,resultn)
            else
           call NoAbeH3jCrossF77Div_c(M1sq,p1,p2,p3,p4,p5,p6,barpsi_p1,psi_p6,psi
     &   _p2,barpsi_p4,mup3,musq,comp,result,resultn,Div)
         endif
         return
         end
