...
c************************************************************************************
c************************************************************************************
       subroutine NoAbeH3jCrossF76Div_c(M1sq,p1,p2,p3,p4,p5,p6,barpsi_p1,psi_p
...
c************************************************************************************
       ...
       SMB0(7) = SC1c(barpsi_p4_P,mup2,psi_p3_P,+1)
       SMB0(8) = SC1r(barpsi_p1_M,p3,psi_p6_M,-1)
...
c************************************************************************************
       ...
       SMB1(15) = SMB0(7)*SMB0(11)
       SMB1(16) = SMB0(2)*SMB0(11)
       SMB1(17) = SMB0(3)*SMB0(11)
       SMB1(18) = SMB0(4)*SMB0(11)
       SMB1(19) = SMB0(9)*SMB0(11)
       SMB1(20) = SMB0(10)*SMB0(11)
       SMB1(21) = SMB0(3)*SMB0(6)
       SMB1(22) = SMB0(4)*SMB0(6)
...
c************************************************************************************
       ...
       SMB(14) = SMB1(3)
       SMB(15) = 0
       SMB(16) = 2*p4mup2*SMB1(5)-2*SMB1(15)
       SMB(17) = SMB1(7)
       SMB(18) = SMB1(1)
       SMB(19) = SMB1(2)
       SMB(20) = SMB1(26)
       ...
       SMB(29) = 0
       SMB(30) = 0
       SMB(31) = (-p5sq+s45)*SMB1(5)-2*SMB1(17)
       SMB(32) = -2*SMB1(1)+2*p1mup2*SMB1(5)
       SMB(33) = -2*SMB1(2)+2*SMB1(6)+SMB1(7)
       SMB(34) = 0
       SMB(35) = SMB1(13)
       SMB(36) = SMB1(14)
       SMB(37) = SMB1(19)
       ...
       SMB(45) = 0
       SMB(46) = 0
       SMB(47) = 2*(2*SMB1(6)+SMB1(7)-SMB1(35))
       SMB(48) = 0
       SMB(49) = 0
       SMB(50) = 0
       SMB(51) = 2*(p5sq-s45)*SMB1(1)-2*(s123-s23+s234-s56)*SMB1(2)+2*
     &   p1mup2*(-p5sq+s45)*SMB1(5)+(s123-s23+s234-s56)*SMB1(7)+2*(s1
     &   6-s234+s56)*SMB1(15)+2*SMB1(36)
       SMB(52) = 2*p4mup2*p5sq*SMB1(5)+2*(-p5sq+s45)*SMB1(6)-2*p5sq*SM
     &   B1(15)-4*p4mup2*SMB1(21)
       SMB(53) = 2*(p5sq+s123-s45-s56)*SMB1(2)+2*p4mup2*(-p5sq+s56)*SM
     &   B1(5)+(-p5sq-s123+s45+s56)*SMB1(7)-2*SMB1(20)-4*p4mup2*SMB1(
     &   22)
       SMB(54) = s16*SMB1(5)
       SMB(55) = (-p5sq+s56)*SMB1(5)
       SMB(56) = 4*SMB1(5)
       SMB(57) = 0
       SMB(58) = 0
       SMB(59) = 0
       SMB(60) = -((s16-s234+s56)*SMB1(5))-2*SMB1(8)
       SMB(61) = 0
       SMB(62) = 4*SMB1(21)
       SMB(63) = 0
       SMB(64) = 0
       ...
       SMB(66) = SMB1(4)
       SMB(67) = 0
       SMB(68) = 2*(2*SMB1(2)-SMB1(7)+SMB1(35))
       SMB(69) = 0
       SMB(70) = 2*(s34-s345+s45)*SMB1(1)-2*p1mup2*(s34-s345+s45)*SMB1
     &   (5)+2*(p2sq-s12+s123-s23)*SMB1(6)-4*p1mup2*SMB1(11)+2*SMB1(2
     &   7)+(-p2sq+s12-s123+s23)*SMB1(35)
       SMB(71) = 0
       SMB(72) = 0
       SMB(73) = 2*(p5sq-s45)*SMB1(1)-2*p4mup2*(s16-s234+s56)*SMB1(5)-
     &   2*(s123-s23+s234-s56)*SMB1(6)+2*(s16-s234+s56)*SMB1(15)+2*SM
     &   B1(28)+(s123-s23+s234-s56)*SMB1(35)
       SMB(74) = 2*s16*(p4mup2*SMB1(5)-SMB1(15))
       SMB(75) = 2*(p5sq-s56)*(-(p4mup2*SMB1(5))+SMB1(15))
       SMB(76) = -2*p5sq*SMB1(1)-2*(s16-s234+s56)*SMB1(2)+2*p1mup2*p5s
     &   q*SMB1(5)-4*p1mup2*SMB1(21)
       SMB(77) = s16*(2*SMB1(2)-2*SMB1(6)+SMB1(35))
       SMB(78) = -((p5sq-s56)*(2*SMB1(2)-2*SMB1(6)+SMB1(35)))
       SMB(79) = 0
c       Print*," SMB(1) ", SMB(1)
c       Print*," SMB(2) ", SMB(2)
c       Print*," SMB(3) ", SMB(3)
