       subroutine NoAbeH3jCross66T_c(M1sq,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,barp
     &   si_p2,psi_p4,mup3,musq,comp,result,resultn,Div)
       IMPLICIT NONE
...
c************************************************************************************
     ...
     -          p4mup3, p4mup4, p5mup3, p5mup4, p6mup3, p6mup4
      ...
      Save/NoAbeH3jCrossPFunctions/
       COMMON/NoAbeH3jCrossInvariants/p1sq,p2sq,p3sq,p4sq,p5sq,p6sq,s12,s23
     &   ,s34,s45,s56,s16,s123,s234,s345
       COMMON/NoAbeH3jCrossFVALFunctions/F0123456R,F123456R,F0123456I,F1234
     &   56I
       COMMON/NoAbeH3jCrossEVALFunctions/ E012345R,E12345R,E012345I,E12345I
     ...
     &   56R,E013456I,E13456I, E023456R,E23456R,E023456I,E23456I
       COMMON/NoAbeH3jCrossDVALFunctions/ D01234R,D1234R,D01234I,D1234I, D0
     ...
     &   56I,D3456I
       COMMON/NoAbeH3jCrossCVALFunctions/ C0123R,C123R,C0123I,C123I, C0124R
     ...
     &   C0456R,C456R,C0456I,C456I
       COMMON/NoAbeH3jCrossBVALFunctions/ B012R,B012I, B013R,B013I, B014R,B
     ...
     &   I, B045R,B045I, B046R,B046I, B056R,B056I
       ...
       complex*16 m1sq
       if(Div.eq.0) then
        call  NoAbeH3jCross66_c(M1sq,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,barp
     &   si_p2,psi_p4,mup3,musq,comp,result,resultn)
       else
        call  NoAbeH3jCross66Div_c(M1sq,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,barp
     &   si_p2,psi_p4,mup3,musq,comp,result,resultn,Div)
       endif
       end


       subroutine NoAbeH3jCross67T_c(M1sq,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,barp
     &   si_p2,psi_p4,mup3,musq,comp,result,resultn,Div)
       IMPLICIT NONE
      Complex*16 SMB(95),Fa(44),F(218)
       Complex*16 SMB0(16),SMB11(0:3),SMB12(0:3),SMB13(0:3),SMB14(0:3)
...
c************************************************************************************
     ...
     &   I, B045R,B045I, B046R,B046I, B056R,B056I
       ...
       complex*16 m1sq
       if(Div.eq.0) then
        call  NoAbeH3jCross67_c(M1sq,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,barp
     &   si_p2,psi_p4,mup3,musq,comp,result,resultn)
       else
        call  NoAbeH3jCross67Div_c(M1sq,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,barp
     &   si_p2,psi_p4,mup3,musq,comp,result,resultn,Div)
       endif
       end

       subroutine NoAbeH3jCross76T_c(M1sq,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,barp
     &   si_p2,psi_p4,mup3,musq,comp,result,resultn,Div)
       IMPLICIT NONE
      Complex*16 SMB(95),Fa(44),F(218)
       Complex*16 SMB0(16),SMB11(0:3),SMB12(0:3),SMB13(0:3),SMB14(0:3)
...
c************************************************************************************
     ...
     &   I, B045R,B045I, B046R,B046I, B056R,B056I
       ...
       complex*16 m1sq
       if(Div.eq.0) then
        call  NoAbeH3jCross76_c(M1sq,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,barp
     &   si_p2,psi_p4,mup3,musq,comp,result,resultn)
       else
        call  NoAbeH3jCross76Div_c(M1sq,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,barp
     &   si_p2,psi_p4,mup3,musq,comp,result,resultn,Div)
       endif
       end
       ...
       subroutine NoAbeH3jCross77T_c(M1sq,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,barp
     &   si_p2,psi_p4,mup3,musq,comp,result,resultn,Div)
       IMPLICIT NONE
      Complex*16 SMB(95),Fa(44),F(218)
       Complex*16 SMB0(16),SMB11(0:3),SMB12(0:3),SMB13(0:3),SMB14(0:3)
...
c************************************************************************************
     ...
     &   I, B045R,B045I, B046R,B046I, B056R,B056I
       ...
       complex*16 m1sq
       if(Div.eq.0) then
        call  NoAbeH3jCross77_c(M1sq,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,barp
     &   si_p2,psi_p4,mup3,musq,comp,result,resultn)
       else
        call  NoAbeH3jCross77Div_c(M1sq,p1,p2,p3,p4,p5,p6,psi_p1,barpsi_p6,barp
     &   si_p2,psi_p4,mup3,musq,comp,result,resultn,Div)
       endif
       end
