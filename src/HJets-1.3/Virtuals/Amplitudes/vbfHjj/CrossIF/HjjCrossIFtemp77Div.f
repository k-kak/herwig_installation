...
c************************************************************************************
c************************************************************************************
       subroutine HjjCrossIF77Div(M1SQ,p1,p2,p3,p4,p5,psi_p1,barpsi_p5
     &   ,psi_p2,barpsi_p3,musq,comp,ngluon,posgluon,result,resultbor
     &   n,Div)
c************************************************************************************
c************************************************************************************
...
c************************************************************************************
c************************************************************************************
       SMB0(1) = SC1r(barpsi_p3_M,p1,psi_p2_M,-1)
       SMB0(2) = SC1r(barpsi_p5_M,p3,psi_p1_M,-1)
       SMB0(3) = SC1r(barpsi_p3_M,p5,psi_p2_M,-1)
...
c************************************************************************************
      do i=0,3
        ...
        v1(2)=delta(i,2)
        v1(3)=delta(i,3)
       SMB11(i) = SC1c(barpsi_p3_M,v1,psi_p2_M,-1)
