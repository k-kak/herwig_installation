...
c************************************************************************************
c************************************************************************************
       subroutine Hjj66Div(M1SQ,p1,p2,p3,p4,p5,barpsi_p1,psi_p5,barpsi
     &   _p2,psi_p3,musq,comp,ngluon,posgluon,result,resultborn,Div)
c************************************************************************************
c************************************************************************************
...
c************************************************************************************
      ...
      Complex*16 SMB1(3)
      Real*8 FI(10),FR(10)
      Complex*16 barpsi_p1_P(2),psi_p5_P(2),barpsi_p2_P(2),psi_p3_P(2) 
       Complex*16 barpsi_p1_M(2),psi_p5_M(2),barpsi_p2_M(2),psi_p3_M(2)
...
c************************************************************************************
      ...
      Integer alpha
       COMMON/HjjFhlFunctions/F
      Save/HjjFhlFunctions/
       COMMON/HjjPFunctions/P
      Save/HjjPFunctions/
       COMMON/HjjInvariants/p1sq,p2sq,p3sq,p4sq,p5sq,s12,s23,s34,s45,s
     &   15
       COMMON/HjjEVALFunctions/ EE0R,EijR,EE0I,EijI 
       COMMON/HjjDVALFunctions/ D01234R,Dij1234R,D01234I,Dij1234I, D01
     &   235R,Dij1235R,D01235I,Dij1235I, D01245R,Dij1245R,D01245I,Dij
     &   1245I, D01345R,Dij1345R,D01345I,Dij1345I, D02345R,Dij2345R,D
     &   02345I,Dij2345I 
       COMMON/HjjCVALFunctions/ C0123R,Cij123R,C0123I,Cij123I, C0124R,
     &   Cij124R,C0124I,Cij124I, C0125R,Cij125R,C0125I,Cij125I, C0134
     &   R,Cij134R,C0134I,Cij134I, C0135R,Cij135R,C0135I,Cij135I, C01
     &   45R,Cij145R,C0145I,Cij145I, C0234R,Cij234R,C0234I,Cij234I, C
     &   0235R,Cij235R,C0235I,Cij235I, C0245R,Cij245R,C0245I,Cij245I,
     &    C0345R,Cij345R,C0345I,Cij345I 
       COMMON/HjjBVALFunctions/ B012R,B012I, B013R,B013I, B014R,B014I,
     &    B015R,B015I, B023R,B023I, B024R,B024I, B025R,B025I, B034R,B
     &   034I, B035R,B035I, B045R,B045I
...
c************************************************************************************
c************************************************************************************
       SMB0(1) = SC1r(barpsi_p1_P,p2,psi_p5_P,+1)
       SMB0(2) = SC1r(barpsi_p2_P,p5,psi_p3_P,+1)
       SMB0(3) = SC1r(barpsi_p1_P,p3,psi_p5_P,+1)
       SMB0(4) = SC1r(barpsi_p2_P,p1,psi_p3_P,+1)
c************************************************************************************
c************************************************************************************
      do i=0,3
        v1(0)=delta(i,0)
        ...
        v1(2)=delta(i,2)
        v1(3)=delta(i,3)
       SMB11(i) = SC1c(barpsi_p1_P,v1,psi_p5_P,+1)
       SMB12(i) = SC1c(barpsi_p2_P,v1,psi_p3_P,+1)
      enddo
c************************************************************************************
c************************************************************************************
c************************************************************************************
...
c************************************************************************************
       ...
       SMB(5) = 16*SMB1(1)
       SMB(6) = 2*s12*SMB1(1)
       SMB(7) = -2*(s12+s15-s34)*SMB1(1)
       SMB(8) = SMB1(3)
       SMB(9) = -2*(s12+s23-s45)*SMB1(1)
...
c  c So, I*(I)=(-1)!!!
       result(1) = F(1)*SMB(1)+F(2)*SMB(3)+F(3)*SMB(4)+F(4)*SMB(5)+F(5
     &   )*SMB(6)+F(6)*SMB(7)+4*(F(7)*SMB(2)+F(8)*SMB(8))+F(9)*SMB(9)
     &   +F(10)*SMB(10)
       result(1) =-result(1)
