       subroutine HjjFFhl2(F2)
       IMPLICIT NONE
       Real*8 P(7),FRe(6:10),FIm(6:10)
       Complex*16 F2(6:10)
       Real*8   p1sq 
       Real*8   p2sq 
       Real*8   p3sq 
...
c************************************************************************************
c************************************************************************************
       FRe(6) = EijR(4,2)-EijR(9,2)
       FIm(6) = EijI(4,2)-EijI(9,2)
       F2(6)=DCMPLX(FRe(6),FIm(6))
       FRe(7) = -EijR(4,1)+EijR(4,2)-EijR(9,2)
       FIm(7) = -EijI(4,1)+EijI(4,2)-EijI(9,2)
       F2(7)=DCMPLX(FRe(7),FIm(7))
       FRe(8) = EijR(4,2)+EijR(6,2)-EijR(7,2)-EijR(10,2)
       FIm(8) = EijI(4,2)+EijI(6,2)-EijI(7,2)-EijI(10,2)
