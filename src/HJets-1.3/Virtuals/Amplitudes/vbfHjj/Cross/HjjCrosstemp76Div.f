...
c************************************************************************************
c************************************************************************************
       subroutine HjjCross76Div(M1SQ,p1,p2,p3,p4,p5,psi_p1,barpsi_p5,b
...
c************************************************************************************
c************************************************************************************
       SMB0(1) = SC1r(barpsi_p2_P,p1,psi_p3_P,+1)
       SMB0(2) = SC1r(barpsi_p5_M,p3,psi_p1_M,-1)
       SMB0(3) = SC1r(barpsi_p2_P,p5,psi_p3_P,+1)
...
c************************************************************************************
      do i=0,3
        ...
        v1(2)=delta(i,2)
        v1(3)=delta(i,3)
       SMB11(i) = SC1c(barpsi_p2_P,v1,psi_p3_P,+1)
