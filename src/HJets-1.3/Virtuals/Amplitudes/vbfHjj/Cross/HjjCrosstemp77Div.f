...
c************************************************************************************
c************************************************************************************
       subroutine HjjCross77Div(M1SQ,p1,p2,p3,p4,p5,psi_p1,barpsi_p5,b
     &   arpsi_p2,psi_p3,musq,comp,ngluon,posgluon,result,resultborn,
     &   Div)
c************************************************************************************
c************************************************************************************
...
c************************************************************************************
      ...
      Complex*16 SMB1(3)
      Real*8 FI(10),FR(10)
      Complex*16 psi_p1_P(2),barpsi_p5_P(2),barpsi_p2_P(2),psi_p3_P(2) 
       Complex*16 psi_p1_M(2),barpsi_p5_M(2),barpsi_p2_M(2),psi_p3_M(2)
       Complex*16 psi_p1(4),barpsi_p5(4),barpsi_p2(4),psi_p3(4)
       Real*8 P(4)
...
c************************************************************************************
      Real*8   p1(0:3),p2(0:3),p3(0:3),p4(0:3),p5(0:3)
       Real*8 dotrr
       Complex*16 A0finGDiv_c,B0finGDiv_c,C0finGDiv_c,D0finGDiv_c,E0finG_c
       EXTERNAL dotrr,A0finGDiv_c,B0finGDiv_c,C0finGDiv_c,D0finGDiv_c,E0finG_c
       Complex*16 B0finGDiv,C0finGDiv,D0finGDiv,E0finG
       EXTERNAL B0finGDiv,C0finGDiv,D0finGDiv,E0finG
      ...
      Integer alpha
       COMMON/HjjCrossFhlFunctions/F
      Save/HjjCrossFhlFunctions/
       COMMON/HjjCrossPFunctions/P
      Save/HjjCrossPFunctions/
       COMMON/HjjCrossInvariants/p1sq,p2sq,p3sq,p4sq,p5sq,s12,s23,s34,
     &   s45,s15
       COMMON/HjjCrossEVALFunctions/ EE0R,EijR,EE0I,EijI 
       COMMON/HjjCrossDVALFunctions/ D01234R,Dij1234R,D01234I,Dij1234I
     &   , D01235R,Dij1235R,D01235I,Dij1235I, D01245R,Dij1245R,D01245
     &   I,Dij1245I, D01345R,Dij1345R,D01345I,Dij1345I, D02345R,Dij23
     &   45R,D02345I,Dij2345I 
       COMMON/HjjCrossCVALFunctions/ C0123R,Cij123R,C0123I,Cij123I, C0
     &   124R,Cij124R,C0124I,Cij124I, C0125R,Cij125R,C0125I,Cij125I, 
     &   C0134R,Cij134R,C0134I,Cij134I, C0135R,Cij135R,C0135I,Cij135I
     &   , C0145R,Cij145R,C0145I,Cij145I, C0234R,Cij234R,C0234I,Cij23
     &   4I, C0235R,Cij235R,C0235I,Cij235I, C0245R,Cij245R,C0245I,Cij
     &   245I, C0345R,Cij345R,C0345I,Cij345I 
       COMMON/HjjCrossBVALFunctions/ B012R,B012I, B013R,B013I, B014R,B
     &   014I, B015R,B015I, B023R,B023I, B024R,B024I, B025R,B025I, B0
     &   34R,B034I, B035R,B035I, B045R,B045I
...
c************************************************************************************
       if(RealRu) then
           m=Dble(sqrt(m1sq))
       B012=B0finGDiv(0d0,0d0,p1sq,musq,Div)
       B012R=Dble(B012)
       B012I=DImag(B012)
       B023=B0finGDiv(0d0,0d0,p2sq,musq,Div)
       B023R=Dble(B023)
       B023I=DImag(B023)
       B034=B0finGDiv(0d0,M,p3sq,musq,Div)
       B034R=Dble(B034)
       B034I=DImag(B034)
       B045=B0finGDiv(M,M,p4sq,musq,Div)
       B045R=Dble(B045)
       B045I=DImag(B045)
       B013=B0finGDiv(0d0,0d0,s12,musq,Div)
       B013R=Dble(B013)
       B013I=DImag(B013)
       B014=B0finGDiv(0d0,M,s45,musq,Div)
       B014R=Dble(B014)
       B014I=DImag(B014)
       B024=B0finGDiv(0d0,M,s23,musq,Div)
       B024R=Dble(B024)
       B024I=DImag(B024)
       B025=B0finGDiv(0d0,M,s15,musq,Div)
       B025R=Dble(B025)
       B025I=DImag(B025)
       B035=B0finGDiv(0d0,M,s34,musq,Div)
       B035R=Dble(B035)
       B035I=DImag(B035)
       B015=B0finGDiv(0d0,M,p5sq,musq,Div)
       B015R=Dble(B015)
       B015I=DImag(B015)
        C0123=C0finGDiv(0d0,0d0,0d0,p1sq,p2sq,s12,musq,Div)
       C0123R=Dble(C0123)
       C0123I=DImag(C0123)
       C0124=C0finGDiv(0d0,0d0,M,p1sq,s23,s45,musq,Div)
       C0124R=Dble(C0124)
       C0124I=DImag(C0124)
       C0125=C0finGDiv(0d0,0d0,M,p1sq,s15,p5sq,musq,Div)
       C0125R=Dble(C0125)
       C0125I=DImag(C0125)
       C0234=C0finGDiv(0d0,0d0,M,p2sq,p3sq,s23,musq,Div)
       C0234R=Dble(C0234)
       C0234I=DImag(C0234)
       C0235=C0finGDiv(0d0,0d0,M,p2sq,s34,s15,musq,Div)
       C0235R=Dble(C0235)
       C0235I=DImag(C0235)
       C0345=C0finGDiv(0d0,M,M,p3sq,p4sq,s34,musq,Div)
       C0345R=Dble(C0345)
       C0345I=DImag(C0345)
       C0134=C0finGDiv(0d0,0d0,M,s12,p3sq,s45,musq,Div)
       C0134R=Dble(C0134)
       C0134I=DImag(C0134)
       C0135=C0finGDiv(0d0,0d0,M,s12,s34,p5sq,musq,Div)
       C0135R=Dble(C0135)
       C0135I=DImag(C0135)
       C0145=C0finGDiv(0d0,M,M,s45,p4sq,p5sq,musq,Div)
       C0145R=Dble(C0145)
       C0145I=DImag(C0145)
       C0245=C0finGDiv(0d0,M,M,s23,p4sq,s15,musq,Div)
       C0245R=Dble(C0245)
       C0245I=DImag(C0245)
        D01234=D0finGDiv(0d0,0d0,0d0,M,s12,s23,p1sq,p2sq,p3sq,s45,musq,Div)
       call tens_red4_new_Re_Com_GDiv(0d0,0d0,0d0,M,p1sq,p2sq,p3sq,p1p2,p1p3,p2p3,C0234R,
     ...
     &   Dij1234R,Dij1234I)
       D01235=D0finGDiv(0d0,0d0,0d0,M,s12,s15,p1sq,p2sq,s34,p5sq,musq,Div)
     ...
     &   ,D01235I,Dij1235R,Dij1235I)
       D01245=D0finGDiv(0d0,0d0,M,M,s45,s15,p1sq,s23,p4sq,p5sq,musq,Div)
       call tens_red4_new_Re_Com_GDiv(0d0,0d0,M,M,p1sq,s23,p4sq,p1p2+p1p3,p1p4,p2p4+p3p
     ...
     &   ,D01245I,Dij1245R,Dij1245I)
       D02345=D0finGDiv(0d0,0d0,M,M,s23,s34,p2sq,p3sq,p4sq,s15,musq,Div)
       call tens_red4_new_Re_Com_GDiv(0d0,0d0,M,M,p2sq,p3sq,p4sq,p2p3,p2p4,p3p4,C0345R,
     ...
     &   Dij2345R,Dij2345I)
       D01345=D0finGDiv(0d0,0d0,M,M,s45,s34,s12,p3sq,p4sq,p5sq,musq,Div)
       call tens_red4_new_Re_Com_GDiv(0d0,0d0,M,M,s12,p3sq,p4sq,p1p3+p2p3,p1p4+p2p4,p3p
...
c************************************************************************************
c************************************************************************************
       B012=B0finGDiv_c(m0,m0,p1sq,musq,Div)
       B012R=Dble(B012)
       B012I=DImag(B012)
       B023=B0finGDiv_c(m0,m0,p2sq,musq,Div)
       B023R=Dble(B023)
       B023I=DImag(B023)
       B034=B0finGDiv_c(m0,M1SQ,p3sq,musq,Div)
       B034R=Dble(B034)
       B034I=DImag(B034)
       B045=B0finGDiv_c(M1SQ,M1SQ,p4sq,musq,Div)
       B045R=Dble(B045)
       B045I=DImag(B045)
       B013=B0finGDiv_c(m0,m0,s12,musq,Div)
       B013R=Dble(B013)
       B013I=DImag(B013)
       B014=B0finGDiv_c(m0,M1SQ,s45,musq,Div)
       B014R=Dble(B014)
       B014I=DImag(B014)
       B024=B0finGDiv_c(m0,M1SQ,s23,musq,Div)
       B024R=Dble(B024)
       B024I=DImag(B024)
       B025=B0finGDiv_c(m0,M1SQ,s15,musq,Div)
       B025R=Dble(B025)
       B025I=DImag(B025)
       B035=B0finGDiv_c(m0,M1SQ,s34,musq,Div)
       B035R=Dble(B035)
       B035I=DImag(B035)
       B015=B0finGDiv_c(m0,M1SQ,p5sq,musq,Div)
       B015R=Dble(B015)
       B015I=DImag(B015)
        C0123=C0finGDiv_c(m0,m0,m0,p1sq,p2sq,s12,musq,Div)
       C0123R=Dble(C0123)
       C0123I=DImag(C0123)
       C0124=C0finGDiv_c(m0,m0,M1SQ,p1sq,s23,s45,musq,Div)
       C0124R=Dble(C0124)
       C0124I=DImag(C0124)
       C0125=C0finGDiv_c(m0,m0,M1SQ,p1sq,s15,p5sq,musq,Div)
       C0125R=Dble(C0125)
       C0125I=DImag(C0125)
       C0234=C0finGDiv_c(m0,m0,M1SQ,p2sq,p3sq,s23,musq,Div)
       C0234R=Dble(C0234)
       C0234I=DImag(C0234)
       C0235=C0finGDiv_c(m0,m0,M1SQ,p2sq,s34,s15,musq,Div)
       C0235R=Dble(C0235)
       C0235I=DImag(C0235)
       C0345=C0finGDiv_c(m0,M1SQ,M1SQ,p3sq,p4sq,s34,musq,Div)
       C0345R=Dble(C0345)
       C0345I=DImag(C0345)
       C0134=C0finGDiv_c(m0,m0,M1SQ,s12,p3sq,s45,musq,Div)
       C0134R=Dble(C0134)
       C0134I=DImag(C0134)
       C0135=C0finGDiv_c(m0,m0,M1SQ,s12,s34,p5sq,musq,Div)
       C0135R=Dble(C0135)
       C0135I=DImag(C0135)
       C0145=C0finGDiv_c(m0,M1SQ,M1SQ,s45,p4sq,p5sq,musq,Div)
       C0145R=Dble(C0145)
       C0145I=DImag(C0145)
       C0245=C0finGDiv_c(m0,M1SQ,M1SQ,s23,p4sq,s15,musq,Div)
       C0245R=Dble(C0245)
       C0245I=DImag(C0245)
        D01234=D0finGDiv_c(m0,m0,m0,M1SQ,s12,s23,p1sq,p2sq,p3sq,s45,musq,Div)
       call tens_red4_Complex_G_Div(m0,m0,m0,M1SQ,p1sq,p2sq,p3sq,p1p2,p1p3,p2p3,C0234R,
     &   C0134R,C0124R,C0123R,Cij234R,Cij134R,Cij124R,Cij123R,C0234I,C0134I,C
     &   0124I,C0123I,Cij234I,Cij134I,Cij124I,Cij123I,D01234,D01234R,D01234I,
     &   Dij1234R,Dij1234I)
       D01235=D0finGDiv_c(m0,m0,m0,M1SQ,s12,s15,p1sq,p2sq,s34,p5sq,musq,Div)
       call tens_red4_Complex_G_Div(m0,m0,m0,M1SQ,p1sq,p2sq,s34,p1p2,p1p3+p1p4,p2p3+p2p
     &   4,C0235R,C0135R,C0125R,C0123R,Cij235R,Cij135R,Cij125R,Cij123R,C0235I
     &   ,C0135I,C0125I,C0123I,Cij235I,Cij135I,Cij125I,Cij123I,D01235,D01235R
     &   ,D01235I,Dij1235R,Dij1235I)
       D01245=D0finGDiv_c(m0,m0,M1SQ,M1SQ,s45,s15,p1sq,s23,p4sq,p5sq,musq,Div)
       call tens_red4_Complex_G_Div(m0,m0,M1SQ,M1SQ,p1sq,s23,p4sq,p1p2+p1p3,p1p4,p2p4+p3p
     &   4,C0245R,C0145R,C0125R,C0124R,Cij245R,Cij145R,Cij125R,Cij124R,C0245I
     &   ,C0145I,C0125I,C0124I,Cij245I,Cij145I,Cij125I,Cij124I,D01245,D01245R
     &   ,D01245I,Dij1245R,Dij1245I)
       D02345=D0finGDiv_c(m0,m0,M1SQ,M1SQ,s23,s34,p2sq,p3sq,p4sq,s15,musq,Div)
       call tens_red4_Complex_G_Div(m0,m0,M1SQ,M1SQ,p2sq,p3sq,p4sq,p2p3,p2p4,p3p4,C0345R,
     &   C0245R,C0235R,C0234R,Cij345R,Cij245R,Cij235R,Cij234R,C0345I,C0245I,C
     &   0235I,C0234I,Cij345I,Cij245I,Cij235I,Cij234I,D02345,D02345R,D02345I,
     &   Dij2345R,Dij2345I)
       D01345=D0finGDiv_c(m0,m0,M1SQ,M1SQ,s45,s34,s12,p3sq,p4sq,p5sq,musq,Div)
       call tens_red4_Complex_G_Div(m0,m0,M1SQ,M1SQ,s12,p3sq,p4sq,p1p3+p2p3,p1p4+p2p4,p3p
     &   4,C0345R,C0145R,C0135R,C0134R,Cij345R,Cij145R,Cij135R,Cij134R,C0345I
     &   ,C0145I,C0135I,C0134I,Cij345I,Cij145I,Cij135I,Cij134I,D01345,D01345R
     &   ,D01345I,Dij1345R,Dij1345I)
...
c************************************************************************************
c************************************************************************************
       call HjjCrossFFhl1(F(1))
       call HjjCrossFFhl2(F(6))
c************************************************************************************
c************************************************************************************
c************************************************************************************
       endif  
...
c************************************************************************************
c************************************************************************************
       SMB0(1) = SC1r(barpsi_p2_M,p1,psi_p3_M,-1)
       SMB0(2) = SC1r(barpsi_p5_M,p3,psi_p1_M,-1)
       SMB0(3) = SC1r(barpsi_p2_M,p5,psi_p3_M,-1)
       SMB0(4) = SC1r(barpsi_p5_M,p2,psi_p1_M,-1)
c************************************************************************************
c************************************************************************************
      do i=0,3
        v1(0)=delta(i,0)
        ...
        v1(2)=delta(i,2)
        v1(3)=delta(i,3)
       SMB11(i) = SC1c(barpsi_p2_M,v1,psi_p3_M,-1)
...
c  c So, I*(I)=(-1)!!!
       result(1) = F(1)*SMB(1)-4*(F(2)*SMB(2)+F(3)*SMB(3))+F(4)*SMB(4)
     &   +F(5)*SMB(5)+F(6)*SMB(6)+F(7)*SMB(7)+F(8)*SMB(8)+F(9)*SMB(9)
     &   +F(10)*SMB(10)
       result(1) =-result(1)
       resultborn = SMB(1)/((s15-M1SQ)*(s23-M1SQ))
c************************************************************************************
c************************************************************************************
c************************************************************************************
       Return
