       subroutine HjjCrossFFhl2(F2)
       IMPLICIT NONE
       Real*8 P(4),FRe(6:10),FIm(6:10)
       Complex*16 F2(6:10)
       Real*8   p1sq 
       Real*8   p2sq 
       Real*8   p3sq 
...
c************************************************************************************
     ...
     &   (9,2)
       ...
       FRe(8) = EijR(3,1)-EijR(4,1)+EijR(4,2)+EijR(6,2)-EijR(7,2)-EijR
     &   (10,2)
       FIm(8) = EijI(3,1)-EijI(4,1)+EijI(4,2)+EijI(6,2)-EijI(7,2)-EijI
     &   (10,2)
       F2(8)=DCMPLX(FRe(8),FIm(8))
       FRe(9) = EijR(4,2)-EijR(9,2)
       FIm(9) = EijI(4,2)-EijI(9,2)
