...
c************************************************************************************
c************************************************************************************
       subroutine HjjCrossF66Div(M1SQ,p1,p2,p3,p4,p5,barpsi_p1,psi_p5,
     &   psi_p2,barpsi_p3,musq,comp,ngluon,posgluon,result,resultborn
     &   ,Div)
c************************************************************************************
c************************************************************************************
...
c************************************************************************************
      ...
      Complex*16 SMB1(3)
      Real*8 FI(10),FR(10)
      Complex*16 barpsi_p1_P(2),psi_p5_P(2),psi_p2_P(2),barpsi_p3_P(2) 
       Complex*16 barpsi_p1_M(2),psi_p5_M(2),psi_p2_M(2),barpsi_p3_M(2)
...
c************************************************************************************
      ...
      Integer alpha
       COMMON/HjjCrossFFhlFunctions/F
      Save/HjjCrossFFhlFunctions/
       COMMON/HjjCrossFPFunctions/P
      Save/HjjCrossFPFunctions/
...
c************************************************************************************
c************************************************************************************
       call HjjCrossFFFhl1(F(1))
       call HjjCrossFFFhl2(F(6))
c************************************************************************************
c************************************************************************************
c************************************************************************************
       endif  
...
c************************************************************************************
       ...
       SMB0(2) = SC1r(barpsi_p3_P,p5,psi_p2_P,+1)
       SMB0(3) = SC1r(barpsi_p1_P,p3,psi_p5_P,+1)
       SMB0(4) = SC1r(barpsi_p3_P,p1,psi_p2_P,+1)
c************************************************************************************
c************************************************************************************
      do i=0,3
        v1(0)=delta(i,0)
       ...
       SMB12(i) = SC1c(barpsi_p3_P,v1,psi_p2_P,+1)
      enddo
c************************************************************************************
c************************************************************************************
c************************************************************************************
