       subroutine boxlineABEmm(p1,p2,p3,p4,barpsi_p4,psi_p1,mup2,mup3,
...
c************************************************************************************
     ...
     -          p4mup2, p4mup3
       ...
       Real*8 dotrr
       Complex*16 B0finG,C0finG,D0finG
       EXTERNAL dotrr,B0finG,C0finG,D0finG
...
c************************************************************************************
c************************************************************************************
c       B012=B0fin(p1sq,musq)            
c       B013=B0fin(s12,musq)   
c       B014=B0fin(p4sq,musq)   
c       B023=B0fin(p2sq,musq)  
c       B024=B0fin(s23,musq)   
c       B034=B0fin(p3sq,musq) 
c 
       B012=B0finG(0d0,0d0,p1sq,musq)            
       B013=B0finG(0d0,0d0,s12,musq)   
       B014=B0finG(0d0,0d0,p4sq,musq)   
...
c************************************************************************************
c************************************************************************************
c       C0123=C0fin(p1sq,p2sq,s12,musq)  
c       C0124=C0fin(p1sq,s23,p4sq,musq)  
c       C0134=C0fin(s12,p3sq,p4sq,musq)  
c       C0234=C0fin(p2sq,p3sq,s23,musq)  

       C0123=C0finG(0d0,0d0,0d0,p1sq,p2sq,s12,musq)  
       C0124=C0finG(0d0,0d0,0d0,p1sq,s23,p4sq,musq)  
       C0134=C0finG(0d0,0d0,0d0,s12,p3sq,p4sq,musq)  
...
c************************************************************************************
c************************************************************************************
c       D01234=D0fin(s12,s23,p1sq,p2sq,p3sq,p4sq,musq)
        D01234=D0finG(0d0,0d0,0d0,0d0,s12,s23,
     $      p1sq,p2sq,p3sq,p4sq,musq)
...
c************************************************************************************
       ...
       End
c************** Calling the Fa functions**********************************************************************
       subroutine FaFunctionABEmm(p1mup2, p1mup3,p2mup2, p2mup3,p3mup2
     ...
     -          p4mup2, p4mup3
       Complex*16 mup2mup3
        common/invarianetsmm/p1sq,p2sq,p3sq,p4sq,s12,s23,Is12
      Real*8 p1sq,p2sq,p3sq,p4sq,s12,s23,Is12
       common/FfunctionsABEmm/F
       common/PfunctionsABEmm/P
       common/KfunctionsABEmm/K
      Complex*16 Fa(5),F(27),K(1)
       Real*8 P(18) 
        Fa(1) = p1mup2*F(2)+p2mup2*F(3)
       Fa(2) = p1mup3*F(6)+p4mup3*F(7)+p2mup3*F(8)
       Fa(3) = p1mup3*F(12)+p2mup3*F(13)+p4mup3*F(14)
       Fa(4) = p2mup2*F(15)+p4mup2*F(16)+p1mup2*F(17)
       Fa(5) = p1mup2*p1mup3*F(18)+p1mup3*p2mup2*F(19)+p1mup3*p4mup2*F
     -   (20)+p1mup2*p2mup3*F(21)+p2mup2*p2mup3*F(22)+p1mup2*p4mup3*F
     -   (23)+p2mup2*p4mup3*F(24)+p4mup2*p4mup3*F(25)+mup2mup3*F(26)+
     -   8*p2mup3*p4mup2*K(1)
       Return
       End
