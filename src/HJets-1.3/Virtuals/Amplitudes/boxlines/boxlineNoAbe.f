       subroutine boxlineNoAbemm(p1,p2,p3,p4,barpsi_p3,psi_p1,mup2,mup
...
c       D01234=D0fin(s12,s23,p1sq,p2sq,p3sq,p4sq,musq)
       D01234=D0finG(0d0,0d0,0d0,0d0,s12,s23,p1sq,p2sq,p3sq,p4sq,musq)
c************************************************************************************
c************************************************************************************
...
c************************************************************************************
       ...
       End
c************** Calling the Fa functions**********************************************************************
       subroutine FaFunctionNoAbemm(p1mup2, p1mup4,p2mup2,p2mup4,p3mup
     -   2, p3mup4,p4mup2,p4mup4,mup2mup4,Fa)
       IMPLICIT NONE
      Complex*16   p1mup2, p1mup4, p2mup2, p2mup4, p3mup2, p3mup4, 
     -          p4mup2, p4mup4
       Complex*16 mup2mup4
        common/FfunctionsNoAbemm/F
      Complex*16 Fa(3),F(17)
      Real*8 P(35) 
        Fa(1) = -(p2mup4*F(1))+p3mup4*F(2)+p4mup4*F(3)
       Fa(2) = -(p2mup2*F(4))+p3mup2*F(5)+p4mup2*F(6)
       Fa(3) = p2mup2*p2mup4*F(7)+mup2mup4*F(8)+p2mup4*p4mup2*F(9)+p2m
     -   up2*p4mup4*F(10)+p2mup4*p3mup2*F(11)+p2mup2*p3mup4*F(12)+p3m
     -   up4*p4mup2*F(13)+p3mup2*p3mup4*F(14)+p3mup2*p4mup4*F(15)+p4m
     -   up2*p4mup4*F(16)
       Return
       End
