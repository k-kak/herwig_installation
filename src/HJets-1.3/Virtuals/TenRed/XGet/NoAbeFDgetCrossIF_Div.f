       subroutine FgetNoAbeCrossIF_Div_c(M1SQ,p1,p2,p3,p4,p5,p6,musq,id)
       IMPLICIT NONE
       integer id
       ...
       Complex*16 A0finGDiv_c,B0finGDiv_c,C0finGDiv_c,D0finGDiv_C
       EXTERNAL A0finGDiv_c,B0finGDiv_c,C0finGDiv_c,D0finGDiv_c
       complex*16 E0finG_c,F0finG_c
       external E0finG_c, F0finG_c
       real*8   dotrr
       external dotrr
       ...
       COMMON/NoAbeH3jCrossIFInvariants/p1sq,p2sq,p3sq,p4sq,p5sq,p6sq,s12,s23,s34,
     &   s45,s56,s16,s123,s234,s345
       COMMON/NoAbeH3jCrossIFFVALFunctions/F0123456R,F123456R,F0123456I,F123456I
       COMMON/NoAbeH3jCrossIFEVALFunctions/ E012345R,E12345R,E012345I,E12345I, E01
     ...
     &   013456I,E13456I, E023456R,E23456R,E023456I,E23456I
       COMMON/NoAbeH3jCrossIFDVALFunctions/ D01234R,D1234R,D01234I,D1234I, D01235R
     ...
     &   3456I
       COMMON/NoAbeH3jCrossIFCVALFunctions/ C0123R,C123R,C0123I,C123I, C0124R,C124
     ...
     &   R,C456R,C0456I,C456I
       COMMON/NoAbeH3jCrossIFBVALFunctions/ B012R,B012I, B013R,B013I, B014R,B014I,
...
C fc %     & C0123,C0123R,C0123I,C123R,C123I)
      C0126=C0finGDiv_c(m0,m0,M1SQ,p1sq,s16,p6sq,musq,id)
      C0126R=Dble(C0126)
      C0126I=DImag(C0126)
...
C fc %     & C0126,C0126R,C0126I,C126R,C126I)
      C0124=C0finGDiv_c(m0,m0,m0,p1sq,s23,s123,musq,id)
      C0124R=Dble(C0124)
      C0124I=DImag(C0124)
...
C fc %     & C0124,C0124R,C0124I,C124R,C124I)
      C0125=C0finGDiv_c(m0,m0,M1SQ,p1sq,s234,s56,musq,id)
      C0125R=Dble(C0125)
      C0125I=DImag(C0125)
...
C fc %     & C0125,C0125R,C0125I,C125R,C125I)
      C0234=C0finGDiv_c(m0,m0,m0,p2sq,p3sq,s23,musq,id)
      C0234R=Dble(C0234)
      C0234I=DImag(C0234)
...
C fc %     & C0234,C0234R,C0234I,C234R,C234I)
      C0235=C0finGDiv_c(m0,m0,M1SQ,p2sq,s34,s234,musq,id)
      C0235R=Dble(C0235)
      C0235I=DImag(C0235)
...
C fc %     & C0235,C0235R,C0235I,C235R,C235I)
      C0236=C0finGDiv_c(m0,m0,M1SQ,p2sq,s345,s16,musq,id)
      C0236R=Dble(C0236)
      C0236I=DImag(C0236)
...
C fc %     & C0236,C0236R,C0236I,C236R,C236I)
      C0345=C0finGDiv_c(m0,m0,M1SQ,p3sq,p4sq,s34,musq,id)
      C0345R=Dble(C0345)
      C0345I=DImag(C0345)
...
C fc %     & C0345,C0345R,C0345I,C345R,C345I)
      C0346=C0finGDiv_c(m0,m0,M1SQ,p3sq,s45,s345,musq,id)
      C0346R=Dble(C0346)
      C0346I=DImag(C0346)
...
C fc %     & C0346,C0346R,C0346I,C346R,C346I)
      C0456=C0finGDiv_c(m0,M1SQ,M1SQ,p4sq,p5sq,s45,musq,id)
      C0456R=Dble(C0456)
      C0456I=DImag(C0456)
...
C fc %     & C0456,C0456R,C0456I,C456R,C456I)
      C0134=C0finGDiv_c(m0,m0,m0,s12,p3sq,s123,musq,id)
      C0134R=Dble(C0134)
      C0134I=DImag(C0134)
...
C fc %     & C0134,C0134R,C0134I,C134R,C134I)
      C0135=C0finGDiv_c(m0,m0,M1SQ,s12,s34,s56,musq,id)
      C0135R=Dble(C0135)
      C0135I=DImag(C0135)
...
C fc %     & C0135,C0135R,C0135I,C135R,C135I)
      C0136=C0finGDiv_c(m0,m0,M1SQ,s12,s345,p6sq,musq,id)
      C0136R=Dble(C0136)
      C0136I=DImag(C0136)
...
C fc %     & C0136,C0136R,C0136I,C136R,C136I)
      C0145=C0finGDiv_c(m0,m0,M1SQ,s123,p4sq,s56,musq,id)
      C0145R=Dble(C0145)
      C0145I=DImag(C0145)
...
C fc %     & C0145,C0145R,C0145I,C145R,C145I)
      C0146=C0finGDiv_c(m0,m0,M1SQ,s123,s45,p6sq,musq,id)
      C0146R=Dble(C0146)
      C0146I=DImag(C0146)
...
C fc %     & C0146,C0146R,C0146I,C146R,C146I)
      C0245=C0finGDiv_c(m0,m0,M1SQ,s23,p4sq,s234,musq,id)
      C0245R=Dble(C0245)
      C0245I=DImag(C0245)
...
C fc %     & C0245,C0245R,C0245I,C245R,C245I)
      C0246=C0finGDiv_c(m0,m0,M1SQ,s23,s45,s16,musq,id)
      C0246R=Dble(C0246)
      C0246I=DImag(C0246)
...
C fc %     & C0246,C0246R,C0246I,C246R,C246I)
      C0256=C0finGDiv_c(m0,M1SQ,M1SQ,s234,p5sq,s16,musq,id)
      C0256R=Dble(C0256)
      C0256I=DImag(C0256)
...
C fc %     & C0256,C0256R,C0256I,C256R,C256I)
      C0356=C0finGDiv_c(m0,M1SQ,M1SQ,s34,p5sq,s345,musq,id)
      C0356R=Dble(C0356)
      C0356I=DImag(C0356)
...
C fc %     & C0356,C0356R,C0356I,C356R,C356I)
      C0156=C0finGDiv_c(m0,M1SQ,M1SQ,s56,p5sq,p6sq,musq,id)
      C0156R=Dble(C0156)
      C0156I=DImag(C0156)
...
C fc %     & C0156,C0156R,C0156I,C156R,C156I)
      ...
      D01234=D0finGDiv_c(m0,m0,m0,m0,s12,s23,p1sq,p2sq,p3sq,s123,musq,id)
      call tens_red4_Complex_G_Div(m0,m0,m0,m0,p1sq,p2sq,p3sq,p1p2,p1p3,p2p3,C0234R,
     &   C0134R,C0124R,C0123R,C234R,C134R,C124R,C123R,C0234I,C0134I,C
     &   0124I,C0123I,C234I,C134I,C124I,C123I,D01234,D01234R,D01234I,
     &   D1234R,D1234I)
      D01235=D0finGDiv_c(m0,m0,m0,M1SQ,s12,s234,p1sq,p2sq,s34,s56,musq,id)
      call tens_red4_Complex_G_Div(m0,m0,m0,M1SQ,p1sq,p2sq,s34,p1p2,p1p3+p1p4,p2p3+p2p
     &   4,C0235R,C0135R,C0125R,C0123R,C235R,C135R,C125R,C123R,C0235I
     &   ,C0135I,C0125I,C0123I,C235I,C135I,C125I,C123I,D01235,D01235R
     &   ,D01235I,D1235R,D1235I)
      D01236=D0finGDiv_c(m0,m0,m0,M1SQ,s12,s16,p1sq,p2sq,s345,p6sq,musq,id)
      call tens_red4_Complex_G_Div(m0,m0,m0,M1SQ,p1sq,p2sq,s345,p1p2,p1p3+p1p4+p1p5,p2
     &   p3+p2p4+p2p5,C0236R,C0136R,C0126R,C0123R,C236R,C136R,C126R,C
     &   123R,C0236I,C0136I,C0126I,C0123I,C236I,C136I,C126I,C123I,D01
     &   236,D01236R,D01236I,D1236R,D1236I)
      D01245=D0finGDiv_c(m0,m0,m0,M1SQ,s123,s234,p1sq,s23,p4sq,s56,musq,id)
      call tens_red4_Complex_G_Div(m0,m0,m0,M1SQ,p1sq,s23,p4sq,p1p2+p1p3,p1p4,p2p4+p3p
     &   4,C0245R,C0145R,C0125R,C0124R,C245R,C145R,C125R,C124R,C0245I
     &   ,C0145I,C0125I,C0124I,C245I,C145I,C125I,C124I,D01245,D01245R
     &   ,D01245I,D1245R,D1245I)
      D01246=D0finGDiv_c(m0,m0,m0,M1SQ,s123,s16,p1sq,s23,s45,p6sq,musq,id)
      call tens_red4_Complex_G_Div(m0,m0,m0,M1SQ,p1sq,s23,s45,p1p2+p1p3,p1p4+p1p5,p2p4
     &   +p2p5+p3p4+p3p5,C0246R,C0146R,C0126R,C0124R,C246R,C146R,C126
     &   R,C124R,C0246I,C0146I,C0126I,C0124I,C246I,C146I,C126I,C124I,
     &   D01246,D01246R,D01246I,D1246R,D1246I)
      D01256=D0finGDiv_c(m0,m0,M1SQ,M1SQ,s56,s16,p1sq,s234,p5sq,p6sq,musq,id)
      call tens_red4_Complex_G_Div(m0,m0,M1SQ,M1SQ,p1sq,s234,p5sq,p1p2+p1p3+p1p4,p1p5,p2
     &   p5+p3p5+p4p5,C0256R,C0156R,C0126R,C0125R,C256R,C156R,C126R,C
     &   125R,C0256I,C0156I,C0126I,C0125I,C256I,C156I,C126I,C125I,D01
     &   256,D01256R,D01256I,D1256R,D1256I)
      D02345=D0finGDiv_c(m0,m0,m0,M1SQ,s23,s34,p2sq,p3sq,p4sq,s234,musq,id)
      call tens_red4_Complex_G_Div(m0,m0,m0,M1SQ,p2sq,p3sq,p4sq,p2p3,p2p4,p3p4,C0345R,
     &   C0245R,C0235R,C0234R,C345R,C245R,C235R,C234R,C0345I,C0245I,C
     &   0235I,C0234I,C345I,C245I,C235I,C234I,D02345,D02345R,D02345I,
     &   D2345R,D2345I)
      D02346=D0finGDiv_c(m0,m0,m0,M1SQ,s23,s345,p2sq,p3sq,s45,s16,musq,id)
      call tens_red4_Complex_G_Div(m0,m0,m0,M1SQ,p2sq,p3sq,s45,p2p3,p2p4+p2p5,p3p4+p3p
     &   5,C0346R,C0246R,C0236R,C0234R,C346R,C246R,C236R,C234R,C0346I
     &   ,C0246I,C0236I,C0234I,C346I,C246I,C236I,C234I,D02346,D02346R
     &   ,D02346I,D2346R,D2346I)
      D02356=D0finGDiv_c(m0,m0,M1SQ,M1SQ,