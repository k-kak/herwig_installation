       subroutine tens_red3_new_Re_Com_GDiv(m0,m1,m2,p1sq,p2sq,s12,
...
c       Print*, "HERE, CijI(1,1)",CijI(1,1),PRI(1),PRI(2),iz11,iz22,PRI(1)-z12*RI(2)
...
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
      ...
      Cijr(4,2) = ( B0r_23 +2d0*m0sq*C0r + Cijr(1,1)*r1r0 +Cijr(2,1)*r2r1)*0.25d0
      CijI(4,2) = ( B0I_23 +2d0*m0sq*C0I + CijI(1,1)*r1r0 +CijI(2,1)*r2r1)*0.25d0    
c 3-5
