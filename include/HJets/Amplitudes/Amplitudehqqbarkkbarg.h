// -*- C++ -*-
//
// Amplitudehqqbarkkbarg.h is a part of HJets
...
//
#ifndef HJets_Amplitudehqqbarkkbarg_H
#define HJets_Amplitudehqqbarkkbarg_H
//
// This is the declaration of the Amplitudehqqbarkkbarg class.
//
...
/**
 * \brief Tree level helicity amplitudes for 0 -> h q qbar k kbar g
 */
class Amplitudehqqbarkkbarg: 
...
public:
   ...
   */
  Amplitudehqqbarkkbarg();

  /**
   * The destructor.
   */
  virtual ~Amplitudehqqbarkkbarg();
  //@}
...
public:
   ...
   */
  virtual int nPartons() const { return 5; }
...
private:
   ...
   */
  Amplitudehqqbarkkbarg & operator=(const Amplitudehqqbarkkbarg &);

  /**
   * The threshold for gauge check failure
   */
  double theGaugeThreshold;
  bool theAccuracyCheck;

};

}

#endif /* HJets_Amplitudehqqbarkkbarg_H */
